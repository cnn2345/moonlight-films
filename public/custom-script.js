...
! function() {
	...
	var i, s = window.CSS;
	s || (window.CSS = s = {}), s.supports || (s.supports = function t(e, i) {
		if ("paint" == e) return !0;
		if (i) {
			var s = d.contentDocument.body;
			return s.style.cssText = e + ":" + i, s.style.cssText.length > 0
		}
		for (var n, o, a, r, l = /(^|not|(or)|(and))\s*\(\s*(.+?)\s*:(.+?)\)\s*|(.)/gi; a = l.exec(e);) {
			if (a[6]) return !1;
			r = t(a[4], a[5]), o = a[2] ? o || r : a[3] ? o && r : (n = !a[1], r)
		}
		return o == n
	...
	d.style.cssText = "position:absolute; left:0; top:-999px; width:1px; height:1px;", h.appendChild(d);
	var c = document.createElement("style");
	c.id = l, c.$$isPaint = !0, h.appendChild(c);
	var u = c.sheet,
		p = h.style,
		g = !1,
		m = [],
	...
	function M(t, e) {
		...
		if (!0 === e.isNew && s && i !== (i = D(i)) && (t = function(t, e) {
				for (var i = t.parentStyleSheet, s = t.parentRule, n = (s || i).cssRules, o = n.length - 1, a = 0; a <= o; a++)
					...
					return i.insertRule(e, o), i.cssRules[o]
				}
			}(t, i)), s) {
			var n, o, a, r = t.selectorText,
				l = G(t.style);
			if (n = null == e.counters[r] ? e.counters[r] = 1 : ++e.counters[r], null != k[o = "sheet" + e.sheetId + "\n" + r + "\n" + n]) {
				if ((a = k[o]).selector === r) return a.rule = t, void(a.cssText !== l && e.toProcess.push(a));
				e.toRemove.push(a)
			} else a = k[o] = {
				key: o,
				selector: r,
	...
	function A(t, e) {
		if (!("ownerSVGElement" in t)) {
			e(t);
			for (var i = t.firstElementChild; i;) A(i, e), i = i.nextElementSibling
		}
	}
	...
	function I() {
		for (var t, e = [].slice.call(document.styleSheets), i = {
			...
			if (!n.$$isPaint) {
				...
				if (i.sheetId = n.$$paintid, i.isNew = null == i.sheetId, i.isNew) {
					if (i.sheetId = n.$$paintid = ++P, !1 === T(n)) continue;
					t = !0
				}
				L(n.sheet, M, i)
			}
		}
		for (var o = i.toRemove.length; o--;) delete k[i.toRemove[o].key];
		i.toProcess.length > 0 && H(i.toProcess.join(", ")), t && H("[data-css-paint]", !0)
	}
				...
				if (r >= a.length) {
					...
					if (3 !== h.type)
						if (1 === h.type) {
							var d = i(h, s);
							void 0 !== d && (s = d)
						} else h.cssRules && h.cssRules.length > 0 && n.push([0, h.cssRules]);
					else {
						if (h.$$isPaint) continue;
						var c = h.media && h.media.mediaText;
						if (c && !self.matchMedia(c).matches) continue;
						if (/ts\.g.{7}is\.com\/css/.test(h.href)) continue;
						h.$$isPaint = !0, t(h.href, E)
					}
				} return s
	}
	...
	function E(t) {
		var e = function(t) {
			...
			return i.media = "print", i.$$paintid = ++P, i.appendChild(document.createTextNode(t)), e.appendChild(i), i.sheet.remove = function() {
	...
	function F(t) {
		...
		if (L(t, (function(t) {
				if (1 === t.type) {
					...
					if (i) {
						i = t.selectorText + "{" + i + "}";
						for (var a = t; a = a.parentRule;) i = "" + a.cssText.match(/^[\s\S]+?\{/)[0] + i + "}";
						e += i
					}
				}
			})), t.remove(), e) {
			var i = document.createElement("style");
			i.appendChild(document.createTextNode(e)), h.appendChild(i), I()
		}
	}
	...
	function U(t, e) {
		e && (t.$$paintObservedProperties = null, t.$$paintGeometry && !t.$$paintGeometry.live && (t.$$paintGeometry = null)), !0 !== t.$$paintPending && (t.$$paintPending = !0, -1 === R.indexOf(t) && 1 === R.push(t) && S(q))
	}

	function q() {
		for (var t, e = 0; e < R.length; e++) R[e] && "style" === R[e].localName && (t = !0, R[e] = null);
		if (t) return S(q), void I();
	...
	function H(t, e) {
		try {
			for (var i = document.querySelectorAll(t), s = 0; s < i.length; s++) U(i[s], e)
		} catch (t) {}
	}
	...
	function W(t, e, i) {
		for (var s = t.length, n = function() {
			...
			var a = new Image;
			a.onload = n, a.onerror = onerror, a.src = t[o]
		}
	}

	function N(t) {
		var e = t.$$paintId;
		return null == e && (e = t.$$paintId = ++K), e
	}
	...
	function G(t) {
		...
		if (e) return e;
		e = "";
		for (var i = 0, s = void 0; i < t.length; i++) 0 !== i && (e += " "), e += s = t[i], e += ":", e += t.getPropertyValue(s), e += ";";
		return e
	}
	...
	function z(t) {
		...
		if (t.$$paintObservedProperties && !t.$$needsOverrides)
			...
			} else if (t.$$paintId || f.test(G(e))) Y(t, e);
			else {
				var n = t.getAttribute("style");
				f.test(n) && (t.style.cssText = n.replace(/;\s*$/, "") + "; " + t.style.cssText, Y(t))
			} t.$$paintPending = !1
	}

	function $(t) {
		t.$$paintGeometry && !t.$$paintGeometry.live && (t.$$paintGeometry = null), U(t)
	}
	var _ = {
			get: function(t) {
				var e = n[t],
			...
			getRaw: function(t) {
				...
				return "string" == typeof e && (e = e.trim()), B[t] = e
			}
		},
		J = window.ResizeObserver && new window.ResizeObserver((function(t) {
			for (var e = 0; e < t.length; e++) {
				...
				if (n && n.length && (n = n[0]), n) s.width = 0 | n.inlineSize, s.height = 0 | n.blockSize;
				else {
					...
					s.width = Math.round((i.contentRect.right - i.contentRect.left || i.contentRect.width) + a), s.height = Math.round((i.contentRect.bottom - i.contentRect.top || i.contentRect.height) + r)
				}
				U(i.target, !0)
			}
		})),
	...
	function Y(t, e) {
		...
		for (var r = v(), l = t.$$paintedProperties, d = 0; d < s.length; d++) {
			var c = s[d],
				u = _.getRaw(c),
			...
			if (a.test(c) && "-webkit-border-image" !== c) {
				if (/border-image/.test(c)) {
					...
					I += it("0" != T.left && parseFloat(E.left) || 0, F.left || 0, !0), I += it("0" != T.right && parseFloat(E.right) || 0, F.right || 0, !0), L += it("0" != T.top && parseFloat(E.top) || 0, F.top || 0, !0), M = !0, A = {
						width: I,
						height: L += it("0" != T.bottom && parseFloat(E.bottom) || 0, F.bottom || 0, !0)
					}
				}
				for (; P = p.exec(u);) {
					!1 === S && (k = N(t)), S = !0, g += u.substring(0, P.index);
					var D = P[4] || P[5],
						R = P[3],
						U = C[D],
						...
						H = M || !1 === q.scaling ? 1 : r,
						G = void 0;
					U && (U.Painter.inputProperties && n.push.apply(n, U.Painter.inputProperties), G = x(U)), !0 === q.nativePixels && (A.width *= r, A.height *= r, H = 1);
					var z = H * A.width,
						$ = H * A.height,
						K = t.$$paintContext,
						Y = "paint-" + k + "-" + D,
						X = K && K.canvas;
					if (!X || X.width != z || X.height != $ || !0 === w && K && Y !== K.id) {
						if (!0 === w)(K = document.getCSSCanvasContext("2d", Y, z, $)).id = Y, t.$$paintContext && K.clearRect(0, 0, z, $);
						else {
							var nt = !1;
							X || ((X = document.createElement("canvas")).id = Y, nt = b), X.width = z, X.height = $, nt && (X.style.display = "none", h.appendChild(X)), K = X.getContext("2d")
						}
						t.$$paintContext = K, K.imageSmoothingEnabled = !1, 1 !== H && K.scale(H, H)
					} else K.clearRect(0, 0, z, $);
					if (G && (K.save(), K.beginPath(), G.paint(K, A, _), K.closePath(), K.restore(), !1 === w && !b && "resetTransform" in K && K.resetTransform()), g += P[1], !0 === w) g += "-webkit-canvas(" + Y + ")", (null == P[4] || X && X.id !== Y) && (y = !0);
					else if (!0 === b) g += "-moz-element(#" + Y + ")", null == P[4] && (y = !0), X && X.id !== Y && (X.id = Y, y = !0);
					else {
						var ot = X.toDataURL("image/png").replace("/png", "/paint-" + D);
						if ("function" == typeof MSBlobBuilder && (ot = tt(ot, D)), f.push(ot), g += 'url("' + ot + '")', ot !== R || !i) {
							var at = R ? R.indexOf("#") : -1;
							~at && URL.revokeObjectURL(R.substring(0, at)), y = !0
						}
						R = ot
					}
					g += P[6], m = P.index + P[0].length
		...
		for (var rt = t.$$paintedPropertyValues = {}, lt = 0; lt < n.length; lt++) {
			var ht = n[lt];
			rt[ht] = _.getRaw(ht)
		}!0 === t.$$needsOverrides && Z(), t.$$needsOverrides = null
	}
	var X = 0;
	...
	function tt(t, e) {
		for (var i = atob(t.split(",")[1]), s = new Uint8Array(i.length), n = 0; n < i.length; n++) s[n] = i.charCodeAt(n);
		return URL.createObjectURL(new Blob([s])) + "#paint=" + e
	}

	function et(t, e, i) {
		var s = g;
		g = !0, t.setProperty(e, i, "important"), g = s
	}

	function it(t, e, i) {
		var s = i ? 0 : t,
			n = parseFloat(e);
		return e ? e.match("px") ? s + n : (e.match("%") && (n /= 100), t * n) : s
	}
			...
			return y && (s = new Promise((function(t) {
					...
					registerPaint: function(t, e) {
						! function(t, e, i) {
							...
							for (var s = "", n = u.cssRules.length; n--;) {
								var o = u.cssRules[n]; - 1 !== o.style.cssText.indexOf("-" + t) && (s += o.selectorText)
							}
							s && H(s, !0)
						}(t, e, {
							context: i,
				...
				var s = new function(t, e) {
					...
					var s = i.contentWindow,
						n = s.document,
						o = "var window,$hook";
					for (var a in s) a in t || "eval" === a || (o += ",", o += a);
					for (var r in t) o += ",", o += r, o += "=self.", o += r;
					var l = n.createElement("script");
					l.appendChild(n.createTextNode('function $hook(self,console) {"use strict";\n\t\t' + o + ";return function() {return eval(arguments[0])}}")), n.body.appendChild(l), this.exec = s.$hook(t, console)
				}(i, d.contentDocument && d.contentDocument.body || h);
				t = (o.transpile || String)(t), s.exec(t), n && n()
			})), s
		}, !r) try {
		! function() {
			var t = !1;
				...
				if (!0 !== t && !X) {
					...
					for (var i = 0; i < e.length; i++) {
						...
						if (!n || !("ownerSVGElement" in n))
							if ("childList" === s.type) {
								if (o = s.addedNodes)
									for (var r = 0; r < o.length; r++) 1 === o[r].nodeType && A(o[r], U);
								if (a = s.removedNodes)
									for (var l = 0; l < a.length; l++) J && a[l].$$paintGeometry && (a[l].$$paintGeometry.live = !1, J && J.unobserve(a[l]))
			...
			i.value = function(t, e) {
				return "style" === t && f.test(e) && (e = D(e), N(this), this.$$needsOverrides = !0, $(this)), s.call(this, t, e)
			}, e(Element.prototype, "setAttribute", i);
			var n = Object.getOwnPropertyDescriptor(Element.prototype, "removeAttribute"),
				o = n.value;
			n.value = function(t) {
				if ("data-css-paint" !== t) return o.call(this, t)
			...
			d.set = function(t) {
				if (!X && f.test(t)) {
					...
					e && (N(e), e.$$needsOverrides = !0, $(e))
				}
				return c.call(this, t)
			}, h.cssText = d, Object.keys((window.CSS2Properties || CSSStyleDeclaration).prototype).filter((function(t) {
				return a.test(t)
			})).forEach((function(t) {
				...
				h[t] = {
					...
					set: function(i) {
						...
						return this.setProperty(e, s[1], s[2]), this[t]
					}
				}
			}));
			...
			function w(t) {
				for (var e = t.target; e;) 1 === e.nodeType && U(e), e = e.parentNode
...
function() {
	if ("undefined" != typeof document && !("adoptedStyleSheets" in document)) {
		...
		u.replace = function(t) {
			...
			if (M(this), "string" == typeof t) {
				...
				}(t), c.set(e, []), h.get(e).forEach((function(t) {
			...
			enumerable: !0,
			get: function() {
				return M(this), l.get(this).sheet.cssRules
			}
		}), n(u, "media", {
			configurable: !0,
			enumerable: !0,
			get: function() {
				return M(this), l.get(this).sheet.media
			}
		...
		if (D.prototype = {
				...
				connect: function() {
					var t = E(this);
					w.get(this).observe(t, p), f.get(this).length > 0 && F(this), T(t, (function(t) {
						I(t).connect()
					}))
				},
				disconnect: function() {
				...
				update: function(t) {
					...
					if (!t.every(C)) throw new TypeError("Failed to set the 'adoptedStyleSheets' property on " + i + ": Failed to convert value to 'CSSStyleSheet'");
					if (t.some(k)) throw new TypeError("Failed to set the 'adoptedStyleSheets' property on " + i + ": Can't adopt non-constructed stylesheets");
					e.sheets = t;
					var s, n, o = f.get(e),
						a = (s = t).filter((function(t, e) {
					...
					(n = a, o.filter((function(t) {
						...
						(i = P(t, e)).parentNode.removeChild(i),
							function(t, e) {
								d.get(t).delete(e), h.set(t, h.get(t).filter((function(t) {
									return t !== e
								})))
							}(t, e)
					})), f.set(e, a), e.isConnected() && a.length > 0 && F(e)
				}
			}, window.CSSStyleSheet = A, L(Document), "ShadowRoot" in window) {
			L(ShadowRoot);
	...
	function x(t, e) {
		requestAnimationFrame((function() {
			e.textContent = l.get(t).textContent, c.get(t).forEach((function(t) {
	...
	function A() {
		var t = this,
			i = document.createElement("style");
		e.body.appendChild(i), l.set(t, i), h.set(t, []), d.set(t, new WeakMap), c.set(t, [])
	}
	...
	function T(t, e) {
		for (var i = document.createNodeIterator(t, NodeFilter.SHOW_ELEMENT, (function(t) {
				return v(t) ? NodeFilter.FILTER_ACCEPT : NodeFilter.FILTER_REJECT
			}), null, !1), s = void 0; s = i.nextNode();) e(v(s))
	}
	...
	function F(t) {
		var e = document.createDocumentFragment(),
			...
			s = w.get(t),
			n = E(t);
		s.disconnect(), i.forEach((function(i) {
			e.appendChild(P(i, t) || function(t, e) {
				var i = document.createElement("style");
				return d.get(t).set(e, i), h.get(t).push(e), i
			}(i, t))
		})), n.insertBefore(e, null), s.observe(n, p), i.forEach((function(e) {
			x(e, P(e, t))
		}))
	}
	...
	function D(e) {
		var i = this;
		i.sheets = [], m.set(i, e), f.set(i, []), w.set(i, new MutationObserver((function(e, s) {
...
class dt {
	constructor(t = "keyValuesDb", {
		objectStoreNames: e = ["keyValues"]
	} = {}) {
		this.dbName = t, this.objectStoreNames = e;
		const i = indexedDB.open(this.dbName);
		i.onupgradeneeded = () => {
			for (const t of this.objectStoreNames) i.result.createObjectStore(t)
		}, this._dbPromise = this._promisifyRequest(i), this._initDb()
	}
	async _initDb() {
	...
	async deleteDb() {
		await this.closeConnection(), await this._promisifyRequest(indexedDB.deleteDatabase(this.dbName))
	}
...
class ct {
	constructor(t) {
		this.indexedDb = t, this.defaultValues = {
			...
			fov: 120,
			gamemodeMatchmaking: "ctfPlusWeekly",
			autoFullScreen: !1,
			quality: 1,
			antialias: !0,
			smoothFiltering: !0,
	...
	waitForSettingsLoad() {
		if (this.settingsLoaded) return Promise.resolve();
...
function ft(t, e) {
	...
	let n = 0;
	for (const e of t)
		if (n += e.probability, n > s) return e.item;
	return null
}
...
const vt = "http://www.w3.org/2000/svg";
...
class kt {
	constructor({
		...
		icon: e = "",
		testLabel: i = "",
		iconSizeMultiplier: s = .9,
		isUpdateIcon: n = !1,
		isExitButton: o = !1,
		onClick: a = null
	} = {}) {
		this.containerEl = document.createElement("div"), this.containerEl.classList.add("main-menu-button-container"), this.el = document.createElement("button"), this.el.classList.add("wrinkledPaper"), this.el.classList.toggle("exit-button", o), this.containerEl.appendChild(this.el), this.el.style.cssText = `\n\t\t\t--wrinkled-paper-seed: ${ut(1,99999)};\n\t\t`, t && (this.el.ariaLabel = t), this.el.classList.add("main-menu-button"), this.el.addEventListener("click", (t => {
			a && a()
	...
	setVisibility(t) {
		this.visible = t, this.containerEl.style.display = t ? "" : "none"
	}
	click(t = !1) {
...
class Pt {
	...
	animateAmount(e, {
		durationMultiplier: i = 1,
		sfx: s = !0
	} = {}) {
		this.isAnimatingAmount ? this.animatingStartValue = this.animatingCurrentValue : this.animatingStartValue = this._amount, this._amount = e, this.animatingTargetValue = e;
		const n = Math.abs(this.animatingTargetValue - this.animatingStartValue);
		this.animatingDurationMs = t(n, 30, 100) * i * 30, this.animatingStartTime = performance.now(), this.animatingSfxEnabled = s;
		const o = !this.isAnimatingAmount;
		this.isAnimatingAmount = !0, o && this.boundAnimationLoop()
	}
	animationLoop() {
		...
		if (n = Math.round(n), this.animatingCurrentValue != n && (this.animatingCurrentValue = n, this._setAmountText(String(n)), this.animatingSfxEnabled && performance.now() > this.lastIncrementSfxTime + 40)) {
			this.lastIncrementSfxTime = performance.now(), Xn().sfx.playSound("ui/coin/pile", {
				volume: .3 * (1 - t)
			});
			const i = e(.7, 1, s),
				n = ut(0, 4);
			Xn().sfx.playSound("ui/coin/" + n, {
				volume: .5 * t,
				minPitch: i,
				maxPitch: i
			})
...
class xt {
	constructor({
		...
		icon: l = null,
		iconSize: h = 1,
		iconIsInvertable: d = !0
	} = {}) {
		this.el = document.createElement("button"), r ? this.el.classList.add("icon-button", ...o) : this.el.classList.add("dialog-button", "blueNight", "wrinkledPaper", ...o), this.el.classList.toggle("currency-button", s), this.el.style.cssText = `\n\t\t\t--wrinkled-paper-seed: ${ut(1,99999)};\n\t\t`, e && (this.el.ariaLabel = e), this.textEl = document.createElement("span"), this.textEl.textContent = t, this.el.appendChild(this.textEl), this._iconEl = null, this._iconSize = h, this._iconIsInvertable = d, this._currentIcon = null, this.setIcon(l), this._visible = !0, s && (this.currencyContainer = new Pt({
			amount: n
...
class Mt {
	...
	setZIndex(t) {
		this.zIndex = t, this.rootEl.style.zIndex = String(t)
	}
	setInert(t) {
...
class At {
	constructor(t) {
		...
		if (this.type = i, this.el = document.createElement("label"), this.el.classList.add("settings-item"), this.textEl = document.createElement("div"), this.el.appendChild(this.textEl), this.textEl.textContent = e, this.textEl.classList.add("settings-item-text"), this.onValueChangeCbs = new Set, "slider" == this.type) {
			...
			i && this.sliderEl.addEventListener("change", o), this.sliderEl.addEventListener("input", (() => {
				s.textContent = n.value, i || o()
			}))
		} else if ("toggle" == this.type) this.toggleEl = document.createElement("input"), this.toggleEl.type = "checkbox", this.toggleEl.classList.add("dialog-checkbox-input", "wrinkledPaper"), this.el.appendChild(this.toggleEl), this.toggleEl.addEventListener("input", (() => {
			this.fireOnValueChange()
		}));
		else if ("enum" == i) {
			const t = document.createElement("div");
			if (t.classList.add("dialog-select-wrapper", "wrinkledPaper"), this.el.appendChild(t), this.dropdownEl = document.createElement("select"), this.dropdownEl.classList.add("dialog-select-input", "blueNight"), t.appendChild(this.dropdownEl), s)
				for (const [t, e] of Object.entries(s)) {
					const i = document.createElement("option");
					i.value = t, i.textContent = e, this.dropdownEl.appendChild(i)
				}
			...
			this.colorEl = t, t.classList.add("dialog-color-input", "wrinkledPaper"), t.type = "color", this.el.appendChild(t), t.addEventListener("input", (() => {
				this.fireOnValueChange()
			}))
		}
	}
	setValue(t) {
		if ("slider" == this.type) {
			if (!this.sliderEl) throw new Error("Assertion failed, slider element doesn't exist.");
			if ("number" != typeof t) throw new Error("Failed to set value of slider setting item: value is not a number");
			if (this.sliderEl.value = String(t), !this.valueEl) throw new Error("Assertion failed, value element doesn't exist.");
			this.valueEl.textContent = this.sliderEl.value
		} else if ("toggle" == this.type && "boolean" == typeof t) {
			if (!this.toggleEl) throw new Error("Assertion failed, toggle element doesn't exist.");
			this.toggleEl.checked = t
		} else if ("enum" == this.type) {
			if (!this.dropdownEl) throw new Error("Assertion failed, dropdown element doesn't exist.");
			if ("string" != typeof t) throw new Error("Failed to set value of enum setting item: value is not a string");
			this.dropdownEl.value = t
		} else if ("color" == this.type) {
			if (!this.colorEl) throw new Error("Assertion failed, no color element");
			if ("string" != typeof t) throw new Error("Assertion failed, color value is not a string");
			this.colorEl.value = t
		}
	}
	getValue() {
		if ("slider" == this.type) {
			if (!this.sliderEl) throw new Error("Assertion failed: No slider element");
			return Number(this.sliderEl.value)
		}
		if ("toggle" == this.type) {
			if (!this.toggleEl) throw new Error("Assertion failed: No toggle element");
			return this.toggleEl.checked
		}
		if ("enum" == this.type) {
			if (!this.dropdownEl) throw new Error("Assertion failed: No dropdown element");
	...
	setDisabled(t) {
		this.sliderEl && (this.sliderEl.disabled = t), this.toggleEl && (this.toggleEl.disabled = t), this.dropdownEl && (this.dropdownEl.disabled = t)
	}
}
class It extends At {
	constructor(t, e) {
...
class Lt extends Mt {
	constructor(t, e, i) {
		super(t), this.settingsManager = e, this.dialogManager = i, this.titleEl = document.createElement("h2"), this.titleEl.classList.add("dialogTitle", "blueNight"), this.titleEl.textContent = "Settings", this.el.appendChild(this.titleEl);
		const s = [{
			name: "Sound",
			settings: [new It("sfxVolume", {
			...
			settings: [new It("quality", {
				...
				text: "Anti-Aliasing",
				type: "toggle"
			}), new It("smoothFiltering", {
				text: "Smooth filtering",
				type: "toggle"
			})]
		}, {
			name: "Controls",
			settings: [new It("autoFullScreen", {
				text: "Enter Full Screen on Game Start",
				type: "toggle"
			}), new It("mouseSensitivity", {
				...
				type: "toggle"
			}), new It("mouseAcceleration", {
				text: "Mouse Acceleration",
				type: "toggle"
			}), new It("touchLookAcceleration", {
			...
			settings: [new It("fov", {
				...
				min: 40,
				max: 140
			}), new It("gamemodeMatchmaking", {
				text: "Gamemodes",
				type: "enum",
				enumValues: {
					ctf: "CTF",
					weekly: "Weekly Gamemodes",
					ctfPlusWeekly: "CTF + Weekly"
				}
			}), new It("showFirstPersonWeapon", {
				text: "Show weapon",
				type: "toggle"
			}), new It("lowerFirstPersonWeaponWhenWalking", {
				...
				text: "Smooth camera",
				type: "toggle"
			}), new It("flyInSpectateTeam", {
				text: "Fly when spectating",
				type: "toggle"
			})]
		}, {
			name: "Crosshair",
			settings: [new It("crosshairStyle", {
				text: "Style",
				type: "enum",
				enumValues: {
					off: "Off",
			...
			}), new It("crosshairColor", {
				text: "Color",
				type: "color"
			}), new It("crosshairOutlineColor", {
				text: "Outline Color",
				type: "color"
			}), new It("crosshairAccuracyOffset", {
			...
			settings: [new It("theme", {
				...
				type: "toggle"
			}), Xn().poki.isPokiBuild ? null : new It("chatProfanityFilterEnabled", {
				text: "Filter chat messages containing profanity",
				type: "toggle"
			}), new It("autoSkipStatsScreen", {
				text: "Auto skip stats screen",
				type: "toggle"
			}), new It("requireAddressBarHide", {
				text: "Join games by hiding the mobile address bar",
				type: "toggle"
			}), new It("autoReconnect", {
		...
		for (const t of s) {
			...
			for (const s of t.settings) {
				...
				s.setValue(t), s.onValueChange((t => {
					e.setValue(s.id, t)
				}))
			}
		}
		const n = this.createSettingsGroup("Account");
		this.linkedAccountsEl = document.createElement("div"), this.linkedAccountsEl.classList.add("linked-accounts"), n.appendChild(this.linkedAccountsEl), this.accountButtonsEl = document.createElement("div"), this.accountButtonsEl.classList.add("account-buttons"), n.appendChild(this.accountButtonsEl), this.loginButton = new xt({
			text: "Log in",
			onClick: () => {
				Xn().auth.loginIfNotLoggedIn(!0)
			}
		}), this.accountButtonsEl.appendChild(this.loginButton.el), this.linkAccountButton = new xt({
			text: "Link new account",
			onClick: async () => {
				const t = await Xn().auth.showLoginDialog("linknew");
				if (t)
					if (t.success) Xn().dialogManager.showAlert({
						title: "Account linked",
						text: "You can now use this account for logging in as well."
					}), Xn().profileState.clearAndRefetch();
					else if ("account-already-exists" == t.error) Xn().dialogManager.showAlert({
					...
					"already-linked" == t.error ? e = "This account is already linked to you." : "linked-maximum-reached" == t.error ? e = "You have reached the maximum of linkable accounts." : console.error("Account link error: " + t.error), Xn().dialogManager.showAlert({
						title: "Account linking failed",
						text: e
					})
				}
			}
		}), this.accountButtonsEl.appendChild(this.linkAccountButton.el), this.linkAccountButton.visible = !1, this.logoutButton = new xt({
			text: "Logout",
			onClick: async () => {
				await Xn().auth.logout() || Xn().dialogManager.showAlert({
					title: "Error logging out",
					text: "An error occurred while logging out everywhere."
				})
			}
		}), this.logoutButton.visible = !1, this.accountButtonsEl.appendChild(this.logoutButton.el), this.logoutEverywhereButton = new xt({
			text: "Logout everywhere",
			onClick: async () => {
				this.logoutEverywhere()
			}
		}), this.logoutEverywhereButton.visible = !1, this.accountButtonsEl.appendChild(this.logoutEverywhereButton.el), this.accountIdContainer = document.createElement("div"), this.accountIdContainer.classList.add("account-id-container"), n.appendChild(this.accountIdContainer), this.accountIdContainer.appendChild(document.createTextNode("Account id: ")), this.accountIdEl = document.createElement("span"), this.accountIdEl.classList.add("account-id"), this.accountIdContainer.appendChild(this.accountIdEl), this.addButtonsContainer(), this.addButton({
			text: "Save",
			onClick: async () => {
		...
		}), this.boundUpdateAccountButtons = this.updateAccountState.bind(this), Xn().auth.onLoggedInAccountChange(this.boundUpdateAccountButtons), this.updateAccountState(), Xn().profileState.onStateChanged((() => {
			this.updateAccountState()
		}))
	}
	destructor() {
		super.destructor(), Xn().auth.removeOnLoggedInAccountChange(this.boundUpdateAccountButtons)
	}
	updateAccountState() {
		const t = Xn(),
			e = t.profileState;
		...
		for (const t of e.linkedAccounts) {
			const i = document.createElement("div");
			i.classList.add("wrinkledPaper"), i.style.cssText = `\n\t\t\t\t--wrinkled-paper-seed: ${ut(1,99999)};\n\t\t\t`, this.linkedAccountsEl.append(i);
			const s = document.createElement("div");
			s.classList.add("account-data"), i.append(s);
			const n = document.createElement("div");
			n.textContent = t.email, s.append(n);
			const o = document.createElement("div");
			if (o.classList.add("issuer"), o.textContent = t.issuer, s.append(o), e.linkedAccounts.length > 1) {
				const s = new xt({
					text: "Unlink",
					onClick: () => {
						Xn().dialogManager.showAlert({
							title: "Are you sure?",
							...
							buttons: [{
								...
								text: "Unlink it!",
								onClick: async () => {
									await Xn().auth.unlinkAccount(t) ? Xn().dialogManager.showAlert({
				...
				e.protected ? (s.enabled = !1, s.el.title = "This account is protected.") : e.canUnlinkAllAccounts ? t.isUnknownEmail && (s.enabled = !1, s.el.title = "This linked account does not have a known email to identify it.") : (s.enabled = !1, s.el.title = "Too many accounts have been linked. Please contact us if you wish to unlink an account."), i.append(s.el)
			}
		}
		this.loginButton.visible = !t.auth.isLoggedIn, this.linkAccountButton.enabled = !0, this.linkAccountButton.el.title = "", e.maxLinkedAccountsReached ? (this.linkAccountButton.enabled = !1, this.linkAccountButton.el.title = "You have reached the maximum amount of linkable accounts.") : e.protected && (this.linkAccountButton.enabled = !1, this.linkAccountButton.el.title = "This account is protected."), this.linkAccountButton.visible = t.auth.isLoggedIn, this.logoutButton.visible = t.auth.isLoggedIn, this.logoutEverywhereButton.visible = t.auth.isLoggedIn;
		const i = e.dbId;
		this.accountIdContainer.style.display = i ? "" : "none", this.accountIdEl.textContent = e.dbId
	}
	createSettingsGroup(t) {
		const e = document.createElement("div");
		this.settingsListEl.appendChild(e);
		const i = document.createElement("h3");
		return i.classList.add("settings-group-header"), i.textContent = t, e.appendChild(i), e
	}
	async logoutEverywhere() {
		await Xn().auth.logoutEverywhere() || Xn().dialogManager.showAlert({
			title: "Error logging out",
			text: "An error occurred while logging out everywhere."
		})
	}
...
const Tt = [{
	...
	Et = new Map;
for (const t of Tt) Et.set(t.id, t);
...
class Dt {
	...
	async startDownloading() {
		...
		const t = await (e = this.url, i = t => {
			...
			n.responseType = "blob", n.addEventListener("progress", (t => {
				if (i) {
					let e = 0;
	...
	parseFilePositions(t) {
		...
		for (; e < t.byteLength;) {
			...
			this.fileLocations.push({
				...
				start: e + 4 + i + 4,
				length: o
			}), o % 4 != 0 && (o = 4 * Math.ceil(o / 4)), e += 4 + i + 4 + o
		}
	}
	onLoad(t) {
...
const Ot = {
	mapCached(t) {
		Xn().mapLoader.markMapAsCached(t)
	},
	reportMapLoadProgress(t, e) {
		Xn().mapLoader.reportMapLoadProgress(t, e)
	},
	firstMapDownloaded() {
		Xn().mapLoader.reportFirstMapDownloaded()
	},
	mapGameplayObjects(t, e) {
		Xn().mapLoader.setGamplayObjects(t, e)
	}
};
class Vt {
	constructor() {
		...
		this.lastWorkerRequestId = 0, this.onWorkerMessageCbs = new Map, this.onWorkerErrorCbs = new Map, this.messenger = new s({
		...
		}), this.workerPromise = this.loadWorker(), this.abortSignalIds = new WeakMap, this.lastAbortSignalId = 0
	}
	async loadWorker() {
		const {
			worker: t
		} = await import("./assetWorkerPreload-C--nGXp4.js");
		this.messenger.initialize(t, Ot), t.addEventListener("error", (t => {
			throw console.error("error occurred while initializing asset loader worker"), t
		}));
		const e = new URL(".", location.href).href;
		return this.messenger.send.setBasePath(e), t
	}
	async getMessenger() {
		return await this.workerPromise, this.messenger
	}
	async registerAbortSignal(t) {
		await this.workerPromise;
		let e = this.abortSignalIds.get(t);
		void 0 === e && (e = this.lastAbortSignalId++, this.abortSignalIds.set(t, e));
		const i = e;
	...
	addPackage(t, {
		...
		let n = null;
		if (t in this.packages) n = this.packages[t];
		else {
			n = new Dt("assetPackages" + "/" + t + ".bin?v=1739742438"), this.packages[t] = n;
			for (const t of this.onPackageAddCbs) t();
			this.onPackageAddCbs = []
		}
		return s || this.waitAndDownloadPack(n, e, i), n
	}
		...
		if (e)
			for (;;) {
				...
				for (const [i, n] of Object.entries(this.packages))
					for (const o of e) i.startsWith(o) && n != t && s.push(n);
				if (!(s.length < i)) {
					for (const t of s) await t.waitForLoad();
					break
				}
	...
	onWorkerMessage(t, e, i = !1) {
		...
		s || (s = new Set, this.onWorkerMessageCbs.set(t, s)), s.add({
			cb: e,
			endOnly: i
		})
	}
	...
	static deserializeThreeObject(t) {
		...
		for (const i of t.geometries) {
			const t = new o;
			for (const e of i.attributes) t.setAttribute(e.name, new a(e.array, e.itemSize, e.normalized));
	...
	static deserializeThreeObjectRecursive(t, e) {
		...
		if (null != t.geo && t.geo >= 0) {
			...
			} else t.material && (n = Xn().materials.getMaterialByName(t.material) || null);
			n && (i = new r(e[t.geo], n))
		}
		i || (i = new l), i.name = t.name;
	...
	async loadGlbViaWorker(t, {
		...
		const a = await Xn().assets.getPackage(e).getFileAsBuffer(t);
		if (!o) {
		...
		const {
			...
			abortSignalId: l,
			unregister: h
		} = await this.registerAbortSignal(o), d = await r.send.loadGlbAsset({
			glbBuffer: a,
			teamId: i,
			keepCustomProperties: s,
			merge: n,
		...
		return h(), Vt.deserializeThreeObject(d)
	}
}

function Bt(t) {
	if (!t.slots || !Array.isArray(t.slots)) {
		if (t.slots = [], t.maleSkin) {
			if (t.maleSkin.additions)
				for (const e of Object.keys(t.maleSkin.additions)) t.slots.push(e);
			if (t.maleSkin.removals)
				for (const e of Object.keys(t.maleSkin.removals)) t.slots.push(e)
		}
		if (t.femaleSkin) {
			if (t.femaleSkin.additions)
				for (const e of Object.keys(t.femaleSkin.additions)) t.slots.push(e);
			if (t.femaleSkin.removals)
				for (const e of Object.keys(t.femaleSkin.removals)) t.slots.push(e)
		}
	}
}
const Rt = ["base", "baseClothes", "baseEyes"],
	Ut = ["male", "female"],
	qt = [{
		cssColor: "#fff6ed",
		skinColor: [1, 1, 1]
...
function Wt(t = null) {
	...
	return t.equippedSkinIds = t.equippedSkinIds.filter((t => "" != t)), t.hairColorMultiplier && (t.hairColorMultiplier = Nt(t.hairColorMultiplier)), t.eyebrowColorMultiplier && (t.eyebrowColorMultiplier = Nt(t.eyebrowColorMultiplier)), t.beardColorMultiplier && (t.beardColorMultiplier = Nt(t.beardColorMultiplier)), t
}

function Nt(t) {
	if (!Array.isArray(t)) return [1, 1, 1];
	if (3 != t.length) return [1, 1, 1];
	for (const e of t.keys()) "number" != typeof t[e] && (t[e] = 1), t[e] = i(t[e]), isNaN(t[e]) && (t[e] = 1);
	return t
}
class jt {
	constructor() {
	...
	init() {
		this.initBaseSkins(), Xn().config.shopConfig.onConfigChange((async t => {
			for (const e of t.purchasableItems) Bt(e), this.purchasableItems.set(e.id, e);
	...
	async initBaseSkins() {
		const t = [],
			e = [];
		for (const t of Ut)
			for (const i of Rt) e.push(`baseSkins/${t}/${i}.glb`);
		for (const {
				bowId: t
			}
			of Tt) e.push(`bows/${t}.glb`);
		e.push("baseSkins/arrow.glb");
		const i = {};
		for (const s of e) {
			const e = (async () => {
				i[s] = await Xn().assets.getPackage("main").getFileAsBuffer(s)
			})();
			t.push(e)
		}
		await Promise.all(t);
		const s = await Xn().assets.getMessenger();
	...
	skinObjectOptsToCacheKey(t) {
		...
		return e.push("beardColor" + o.join(",")), e.join("-")
	}
	async getSkinObject(t, e) {
		let i, s = !1;
		t.rawSkin ? (i = t.rawSkin, s = !0) : i = this.skinNetworkDataToSkinConfig(t.skin);
		let n = null;
		const o = [],
			{
				messenger: a,
				abortSignalId: r,
				unregister: l
			} = await Xn().assets.registerAbortSignal(e);
		try {
			try {
			...
			if (!n && !s) {
				...
				try {
					...
					if (t instanceof DOMException && "AbortError" == t.name) throw t;
					throw o.push(t), new AggregateError(o)
				}
			}
		} finally {
			l()
		...
		if (!n) return null;
		return Vt.deserializeThreeObject(n)
	}
	async getBowObject(t, e) {
		const {
			...
			abortSignalId: s,
			unregister: n
		} = await Xn().assets.registerAbortSignal(e), o = await i.send.buildBow({
			...t,
			abortSignalId: s
		});
		return n(), {
			bow: Vt.deserializeThreeObject(o.bow),
	...
	async buildConfigObject(t, e) {
		const {
			...
			abortSignalId: s,
			unregister: n
		} = await Xn().assets.registerAbortSignal(e), o = await i.send.buildConfigObject({
			...t,
			abortSignalId: s
		});
		return n(), {
			asset: Vt.deserializeThreeObject(o.asset)
		}
	}
	addShopItemToSkinData(t, e) {
		const i = new Set(e.equippedSkinIds),
			s = this.addItemAndRemoveDuplicateSlots(i, t);
		return e.equippedSkinIds = Array.from(i), s
	}
	...
	addPreset({
		...
		let e = mt(this.defaultSkinPresets);
		e || (e = {});
		...
		e.hairColorMultiplier && (s.hairColorMultiplier = [...e.hairColorMultiplier]), e.eyebrowColorMultiplier && (s.eyebrowColorMultiplier = [...e.eyebrowColorMultiplier]), e.beardColorMultiplier && (s.beardColorMultiplier = [...e.beardColorMultiplier]), this.skinPresets.push(s), this.savePresets(), t && this.fireConfigChanged()
	}
	deletePreset(t) {
	...
	addShopItemToPreset(t, e) {
		...
		return this.savePresets(), this.fireConfigChanged(), s
	}
	...
	setPresetSkinItemColor(t, e, i) {
		...
		"hair" == e ? s.hairColorMultiplier = i : "eyebrows" == e ? s.eyebrowColorMultiplier = i : "beard" == e && (s.beardColorMultiplier = i), this.savePresets(), this.fireConfigChanged()
	}
	async savePresets() {
		try {
			await Xn().indexedDb.set("skinPresets", this.skinPresets)
		} catch {}
	}
	...
	getClassSkinDataWithAppliedPreset(t) {
		...
		if (e.equippedSkinIds)
			for (const t of e.equippedSkinIds) this.addItemAndRemoveDuplicateSlots(s, t);
		if (e.unequippedSkinIds)
			for (const t of e.unequippedSkinIds) s.delete(t);
		return {
	...
	addShopItemToClass(t, e) {
		...
		s.delete(t), 0 == s.size ? delete i.unequippedSkinIds : i.unequippedSkinIds = Array.from(s);
		let n = !1;
		if (null != i.presetId) {
			const e = this.getPreset(i.presetId, !1);
			e.equippedSkinIds && e.equippedSkinIds.includes(t) && (n = !0)
		}
		this.addShopItemToSkinData(t, i), n && this.removeShopItemFromSkinData(t, i), this.saveClassSkins(), this.fireConfigChanged()
	}
	removeShopItemFromClass(t, e) {
		...
		if (this.removeShopItemFromSkinData(t, i), s) {
	...
	setClassGender(t, e) {
		...
		e == s ? delete i.gender : i.gender = e, this.saveClassSkins(), this.fireConfigChanged()
	}
	setClassSkinItemColor(t, e, i) {
		...
		"hair" == e ? a("hairColorMultiplier") : "eyebrows" == e ? a("eyebrowColorMultiplier") : "beard" == e && a("beardColorMultiplier"), this.saveClassSkins(), this.fireConfigChanged()
	}
	saveClassSkins() {
		try {
			Xn().indexedDb.set("classSkins", this.classSkins)
		} catch {}
	}
	fireConfigChanged() {
	...
	addItemAndRemoveDuplicateSlots(t, e) {
		return function(t, e, i) {
			const s = new Set,
				n = t.get(i);
			if (n && (i && e.add(i), n.slots))
				for (const o of n.slots)
					for (const n of e) {
						if (n == i) continue;
						const a = t.get(n);
						a && a.slots && a.slots.includes(o) && (e.delete(n), s.add(n))
					}
			return s
	...
	getStatClassValuesFromShopSkinIds(t, e) {
		...
		for (const o of t) {
			...
			if (t && t.statClasses && (!t.bowSkin || t.bowSkin.bowId == e)) {
				...
				i = Math.max(i, t.legMoveAmount || 1), s = Math.min(s, t.legMoveAmount || 1)
			}
		}
		let o = 1;
	...
	skinNetworkDataToSkinConfig(t) {
		...
		for (const t of d) {
			let s = i.get(t);
			s || (s = new Set, i.set(t, s));
			for (const t of Rt) s.add(`${e}/${t}`)
		}
		const s = [];
				...
				if (a && a.additions)
					for (const [e, n] of Object.entries(a.additions)) {
						...
						if (n && Array.isArray(n)) {
							let e = i.get(a);
							e || (e = new Set, i.set(a, e));
							for (const i of n)
								if (e.add(i), o.colorizableCategory) {
									let e;
									"hair" == o.colorizableCategory ? e = t.hairColorMultiplier : "eyebrows" == o.colorizableCategory ? e = t.eyebrowColorMultiplier : "beard" == o.colorizableCategory && (e = t.beardColorMultiplier), e && s.push({
										assetName: i,
										colorMultiplier: e,
										joints: [a]
									})
				...
				if (n && n.removals)
					for (const [t, s] of Object.entries(n.removals)) {
						...
						if (s && Array.isArray(s)) {
							const t = i.get(n);
							if (t)
								for (const i of s) Rt.includes(i) ? t.delete(`${e}/${i}`) : t.delete(i)
						}
					}
			}
			for (const s of t.equippedSkinIds) {
				...
				if (n && n.replaceAssets)
					for (const t of n.replaceAssets)
						for (const s of i.values()) {
							...
							for (const e of i) s.has(e) && (s.delete(e), s.add(t.replaceWith))
						}
			}
		}
		const n = {};
	...
	getConfigForPreviewShopItemId(t, {
		...
		return i && s && ("hair" == i ? o.hairColorMultiplier = s : "eyebrows" == i ? o.eyebrowColorMultiplier = s : "beard" == i && (o.beardColorMultiplier = s)), o
	}
...
class Gt {
	...
	createAndPushPage(t) {
		...
		if (e.classList.add("paged-view-page"), t.headerVisible || void 0 === t.headerVisible) {
			...
			const s = document.createElement("div");
			s.classList.add("paged-view-page-header-line", "wrinkledLine"), e.appendChild(s);
			...
			if (!n || t.onBackButtonClick) {
				const e = new xt({
					...
					onClick: () => {
						t.onBackButtonClick && t.onBackButtonClick(), n || this.popPage()
					}
				});
				i.appendChild(e.el)
			}
			const o = document.createElement("h2");
			if (o.classList.add("paged-view-page-header-title"), o.textContent = t.header || t.itemName || "", i.appendChild(o), t.rightCorner) {
				const e = document.createElement("div");
	...
	updatePageVisibilities() {
		for (let t = 0; t < this.createdPageEls.length; t++) {
			const e = this.createdPageEls[t],
				...
				n = e.el;
			if (n.classList.toggle("hiddenleft", !s), n.classList.toggle("hidden", !s), n.inert = !s, n.classList.remove("hiddenright"), i != s) {
				const t = e.structure;
...
class zt {
	...
	async reloadPose() {
		...
		let i = null;
		try {
			this.skeletonObject = await Xn().skeletons.getSkeleton(t, {
				signal: this.currentlyLoadingPoseAbortController.signal
			})
		} catch (t) {
			t instanceof DOMException && t.name, i = t
		}
		if (i || this.skeletonObject || (i = new Error("Failed to load skeleton, result is null")), i) {
			for (const {
					reject: t
				}
				of this.onSkeletonLoadCbs) t(i);
			this.onSkeletonLoadCbs.clear()
...
class $t {
	constructor({
		...
		this.player = t, this.isInit = !1, this.onInitCbs = new Set, this.onAllLinkLayerObjectsBuiltCbs = new Set, this._currentGender = e, this.poseLayers = [], this.skeletonMatrixObjects = [], this.baseSkeletonObject = null, this.headObj = null, this.bodyObj = null, this.armLObj = null, this.armRObj = null, this.legObjectsL = null, this.legObjectsR = null, this.initCalled = !1
	}
	async init() {
		if (this.initCalled) return await this.waitForLoad();
		this.initCalled = !0, this.baseSkeletonObject = await Xn().skeletons.getSkeleton("male/baseRig", {
			clone: !0
		});
		...
		this.headObj = this.baseSkeletonObject.getObjectByName("head"), this.bodyObj = this.baseSkeletonObject.getObjectByName("torso"), this.armLObj = this.baseSkeletonObject.getObjectByName("upperArmL"), this.armRObj = this.baseSkeletonObject.getObjectByName("upperArmR"), this.legObjectsL = e("L"), this.legObjectsR = e("R"), this.isInit = !0;
	...
	createPoseLayer(t) {
		const e = new zt(t, this._currentGender);
		return this.linkLayerObjects(e), e
	}
	addPoseLayer(t) {
		const e = this.createPoseLayer(t);
		return this.poseLayers.push(e), e
	}
	removePoseLayer(t) {
	...
	insertPoseLayer(t, e) {
		const i = this.createPoseLayer(e);
		return this.poseLayers.splice(t, 0, i), i
	}
	setLookRotY(t, e) {
		if (this.bodyObj) {
			const i = e.head ?? .3;
	...
	applyLookRotation(t, e, i) {
		...
		n.applyQuaternion(s);
		const o = new p;
		o.setFromAxisAngle(n, i), t.quaternion.multiply(o)
	}
	applyLayers() {
		this.assertInit();
...
class _t {
	...
	init() {
		...
		this.basicUnlitMat = this.createMaterial({
			...
			depthWrite: !1
		}), this.skyDomeMat.side = m, this.lightsMat = this.createMaterial({
			name: "lights",
			fog: !1,
			applyWorldColor: !1,
			depthWrite: !1,
			depthTest: !0
		}), this.lightsMat.blending = f, this.screenFlashMat = this.createMaterial({
			name: "screenFlash",
			fog: !1,
			applyWorldColor: !1,
			depthWrite: !1,
		...
		const s = d.length,
			n = [];
		for (let t = 0; t < s; t++) n.push(new h);
		const o = [],
			a = [];
		for (let t = 0; t < 5; t++) o.push(0), a.push(new u);
		const r = {
			vertexShaderOpts: {
	...
	async precompileShaders() {
		...
		if (!n) return;
		const o = s.cam.cam;
		for (const e of this.materialsCache.values()) await Xn().renderer.waitForFrameRender(), i.material = e, n.compile(t, o);
	...
	applyWeatherParams(t) {
		for (const e of this.allMaterials()) e.uniforms.colorMultiplier.value.copy(t.colorMultiplier), e.uniforms.colorAdder.value.copy(t.colorAdder), e.uniforms.saturation.value = t.saturation, e.uniforms.skyLowCol.value.copy(t.skyLowColor), e.uniforms.skyHighCol.value.copy(t.skyHighColor), e.uniforms.skyMidCol.value.copy(t.skyMidColor), e.uniforms.skyPower.value = t.skyPower, e.uniforms.fogAmount.value = t.fogAmount, e.uniforms.fogHeightAmount.value = t.fogHeightAmount, e.uniforms.fogHeightOffset.value = t.fogHeightOffset, e.uniforms.fogHeightDistFalloff.value = t.fogHeightDistFalloff + 1, e.uniforms.fogHeightAmountMin.value = t.fogHeightAmountMin, e.uniforms.fogHeightAmountMax.value = t.fogHeightAmountMax
	}
	static resetWeatherUniforms(t) {
		t.uniforms.colorMultiplier.value.set(new y(1, 1, 1)), t.uniforms.colorAdder.value.set(new y(0, 0, 0)), t.uniforms.saturation.value = 1, t.uniforms.fogAmount.value = 0, t.uniforms.fogHeightAmountMin.value = 0, t.uniforms.fogHeightAmountMax.value = 0
	}
	setLightningValue(t) {
		this.basicUnlitMat && (this.basicUnlitMat.uniforms.lightning.value = t), this.basicUnlitMatDouble && (this.basicUnlitMatDouble.uniforms.lightning.value = t)
	}
	buildVertexShader({
		name: t = "",
		extraVariables: e = "",
		modifyWorldPosFn: i = "",
		modifyWorldPosAfterColorFn: s = "",
		modifyWorldPosBeforeModelMatrixFn: n = "",
		modifyColFn: o = "",
		extraFunctions: a = "",
		fog: r = !0,
		needsFogColor: l = !1,
	...
	createMaterial({
		...
		exactVertShader: s = null,
		exactFragShader: n = null,
		uniforms: o = {},
		...
		e = {
			...
			...m,
			...i
		}, f = s || this.buildVertexShader(e), w = n || this.buildFragShader(i), o = {
			saturation: {
				value: 1
			},
			colorMultiplier: {
	...
	for (const n of c(t))
		if (n instanceof r && n.geometry) {
			...
			for (let n = 0; n < t.count; n++) {
				if (s.fromBufferAttribute(t, n), o && e) {
					const t = e[o.getX(n)];
					s.applyMatrix4(t)
				}
				i ? i.expandByPoint(s) : i = new C(s.clone(), s.clone())
			}
		} if (!i) return new k(new u(0, 0, 0), 1);
	...
	for (const i of c(t))
		if (i instanceof r && i.geometry) {
			...
			for (let i = 0; i < t.count; i++) {
				if (s.fromBufferAttribute(t, i), a && e) {
					const t = e[a.getX(i)];
					s.applyMatrix4(t)
				}
...
class Kt {
	constructor({
		...
		this.skinObjectOpts = t, this.isInit = !1, this.destructed = !1, this.obj = null, this.materials = [], this.lastSetMatrices = null, this.onInitCbs = new Set, this.getSkinAbortController = new AbortController, this.useWorldWeather = i, this.initCalled = !1, e && this.init()
	}
	destructor() {
		this.destructed = !0;
		for (const t of this.materials) t.dispose();
		if (this.materials = [], this.obj) {
			for (const t of c(this.obj)) t instanceof r && t.geometry.dispose();
			this.obj = null
		}
	...
	async init() {
		...
		let t = null;
		try {
			t = await Xn().skins.getSkinObject(this.skinObjectOpts, this.getSkinAbortController.signal)
		} catch (t) {
			if (!(this.destructed && t instanceof DOMException && "AbortError" == t.name)) throw t
		}
		if (t && (t.geometry.boundingSphere = new k(new u(0, 1, 0), 1), !this.destructed)) {
			this.obj = t;
			const e = new Map;
			this.obj.traverse((t => {
				if (t instanceof r)
					if (Array.isArray(t.material)) {
						...
						for (const [s, n] of i.entries()) {
							let i = e.get(n);
							i || (i = n.clone(), this.materials.push(i), e.set(n, i)), t.material[s] = i
						}
					} else {
		...
		if (!this.useWorldWeather)
			for (const t of this.materials) _t.resetWeatherUniforms(t);
		this.isInit = !0;
		for (const t of this.onInitCbs) t();
		this.onInitCbs.clear()
	}
	...
	setHitFlashMaterialsValue(t, e, i) {
		...
		for (const s of this.materials) s.uniforms.hitFlashTimes.value[t] = e, s.uniforms.hitFlashPositions.value[t].copy(i)
	}
...
class Yt extends Mt {
	constructor(t, e, {
		...
		}), this.onPurchaseSuccessCbs = new Set, this.shopItem = new ie(t, e, {
			usage: "preview",
			renderOptions: i,
			dialog: this
		...
		e.price && e.price > 0 ? (s.showCurrency = !0, s.currency = e.price) : (s.text = "Get Item", e.hasRewardedAd && (s.icon = "static/img/rewardedAdIcon.svg")), this.purchaseButton = this.addButton(s), Xn().shopState.isPurchasingItem(e.id) && (this.setButtonEnabled(!1), (async () => {
			await Xn().shopState.waitForItemPurchase(e.id), this.setButtonEnabled(!0)
		})())
	}
	destructor() {
	...
	async purchaseButtonClick() {
		...
		const t = Xn();
		await t.shopState.purchaseItem(this.shopItem.config, t.poki, t.dialogManager, "shop") ? (this.onPurchaseSuccessCbs.forEach((t => t())), this.close()) : this.setButtonEnabled(!0)
	}
	onPurchaseSuccess(t) {
...
class Xt {
	constructor({
		...
		this.obj = new l, this.obj.name = `${e} asset loader`, this.label = e, this.useWorldWeather = t, this.currentlyLoadingAbortController = null, this.currentAssetName = "", this.currentMeleeAsset = null, this.onFirstAssetLoadCbs = new Set, this.onNewAssetLoadedCbs = new Set, this.currentlyLoadedMaterials = []
	}
	destructor() {
	...
	async setConfig(t) {
		...
		this.currentMeleeAsset && this.obj.remove(this.currentMeleeAsset), this.currentMeleeAsset = null, this.destroyMaterials(), this.destroyBowMeshes(), s && (this.currentMeleeAsset = s, this.obj.add(s)), this.currentlyLoadingAbortController = null, this.onFirstAssetLoadCbs.forEach((t => t())), this.onFirstAssetLoadCbs.clear(), this.onNewAssetLoadedCbs.forEach((t => t()))
	}
	destroyMaterials() {
	...
	destroyBowMeshes() {
		if (this.currentMeleeAsset)
			for (const t of c(this.currentMeleeAsset)) t instanceof r && t.geometry.dispose()
	}
	async waitForLoad() {
...
class Zt {
	constructor({
		...
		this.obj = new l, this.obj.name = "Bow asset loader", this.useWorldWeather = t, this.lastFireAmount01 = 0, this.lastVisibleCount = 0, this.currentBowAsset = null, this.onFirstAssetLoadCbs = new Set, this.onAssetChangeCbs = new Set, this.currentlyLoadingAbortController = null, this.currentlyLoadedMaterials = [], this.currentArrowObjs = [], this.currentArrowOffsets = [], this.onArrowDestroyCallbacks = new Set, this.arrowAssetLoader = new Xt({
			useWorldWeather: t,
			label: "Arrow"
		}), this.arrowAssetLoader.onNewAssetLoaded((() => {
			this.rebuildArrowObjects(), this.onArrowDestroyCallbacks.forEach((t => t())), this.onArrowDestroyCallbacks.clear()
		})), this.arrowObjectsConfig = {
			arrowCount: 0,
			arrowPositions: "stacked"
		}, this.arrowPointIdle = new l, this.arrowPointIdle.name = "Arrow point idle", this.obj.add(this.arrowPointIdle), this.arrowPointLoaded = new l, this.arrowPointLoaded.name = "Arrow point loaded", this.obj.add(this.arrowPointLoaded)
	}
	destructor() {
		this.destroyMaterials(), this.destroyBowMeshes(), this.arrowAssetLoader.setConfig({
			skinAssetName: null
		})
	}
	async setConfig(t) {
		...
		const {
			bow: o,
			arrowPointIdleMatrix: a,
			arrowPointLoadedMatrix: l
		} = s;
		if (this.currentBowAsset && this.obj.remove(this.currentBowAsset), this.destroyMaterials(), this.destroyBowMeshes(), this.currentBowAsset = o, this.obj.add(o), !(o instanceof r)) throw new Error("Assertion failed, bow is not a mesh");
		const h = o.material;
		if (!Array.isArray(h)) throw new Error("Assertion failed, materials is not an array");
		for (let t = 0; t < h.length; t++) {
			const e = h[t].clone();
			h[t] = e, e instanceof S && (this.useWorldWeather || _t.resetWeatherUniforms(e)), this.currentlyLoadedMaterials.push(e)
		}
		this.arrowPointIdle.position.set(0, 0, 0), this.arrowPointIdle.quaternion.identity(), this.arrowPointIdle.scale.set(1, 1, 1), this.arrowPointIdle.applyMatrix4(a), this.arrowPointLoaded.position.set(0, 0, 0), this.arrowPointLoaded.quaternion.identity(), this.arrowPointLoaded.scale.set(1, 1, 1), this.arrowPointLoaded.applyMatrix4(l);
		...
		this.arrowObjectsConfig.arrowCount == d && this.arrowObjectsConfig.arrowPositions == c || (this.arrowObjectsConfig = {
			arrowCount: d,
			arrowPositions: c
		}, this.rebuildArrowObjects()), this.internalUpdateFireAmount(), this.currentlyLoadingAbortController = null, this.onFirstAssetLoadCbs.forEach((t => t())), this.onFirstAssetLoadCbs.clear(), this.onAssetChangeCbs.forEach((t => t(o)))
	}
	rebuildArrowObjects() {
		this.currentArrowOffsets = [];
		for (const t of this.currentArrowObjs) this.obj.remove(t);
		this.currentArrowObjs = [];
		const t = this.arrowAssetLoader.obj.children[0];
		if (t) {
			for (let e = 0; e < this.arrowObjectsConfig.arrowCount; e++) {
				const i = t.clone();
				i.position.z = .6, this.obj.add(i), this.currentArrowObjs.push(i);
				const s = new P;
				"stacked" == this.arrowObjectsConfig.arrowPositions ? s.set(0, .01 * e) : (s.x = Math.cos(e) * e * .01, s.y = Math.sin(e) * e * .01), this.currentArrowOffsets.push(s)
			}
	...
	getClonedArrowObject(t) {
		...
		return e ? (this.onArrowDestroyCallbacks.add(t), e.clone()) : null
	}
	destroyMaterials() {
		for (const t of this.currentlyLoadedMaterials) t.dispose();
		this.currentlyLoadedMaterials = []
	...
	destroyBowMeshes() {
		if (this.currentBowAsset)
			for (const t of c(this.currentBowAsset)) t instanceof r && t.geometry.dispose()
	}
	async waitForLoad() {
		if (!this.isLoadingAsset) return;
		const t = new Promise((t => this.onFirstAssetLoadCbs.add(t)));
	...
	updateFireAmount(t, e) {
		this.lastFireAmount01 = t, this.lastVisibleCount = e, this.internalUpdateFireAmount()
	}
	internalUpdateFireAmount() {
		for (const [t, e] of this.currentArrowObjs.entries()) {
			...
			e.position.x += i.x, e.position.y += i.y, e.scale.lerpVectors(this.arrowPointIdle.scale, this.arrowPointLoaded.scale, this.lastFireAmount01), e.quaternion.slerpQuaternions(this.arrowPointIdle.quaternion, this.arrowPointLoaded.quaternion, this.lastFireAmount01), e.visible = this.lastVisibleCount > t
		}
		for (const t of this.currentlyLoadedMaterials) t instanceof S && (t.uniforms.bowMorphAmount.value = this.lastFireAmount01)
	}
}
const te = new Map;
te.set("movementSpeed", {
...
class ee {
	constructor({
		...
		this.el = document.createElement("div"), this.el.classList.add("stat-class-tooltip", "transitioning", "wrinkledPaper"), this.el.style.setProperty("--wrinkled-paper-seed", String(ut(1, 99999))), this.el.style.zIndex = String(t), document.body.appendChild(this.el);
		const o = document.createElement("ul");
		this.el.appendChild(o);
		for (const [t, i] of te) {
			const a = e[t] || 0;
			if (!s && 0 == a) continue;
			if (n && !i.tooltipCategories.includes(n)) continue;
			const r = document.createElement("li");
			o.appendChild(r);
			const l = document.createElement("span");
			let h;
			if (l.classList.add("stat-class-icon"), l.style.backgroundImage = `url("${i.icon}")`, r.appendChild(l), s) {
		...
		this.el.style.left = i.left + i.width / 2 + "px", this.el.style.top = i.top + "px", getComputedStyle(this.el).left, this.el.classList.remove("transitioning")
	}
	destructor() {
		this.el.remove()
	}
...
class ie {
	constructor(t, e, {
		...
		if (this.gameWrapper = t, this.configIndex = i, this.config = e, this.usage = s, this.renderOptions = n, this.dialog = o, this.destructed = !1, "button" == s) this.el = document.createElement("button");
		else {
			if ("preview" != s) throw new Error(`Unknown usage: ${s}`);
			this.el = document.createElement("div")
		}
		this.el.classList.add("shopItem", "wrinkledPaper", "shopItemUsage-" + s), e.preventUnequip && this.el.classList.add("preventUnequip"), this.el.style.cssText = `\n\t\t\t--wrinkled-paper-seed: ${ut(1,99999)};\n\t\t`, this.onSelectedChangeRequestCbs = new Set, this.statsTooltip = null, this.onHoveringChangeCbs = new Set, this.selected = !1, this.owned = !1, this.isHovering = !1, this.isLooping = !1, this.shouldStopLooping = !1, this.prevNow = 0, this.boundAnimationLoop = this.animationLoop.bind(this), this.el.addEventListener("pointerenter", (() => {
			this.setIsHovering(!0), this.addStatsTooltip()
		})), this.el.addEventListener("pointerleave", (() => {
			this.setIsHovering(!1), this.removeStatsTooltip()
		})), this.boundRemoveStatsTooltip = this.removeStatsTooltip.bind(this), this.scrollingContainer = a, a && a.addEventListener("scroll", this.boundRemoveStatsTooltip), this.el.addEventListener("click", (() => {
			"preview" != this.usage && (this.owned || this.selected ? this.requestSelectedState(!this.selected) : this.openConfirmPurchaseDialog())
		})), this.onConfirmPurchaseDialogOpenCbs = new Set;
		this.renderView = Xn().renderer.createRenderView({
			width: 200,
			height: 200
		}), (this.config.meleeSkin || this.config.bowSkin) && this.renderView.canvas.classList.add("needs-mask"), this.el.appendChild(this.renderView.canvas), this.cam = new x, this.cam.name = "cam", this.cam.far = 10, this.camTarget = new l, this.camTarget.name = "cam target", this.rotY = 0, this.defaultRotY = 0, this.setDefaultRotY(.2 * Math.PI), this.camTarget.add(this.cam), this.scene = new w, this.scene.add(this.camTarget), this.renderView.setRenderObjects(this.scene, this.cam, !1), this.skeleton = new $t({
			gender: this.renderOptions.gender
		}), this.skeleton.addPoseLayer("shopItem"), this.loadingModelSym = null, this.loadingModel = null, this.visibleModel = null, this.skinObject = null, this.bowAsset = null, this.skinObjectAsset = null, this.currencyWrapperEl = null, this.currencyContainer = null, "button" == s ? this.setOwned(!this.config.price && !this.config.hasRewardedAd) : this.setOwned(!0), this.lockEl = document.createElement("div"), this.lockEl.classList.add("shopItemLock"), this.lockEl.classList.toggle("rewarded-break-unlockable", this.config.hasRewardedAd || !1), this.el.appendChild(this.lockEl), this.elementVisible = !1, this.skinObjectDirty = !0, this.intersectionObserver = new IntersectionObserver((t => {
		...
		})), this.intersectionObserver.observe(this.el), this.setSelectedState(this.selected), this.setOwned(this.owned), "preview" == this.usage && this.startLooping(), this.updateAriaLabel()
	}
	get id() {
		return this.config.id
	}
	destructor() {
		this.destructed = !0, Xn().renderer.removeRenderView(this.renderView), this.loadingModel && this.loadingModel.destructor(), this.visibleModel && this.visibleModel.destructor(), this.bowAsset && this.bowAsset.destructor(), this.stopLooping(), this.intersectionObserver.unobserve(this.el), this.intersectionObserver.disconnect(), this.removeStatsTooltip(), this.scrollingContainer && this.scrollingContainer.removeEventListener("scroll", this.boundRemoveStatsTooltip)
	}
	setRenderOptions(t) {
		this.renderOptions = t, this.skinObjectDirty = !0, this.elementVisible && this.reloadSkinObjectNow()
	}
	setDefaultRotY(t) {
		this.defaultRotY = t, this.camTarget.rotation.set(-.1 * Math.PI, this.defaultRotY, 0, "YZX")
	}
	async reloadSkinObjectNow() {
		if (!this.skinObjectDirty) return;
		const t = Symbol("Loading model");
		this.loadingModelSym = t, this.loadingModel && (this.loadingModel.destructor(), this.loadingModel = null);
		let e = new k;
		if (this.bowAsset && this.bowAsset.destructor(), this.skinObjectAsset && this.skinObjectAsset.destructor(), this.config.bowSkin) {
			const {
				skins: i,
				arrowSkin: s
			} = Xn().skins.skinNetworkDataToBowAssetData(this.config.bowSkin.bowId, {
				equippedSkinIds: [this.config.id]
			});
			if (this.bowAsset = new Zt({
					useWorldWeather: !1
			...
			if (this.scene.add(this.bowAsset.obj), await this.bowAsset.waitForLoad(), t != this.loadingModelSym) return;
			e = Jt(this.bowAsset.obj)
		} else if (this.config.meleeSkin) {
			if (Xn().skins.skinNetworkDataToMeleeSkinConfig({
					equippedSkinIds: [this.config.id]
				})) {
				if (this.skinObjectAsset = new Xt({
						useWorldWeather: !1,
						label: "melee"
					}), this.skinObjectAsset.setConfig({
						skinAssetName: this.config.meleeSkin.skin,
						teamId: 1
					}), this.scene.add(this.skinObjectAsset.obj), await this.skinObjectAsset.waitForLoad(), t != this.loadingModelSym) return;
				e = Jt(this.skinObjectAsset.obj)
			}
			...
			if (this.skinObjectAsset = new Xt({
					...
					teamId: 1
				}), this.scene.add(this.skinObjectAsset.obj), this.skinObjectAsset.obj.position.add(new u(0, .35, .35)), this.skinObjectAsset.obj.rotateX(-.25 * Math.PI), await this.skinObjectAsset.waitForLoad(), t != this.loadingModelSym) return;
			e = new k(new u, .4), this.setDefaultRotY(.5 * Math.PI)
		} else {
			const i = [],
				s = this.config.colorizableCategory;
			let n = {};
			if ("male" == this.renderOptions.gender && this.config.maleSkin ? n = this.config.maleSkin : "female" == this.renderOptions.gender && this.config.femaleSkin && (n = this.config.femaleSkin), s && n.additions)
			...
			let o = {};
			if (n.additions && (o = n.additions), this.config.showFullBodyInShopItem) {
				o = Xn().skins.skinNetworkDataToSkinConfig({
					equippedSkinIds: [this.config.id],
					gender: this.renderOptions.gender
				}).equippedItems
			}
			if (this.loadingModel = new Kt({
					init: !1,
					skinObjectOpts: {
						teamId: 1,
						skin: {},
	...
	animationLoop() {
		...
		if (this.prevNow = t, this.isHovering || "preview" == this.usage ? (this.rotY -= .001 * i, this.rotY = M(this.rotY + Math.PI, 2 * Math.PI) - Math.PI) : (this.rotY = e(this.rotY, 0, .1), Math.abs(this.rotY) < .001 && this.stopLooping()), this.camTarget.rotation.y = this.rotY + this.defaultRotY, this.shouldStopLooping) return this.isLooping = !1, this.shouldStopLooping = !1, this.prevNow = 0, void(this.renderView && (this.renderView.alwaysDirty = !1));
	...
	addStatsTooltip() {
		...
		if ("button" != this.usage) return;
		const t = this.dialog.zIndex + 1;
		if (!this.config.statClasses) return;
		const e = this.el.getBoundingClientRect();
		this.statsTooltip = new ee({
			zIndex: t,
	...
	removeStatsTooltip() {
		this.statsTooltip && (this.statsTooltip.destructor(), this.statsTooltip = null)
	}
	setSelectedState(t) {
	...
	updateAriaLabel() {
		...
		} else "preview" == this.usage && (t = "Shop item preview");
	...
	openConfirmPurchaseDialog() {
		const t = new Yt(this.gameWrapper, this.config, {
			renderOptions: this.renderOptions
		});
		Xn().dialogManager.addDialog(t), t.onPurchaseSuccess((() => {
...
class se {
	constructor(t) {
		this.gameWrapper = t, this.el = document.createElement("div"), this.el.classList.add("shop-items-grid-view"), this.shopItems = new Map, this.activeConfirmPurchaseDialogs = new Set, this.currentHoveringItem = null, this.onHoveringItemChangeCbs = new Set, this.onSelectedItemChangeRequestCbs = new Set
	}
	destructor() {
		this.destructShopItems()
	}
	addShopItem(t, e) {
		const i = new ie(this.gameWrapper, t, e);
		this.el.appendChild(i.el), i.onHoveringChange((t => {
	...
	loadShopItems(t, e) {
		this.destructShopItems();
		for (const [i, s] of t.entries()) this.addShopItem(s, {
			configIndex: i,
			...e
		});
		this.sortShopItems()
...
class ne extends Mt {
	constructor(t, e, i, s) {
		super(t), this.avatarsManager = e, this.contentEl = document.createElement("div"), this.contentEl.classList.add("skin-downloader-dialog-content"), this.el.appendChild(this.contentEl);
		const n = document.createElement("div");
		n.classList.add("skin-downloader-dialog-controls"), this.contentEl.appendChild(n);
		const o = document.createElement("div");
		o.textContent = "Team color ", n.appendChild(o), this.teamColorInput = document.createElement("input"), this.teamColorInput.type = "color", this.teamColorInput.value = A[1].cssColor, this.teamColorInput.addEventListener("change", (() => this.reloadPreview())), o.appendChild(this.teamColorInput);
		const a = document.createElement("div");
		a.textContent = "Background color ", n.appendChild(a), this.backgroundColorInput = document.createElement("input"), this.backgroundColorInput.type = "color", this.backgroundColorInput.value = A[2].cssColor, this.backgroundColorInput.addEventListener("change", (() => this.reloadPreview())), a.appendChild(this.backgroundColorInput);
		const r = document.createElement("div");
		r.textContent = "Background opacity ", n.appendChild(r), this.backgroundOpacityInput = document.createElement("input"), this.backgroundOpacityInput.type = "range", this.backgroundOpacityInput.min = "0", this.backgroundOpacityInput.max = "1", this.backgroundOpacityInput.step = "0.01", this.backgroundOpacityInput.value = "1", this.backgroundOpacityInput.addEventListener("change", (() => this.reloadPreview())), r.appendChild(this.backgroundOpacityInput);
		const l = document.createElement("div");
		l.textContent = "Shape ", n.appendChild(l), this.shapeInput = document.createElement("select");
		for (const t of ["none", "circle"]) {
			const e = document.createElement("option");
			e.value = t, e.textContent = t, this.shapeInput.appendChild(e)
		}
		this.shapeInput.value = "circle", this.shapeInput.addEventListener("change", (() => this.reloadPreview())), l.appendChild(this.shapeInput);
		const h = document.createElement("div");
		h.textContent = "Camera ", n.appendChild(h), this.cameraInput = document.createElement("select");
		for (const t of ["face-close", "face", "upper-body", "full-body"]) {
			const e = document.createElement("option");
			e.value = t, e.textContent = t.replaceAll("-", " "), this.cameraInput.appendChild(e)
		}
		this.cameraInput.value = "face-close", this.cameraInput.addEventListener("change", (() => this.reloadPreview())), h.appendChild(this.cameraInput);
		const d = document.createElement("div");
		d.textContent = "Pose ", n.appendChild(d), this.poseInput = document.createElement("select");
		const c = [];
		c.push(["", "None"]);
		for (const {
				uiName: t,
		...
		this.poseInput.value = "", this.poseInput.addEventListener("change", (() => this.reloadPreview())), d.appendChild(this.poseInput);
		const u = document.createElement("div");
		u.textContent = "Size ", n.appendChild(u), this.widthInput = document.createElement("input"), this.widthInput.classList.add("skin-downloader-size-input"), this.widthInput.type = "number", this.widthInput.value = "1024", u.appendChild(this.widthInput), u.appendChild(document.createTextNode(" x ")), this.heightInput = document.createElement("input"), this.heightInput.classList.add("skin-downloader-size-input"), this.heightInput.type = "number", this.heightInput.value = "1024", u.appendChild(this.heightInput);
		const p = document.createElement("div");
		p.classList.add("skin-downloader-download-container"), n.appendChild(p);
		const g = new xt({
			text: "Download",
			onClick: () => this.downloadCurrentAvatar()
		});
		p.appendChild(g.el), this.imageEl = document.createElement("div"), this.imageEl.classList.add("downloadable-skin-preview"), this.contentEl.appendChild(this.imageEl), this.currentBlobReference = null, this.createdDownloadBlobReferences = [], this.skinConfig = s, this.reloadPreview()
	}
	destructor() {
	...
	getCurrentAvatarConfig(t, e) {
		...
		if (this.poseInput.value) {
			const t = Ft(this.poseInput.value);
			a = [`bows/${t.bowId}/shopClassItem`];
			const {
				skins: e,
				arrowSkin: i
			} = Xn().skins.skinNetworkDataToBowAssetData(t.bowId, this.skinConfig);
			r = {
				teamId: 1,
				teamColor: o,
				bowId: t.bowId,
		...
		return a && (l.skeletonPoseLayers = a), l
	}
	reloadPreview() {
	...
	downloadCurrentAvatar() {
		...
		this.createdDownloadBlobReferences.push(s), (async () => {
...
class oe {
	constructor(t) {
		this.destructed = !1, this.el = document.createElement("div"), this.el.classList.add("shopSkinPreview", "wrinkledPaper", "wrinkled-paper-mask"), this.currentlyLoadedSkinData = null, this.currentTeamId = 1, this.el.addEventListener("click", (() => {
		...
		})), this.tooltipCategory = "none", this.statsTooltip = null, this.el.addEventListener("pointerenter", (() => {
			if (this.statsTooltip) return;
			if (!this.currentlyLoadedSkinData) return;
			if ("none" == this.tooltipCategory) return;
			const t = this.el.getBoundingClientRect(),
				{
					statClassValues: e
				} = Xn().skins.getStatClassValuesFromShopSkinIds(this.currentlyLoadedSkinData.equippedSkinIds || [], this.currentVisibleBowId),
				i = {};
			for (const [t, s] of e) i[t] = s;
			this.statsTooltip = new ee({
				zIndex: 1e3,
				statClasses: i,
				aboveRect: t,
			...
			if (this.currentlyLoadedSkinData) {
				const e = new ne(t, Xn().avatars, Xn().skins, this.currentlyLoadedSkinData);
				Xn().dialogManager.addDialog(e)
			}
		})), this.el.appendChild(this.downloadButton), this.cam = new x(45, 200 / 300, .1, 5), this.cam.far = 10, this.camTarget = new l, this.rotY = 0, this.currentMouseYMultiplier = 1, this.camTarget.add(this.cam), this.scene = new w, this.scene.add(this.camTarget), this.modelRotationContainer = new l, this.scene.add(this.modelRotationContainer), this.bowParentObj = new l, this.modelRotationContainer.add(this.bowParentObj), this.bowParentObj.matrixAutoUpdate = !1, this.meleeParentObj = new l, this.modelRotationContainer.add(this.meleeParentObj), this.meleeParentObj.matrixAutoUpdate = !1, this.smoothCamPosOffset = new u, this.smoothCamTargetRot = 0, this.activeCamFollowingTarget = null, this.activeSlotPositionId = null, this.camPositions = new Map, this.camPositions.set("full", {
			pos: new u(0, 1, 2.8)
			...
			activeFollowingTarget: this.bowParentObj,
			rot: .9
		}), this.setActiveSlotPosition("full", !0), this.renderView.setRenderObjects(this.scene, this.cam), this.boundOnMouseMove = this.onMouseMove.bind(this), window.addEventListener("mousemove", this.boundOnMouseMove), this.lastMouseX = 0, this.lastMouseY = 0, this.skeleton = new $t, this.skeleton.init(), this.activeExtraPoseLayer = null, this.bowAssetLoader = new Zt({
			useWorldWeather: !1
		}), this.bowAssetLoader.updateFireAmount(1, 1), this.hoveringBowAssetLoader = new Zt({
			useWorldWeather: !1
		}), this.hoveringBowAssetLoader.updateFireAmount(1, 1), this.bowParentObj.add(this.bowAssetLoader.obj), this.bowParentObj.add(this.hoveringBowAssetLoader.obj), this.bowSkeletonObj = null, this.currentVisibleBowId = null, this.currentEquippedSkinIds = [], this.hoveringBowVisible = !1, this.meleeAssetLoader = new Xt({
			useWorldWeather: !1,
			label: "melee"
		}), this.hoveringMeleeAssetLoader = new Xt({
			useWorldWeather: !1,
			label: "melee"
		}), this.meleeParentObj.add(this.meleeAssetLoader.obj), this.meleeParentObj.add(this.hoveringMeleeAssetLoader.obj), this.meleeSkeletonObj = null, this.currentVisibleMeleeSkinAssetName = null, this.hoveringMeleeVisible = !1, this.activeModel = null, this.loadingModel = null, this.hoveringModel = null, this.hoveringModelVisible = !1, this.lastHoveringModelCacheKey = "", this.initSkeleton(), this.updateSkinModel(), this.updateBackgroundColor()
	}
	destructor() {
		this.destructed = !0, this.bowAssetLoader.destructor(), this.hoveringBowAssetLoader.destructor(), this.meleeAssetLoader.destructor(), this.hoveringMeleeAssetLoader.destructor(), Xn().renderer.removeRenderView(this.renderView), this.removeModel(this.activeModel), this.activeModel = null, this.removeModel(this.loadingModel), this.loadingModel = null, this.removeModel(this.hoveringModel), this.hoveringModel = null, window.removeEventListener("mousemove", this.boundOnMouseMove)
	}
	async initSkeleton() {
		...
		if (!i) throw new Error("Assertion failed, melee holding pos object not found");
	...
	loop(t, i) {
		let s = !1;
		this.cam.position.distanceTo(this.smoothCamPosOffset) > .01 && (s = !0), this.cam.position.lerp(this.smoothCamPosOffset, .1);
		let n = new u;
		this.activeCamFollowingTarget && (n = this.activeCamFollowingTarget.getWorldPosition(new u));
		this.camTarget.position.distanceTo(n) > .01 && (s = !0), this.camTarget.position.lerp(n, .1);
		Math.abs(this.camTarget.rotation.y - this.smoothCamTargetRot) > .01 && (s = !0), this.camTarget.rotation.y = e(this.camTarget.rotation.y, this.smoothCamTargetRot, .1), s && this.renderView.markDirty()
	}
	setHoveringModel(t) {
		if (this.hoveringModelVisible = !1, t) {
			this.hoveringModelVisible = !0;
			const e = Xn().skins.skinObjectOptsToCacheKey(t);
			this.lastHoveringModelCacheKey != e && (this.lastHoveringModelCacheKey = e, this.removeModel(this.hoveringModel), this.hoveringModel = null, t && (this.hoveringModel = new Kt({
				skinObjectOpts: t,
				useWorldWeather: !1
			}), this.addModel(this.hoveringModel), this.updateVisibleModelAfterHoveringInit()))
		}
		if (this.updateVisibleModel(), this.hoveringBowVisible = !1, this.hoveringMeleeVisible = !1, t)
			if (this.currentVisibleBowId) {
				const {
					skins: e,
					arrowSkin: i
				} = Xn().skins.skinNetworkDataToBowAssetData(this.currentVisibleBowId, t.skin);
			...
			const e = Xn().skins.skinNetworkDataToMeleeSkinConfig(t.skin);
			e && (this.hoveringMeleeAssetLoader.setConfig({
				skinAssetName: e.skin,
				teamId: this.currentTeamId
			}), (async () => {
				await this.hoveringMeleeAssetLoader.waitForLoad(), this.updateVisibleMelee()
			})()), this.hoveringMeleeVisible = !0
		}
		this.updateVisibleBow(), this.updateVisibleMelee()
	}
	setHoveringShopItemId(t) {
		if (!this.currentlyLoadedSkinData) return;
		const e = {
			teamId: this.currentTeamId,
			skin: Xn().skins.getConfigForPreviewShopItemId(this.currentlyLoadedSkinData, {
				itemId: t
			})
		};
	...
	setCurrentSkinConfig(t) {
		this.currentlyLoadedSkinData = t, this.removeModel(this.loadingModel), this.loadingModel = new Kt({
			skinObjectOpts: {
				teamId: this.currentTeamId,
				skin: t
			},
			useWorldWeather: !1
		}), this.addModel(this.loadingModel), this.replaceLoadingModel(), this.currentEquippedSkinIds = t.equippedSkinIds || [], this.updateBowConfig(), this.updateMeleeConfig()
	}
	...
	updateVisibleMelee() {
		...
		this.meleeAssetLoader.obj.visible = t && !e, this.hoveringMeleeAssetLoader.obj.visible = t && e
	}
	...
	updateBowConfig() {
		if (this.currentVisibleBowId) {
			const {
				skins: t,
				arrowSkin: e
			} = Xn().skins.skinNetworkDataToBowAssetData(this.currentVisibleBowId, {
	...
	setMelee(t) {
		this.currentVisibleMeleeSkinAssetName = t, this.updateMeleeConfig(), this.updateVisibleMelee()
	}
	updateMeleeConfig() {
		if (this.currentVisibleMeleeSkinAssetName) {
			const t = Xn().skins.skinNetworkDataToMeleeSkinConfig({
				equippedSkinIds: this.currentEquippedSkinIds
			});
...
class ae {
	constructor(t, e, {
		...
		let o;
		this.gameWrapper = t, this.el = document.createElement("div"), this.el.classList.add("shopDialogContent"), this.dialog = n, this.skinManager = e, this.customizationId = i, this.onBackButtonClickCbs = new Set, this.pagedView = new Gt({
			extraClasses: ["shop-paged-view-container"]
		}), this.el.appendChild(this.pagedView.el), this.createdGrids = new Map, this.skinPreview = new oe(t), this.el.appendChild(this.skinPreview.el), this.updateSkinPreviewConfig(), this.filterSubPages = new Map;
		let a = null;
		if ("class" == i.type) {
			const t = Ft(i.classId);
			o = {
				itemName: "Bow",
				...
				onBecomeVisible: () => {
					this.setSkinPreview(this.createBowGridViewConfig(t, "full")), this.skinPreview.setTooltipCategory("bow")
				}
			}, a = t.bowId
		} else {
			const t = [];
			for (const e of Tt) t.push({
				itemName: e.uiName,
				subPages: [this.createGridViewSubPage({
					itemName: "Handle",
					buttonIcon: "static/img/menuUI/shop/categoryIcons/bowHandle.svg",
				...
				onBecomeVisible: () => {
					this.setSkinPreview(this.createBowGridViewConfig(e, "full")), this.skinPreview.setTooltipCategory("bow")
				}
			});
			o = {
				itemName: "Bow",
		...
		this.pagedView.setActiveStructure({
			...
			rightCorner: t => {
				if ("class" == i.type) {
					...
					o.classList.add("dialog-select-wrapper", "wrinkledPaper"), t.appendChild(o);
					const a = document.createElement("select");
					a.classList.add("dialog-select-input", "blueNight"), o.appendChild(a);
					const r = document.createElement("option");
					r.value = "none", r.textContent = "None", a.appendChild(r);
					for (const t of e.skinPresets.keys()) {
						const e = document.createElement("option");
						e.value = String(t), e.textContent = `Preset ${t+1}`, a.appendChild(e)
					}
					null == n.presetId ? a.value = "none" : a.value = String(n.presetId), a.addEventListener("change", (() => {
						let t;
						t = "none" == a.value ? null : Number(a.value), this.skinManager.setClassPreset(s, t), this.updateSkinPreviewConfig()
					}))
				}
			},
			subPages: [{
				...
				rightCorner: t => {
					const e = document.createElement("div");
					e.classList.add("shop-gender-toggle-container"), t.appendChild(e);
					const s = document.createElement("div");
					s.classList.add("gender-icon", "male"), e.appendChild(s);
					const n = document.createElement("input");
					n.type = "checkbox", n.classList.add("dialog-toggle-input", "wrinkledPaper"), n.ariaLabel = "Gender";
					let o = "male";
					if ("preset" == i.type) {
						const t = i.presetId;
					...
					n.checked = "female" == o, n.addEventListener("change", (() => {
						const t = n.checked ? "female" : "male";
						"preset" == i.type ? this.skinManager.setPresetGender(i.presetId, t) : "class" == i.type && this.skinManager.setClassGender(i.classId, t), this.updateSkinPreviewConfig(), this.pagedView.updateButtonVisibilies()
					})), e.appendChild(n);
					const a = document.createElement("div");
					a.classList.add("gender-icon", "female"), e.appendChild(a)
				},
				subPages: [this.createGridViewSubPage({
					itemName: "Skin color",
	...
	highlightOrOpenShopItem(t, e, i) {
		...
		if (!s) throw new Error(`No subpage structure found for shop item "${e}"`);
		...
		for (const {
			...
			if (e === s) {
				n = t;
				break
			} if (!n) throw new Error("Assertion failed, no grid was created for the subpage");
		n.performHighlightShopItemAction(e, i)
	}
	resetSkinPreview({
		camPosition: t = "full"
	} = {}) {
		this.skinPreview.setActiveSlotPosition(t), this.skinPreview.setSkeletonPose(null), this.skinPreview.setBow(null), this.skinPreview.setMelee(null), this.skinPreview.setTooltipCategory("armor")
	}
	createBowGridViewConfig(t, e) {
		let i = "full",
			s = [];
		"full" == e ? i = t.bowShopCamPosition : "handle" == e ? (i = t.bowHandleShopCamPosition, s = t.bowHandleShopCategories) : "tip" == e && (i = t.bowTipShopCamPosition, s = t.bowTipShopCategories);
		const n = {
	...
	setSkinPreview({
		skinPreviewCamPosition: t = null,
		skeletonPose: e = null,
		bowId: i = null,
		meleeSkinAssetName: s = null
	}) {
		t && this.skinPreview.setActiveSlotPosition(t), this.skinPreview.setSkeletonPose(e), this.skinPreview.setBow(i), this.skinPreview.setMelee(s)
	}
	createGridViewSubPage({
		...
		buttonIconSize: i,
		filterOptions: s,
		skinPreviewCamPosition: n = null,
		skeletonPose: o = null,
		bowId: a = null,
		meleeSkinAssetName: r = null,
		colorButtonsCategory: l = "none",
		previewTooltipCategory: h = "none"
	}) {
		const d = {
			itemName: t,
			buttonIcon: e,
		...
		if ("none" != l && (d.rightCorner = t => {
				...
				for (const {
					...
					s.classList.add("shop-color-button"), s.style.backgroundColor = e, t.appendChild(s), s.addEventListener("click", (() => {
						const t = Xn().skins;
			...
			for (const t of s.shopCategoriesFilter) this.filterSubPages.set(t, d);
		return d
	}
	filterPurchasableItems(t, e, {
		filterType: i = "default",
		shopCategoriesFilter: s,
		useSingleWeaponType: n,
		hideNonBowSkins: o
	}) {
		if ("missing" == i) return [];
		if ("uncategorized" == i) return t.filter((t => !t.categories));
		{
			const a = Xn().shopState.purchasedItems;
			return t.filter((t => {
				if ("rewarded" == i) {
					if (!t.hasRewardedAd) return !1;
					if (a.has(t.id)) return !1
				}
				if (n && t.bowSkin && n != t.bowSkin.bowId) return !1;
				if (o && !t.bowSkin) return !1;
				if (!(t.showFullBodyInShopItem || t.bowSkin || t.meleeSkin || t.arrowSkin)) {
					if ("male" == e && !t.maleSkin) return !1;
					if ("female" == e && !t.femaleSkin) return !1
				}
				if (s) {
					if (!t.categories) return !1;
					let e = !1;
				...
				if (!this.showHiddenItems) {
					if ("hidden" == t.shopVisibility) return !1;
	...
	createShopItemsGrid(t, {
		...
		const n = new se(this.gameWrapper);
		t.appendChild(n.el);
		const o = () => {
				const i = this.getShopItemRenderOptions(s),
					o = Xn().config.shopConfig.loadedConfigData,
			...
			a = Xn();
		if (a.config.shopConfig.onConfigChange(o), n.onHoveringItemChange((t => {
				let e = null;
			...
			})), n.setPurchasedItems(a.shopState.purchasedItems), "preset" == this.customizationId.type) {
			const t = this.customizationId.presetId,
				e = this.skinManager.getPreset(t),
				i = new Set(e.equippedSkinIds);
			n.setSelectedItems(i), n.onSelectedItemChangeRequest(((e, i) => {
				if (i) {
					const i = this.skinManager.addShopItemToPreset(e, t);
					for (const t of i) n.setSelectedItemState(t, !1)
				} else this.skinManager.removeShopItemFromPreset(e, t);
				n.setSelectedItemState(e, i), this.updateSkinPreviewConfig()
			}))
		} else if ("class" == this.customizationId.type) {
			const t = this.customizationId.classId;
			this.updateSelectedItemsForClass(t, n), n.onSelectedItemChangeRequest(((e, i) => {
				i ? this.skinManager.addShopItemToClass(e, t) : this.skinManager.removeShopItemFromClass(e, t), this.updateSelectedItemsForClass(t, n), this.updateSkinPreviewConfig()
			}))
		}
	...
	updateSelectedItemsForClass(t, e) {
		...
		if (i.equippedSkinIds)
			for (const t of i.equippedSkinIds) this.skinManager.addItemAndRemoveDuplicateSlots(n, t);
		if (i.unequippedSkinIds)
			for (const t of i.unequippedSkinIds) n.delete(t);
	...
	destroyShopItemsGrid(t) {
		...
		const {
			grid: i,
			reloadFilteredItems: s
		} = e;
		i.destructor(), this.createdGrids.delete(t), Xn().config.shopConfig.removeOnConfigChange(s)
	}
}
class re {
	constructor(t, {
...
class le {
	constructor(t) {
		...
		e.classList.add("dialogTitle", "blueNight"), e.textContent = t.uiName, this.el.appendChild(e), this.onClickCbs = new Set, this.classSelectionImage = new re(t.id);
		const {
			colors: i
		} = Xn().gameManager.getMyTeamColor();
		this.classSelectionImage.setCssColor(i.cssColor, i.cssColorDark), this.el.appendChild(this.classSelectionImage.el);
		const s = new xt({
			text: "Edit",
			onClick: () => {
...
class he {
	constructor({
		...
		const n = document.createElement("div");
		n.classList.add("shop-skin-selection-image", "wrinkledPaper", "wrinkled-paper-mask"), n.style.cssText = `\n\t\t\t--wrinkled-paper-seed: ${ut(1,99999)};\n\t\t`, this.el.appendChild(n);
		const o = new xt({
			text: "Edit",
			onClick: e,
			extraClasses: ["shop-skin-selection-edit-button"]
		...
		if (this.avatarBlobUrlReference = a.getBlobUrlReference(), (async () => {
...
class de {
	constructor(t) {
		...
		s.textContent = "Presets", s.classList.add("dialogTitle", "blueNight", "shop-presets-title"), e.appendChild(s), this.presetsList = document.createElement("div"), this.presetsList.classList.add("shop-skin-selection-list"), this.el.appendChild(this.presetsList), this.createdPresetItems = [], this.addPresetButton = new xt({
			text: "+",
...
class ce extends Mt {
	constructor(t) {
		...
		this.boundUpdateShopState = this.updateShopState.bind(this), Xn().shopState.onStateChanged(this.boundUpdateShopState), Xn().shopState.fetchCurrentData(), this.updateShopState()
	}
	destructor() {
		Xn().shopState.removeOnStateChanged(this.boundUpdateShopState), this.hideCustomizationView(), this.hidePresetsView(), super.destructor();
	...
	updateShopState() {
		this.currencyContainer.setAmount(Xn().shopState.ownedCoins), this.currentCustomizationView && this.currentCustomizationView.updateShopState(Xn().shopState.purchasedItems)
	}
	...
	showCustomizationView(t) {
		...
		const e = Xn().skins;
		this.currentCustomizationView = new ae(this.gameWrapper, e, t), this.el.appendChild(this.currentCustomizationView.el), this.currentCustomizationView.onBackButtonClick((() => {
	...
	showPresetsView() {
		this.currentPresetsView || (this.currentPresetsView = new de(Xn().skins), this.currentPresetsView.onPresetOpenClick((t => {
	...
	openShopItemSubPage(t, e) {
		...
		if (!n) throw new Error("Assertion failed, the shop config hasn't been loaded");
		const o = new Map;
		for (const t of Object.values(s.classSkins))
			...
			r = 0;
		for (const [t, e] of o) e > r && (a = t, r = e);
		if (this.showPresetCustomizationView(a), !this.currentCustomizationView) throw new Error("Assertion failed, customization view not visible");
...
class ue extends Mt {
	constructor(t, {
		...
		super(t);
		const i = document.createElement("div");
		i.classList.add("profile-container"), this.el.appendChild(i), this.avatarEl = document.createElement("div"), this.avatarEl.classList.add("avatar"), i.appendChild(this.avatarEl), this.boundChangeAvatarUrl = this.changeAvatarUrl.bind(this), Xn().playerAvatarManager.onAvatarUrlChange(this.boundChangeAvatarUrl), this.usernameForm = document.createElement("form"), this.usernameForm.addEventListener("submit", (t => (t.preventDefault(), this.submitUsername(), this.usernameInput.blur(), !1))), this.usernameForm.addEventListener("click", (() => {
			const t = Xn();
			t.profileState.isGuest ? t.auth.loginIfNotLoggedIn(!0) : this.usernameInput.focus()
		})), i.appendChild(this.usernameForm), this.usernameDummyText = document.createElement("div"), this.usernameDummyText.classList.add("dummy-text", "blueNight"), this.usernameForm.appendChild(this.usernameDummyText), this.usernameInput = document.createElement("input"), this.usernameInput.classList.add("dialog-text-input", "blueNight", "wrinkledPaper"), this.usernameInput.placeholder = "Username", this.usernameInput.maxLength = 20, this.usernameInput.addEventListener("change", (async () => {
			this.submitUsername()
		})), this.usernameInput.addEventListener("blur", (() => {
			this.updateUsernameInputVisibility()
		})), this.usernameInput.addEventListener("focus", (() => {
			this.updateUsernameInputVisibility()
		})), this.usernameForm.appendChild(this.usernameInput), this.usernameEditButton = document.createElement("button"), this.usernameEditButton.classList.add("edit-button"), this.usernameEditButton.ariaLabel = "edit username", this.usernameEditButton.type = "button", this.usernameForm.appendChild(this.usernameEditButton), this.boundUpdateProfileState = this.updateProfileState.bind(this);
		const s = document.createElement("div");
		s.classList.add("profile-stats"), this.el.appendChild(s), this.stats = new Map;
		const n = (t, e, {
			hasIcon: i = !0
		} = {}) => {
			const n = document.createElement("div");
			s.appendChild(n), n.classList.add("wrinkledPaper", "profile-stat"), n.style.cssText = `\n\t\t\t\t--wrinkled-paper-seed: ${ut(1,99999)};\n\t\t\t`;
			const o = document.createElement("div");
			o.classList.add("profile-stat-icon"), i && (o.style.background = `url(static/img/profileStats/${t}.svg)`), n.appendChild(o);
			const a = document.createElement("div");
			a.textContent = e, n.appendChild(a);
			const r = document.createElement("div");
			r.textContent = "-", n.appendChild(r), this.stats.set(t, {
				valueEl: r
			})
		};
		n("gamesPlayed", "Games Played"), n("gamesWon", "Games Won"), n("flagsCaptured", "Flags Captured"), n("totalPoints", "Points Scored"), n("kills", "Kills"), n("deaths", "Deaths"), e && n("elo", "Elo Rating", {
			hasIcon: !1
		}), Xn().profileState.onStateChanged(this.boundUpdateProfileState), Xn().profileState.fetchCurrentData(), this.updateProfileState(), this.updateUsernameInputVisibility()
	}
	destructor() {
		super.destructor(), Xn().profileState.removeOnStateChanged(this.boundUpdateProfileState), Xn().playerAvatarManager.removeOnAvatarUrlChange(this.boundChangeAvatarUrl)
	}
	updateProfileState() {
		const t = Xn(),
			e = t.profileState,
		...
		for (const {
			...
			of this.stats.values()) t.textContent = "-";
		for (const [e, i] of Object.entries(t.profileState.stats)) {
			const s = e,
				n = this.stats.get(s);
			if (n) {
				let e = Math.round(i);
				"elo" == s && (e = Math.round(t.profileState.getElo())), n.valueEl.textContent = String(e)
			}
		}
		let s = !0;
		const n = t.profileState.usernameData;
		n && (n.protected || n.verified) && (s = !1), this.usernameInput.disabled = !s || e.isGuest, this.usernameForm.classList.toggle("editable", s), this.usernameEditButton.style.display = s ? "" : "none", this.updateUsernameInputVisibility()
	}
	async submitUsername() {
		await Xn().profileState.setUsername(this.usernameInput.value) || this.updateProfileState()
	}
	updateUsernameInputVisibility() {
		const t = document.activeElement == this.usernameInput || !this.usernameInput.value;
		this.usernameForm.classList.toggle("input-visible", t), t ? this.usernameInput.style.width = "250px" : (this.usernameDummyText.textContent = this.usernameInput.value, this.usernameInput.style.width = this.usernameDummyText.clientWidth + "px")
	}
	changeAvatarUrl(t) {
...
class pe {
	constructor() {
		this.el = document.createElement("button"), this.el.classList.add("main-menu-corner-profile"), this.clickCbs = new Set, this.el.addEventListener("click", (t => {
			this.clickCbs.forEach((e => e(t)))
		})), this.avatarEl = document.createElement("div"), this.avatarEl.classList.add("avatar"), this.el.appendChild(this.avatarEl), this.usernameEl = document.createElement("div"), this.usernameEl.classList.add("main-menu-username", "blueNight", "whiteBigText"), this.usernameEl.textContent = "Guest", this.el.appendChild(this.usernameEl), this.ownedCoins = new Pt({
			testLabel: "cornerProfile"
		}), this.el.appendChild(this.ownedCoins.el), this.boundAvatarUrlChanged = this.avatarUrlChanged.bind(this)
	}
	init() {
		Xn().shopState.onStateChanged((() => {
			this.ownedCoins.setAmount(Xn().shopState.ownedCoins)
		})), Xn().profileState.onStateChanged((() => {
			this.setUsername(Xn().profileState.getUsername())
		}))
	}
	setUsername(t) {
	...
	setMainMenuVisibility(t) {
		t ? Xn().playerAvatarManager.onAvatarUrlChange(this.boundAvatarUrlChanged) : Xn().playerAvatarManager.removeOnAvatarUrlChange(this.boundAvatarUrlChanged)
	}
	avatarUrlChanged(t) {
		t && (this.avatarEl.style.backgroundImage = `url("${t}")`)
	}
...
class ge {
	...
	loadNewBestPromo() {
		...
		for (const t of i) s.delete(t.id);
		for (const t of s) this.promoViewData.delete(t);
		i = i.filter((t => !!(t && t.id && t.image))), i = i.filter((t => {
			if (t.actionShopItem && this.shopStateManager.itemIsPurchased(t.actionShopItem)) return !1;
			if (t.seasonalRange) {
				const e = t.seasonalRange;
				if (e.startDay && e.endDay && e.startMonth && e.endMonth) {
					const t = new Date,
		...
		for (const s of i) {
			...
			i.viewCount <= e && (t = s, e = i.viewCount)
		}
	...
	setActivePromo(t) {
		...
		this.bannerEl.style.backgroundImage = `${e}`, this.bannerEl.style.backgroundImage = `${e} !important`, t.buttonText && this.button.setText(t.buttonText), t.buttonIcon ? this.button.setIcon(`static/img/${t.buttonIcon}`) : this.button.setIcon(null), this.button.visible = !!t.buttonText, this.updateVisibility(), this.updatePromoViewdata(t.id, (t => {
			t.viewCount++
		}))
	}
	async onPromoClick() {
		...
		if (this.activePromo.action && (t = this.activePromo.action), "highlightShopItem" == t) {
			...
			if (t) {
				...
				if (e && !e.price && e.hasRewardedAd) {
					...
					let s;
					s = await this.shopStateManager.purchaseItem(e, this.pokiManager, this.dialogManager, "in-menu") ? "highlight-and-equip" : "open", i.highlightShopItem(t, s)
				}
			}
	...
	updatePromoViewdata(t, e) {
		...
		const s = e(i);
		s && (i = s), this.promoViewData.set(t, i), this.savePromoViewData()
	}
}
class me {
	constructor({
...
class we extends Mt {
	constructor(t, e) {
		super(t), this.squadManager = e, this.settings = new Map, this.privateSquadOnlySettings = new Set, this.privateSquadSetting = new At({
			text: "Private squad",
			type: "toggle"
		}), this.settings.set("privateSquad", this.privateSquadSetting), this.privateSquadSetting.onValueChange((() => {
		...
		this.settings.set("scoreTimer", i), this.privateSquadOnlySettings.add(i), this.leaderOnlyMessage = document.createElement("div"), this.leaderOnlyMessage.classList.add("squad-settings-leader-only-message"), this.leaderOnlyMessage.textContent = "Only the squad leader can change these settings.", this.el.appendChild(this.leaderOnlyMessage);
		for (const [t, i] of this.settings) e.currentSquadSettings && i.setValue(e.currentSquadSettings[t]), this.el.appendChild(i.el), i.onValueChange((i => {
			e.setSquadSetting(t, i)
		}));
		e.onSquadSettingChange(this.onSquadSettingChange), e.onMySquadLeaderStateChange(this.onMySquadLeaderStateChange), this.updateDisabledState(), this.updateLeaderMessageVisibility()
	}
	destructor() {
		super.destructor(), this.squadManager.removeOnSquadSettingChange(this.onSquadSettingChange), this.squadManager.removeOnMySquadLeaderStateChange(this.onMySquadLeaderStateChange)
	}
	...
	onMySquadLeaderStateChange = () => {
		this.updateDisabledState(), this.updateLeaderMessageVisibility()
	};
	...
	updateDisabledState() {
		if (this.squadManager.myClientIsSquadLeader) {
			...
			for (const e of this.privateSquadOnlySettings) e.setDisabled(!t)
		} else
			for (const t of this.settings.values()) t.setDisabled(!0)
	}
}
class be extends Mt {
	constructor(t, e, i, s, n, o) {
		super(t), this.networkManager = e, this.squadManager = i, this.gameManager = s, this.avatarsManager = n, this.skinManager = o;
		const a = document.createElement("div");
		a.classList.add("squad-split-container"), this.el.appendChild(a);
		const r = document.createElement("div");
		r.classList.add("squad-split-section"), a.appendChild(r);
		const l = document.createElement("h3");
		l.classList.add("dialogTitle", "blueNight"), l.textContent = "Invite someone", r.appendChild(l);
		const h = document.createElement("div");
		h.classList.add("squad-id-block"), r.appendChild(h);
		const d = document.createElement("div");
		d.textContent = "Invite Code:", h.appendChild(d);
		const c = document.createElement("div");
		c.classList.add("squad-id-container"), h.appendChild(c), this.currentSquadId = null, this.squadIdText = document.createElement("div"), this.squadIdText.classList.add("allow-select", "squad-id"), c.appendChild(this.squadIdText);
		const u = document.createElement("div");
		u.classList.add("squad-id-copied-text"), u.textContent = "Copied!", this.copyUrlButton = new xt({
			isIconButton: !0,
			ariaLabel: "Copy squad id to clipboard",
			icon: "static/img/menuUI/copy.svg",
			extraClasses: ["squad-id-button"],
			onClick: async () => {
				null != this.currentSquadId && (await navigator.clipboard.writeText(this.currentSquadId), u.classList.remove("animating"), u.offsetHeight, u.classList.add("animating"))
			}
		}), c.appendChild(this.copyUrlButton.el), this.copyUrlButton.el.appendChild(u), this.clipboardPermissionGranted = !1, this.updateCopyUrlButtonVisibility(), this.queryClipboardPermission();
		const p = document.createElement("div");
		p.classList.add("squad-split-divider"), a.appendChild(p);
		const g = document.createElement("div");
		g.classList.add("squad-split-divider-line", "wrinkledLine"), g.style.cssText = "--wrinkled-line-seed: 18", p.appendChild(g);
		const m = document.createElement("span");
		m.textContent = "or", p.appendChild(m);
		const f = document.createElement("div");
		f.classList.add("squad-split-divider-line", "wrinkledLine"), f.style.cssText = "--wrinkled-line-seed: 12", p.appendChild(f);
		const w = document.createElement("div");
		w.classList.add("squad-split-section"), a.appendChild(w);
		const b = document.createElement("h3");
		b.classList.add("dialogTitle", "blueNight"), b.textContent = "Join existing squad", w.appendChild(b);
		const y = document.createElement("form");
		y.classList.add("text-with-submit-form"), w.appendChild(y), y.addEventListener("submit", (async t => {
			if (t.preventDefault(), this.networkManager.hasGameServerConnection) {
				const t = Xn().dialogManager.showAlert({
					title: "Are you sure?",
		...
		}), y.appendChild(this.joinSquadIdInput.el), this.joinSquadIdButton = new xt({
			text: "Join"
		}), y.appendChild(this.joinSquadIdButton.el), this.updateJoinButtonVisibility();
		const S = document.createElement("div");
		S.classList.add("in-squad-content"), this.el.appendChild(S);
		const v = document.createElement("div");
		v.classList.add("squad-players-list", "wrinkledPaper", "wrinkled-paper-mask"), v.style.cssText = `\n\t\t\t--wrinkled-paper-seed: ${ut(1,99999)};\n\t\t`, S.appendChild(v);
		const C = document.createElement("table");
		C.classList.add("itemsTable"), v.appendChild(C), this.membersTbody = document.createElement("tbody"), C.appendChild(this.membersTbody), this.inSquadButtonsContainer = document.createElement("div"), this.inSquadButtonsContainer.classList.add("in-squad-buttons"), S.appendChild(this.inSquadButtonsContainer);
		const k = new xt({
			text: "Ready",
			onClick: () => {
				s.joinGameWithoutAd()
		...
		this.inSquadButtonsContainer.appendChild(k.el), k.enabled = s.readyToJoin, this.boundOnReadyToJoinChange = t => {
			k.enabled = t
		}, s.onReadyToJoinChange(this.boundOnReadyToJoinChange), this.startButton = new xt({
			text: "Start",
			onClick: () => {
				i.startSquad()
			}
		...
		const P = new xt({
			...
			iconSize: 1.5,
			onClick: () => {
				this.squadSettingsDialog || (this.squadSettingsDialog = new we(t, this.squadManager), Xn().dialogManager.addDialog(this.squadSettingsDialog), this.squadSettingsDialog.addOnCloseCb((() => {
					this.squadSettingsDialog = null
				})))
			}
		});
		this.el.appendChild(P.el), this.currentAvatarBlobUrlReferences = new Set, this.boundUpdateSquadId = this.updateSquadId.bind(this), this.boundOnSquadIdChange = this.onSquadIdChanged.bind(this), i.onUserVisibleSquadIdChange(this.boundOnSquadIdChange), i.onIsJoiningSquadChange(this.boundUpdateSquadId), this.boundOnSquadMembersChange = () => {
			this.updateMembersUi(), this.updateReadyStartButtonVisibility()
		}, this.boundOnLeaderStateChange = () => {
			this.updateMembersUi()
		}, this.boundOnSquadSettingChange = (t, e) => {
			"privateSquad" == t && this.updateMembersUi()
		}, i.onSquadMembersChange(this.boundOnSquadMembersChange), i.onMySquadLeaderStateChange(this.boundOnLeaderStateChange), i.onSquadSettingChange(this.boundOnSquadSettingChange), this.boundUpdateStartButtonEnabled = this.updateStartButtonEnabled.bind(this), i.onServerReadyForStartStateChange(this.boundUpdateStartButtonEnabled), this.boundUpdateStartButtonEnabledFromStartClicked = () => {
			this.updateStartButtonEnabled(!0)
		}, i.onStartClickedChange(this.boundUpdateStartButtonEnabledFromStartClicked), this.boundOnInGameChange = () => {
			this.updateReadyStartButtonVisibility()
		}, s.onActiveGameChange(this.boundOnInGameChange), this.updateSquadId(), this.updateMembersUi(), this.updateReadyStartButtonVisibility(), this.handleRequestInitialSquadId()
	}
	destructor() {
		super.destructor(), this.squadManager.removeOnUserVisibleSquadIdChange(this.boundOnSquadIdChange), this.squadManager.removeOnIsJoiningSquadChange(this.boundUpdateSquadId), this.squadManager.removeOnSquadMembersChange(this.boundOnSquadMembersChange), this.squadManager.removeOnMySquadLeaderStateChange(this.boundOnLeaderStateChange), this.squadManager.removeOnSquadSettingChange(this.boundOnSquadSettingChange), this.squadManager.removeOnServerReadyForStartStateChange(this.boundUpdateStartButtonEnabled), this.squadManager.removeOnStartClickedChange(this.boundUpdateStartButtonEnabledFromStartClicked), this.gameManager.removeOnReadyToJoinChange(this.boundOnReadyToJoinChange), this.gameManager.removeOnCurrentGameChange(this.boundOnInGameChange), this.squadSettingsDialog && this.squadSettingsDialog.close();
	...
	async handleRequestInitialSquadId() {
		try {
			...
			t instanceof fe && (e = "Could not connect to the server. Please try again later."), Xn().dialogManager.showAlert({
	...
	createMemberAvatarEl(t, e) {
		...
		let n = null; - 1 == e && (e = 1, n = A[2].cssColor);
		...
		return this.currentAvatarBlobUrlReferences.add(o), (async () => {
	...
	updateMembersUi() {
		...
		for (const [s, o] of t.entries()) {
			...
			if (a.classList.add("squad-players-leader-container"), t.appendChild(a), o.leader) {
				const t = document.createElement("div");
				t.classList.add("squad-leader-icon"), a.appendChild(t)
			}
			const r = o.matchmakeServerId;
			if (n && null != r) {
				const e = document.createElement("div");
				e.classList.add("squad-team-color-selection-group"), t.appendChild(e);
				const i = [-1, 1, 2, 0];
				for (const t of i) {
					...
					a.type = "radio", a.name = i, a.value = String(t), o.teamId == t && (a.checked = !0);
					const l = r;
					a.addEventListener("change", (() => {
						const t = e.querySelector("input:checked");
						t && this.squadManager.setConfiguredTeamColor(l, parseInt(t.value, 10))
					})), n.appendChild(a), n.appendChild(document.createElement("span"));
					const h = this.createMemberAvatarEl(o, t);
					n.appendChild(h)
				}
			} else {
				const e = document.createElement("td");
				e.classList.add("squad-players-avatar-container"), t.appendChild(e);
				const i = this.createMemberAvatarEl(o, o.teamId);
				e.appendChild(i)
			}
			const l = document.createElement("td");
			t.appendChild(l), l.textContent = o.name;
			let h = "";
			if (o.joined && !i ? h = "Joined" : o.ready && !e && (h = "Ready"), h) {
				const t = document.createElement("span");
				t.classList.add("players-list-label"), t.textContent = h, l.appendChild(t)
			}
		}
		for (const t of o) t.destructor();
	...
	updateStartButtonEnabled(t = !1) {
		this.startButton.enabled = this.squadManager.startButtonEnabled, this.squadManager.startClicked && t && this.close()
	}
...
class ye {
	constructor(t, e) {
		if (this.onJoinClickedCbs = new Set, this.el = document.createElement("div"), this.el.classList.add("map-item"), this.titleEl = document.createElement("h2"), this.titleEl.classList.add("map-item-title", "blueNight"), this.titleEl.textContent = e.name, this.el.appendChild(this.titleEl), this.thumbContainer = document.createElement("div"), this.thumbContainer.classList.add("map-item-thumb", "wrinkled-paper-mask"), this.el.appendChild(this.thumbContainer), e.thumbLayers && e.thumbLayers.length > 0)
			for (const [i, s] of e.thumbLayers.entries()) {
				const n = `url("${t.basePath}mapThumbs/${e.assetName}/${i}.webp")`,
					o = document.createElement("div");
				o.classList.add("map-item-thumb-layer"), o.style.backgroundImage = `${n}`, o.style.zIndex = String(i), o.style.setProperty("--layer-offset", s + "px"), this.thumbContainer.appendChild(o)
			} else {
				const i = `url("${t.basePath}mapThumbs/${e.assetName}.webp")`,
					s = document.createElement("div");
				s.classList.add("map-item-thumb-layer", "legacy"), s.style.backgroundImage = `${i}`, s.style.setProperty("--layer-offset", "0px"), this.thumbContainer.appendChild(s)
			}
...
class Se extends Mt {
	constructor(t, e, i, s) {
		super(t), this.configManager = e, this.preferredMapManager = i, this.gameManager = s, this.mapsContainer = document.createElement("div"), this.mapsContainer.classList.add("maps-container"), this.el.appendChild(this.mapsContainer), this.maps = [], this.configManager.mapsConfig.onConfigChange((t => {
			this.updateMaps(t)
		}))
	}
	updateMaps(t) {
		...
		for (const e of t.maps) {
			if (e.hiddenInUi) continue;
			const t = new ye(this.configManager, e);
			this.maps.push(t), this.mapsContainer.appendChild(t.el), t.onJoinClicked((async () => {
				const t = Xn(),
					i = t.network.squadManager;
				if (i.isInSquad && !i.myClientIsSquadLeader) return void t.dialogManager.showAlert({
				...
				if (e.alternativeMaps) {
					...
					for (const e of t) e && s.push(e.hash)
				}
				const n = mt(s);
				if (!n) throw new Error("Assertion failed, no map hash found");
				if (this.preferredMapManager.forceSoloMap(n), i.myClientIsSquadLeader && !t.gameManager.getOnlineGame()) i.startSquad(), this.close();
				else {
...
class ve extends Mt {
	constructor(t) {
		super(t, {
			startVisible: !1
		}), this.el.classList.add("ios-pwa-install-dialog"), this.el.innerHTML = '\n\t\t\t<h2 class="dialogTitle blueNight">Install Narrow One</h2>\n\t\t\t<ol>\n\t\t\t\t<li>Tap the <span class="text-icon ios-share-icon"></span> icon.</li>\n\t\t\t\t<li>Choose <b>Add to Home Screen<span class="text-icon ios-add-icon"></span></b>.</li>\n\t\t\t</ol>\n\t\t', bt(this.el), this.visible = !0
	}
}
let Ce = "serviceWorker" in navigator;
navigator.userAgent.includes("AppleWebKit/605.1.15") && !St().serviceWorker && (Ce = !1);
let ke = !1,
	Pe = null;
const xe = new Set;
let Me, Ae = !1;
...
function Ee() {
	if (!Pe) throw new Error("No active service worker registration");
	const t = Pe.waiting;
	if (!t) throw new Error("No service worker is currently waiting");
	t.postMessage({
		type: "skipWaiting"
	})
}
window.addEventListener("beforeinstallprompt", (t => {
	Ve(), Me = t, t.preventDefault()
}));
let Fe = !1;
const De = new Set;
let Oe = !1;
...
class Be {
	...
	stop() {
		if (!this.isDestructed) return this.id >= 0 && (clearTimeout(this.id), this.id = -1, !0)
	}
	start(t = this.ms) {
...
class Re {
	constructor({
		...
		this.value = t, this.target = t, this.velocity = 0, this.springMultiplier = e, this.maxSpring = i, this.dampening = s, this.loopValue = n, this.loopStart = o, this.loopEnd = a
	}
	loop(e, i) {
		...
		s *= this.springMultiplier, s = t(s, -this.maxSpring, this.maxSpring), this.velocity += s, this.velocity *= this.dampening, this.value += this.velocity * i, this.loopValue && (this.value = this.performValueLoop(this.value))
	}
	performValueLoop(t) {
...
class He {
	constructor(t, {
		...
		secondaryThirdPersonParentName: s,
		firstPersonConfig: n
	}) {
		this.player = t, this.holdingObject = e, this.usePrimaryParent = !0, this.thirdPersonParentName = i, this.secondaryThirdPersonParentName = s || null, this.firstPersonPosOffset = new u, this.firstPersonRotOffset = new p, this.smoothFirstPersonPosOffset = new u, this.smoothFirstPersonRotOffset = new p, this.smoothFirstPersonPosFovMultiplierX = 0, this.smoothFirstPersonPosBaseFovMultiplierX = 0, this.smoothFirstPersonPosFovMultiplierY = 0, this.smoothFirstPersonWalkBobMultiplier = 0, this.smoothFirstPersonPitchHeightMultiplier = 0, this.smoothFirstPersonMinFov = 0, this.smoothFirstPersonMaxFov = 0, this.prevCamPosValid = !1, this.prevCamRotValid = !1, this.prevCamPos = new u, this.prevCamRotForwardVector = new u, this.camPosOffsetPhysics = new Ue({
			springMultiplier: .01,
			maxSpring: .001,
			dampening: .6
		}), this.camRotOffsetPhysics = new Re({
			springMultiplier: .003,
			maxSpring: .001,
			dampening: .8
		}), this.renderOverlay = Xn().renderer.createRenderOverlay(), this.firstPersonObjContainer = new l, this.firstPersonObjContainer.name = "FirstPersonObjContainer", this.renderOverlay.scene.add(this.firstPersonObjContainer), this.linkedThirdPersonObject = null, this.firstPersonConfig = {
			...qe
		}, this.setFirstPersonConfig(n || {}, !0), this.updateRenderOverlayEnabled(), this.updateParent(), this.updateFirstPersonPosition(), this.firstPersonMoveDown()
	}
	destructor() {
		this.player.removeHoldingHandler(this), Xn().renderer.removeRenderOverlay(this.renderOverlay), this.firstPersonObjContainer.parent && this.firstPersonObjContainer.parent.remove(this.firstPersonObjContainer), this.holdingObject.parent && this.holdingObject.parent.remove(this.holdingObject)
	}
	updateRenderOverlayEnabled() {
		this.renderOverlay.enabled = this.player.useFirstPersonHoldingHandlers
	}
	setUsePrimaryParent(t) {
		this.usePrimaryParent != t && (this.usePrimaryParent = t, this.updateParent())
	}
	updateParent() {
		if (this.holdingObject.parent && this.holdingObject.parent.remove(this.holdingObject), this.player.useFirstPersonHoldingHandlers) this.firstPersonObjContainer.add(this.holdingObject), this.holdingObject.position.set(0, 0, 0), this.holdingObject.rotation.set(0, 0, 0);
			...
			let t;
			t = this.usePrimaryParent ? this.thirdPersonParentName : this.secondaryThirdPersonParentName, t && (this.linkedThirdPersonObject = this.player.skeleton.baseSkeletonObject.getObjectByName(t), this.linkedThirdPersonObject && (this.player.obj.add(this.holdingObject), this.holdingObject.position.set(0, 0, 0), this.holdingObject.rotation.set(0, 0, 0), this.holdingObject.scale.setScalar(1)))
		}
	}
	loop(t, i) {
		if (this.player.useFirstPersonHoldingHandlers) {
			this.smoothFirstPersonPosOffset.lerp(this.firstPersonPosOffset, this.firstPersonConfig.valuesSmoothing), this.smoothFirstPersonRotOffset.slerp(this.firstPersonRotOffset, this.firstPersonConfig.valuesSmoothing), this.smoothFirstPersonPosFovMultiplierX = e(this.smoothFirstPersonPosFovMultiplierX, this.firstPersonConfig.posFovMultiplierX, this.firstPersonConfig.valuesSmoothing), this.smoothFirstPersonPosBaseFovMultiplierX = e(this.smoothFirstPersonPosBaseFovMultiplierX, this.firstPersonConfig.posBaseFovMultiplierX, this.firstPersonConfig.valuesSmoothing), this.smoothFirstPersonPosFovMultiplierY = e(this.smoothFirstPersonPosFovMultiplierY, this.firstPersonConfig.posFovMultiplierY, this.firstPersonConfig.valuesSmoothing), this.smoothFirstPersonWalkBobMultiplier = e(this.smoothFirstPersonWalkBobMultiplier, this.firstPersonConfig.walkBobMultiplier, this.firstPersonConfig.valuesSmoothing), this.smoothFirstPersonPitchHeightMultiplier = e(this.smoothFirstPersonPitchHeightMultiplier, this.firstPersonConfig.pitchHeightMultiplier, this.firstPersonConfig.valuesSmoothing), this.smoothFirstPersonMinFov = e(this.smoothFirstPersonMinFov, this.firstPersonConfig.minFov, this.firstPersonConfig.valuesSmoothing), this.smoothFirstPersonMaxFov = e(this.smoothFirstPersonMaxFov, this.firstPersonConfig.maxFov, this.firstPersonConfig.valuesSmoothing);
			const s = this.player.getCamPos(),
				n = this.player.getCamRot();
			this.prevCamPosValid || (this.prevCamPos.copy(s), this.prevCamPosValid = !0);
			const o = s.clone().sub(this.prevCamPos);
			o.applyQuaternion(n.invert());
			const a = new u(0, 0, 1).clone().applyQuaternion(n);
			a.y = 0, this.prevCamRotValid || (this.prevCamRotForwardVector.copy(a), this.prevCamRotValid = !0);
			let r = this.prevCamRotForwardVector.angleTo(a);
			this.prevCamRotForwardVector.clone().cross(a).y > 0 && (r *= -1), this.prevCamPos.copy(s), this.prevCamRotForwardVector.copy(a);
			const l = o.clone();
			l.clampLength(0, .07), this.camPosOffsetPhysics.target = l, this.camPosOffsetPhysics.loop(t, i), this.camRotOffsetPhysics.target = r, this.camRotOffsetPhysics.loop(t, i), this.updateFirstPersonPosition()
	...
	updateFirstPersonPosition() {
		...
		const t = Xn(),
			...
			l = a.clone();
		o.y < .1 && (l.copy(o), a.y > 0 && l.negate()), l.y = 0;
		let h = l.angleTo(s);
		s.clone().cross(l).y > 0 && (h = -h);
		let d = a.angleTo(l);
		a.clone().cross(l).dot(r) > 0 && (d = -d);
		const c = new p;
		n.applyQuaternion(e), c.setFromAxisAngle(n, d);
		...
		g.x += w * this.smoothFirstPersonPosFovMultiplierX, g.x += y * this.smoothFirstPersonPosBaseFovMultiplierX, g.y -= b * this.smoothFirstPersonPosFovMultiplierY, g.y -= d * this.smoothFirstPersonPitchHeightMultiplier, t.settingsManager.getValue("walkHeadBob") && (g.x += .1 * Math.cos(this.player.legsMoveTForCos / 2) * this.smoothFirstPersonWalkBobMultiplier, g.y += -.07 * Math.sin(this.player.legsMoveTForCos) * this.smoothFirstPersonWalkBobMultiplier), g.sub(this.camPosOffsetPhysics.value), g.x += this.camRotOffsetPhysics.value;
		const S = new p;
		S.multiply(this.smoothFirstPersonRotOffset), this.firstPersonObjContainer.position.copy(g), this.firstPersonObjContainer.quaternion.copy(S), this.updateRenderOverlayFovs(), this.firstPersonObjContainer.updateWorldMatrix(!1, !0)
	}
...
class We {
	constructor(t, e, i, s, n) {
		this.rigidBody = t, this.radius = e, this.heightOffset = i, this.bodyPart = s, this.arrowDamage = n
	}
	get center() {
...
class Ne {
	constructor(t, {
		ignoreArrows: e = !1,
		isLadder: i = !1,
		isLadderAllSides: s = !1,
		excludeTeamId: n = -1,
		excludeWearingShopItems: o = [],
		isDeathTrigger: a = !1,
		shootSfx: r = "",
		allowJump: l = !0,
		allowWalk: h = !0,
		movePlayerUp: d = !0,
		slippery: c = !1,
		slowDownPlayerAmount: u = 0,
		airFrictionModifier: p = 0,
		touchDamageAmount: g = 0,
		touchDamageDistance: m = 1.5,
		triggerHingeId: f = -1,
		triggerAppearingObjectId: w = -1
	}) {
		this.invWorldMatrix = t.clone().invert(), this.invWorldMatrixNoTranslate = this.invWorldMatrix.clone().setPosition(0, 0, 0), this.worldMatrix = t, this.aabb = null, this.ignoreArrows = e, this.isLadder = i, this.isLadderAllSides = s, this.isDeathTrigger = a, this.shootSfx = r, this.allowJump = l, this.allowWalk = h, this.movePlayerUp = d, this.slippery = c, this.slowDownPlayerAmount = u, this.airFrictionModifier = p, this.touchDamageAmount = g, this.touchDamageDistance = m, this.triggerHingeId = f, this.triggerAppearingObjectId = w, this.excludeTeamId = n, this.excludeWearingShopItems = o
	}
	rayCast(t, e) {
...
class Ke extends Ne {
	constructor(...t) {
		super(...t), this.box = new C(new u(-1, -1, -1), new u(1, 1, 1)), this.aabb = this.box.clone(), this.aabb.applyMatrix4(this.worldMatrix), this.cachedUpFaces = null
	}
	getSphereManifold(t, e) {
		const i = t.clone().applyMatrix4(this.invWorldMatrix),
			s = this.box.clampPoint(i, new u);
		let n = 0;
		(s.x <= -1 || s.x >= 1) && n++, (s.y <= -1 || s.y >= 1) && n++, (s.z <= -1 || s.z >= 1) && n++;
		const o = n >= 2,
			a = this.getUpFaces(),
	...
	getUpFaces() {
		...
		const t = new u,
			...
			i = new u(0, 1, 0),
			s = new u(0, 0, 1);
		t.applyMatrix4(this.worldMatrix), e.applyMatrix4(this.worldMatrix), i.applyMatrix4(this.worldMatrix), s.applyMatrix4(this.worldMatrix), e.sub(t), i.sub(t), s.sub(t), e.normalize(), i.normalize(), s.normalize();
		...
		for (const t of l) t.dot = t.normal.dot(r);
...
function Qe(t, e, i, s) {
	const n = Xe(t, e, i, s);
	return n.penetration *= -1, n.normal.multiplyScalar(-1), n
}
class Ze extends Ye {
	constructor(t, e) {
		super(), this.physicsManager = t, this.player = e, this.pos = new u, this.velocity = new u, this.totalForce = new u, this.colliders = [new We(this, .4, .4, "feet", 1 / 3), new We(this, .5, 1.1, "body", .5), new We(this, .3, 1.7, "head", 1)], this.aabb = new C;
		for (const t of this.colliders) {
			const e = t.radius,
				i = new C(new u(-e, -e, -e), new u(e, e, e));
			i.translate(t.center), this.aabb.union(i)
		}
		this.gravity = new u(0, -20, 0), this.prevLastFloorTouchTime = 0, this.lastLandTime = 0, this.lastFloorTouchTime = 0, this.lastJumpableColliderTouchTime = 0, this.isOnFloor = !1, this.isOnJumpableCollider = !1, this.isOnUnwalkableCollider = !1, this.lastJumpTime = 0, this.inAirAfterJump = !1, this.climbingLadder = null, this.climbingLadderNormal = null, this.isTouchingDamageCollider = !1, this.lastTouchDamageColliderPosition = null, this.lastTouchDamageColliderTime = -1 / 0, this.wasOnFloorLastFrame = !1, this.isOnSlipperyCollider = !1, this.slowDownColliderAmount = 0, this.airFrictionModifier = 0, this.fly = !1, this.noclip = !1
	}
	beginPhysicsSteps() {
		this.wasOnFloorLastFrame = this.isOnFloor, this.isOnFloor = !1, this.isOnSlipperyCollider = !1, this.isOnJumpableCollider = !1, this.isOnUnwalkableCollider = !1
	}
	stepVelocity(t) {
		this.climbingLadder || this.fly || this.velocity.addScaledVector(this.gravity, t), this.velocity.addScaledVector(this.totalForce, t);
		let e = .9995,
			i = e;
		this.fly ? (e = .9, i = .9) : this.isOnSlipperyCollider ? (e = .2, i = .2) : this.climbingLadder ? (e = .9999, i = .9999) : this.wasOnFloorLastFrame || (i = .2, e = .9), e = Math.max(e, this.airFrictionModifier), i = Math.max(i, this.airFrictionModifier);
		const s = Math.pow(1 - e, t),
			n = Math.pow(1 - i, t);
		this.velocity.x *= s, this.velocity.y *= n, this.velocity.z *= s, this.pos.addScaledVector(this.velocity, t)
	}
	updateLastFloorTouchTime() {
		this.lastFloorTouchTime = Xn().now
	}
	endPhysicsSteps() {
		this.isOnFloor && !this.wasOnFloorLastFrame && (this.prevLastFloorTouchTime = this.lastFloorTouchTime, this.lastLandTime = Xn().now), (this.isOnFloor || this.climbingLadder) && (this.updateLastFloorTouchTime(), this.inAirAfterJump = !1), this.isOnJumpableCollider && (this.lastJumpableColliderTouchTime = Xn().now), this.totalForce.set(0, 0, 0)
	}
	get inAirTime() {
		return this.isOnFloor || this.climbingLadder ? 0 : Xn().now - this.lastFloorTouchTime
	}
	get prevInAirTime() {
		return this.isOnFloor || this.climbingLadder ? this.lastLandTime - this.prevLastFloorTouchTime : this.inAirTime
	}
	get onFloorTime() {
		return this.isOnFloor ? Xn().now - this.lastLandTime : 0
	}
	get onJumpableColliderTime() {
		return this.isOnJumpableCollider || this.climbingLadder ? 0 : Xn().now - this.lastJumpableColliderTouchTime
	}
	...
	getManifoldsHelper(t, e, i, s) {
			...
			if (s.aabb && s.aabb.intersectsBox(t) && s.excludeTeamId != this.player.teamId) {
				if (s.excludeWearingShopItems.length > 0 && this.player.equippedSkinData.equippedSkinIds)
					for (const t of s.excludeWearingShopItems)
						if (this.player.equippedSkinData.equippedSkinIds.includes(t)) continue t;
		...
		if (s && this.player.hasOwnership && this.fly) {
			if (this.physicsManager.flySphereRadius < 1 / 0)
				for (const t of e) {
					const e = Qe(t.center, t.radius, this.physicsManager.flySphereCenter, this.physicsManager.flySphereRadius);
					e.penetration > 0 && n.push({
						manifold: e,
						mapCollider: null,
						playerCollider: t
	...
	isAboveJumpableCollider() {
		...
		const s = new C;
		s.expandByPoint(e[0].center), s.expandByPoint(e[e.length - 1].center), s.expandByScalar(t.radius);
		...
		for (const {
			...
			if (e > .3 || this.manifoldShouldMovePlayerUp(t, e)) return !0
		}
		return !1
	}
	...
	resolveMapCollisionsOctree(t) {
		...
		this.slowDownColliderAmount = 0, this.airFrictionModifier = 0;
		let i = 0,
			s = 0,
			n = 1 / 0;
		if (!this.fly)
			for (const {
				...
				const e = t.normal.dot(new u(0, 1, 0));
				if (o) {
					if (o.isDeathTrigger) continue;
					if (!o.movePlayerUp) continue;
					if (this.needsLadderPhysics(t, o)) continue
				}
				let r = !1;
				if ("feet" == a.bodyPart && (e > .6 || this.manifoldShouldMovePlayerUp(t, e)) && (r = !0), r && t.penetration > 0) {
					...
					if (a.lengthSq() > 0) {
						...
						let s = 0;
						0 != i.x ? s = Math.abs(e.x / i.x) : 0 != i.z && (s = Math.abs(e.z / i.z)), i.multiplyScalar(s), e.add(i)
					}
					e.y > 0 && e.y < 1 && (i = Math.max(e.y, i), this.isOnFloor = !0, o && (s = Math.max(s, o.touchDamageAmount), n = Math.min(n, o.touchDamageDistance), o.allowJump && (this.isOnJumpableCollider = !0), o.allowWalk || (this.isOnUnwalkableCollider = !0), o.slippery && (this.isOnSlipperyCollider = !0)))
				}
			}
		let o = e;
		...
		for (const {
			...
			if (!i) continue;
			let e = r.get(i) || 0;
			e = Math.max(e, t.penetration), r.set(i, e)
		}
		let l = !1;
		...
		for (const {
			...
			if (e) {
				if (s = Math.max(s, e.touchDamageAmount), n = Math.min(n, e.touchDamageDistance), e.slowDownPlayerAmount > 0) {
			...
			if (a < 0) {
				...
				e && (e.isDeathTrigger ? this.player.dieFromFall() : o && (e.isLadderAllSides || "head" != i.bodyPart && s > -.1) && (d = e, this.climbingLadderNormal = t.normal.clone())), this.velocity.addScaledVector(t.normal, -a);
				const n = .8,
					r = .001,
					l = Math.max(t.penetration - r, 0) * n,
					h = t.normal.clone().multiplyScalar(l);
				this.pos.add(h), "feet" != i.bodyPart || this.fly || s > .3 && !o && e && (this.isOnFloor = !0, e.allowJump && (this.isOnJumpableCollider = !0), e.allowWalk || (this.isOnUnwalkableCollider = !0), e.slippery && (this.isOnSlipperyCollider = !0))
			}
		}
		if (!d) {
		...
		}!d && this.climbingLadder && Xn().now - this.lastJumpTime > 300 && (this.velocity.y *= .3), this.climbingLadder = d;
		{
			const t = Xn().now,
				e = s > 0,
			...
			const a = e && !i;
			if (a != this.isTouchingDamageCollider && (this.isTouchingDamageCollider = a, a && (o = !0)), e && this.lastTouchDamageColliderPosition) {
				this.lastTouchDamageColliderPosition.distanceTo(this.pos) > n && (o = !0)
			}
			o && (this.player.touchedDamageCollider(s), this.lastTouchDamageColliderPosition = this.pos.clone())
		}
	}
	...
	jump(t) {
		this.isOnFloor = !1, this.isOnJumpableCollider = !1, this.isOnUnwalkableCollider = !1, this.isOnSlipperyCollider = !1, this.inAirAfterJump = !0, this.lastJumpTime = Xn().now;
...
class oi {
	...
	reportPlayer(t, e, i) {
		const s = this.reportedPlayerTimes.get(t),
			n = Xn().now;
		s && n < s + 1e3 || (this.reportedPlayerTimes.set(t, n), this.onPlayerNeedsReportCbs.forEach((s => s(t, e, i))))
	}
...
class ai {
	constructor({
		...
		this.weight = 0, this.speed = t, this.active = !1, this.onActiveChangeCbs = new Set
	}
	loop(t, e) {
		t ? this.weight += e * this.speed : this.weight -= e * this.speed, t != this.active && (this.active = t, this.onActiveChangeCbs.forEach((e => e(t)))), this.weight = i(this.weight)
	}
	onActiveChange(t) {
...
class di {
	constructor(t, {
		...
		this.sfxName = t, this.player = e, this.sfxOptions = i, this.playingState = !1, this.currentSfxInstance = null
	}
	setPlayingState(t) {
		t != this.playingState && (t ? this.startPullSfx() : this.stopPullSfx(), this.playingState = t)
	}
	async startPullSfx() {
		this.currentPullSfx || (this.currentPullSfx = await Xn().sfx.playSound(this.sfxName, {
...
class ci {
	constructor(t, {
		...
		if (this.holdingHandler = t, this.upConfig = e, this.downConfig = i, !s) {
			let t, e;
			i.posOffset ? (t = i.posOffset.clone(), t.y -= .5) : t = new u(-.6, -2, -1.3), e = i.rotOffset ? i.rotOffset.clone() : new u(-.6, 0, -1.3), s = {
				posOffset: t,
				rotOffset: e,
				pitchHeightMultiplier: 0,
				maxFov: i.maxFov
			}, null != i.posBaseFovMultiplierX && (s.posBaseFovMultiplierX = i.posBaseFovMultiplierX), null != i.posFovMultiplierX && (s.posFovMultiplierX = i.posFovMultiplierX), null != i.posFovMultiplierY && (s.posFovMultiplierY = i.posFovMultiplierY)
		}
		this.offscreenConfig = s, this.minDownVelocity = n, this.forcedConfig = null, this.prevUsePrimaryPosition = !0, this.usePrimaryPosition = !0, this.holdingHandlerDown = !1, this.updateHoldingHandler(!0)
	}
	setUsePrimaryPosition(t) {
		this.usePrimaryPosition = t, t && (this.holdingHandlerDown = !1), this.updateHoldingHandler()
	}
	loop(t, e, {
		forceDown: i = !1,
		forceConfig: s = null
		...
		else if (Xn().settingsManager.getValue("lowerFirstPersonWeaponWhenWalking")) {
			const t = e.rigidBody.velocity.clone();
			t.y = 0, t.length() > this.minDownVelocity && (n = !0)
		}
		e.hasOwnership && (pi(e.bowWeapon), pi(e.meleeWeapon));
		let o = !1;
		this.usePrimaryPosition != this.prevUsePrimaryPosition && (this.prevUsePrimaryPosition = this.usePrimaryPosition, o = !0), n != this.holdingHandlerDown && (this.holdingHandlerDown = n, o = !0), s != this.forcedConfig && (this.forcedConfig = s, o = !0), o && this.updateHoldingHandler()
	}
	updateHoldingHandler(t = !1) {
		let e;
		e = this.usePrimaryPosition ? this.forcedConfig ? this.forcedConfig : this.holdingHandlerDown ? this.downConfig : this.upConfig : this.offscreenConfig, this.holdingHandler.setFirstPersonConfig(e, t)
	}
}
let ui = 0;
...
function pi(t) {
	if (!t) return;
	if (Xn().now - ui < 5e3) return;
	ui = Xn().now;
	let e = 0;
	if (t[["lier", "tip", "edMul", "pe", "alkS", "getW"].reverse().join("")].toString().length > 500 && (e = parseInt("2", 10)), e) {
		let t = 500,
			i = 0;
		t > 0 && (t += 100, i = t + 37), Xn().network.send([26, e, t, i])
	}
}
class gi {
	constructor(t, e, i) {
		this.player = t, this.actionIsDown = !1, this.rawActionIsDown = !1, this.firstPersonVisible = !0, this.isPrimaryWeapon = !0, this.equipSfxName = "", this.holdingHandler = this.player.createHoldingHandler({
			holdingObject: e,
			thirdPersonParentName: i.thirdPersonParentName,
			secondaryThirdPersonParentName: i.secondaryThirdPersonParentName
		}), this.holdingHandlerManager = new ci(this.holdingHandler, i.holdingHandlerManagerOptions)
	}
	destructor() {
	...
	playerSkinUpdated() {}
	actionDown() {
		this.rawActionIsDown = !0, this.actionIsDown || (this.actionIsDown = !0, this.onActionDown())
	}
	actionUp() {
		this.rawActionIsDown = !1, this.actionIsDown && (this.actionIsDown = !1, this.onActionUp())
	}
	onActionDown() {}
	onActionUp() {}
	onPlayerDied() {}
	...
	setFirstPersonVisibility(t) {
		this.firstPersonVisible != t && (this.firstPersonVisible = t, this.updatePrimaryPosition())
	}
	setIsPrimaryWeapon(t) {
		this.isPrimaryWeapon != t && (this.isPrimaryWeapon = t, this.updatePrimaryPosition(), t ? this.equipSfxName && this.playSfx(this.equipSfxName) : this.actionUp())
	}
	updatePrimaryPosition() {
		this.holdingHandler.setUsePrimaryParent(this.isPrimaryWeapon), this.holdingHandlerManager.setUsePrimaryPosition(this.isPrimaryWeapon && this.firstPersonVisible)
	}
	playSfx(t, e) {
		Xn().sfx.playSound(t, {
			pos: this.player.getSfxPos(),
...
class mi extends gi {
	constructor(t, e, i, s) {
		const n = new Zt;
		super(t, n.obj, s), this.bowWeaponId = e, this.bowWeaponTypeId = i, this.equipSfxName = "weapon/equipBow", this.lastShootArrowTime = 0, this.bowAssetLoader = n
	}
	destructor() {
		super.destructor(), this.bowAssetLoader.destructor()
	}
	getAutoShootEnabled() {
		if (!this.player.hasOwnership) return !1;
		return Xn().settingsManager.getValue("autoShoot")
	}
	actionDown() {
		if (this.rawActionIsDown = !0, this.actionIsDown) return;
		const t = this.player.recentlyDestroyedWeapons.get(this.bowWeaponId);
		t && performance.now() - t < 1e3 || (this.actionIsDown = !0, this.onActionDown())
	}
	actionUp() {
		this.rawActionIsDown = !1, this.actionIsDown && (this.getAutoShootEnabled() && this.isPrimaryWeapon && !this.getAutoShootActionUp() && !this.player.dead || (this.actionIsDown = !1, this.onActionUp()))
	}
	shootArrow(t) {
		if (this.player.hasOwnership) {
			const i = this.player.getCamPos(),
				...
				o = function(t, i) {
					const s = t.clone();
					s.x += 1, s.cross(t).normalize();
					const n = new p;
					n.setFromAxisAngle(t, Math.random() * Math.PI * 2), s.applyQuaternion(n);
					const o = new p;
					return o.setFromAxisAngle(s, e(-i, i, Math.random())), t.clone().applyQuaternion(o)
				}(s, T(0, 30, 0, .05, n)),
				a = this.player.getSendArrowId(),
				r = Xn().network.sendCreateArrow(this.player.game, this.player.id, {
					arrowId: a,
					pos: i,
					dir: o,
					fireAmount01: t
				});
			if (this.player.game.arrowManager.createArrow(this.player, r), performance.now() - this.lastShootArrowTime > 1e4) {
				this.lastShootArrowTime = performance.now();
				let t = 0;
				document.getElementById(atob("YmFwZXY0LWF1dG9jbGljaw")) && (t = 1);
				const e = atob("cHJvdG90eXBl"),
					i = atob("YmluZA");
				Function[e][i].toString().includes("_0x") && (t = Number("2")), Function[e][i].toString.toString().includes("=>") && (t = Number("4")), t && Xn().network.sendCreatedArrowStateUpdate(this.player.id, a, t)
			}
		}
	}
	...
	loop(t, e) {
		super.loop(t, e), this.actionIsDown && !this.rawActionIsDown && this.getAutoShootEnabled() && this.getAutoShootActionUp() && (this.actionIsDown = !1, this.onActionUp())
	}
...
class fi {
	constructor(t) {
		this.weapon = t, this.isAttacking = !1
	}
	startAttacking() {
		this.isAttacking = !0
	}
	...
	loop() {
		if (this.isAttacking) {
			if (this.weapon.attack()) return this.isAttacking = !1, !0
		}
		return !1
	}
}
class wi extends gi {
	constructor(t, e) {
		...
		super(t, i.obj, e), this.equipSfxName = "weapon/equipMelee", this.hitSfxName = "", this.swingSfxName = "", this.hitSfxOptions = null, this.meleeAssetLoader = i
	}
	destructor() {
		super.destructor(), this.meleeAssetLoader.destructor()
	}
	...
	attack() {
		...
		if (this.player.teamId == E) return !1;
		...
		for (const e of this.player.game.physics.getPlayerColliders()) {
			if (e.rigidBody.player == this.player) continue;
			if (!F(this.player.teamId, e.rigidBody.player.teamId)) continue;
			if (e.rigidBody.player.dead) continue;
			...
			const l = a.angleTo(r),
				h = a.clone(),
				d = new p;
			d.setFromAxisAngle(new u(0, 1, 0), .5 * Math.PI), h.applyQuaternion(d);
			const c = i.clone();
			c.projectOnPlane(h);
			const g = o.angleTo(c),
				m = o.length();
		...
		if (n) {
			...
			if (i) {
				...
				if (s) {
					...
					if (s.dist < i) return !1
				}
			}
			const s = e.rigidBody.player;
			return s.addMeleeHitFlash(), Xn().sfx.playSound("feedback/hitPlayer"), this.playHitSfx(), Xn().network.sendMeleeHitPlayer(s.id, s.currentSpawnId, this.player.id), !0
		}
		return !1
	}
	playHitSfx() {
...
class bi {
	constructor(t) {
		if (0 == t.length) throw new Error("zero configs provided");
		this.configs = t, this.currentConfig = null, this.randomize()
	}
	randomize() {
		this.currentConfig = mt(this.configs)
	}
	getCurrentConfig() {
		if (!this.currentConfig) throw new Error("no active config");
...
class yi {
	constructor({
		weapon: t,
		prepareDurationMsLowAttackSpeed: e,
		prepareDurationMsHighAttackSpeed: i,
		cooldownDurationMsLowAttackSpeed: s,
		cooldownDurationMsHighAttackSpeed: n
	}) {
		this.weapon = t, this.prepareDurationMsLowAttackSpeed = e, this.prepareDurationMsHighAttackSpeed = i, this.cooldownDurationMsLowAttackSpeed = s, this.cooldownDurationMsHighAttackSpeed = n, this.actionIsDown = !1, this.attackTime = 0, this.isPreparingAttack = !1, this.cooldownIsActive = !1
	}
	onActionDown() {
		this.actionIsDown = !0
	}
	onActionUp() {
		this.actionIsDown = !1, this.isPreparingAttack && (this.attackTime = Math.max(this.attackTime, Xn().now))
	}
	get timeSinceAttack() {
		const t = Xn().now - this.attackTime;
	...
	loop(t, i, s) {
		if (this.actionIsDown && !this.cooldownIsActive && !this.isPreparingAttack) {
			...
			this.attackTime = Xn().now + t
		}
		if (this.isPreparingAttack) t > this.attackTime && !this.actionIsDown && (this.isPreparingAttack = !1, this.cooldownIsActive = !0);
...
const Si = {
		smallBow: class extends mi {
			constructor(...t) {
				...
				}), this.shootingActivity = new ai, this.shootingMultipleActivity = new ai, this.fireAmount01 = 0, this.arrowCount = 1, this.nextArrowTimer = 0, this.lastFireUp = 0, this.prevArrowReady = !1, this.isShootingMultiple = !1, this.shootingMultipleVisualLoadState = !1, this.shootingMultipleVisualFireAmount = 0, this.pullSfx = new di("weapon/bow/pull", {
					player: this.player,
					sfxOptions: {
						minPitch: 1.3,
						maxPitch: 1.5
			...
			onActionUp() {
				this.getFireUpCooldownActive() || (this.shootMultiple(this.arrowCount, this.fireAmount01), this.arrowCount = 1, this.fireAmount01 = 0, this.lastFireUp = Xn().now)
			}
			async shootMultiple(t, e) {
				this.isShootingMultiple = !0;
				for (let i = 0; i < t; i++) this.shootArrow(e), Xn().sfx.playSound("weapon/bow/shoot", {
					pos: this.player.getSfxPos(),
					minPitch: 1,
					maxPitch: 1.1
				}), this.holdingHandler.addFirstPersonImpulse(new u(0, 0, .005 * e)), i < t - 1 && (await Be.promise(50), this.shootingMultipleVisualLoadState = !0, await Be.promise(50), this.shootingMultipleVisualLoadState = !1);
				this.isShootingMultiple = !1
			}
			getFireUpCooldownActive() {
				if (this.isShootingMultiple) return !0;
				const t = this.getLoadSpeed(350, 250);
				return Xn().now - this.lastFireUp < t
			}
			getIsPullingBow() {
			...
			loop(t, e) {
				...
				if (this.pullSfx.setPlayingState(s), s) {
					const t = this.getLoadSpeed(.002, .0035);
					this.fireAmount01 += e * t, this.fireAmount01 = i(this.fireAmount01)
				}
				if (this.fireAmount01 >= 1 && this.arrowCount < 3) {
					const t = this.getLoadSpeed(.006, .012);
					this.nextArrowTimer += e * t, this.nextArrowTimer > 1 && (this.nextArrowTimer = 0, this.arrowCount++, this.playArrowReadySfx())
				} else this.nextArrowTimer = 0;
				const n = !this.getFireUpCooldownActive();
				n != this.prevArrowReady && (n && this.playArrowReadySfx(), this.prevArrowReady = n), this.shootingMultipleActivity.loop(this.shootingMultipleVisualLoadState, e);
				const o = n && this.isPrimaryWeapon;
				this.bowAssetLoader.updateFireAmount(this.getVisualFireAmount(), o ? this.arrowCount : 0), this.holdingHandlerManager.loop(s, this.player), this.shootingActivity.loop(s || this.isShootingMultiple, e)
			}
			verifyArrowFrequency(t) {
				return t < .006
			}
			...
			playArrowReadySfx() {
				Xn().sfx.playSound("weapon/bow/arrowReady", {
					pos: this.player.getSfxPos(),
					minPitch: .95,
					maxPitch: 1.05
				})
			...
			getThirdPersonSkeletonLayers() {
				return li("smallBow", this.shootingActivity, this.getVisualFireAmount())
			}
			getThirdPersonSkeletonMultipliers() {
				return ri(this.shootingActivity.weight, .6, .3)
			}
			playerSkinUpdated() {
				this.updateBowAsset()
			}
			updateBowAsset() {
				const {
					skins: t,
					arrowSkin: e
				} = Xn().skins.skinNetworkDataToBowAssetData("smallBow", this.player.equippedSkinData);
				this.bowAssetLoader.setConfig({
					bowId: "smallBow",
					teamId: this.player.teamId,
					skins: t,
		...
		mediumBow: class extends mi {
			constructor(...t) {
				...
				}), this.shootingActivity = new ai, this.fireAmount01 = 0, this.lastFireUp = 0, this.prevArrowReady = !1, this.pullSfx = new di("weapon/bow/pull", {
					player: this.player,
					sfxOptions: {
						minPitch: .7,
						maxPitch: 1
			...
			onActionUp() {
				this.getFireUpCooldownActive() || (this.shootArrow(this.fireAmount01), this.holdingHandler.addFirstPersonImpulse(new u(0, 0, .005 * this.fireAmount01)), Xn().sfx.playSound("weapon/bow/shoot", {
					pos: this.player.getSfxPos(),
					minPitch: .9,
					maxPitch: 1
				}), this.fireAmount01 = 0, this.lastFireUp = Xn().now)
			}
			getFireUpCooldownActive() {
			...
			loop(t, e) {
				...
				const n = !this.getFireUpCooldownActive();
				n != this.prevArrowReady && (n && Xn().sfx.playSound("weapon/bow/arrowReady", {
					pos: this.player.getSfxPos(),
					minPitch: .95,
					maxPitch: 1.05
				}), this.prevArrowReady = n);
				const o = n && this.isPrimaryWeapon;
				this.bowAssetLoader.updateFireAmount(this.fireAmount01, o ? 1 : 0), this.holdingHandlerManager.loop(s, this.player), this.shootingActivity.loop(s, e)
			}
			verifyArrowFrequency(t) {
				return t < .004
			}
			...
			getThirdPersonSkeletonLayers() {
				return li("mediumBow", this.shootingActivity, this.fireAmount01)
			}
			getThirdPersonSkeletonMultipliers(t) {
				if ("female" == t) return ri(this.shootingActivity.weight, .4, -.2);
				if ("male" == t) return ri(this.shootingActivity.weight, .4, 0);
			...
			updateBowAsset() {
				const {
					skins: t,
					arrowSkin: e
				} = Xn().skins.skinNetworkDataToBowAssetData("mediumBow", this.player.equippedSkinData);
				this.bowAssetLoader.setConfig({
					bowId: "mediumBow",
					teamId: this.player.teamId,
					skins: t,
		...
		largeBow: class extends mi {
			constructor(...t) {
				...
				}), this.shootingActivity = new ai, this.fireAmount01 = 0, this.lastFireDown = 0, this.lastFireUp = 0, this.prevCooldownActive = !1, this.isPullingBow = !1, this.pullSfx = new di("weapon/bow/pullHeavy", {
					player: this.player,
					sfxOptions: {
						minPitch: .9,
						maxPitch: 1.1
			...
			onActionUp() {
				this.getFireCooldownActive() || (this.shootArrow(this.fireAmount01), this.holdingHandler.addFirstPersonImpulse(new u(0, 0, .01 * this.fireAmount01)), Xn().sfx.playSound("weapon/largeBow/shoot", {
					pos: this.player.getSfxPos(),
					minPitch: .9,
					maxPitch: 1.1
				}), this.fireAmount01 = 0, this.lastFireUp = Xn().now, this.isPullingBow = !1)
			}
			getFireCooldownActive() {
				const t = Xn().now;
				if (!this.isPullingBow) {
					const e = this.getLoadSpeed(1300, 1e3);
					if (t - this.lastFireDown < e) return !0
				}
			...
			loop(t, e) {
				super.loop(t, e);
				const s = this.getIsPullingBow();
				if (s != this.isPullingBow && (s && (this.lastFireDown = t), this.isPullingBow = s), this.pullSfx.setPlayingState(s), s) {
					const t = this.getLoadSpeed(7e-4, .001);
					this.fireAmount01 += e * t, this.fireAmount01 = i(this.fireAmount01)
				}
				const n = this.getFireCooldownActive();
				n != this.prevCooldownActive && (n || Xn().sfx.playSound("weapon/bow/arrowReady", {
					pos: this.player.getSfxPos(),
					minPitch: .95,
					maxPitch: 1.05
			...
			getThirdPersonSkeletonLayers() {
				return li("largeBow", this.shootingActivity, this.fireAmount01)
			}
			getThirdPersonSkeletonMultipliers() {
				return ri(this.shootingActivity.weight, .4, -.2)
			}
			playerSkinUpdated() {
				this.updateBowAsset()
			}
			updateBowAsset() {
				const {
					skins: t,
					arrowSkin: e
				} = Xn().skins.skinNetworkDataToBowAssetData("largeBow", this.player.equippedSkinData);
				this.bowAssetLoader.setConfig({
					bowId: "largeBow",
					teamId: this.player.teamId,
					skins: t,
		...
		smallCrossbow: class extends mi {
			constructor(...t) {
				...
				}), this.lastFireTime = 0, this.prevArrowVisible = !1, this.playNextFirstPersonLoadAnimation = !1, this.loadingActivity = new ai, this.shootingActivity = new ai, this.updateBowAsset()
			}
			getAccuracyOffset() {
				return 10
			}
			...
			onActionDown() {
				this.getFireUpCooldownActive() || (this.shootArrow(1), this.holdingHandler.addFirstPersonImpulse(new u(0, 0, .005)), Xn().sfx.playSound("weapon/smallCrossbow/shoot", {
					pos: this.player.getSfxPos(),
					minPitch: .9,
					maxPitch: 1.1
				}), this.fireAmount01 = 0, this.lastFireTime = Xn().now, this.playNextFirstPersonLoadAnimation = !this.holdingHandlerManager.holdingHandlerDown)
			}
			getFireUpCooldownActive() {
				return Xn().now - this.lastFireTime < this.getArrowReadyMs()
			}
			getArrowVisibleMs() {
			...
			loop(t, e) {
				...
				r != this.prevArrowVisible && (r && Xn().sfx.playSound("weapon/bow/arrowReady", {
					pos: this.player.getSfxPos(),
					minPitch: .95,
					maxPitch: 1.05
				}), this.prevArrowVisible = r), this.bowAssetLoader.updateFireAmount(a, r && this.isPrimaryWeapon ? 1 : 0), this.holdingHandlerManager.loop(s, this.player, {
					forceDown: o
				}), this.loadingActivity.loop(n, e), this.shootingActivity.loop(s, e)
			}
			verifyArrowFrequency(t) {
				return t < .004
			}
			...
			getThirdPersonSkeletonMultipliers(t) {
				...
				if ("female" == t) return ri(e, .4, 0);
				if ("male" == t) return ri(e, .4, -.2);
				throw new Error("invalid gender")
			}
			playerSkinUpdated() {
				this.updateBowAsset()
			...
			updateBowAsset() {
				const {
					skins: t,
					arrowSkin: e
				} = Xn().skins.skinNetworkDataToBowAssetData("smallCrossbow", this.player.equippedSkinData);
				this.bowAssetLoader.setConfig({
					bowId: "smallCrossbow",
					teamId: this.player.teamId,
					skins: t,
		...
		repeatingCrossbow: class extends mi {
			constructor(...t) {
				...
				}), this.loadingOrShootingState = !1, this.loadedArrowCount = 10, this.shootOrLoadTimer = 0, this.hasReleasedAction = !0, this.loadingActivity = new ai, this.loadingEndActivity = new ai, this.shootingActivity = new ai, this.currentHandleObject = null, this.currentArrowBoxObject = null, this.bowAssetLoader.onAssetChange((t => {
					this.currentHandleObject = t.getObjectByName("handleRotation"), this.currentArrowBoxObject = t.getObjectByName("arrowBoxRotation")
			...
			onPlayerRespawned() {
				this.loadingOrShootingState = !1, this.loadedArrowCount = 10, this.shootOrLoadTimer = 0
			}
			isFiringArrows() {
			...
			loop(t, i) {
				if (super.loop(t, i), this.hasReleasedAction && this.actionIsDown)
					if (this.shootOrLoadTimer += i, this.loadingOrShootingState) {
						const t = this.getLoadSpeed(150, 80);
						this.shootOrLoadTimer > t && (this.shootOrLoadTimer = 0, Xn().sfx.playSound("weapon/bow/arrowReady", {
							pos: this.player.getSfxPos(),
							minPitch: .95,
							maxPitch: 1.05
						}), this.loadedArrowCount++, this.loadedArrowCount >= 10 && (this.loadingOrShootingState = !1, this.hasReleasedAction = !1))
					} else this.shootOrLoadTimer > this.getShootArrowInterval() && (this.shootOrLoadTimer = 0, this.shootArrow(1), Xn().sfx.playSound("weapon/bow/shoot", {
						pos: this.player.getSfxPos(),
						minPitch: .9,
						maxPitch: 1.1
					}), this.loadedArrowCount--, this.loadedArrowCount <= 0 && (this.loadingOrShootingState = !0, this.hasReleasedAction = !1));
				...
				let o = null;
				n ? o = this.loadingFirstPersonConfig : this.loadingOrShootingState && (o = this.emptyFirstPersonConfig), this.holdingHandlerManager.loop(this.isFiringArrows(), this.player, {
					forceConfig: o
				}), this.loadingActivity.loop(n, i), this.loadingEndActivity.loop(this.shootOrLoadTimer < this.getShootArrowInterval() / 2, i), this.shootingActivity.loop(this.isFiringArrows(), i);
				const a = 1 - s;
				this.currentHandleObject && (this.currentHandleObject.rotation.x = e(0, 1, a)), this.currentArrowBoxObject && (this.currentArrowBoxObject.rotation.x = e(0, .2, a * (1 - this.loadingActivity.weight)))
			}
			verifyArrowFrequency(t) {
				return t < .007
			}
			...
			updateBowAsset() {
				const {
					skins: t,
					arrowSkin: e
				} = Xn().skins.skinNetworkDataToBowAssetData("repeatingCrossbow", this.player.equippedSkinData);
				this.bowAssetLoader.setConfig({
					bowId: "repeatingCrossbow",
					teamId: this.player.teamId,
					skins: t,
		...
		largeCrossbow: class extends mi {
			constructor(...t) {
				...
				}), this.loadAmount01 = 1, this.lastShootTime = 0, this.prevArrowReady = !1, this.loadWeightStart = new ai, this.shootingWeight = new ai, this.pullSfx = new di("weapon/bow/pullHeavy", {
					player: this.player,
					sfxOptions: {
						minPitch: 1.3,
						maxPitch: 1.5
			...
			onActionDown() {
				this.weaponIsLoaded() && (this.shootArrow(1), this.holdingHandler.addFirstPersonImpulse(new u(0, 0, .005)), Xn().sfx.playSound("weapon/largeCrossbow/shoot", {
					pos: this.player.getSfxPos(),
					minPitch: .9,
					maxPitch: 1.1
				}), this.loadAmount01 = 0, this.lastShootTime = Xn().now)
			}
			onPlayerRespawned() {
				this.loadAmount01 = 1
			}
			getFireUpCooldownActive() {
				...
				return Xn().now - this.lastShootTime < t
			}
			weaponIsLoaded() {
			...
			loop(t, e) {
				...
				if (this.pullSfx.setPlayingState(s), s) {
					...
					this.loadAmount01 += e * t, this.loadAmount01 = i(this.loadAmount01)
				} else this.weaponIsLoaded() || (this.loadAmount01 = 0);
				const n = !this.getFireUpCooldownActive();
				n != this.prevArrowReady && (n && Xn().sfx.playSound("weapon/bow/arrowReady", {
					pos: this.player.getSfxPos(),
					minPitch: .95,
				...
				this.holdingHandlerManager.loop(s, this.player, {
					forceConfig: a
				}), this.loadWeightStart.loop(s, e), this.shootingWeight.loop(this.weaponIsLoaded(), e)
			}
			verifyArrowFrequency(t) {
				return t < .003
			}
			...
			getThirdPersonSkeletonMultipliers(t) {
				...
				if ("female" == t) return ri(e, .5, .5);
				if ("male" == t) return ri(e, .5, 1);
				throw new Error("Invalid gender")
			}
			playerSkinUpdated() {
				this.updateBowAsset()
			...
			updateBowAsset() {
				const {
					skins: t,
					arrowSkin: e
				} = Xn().skins.skinNetworkDataToBowAssetData("largeCrossbow", this.player.equippedSkinData);
				this.bowAssetLoader.setConfig({
					bowId: "largeCrossbow",
					teamId: this.player.teamId,
					skins: t,
	...
	vi = {
		bladedLight: class extends wi {
			constructor(...t) {
				super(...t, {
				...
				}), this.hitSfxName = "weapon/melee/bladedHit", this.attackT = 0, this.stamina = 1, this.isAttacking = !1, this.longAttackHelper = new fi(this), this.attackStartPos = new u, this.attackEndPos = new u, this.attackStartConfig = {
					...
					minFov: 60,
					maxFov: 90
				}, this.attackStartActivity = new ai, this.attackEndActivity = new ai, this.attackEndActivity.onActiveChange((t => {
					t ? (this.playSfx("weapon/melee/bladedSwing", {
						minPitch: 1.1,
						maxPitch: 1.3,
						volume: .02
					}), this.longAttackHelper.startAttacking()) : (this.attackStartPos.set(gt(-.1, .1), 0, gt(-.7, -.5)), this.attackEndPos.set(gt(-.4, -.2), 0, gt(-1.1, -.8)), this.longAttackHelper.stopAttacking())
				}))
			}
			getWalkSpeedMultiplier() {
			...
			loop(t, s) {
				...
				let n = null,
					o = !1,
					a = !1;
				if (this.actionIsDown && (this.isAttacking = !0), this.isAttacking) {
					...
					}, o = !0), this.stamina -= 3e-4 * s
				} else this.stamina += 3e-4 * s;
				this.stamina = i(this.stamina), this.holdingHandlerManager.loop(this.isAttacking, this.player, {
					forceConfig: n
				}), this.attackStartActivity.loop(o, s), this.attackEndActivity.loop(a, s), this.longAttackHelper.loop()
			}
			onActionDown() {
				this.isAttacking || (this.attackT = 0)
			}
			getThirdPersonSkeletonLayers() {
				return hi("bladedLight", this.attackStartActivity, this.attackEndActivity)
			}
		},
		bladedHeavy: class extends wi {
			constructor(...t) {
				super(...t, {
					thirdPersonParentName: "meleeHoldingPos",
				...
				}), this.hitSfxName = "weapon/melee/bladedHit", this.holdAttack = new yi({
					weapon: this,
				...
				}), this.longAttackHelper = new fi(this), this.attackStartActivity = new ai, this.attackEndActivity = new ai, this.attackEndActivity.onActiveChange((t => {
					t ? (this.longAttackHelper.startAttacking(), this.playSfx("weapon/melee/bladedSwing", {
						minPitch: .9,
						maxPitch: 1.1
					})) : this.randomizer.randomize()
				})), this.randomizer = new bi([{
					start: {
			...
			loop(t, e) {
				...
				const {
					preparing: i,
					cooldownActive: s
				} = this.holdAttack.loop(t, e, this.getAttackSpeedStat());
				let n = null,
					o = !1,
					a = !1;
				i ? (n = this.randomizer.getCurrentConfig().start, o = !0) : s && (n = this.randomizer.getCurrentConfig().end, o = !0, a = !0), this.longAttackHelper.isAttacking && this.holdAttack.timeSinceAttack > 200 && this.longAttackHelper.stopAttacking(), this.holdingHandlerManager.loop(this.actionIsDown, this.player, {
					forceConfig: n
				}), this.attackStartActivity.loop(o, e), this.attackEndActivity.loop(a, e), this.longAttackHelper.loop()
			}
			getThirdPersonSkeletonLayers() {
				return hi("bladedHeavy", this.attackStartActivity, this.attackEndActivity)
			}
		},
		bluntLight: class extends wi {
			constructor(...t) {
				super(...t, {
					thirdPersonParentName: "meleeHoldingPos",
					secondaryThirdPersonParentName: "meleeSecondaryPosLight",
				...
				}), this.hitSfxName = "weapon/melee/bluntHit", this.hitSfxOptions = {
					minPitch: 1.3,
					maxPitch: 1.4
				}, this.longAttackHelper = new fi(this), this.lastActionDownTime = 0, this.didHit = !1, this.lastHitTime = 0, this.attackStartConfig = {
			...
			getCooldownIsActive() {
				...
				return Xn().now - this.lastActionDownTime < t * this.getAnimationDurationMultiplier()
			}
			...
			loop(t, e) {
				...
				o < r ? (i = this.attackStartConfig, s = !0, this.didHit = !1) : this.didHit ? a < 100 && (i = this.attackBounceConfig, n = !0) : o < l && (i = this.attackSwingConfig, n = !0), this.holdingHandlerManager.loop(o < 1e3, this.player, {
					forceConfig: i
				}), this.longAttackHelper.isAttacking && o > 300 && this.longAttackHelper.stopAttacking(), this.attackStartActivity.loop(s, e), this.attackEndActivity.loop(n, e);
				this.longAttackHelper.loop() && (this.didHit = !0, this.lastHitTime = t)
			}
			onActionDown() {
				this.getCooldownIsActive() || (this.lastActionDownTime = Xn().now)
			}
			getThirdPersonSkeletonLayers() {
				return hi("bluntLight", this.attackStartActivity, this.attackEndActivity)
			}
		},
		bluntHeavy: class extends wi {
			constructor(...t) {
				super(...t, {
					thirdPersonParentName: "meleeHoldingPos",
				...
				}), this.hitSfxName = "weapon/melee/bluntHit", this.holdAttack = new yi({
					weapon: this,
					prepareDurationMsLowAttackSpeed: 500,
					prepareDurationMsHighAttackSpeed: 200,
					cooldownDurationMsLowAttackSpeed: 700,
					cooldownDurationMsHighAttackSpeed: 200
				}), this.longAttackHelper = new fi(this), this.attackStartTime = 0, this.attackStartActivity = new ai({
					speed: .003
				}), this.attackStartActivity.onActiveChange((t => {
					t && (this.attackStartTime = Xn().now)
				})), this.attackEndActivity = new ai, this.attackEndActivity.onActiveChange((t => {
					t && (this.longAttackHelper.startAttacking(), this.playSfx("weapon/melee/bluntSwing", {
						minPitch: .9,
						maxPitch: 1.1
					}))
				})), this.attackStartConfig = {
			...
			getWalkSpeedMultiplier() {
				if (this.attackStartActivity.active) {
					const t = Xn().now - this.attackStartTime,
			...
			loop(t, e) {
				...
				let n = null,
					o = !1,
					a = !1;
				s ? (n = this.attackStartConfig, o = !0) : i && (n = this.attackEndConfig, a = !0), this.holdingHandlerManager.loop(this.actionIsDown, this.player, {
					forceConfig: n
				}), this.longAttackHelper.isAttacking && this.holdAttack.timeSinceAttack > 400 && this.longAttackHelper.stopAttacking(), this.attackStartActivity.loop(o, e), this.attackEndActivity.loop(a, e), this.longAttackHelper.loop()
			}
			getThirdPersonSkeletonLayers() {
				return hi("bluntHeavy", this.attackStartActivity, this.attackEndActivity)
			}
		},
		pokeLight: class extends wi {
			constructor(...t) {
				super(...t, {
					thirdPersonParentName: "meleeHoldingPos",
				...
				}), this.hitSfxName = "weapon/melee/pokeHit", this.lastActionDownTime = 0, this.stamina = 1, this.isAttacking = !1, this.attackEndActiveCountSinceStaminaReset = 0, this.longAttackHelper = new fi(this), this.attackStartPos = new u, this.attackEndPos = new u, this.attackStartConfig = {
					posOffset: this.attackStartPos,
					rotOffset: new u(-1.9, 0, 0),
					posFovMultiplierX: .4,
					posFovMultiplierY: .5,
					...
					t ? (this.playSfx("weapon/melee/pokeSwing", {
						...
						maxPitch: 1.3,
						volume: .03
					}), this.longAttackHelper.startAttacking(), this.attackEndActiveCountSinceStaminaReset++) : (this.attackStartPos.set(gt(-.1, .1), 0, gt(.1, .3)), this.attackEndPos.set(gt(-.2, .1), -.1, gt(-1.1, -.9)), this.longAttackHelper.stopAttacking())
				}))
			}
			getDamageMultiplier() {
				return .4
			...
			getAdditionalWalkAcceleration() {
				let t = 0;
				return this.isAttacking && this.attackEndActiveCountSinceStaminaReset < 3 && (t = this.attackEndActivity.active ? 3.5 : -1.5, 2 == this.attackEndActiveCountSinceStaminaReset && (t *= .5)), new P(0, -t)
			}
			getAdditionalWalkAccelerationClampLength() {
				return 3.5
			}
			...
			loop(t, s) {
				...
				if (this.actionIsDown && (this.isAttacking = !0), this.isAttacking) {
					...
					r < 100 && !this.actionIsDown && !this.attackEndActivity.active ? this.isAttacking = !1 : r < 100 ? (n = {
						...
						...this.attackStartConfig
					}, o = !0), this.stamina -= 5e-4 * s
				} else this.stamina += 5e-4 * s;
				this.stamina = i(this.stamina), this.stamina >= 1 && (this.attackEndActiveCountSinceStaminaReset = 0), this.holdingHandlerManager.loop(this.isAttacking, this.player, {
					forceConfig: n
				}), this.attackStartActivity.loop(o, s), this.attackEndActivity.loop(a, s), this.longAttackHelper.loop()
			}
			onActionDown() {
				this.isAttacking || (this.lastActionDownTime = Xn().now)
			}
			getThirdPersonSkeletonLayers() {
				return hi("pokeLight", this.attackStartActivity, this.attackEndActivity)
			}
		},
		pokeHeavy: class extends wi {
			constructor(...t) {
				super(...t, {
					thirdPersonParentName: "meleeHoldingPos",
					secondaryThirdPersonParentName: "meleeSecondaryPosPoke",
				...
				}), this.hitSfxName = "weapon/melee/pokeHit", this.chargeDuration = 0, this.lastChargeDuration = 0, this.lastActionUpTime = 0, this.longAttackHelper = new fi(this), this.attackStartActivity = new ai, this.attackEndActivity = new ai, this.attackEndActivity.onActiveChange((t => {
					t ? (this.playSfx("weapon/melee/pokeSwing", {
						minPitch: .9,
						maxPitch: 1.1
					}), this.longAttackHelper.startAttacking()) : (this.didHitCurrentAttack = !1, this.longAttackHelper.stopAttacking())
				})), this.didHitCurrentAttack = !1, this.attackStartConfig = {
			...
			getAdditionalWalkAcceleration() {
				let t = 0;
				Xn().now - this.lastActionUpTime < 200 && (t = 3);
				return t *= T(100, this.getCooldownDuration(), 0, 1, this.lastChargeDuration, !0), new P(0, -t)
			}
			getAdditionalWalkAccelerationClampLength() {
				return 3
			}
			getLookInputMultiplier() {
				return T(200, 500, 0, 1, Xn().now - this.lastActionUpTime, !0)
			}
			getAttackCooldownActive() {
				return Xn().now - this.lastActionUpTime < this.getCooldownDuration()
			}
			onActionUp() {
				this.getAttackCooldownActive() || (this.lastActionUpTime = Xn().now, this.lastChargeDuration = this.chargeDuration, this.chargeDuration = 0)
			}
			getRequiredVerticalAngleMultiplier() {
				return .4
			}
			...
			loop(t, i) {
				...
				let s = null,
					n = !1,
					o = !1;
				if (this.getIsCharging()) this.chargeDuration += i, s = this.attackStartConfig, n = !0;
				else {
					const i = e(400, 200, this.getAttackSpeedStat());
					t - this.lastActionUpTime < i && (s = this.attackEndConfig, o = !0)
				}
				this.holdingHandlerManager.loop(this.actionIsDown, this.player, {
					forceConfig: s
				}), this.attackStartActivity.loop(n, i), this.attackEndActivity.loop(o, i), this.longAttackHelper.loop()
			}
			onActionDown() {
				this.lastActionDownTime = Xn().now
			}
			getThirdPersonSkeletonLayers() {
				return hi("pokeHeavy", this.attackStartActivity, this.attackEndActivity)
			}
		}
	};
class Ci {
	constructor({
		...
		this.keyNumber = e, this.el = document.createElement("div"), this.el.classList.add("weaponSelectionItem"), this.classSelectionImage = new re(t, {
...
function Oi(t) {
	let e = Number(t);
	return isNaN(e) && (e = 1), e = M(e, Tt.length), e
}
class Vi extends Mt {
	constructor(t) {
		super(t, {
		...
		}), this.playerVisibility = !0, this.selectionItemsContainer = document.createElement("div"), this.selectionItemsContainer.classList.add("weapon-selection-container"), this.el.appendChild(this.selectionItemsContainer), this.weaponSelectionItems = [];
		for (const [t, e] of Tt.entries()) {
			const i = e.id,
				s = new Ci({
					classId: i,
					keyNumber: t + 1
			...
			s.onClick((() => {
				this.selectWeapon(t)
			})), this.weaponSelectionItems.push(s), this.selectionItemsContainer.appendChild(s.el)
		}
		this.updateSelectedUi(), this.boundPrevPress = () => this.deltaSelectWeapon(-1), this.boundNextPress = () => this.deltaSelectWeapon(1), this.prevKey = Xn().input.getKey("prevWeapon"), this.prevKey.onPressedDown(this.boundPrevPress), this.nextKey = Xn().input.getKey("nextWeapon"), this.nextKey.onPressedDown(this.boundNextPress), this.boundKeyDown = this.onKeyDown.bind(this), window.addEventListener("keydown", this.boundKeyDown), this.addOnVisibilityChangeCb((() => {
			this.updateNeedsAvatarUpdates()
		})), this.addOnInertChangeCb((() => {
			this.updateNeedsAvatarUpdates()
		})), this.boundUpdateSelectedUi = () => {
			this.updateSelectedUi()
		}, Ti(this.boundUpdateSelectedUi), async function() {
			if (Di) return;
			Di = !0;
			let t = await Xn().indexedDb.get("selectedWeaponId");
			t = Oi(t), isNaN(t) || t == Ai || (Ai = t, Fi())
		}(), this.boundUpdateVisible = this.updateVisible.bind(this), Xn().mainMenu.onVisibilityChange(this.boundUpdateVisible), xi(this.boundUpdateVisible), window.addEventListener("resize", this.boundUpdateVisible), Xn()
	}
	destructor() {
		super.destructor(), this.prevKey.removeCb(this.boundPrevPress), this.nextKey.removeCb(this.boundNextPress), window.removeEventListener("keydown", this.boundKeyDown), Ei(this.boundUpdateSelectedUi);
		var t;
		Xn().mainMenu.removeOnVisibilityChange(this.boundUpdateVisible), t = this.boundUpdateVisible, Pi.delete(t), window.removeEventListener("resize", this.boundUpdateVisible)
	}
	updateSelectedUi() {
		for (const [t, e] of this.weaponSelectionItems.entries()) e.selected = t == Ai
	}
	...
	setCssColor(t, e) {
		for (const i of this.weaponSelectionItems) i.setCssColor(t, e)
	}
	onKeyDown(t) {
		if (!Xn().input.inputHasFocus())
			for (const [e, i] of this.weaponSelectionItems.entries()) t.code == "Digit" + i.keyNumber && this.selectWeapon(e)
	}
	selectWeapon(t) {
		return !!this.visible && (Ai = Oi(t), Xn().indexedDb.set("selectedWeaponId", Ai), Fi(), !0)
	}
	deltaSelectWeapon(t) {
		return this.selectWeapon(Ai + t)
	}
	setPlayerVisibility(t) {
		this.playerVisibility = t, this.updateVisible()
	}
	setMainMenuVisibility(t) {
		this.mainMenuVisibility = t, this.updateVisible()
	}
	updateVisible() {
		let t = !0;
		this.playerVisibility ? (Xn().mainMenu.visible && (window.innerWidth < 800 || window.innerHeight < 460) || Mi()) && (t = !1) : t = !1, this.visible = t
	}
}
const Bi = "urigkuup".replace("k", "inalL").replaceAll("u", "o"),
	Ri = "uriglruw".replace("l", "ktAr").replace("k", "inalShuu").replaceAll("u", "o"),
	Ui = "kdmenknel".replace("en", "in-p").replaceAll("k", "a");
class qi {
	constructor(t, e, i, s, n, o, a, {
		teamId: r = 0,
		needsPlayerModel: l = !0,
		needsSkeleton: h = !0,
		isDummyPlayer: d = !1
	} = {}) {
		this.game = t, this.inputManager = e, this.sfxManager = i, this.physicsManager = s, this.settingsManager = n, this.hudIconsManager = o, this.id = a, this.hasOwnership = !1, this.creationTime = performance.now(), this.teamId = r, this.isDummyPlayer = d, this.equippedSkinData = {}, this.isSameSquadPlayer = !1, this.isSquadLeader = !1, this.iconOwnershipVisibility = !1, this.squadPlayerId = 0, this.gender = "male", this.walkSpeed = 60, this.recentStunEvents = new Set, this.airWalkSpeedMultiplier = .4, this.flagWalkSpeed = 45, this.jumpForce = 8.6, this.ladderClimbSpeed = 1, this.ladderTangentWalkSpeed = .5, this.playerHasInteracted = !1, this.onPlayerHasInteractedChangeCbs = new Set, this.health = 1, this.lastHitTime = 0, this.damageReceivedHistory = [], this.currentHealthRegenSfx = null, this.playerName = "", this.playerNameVerified = !1, this.scoreFlags = 0, this.scoreKills = 0, this.scoreDeaths = 0, this.scoreTotal = 0, this.elo = 0, this.serverPos = new u, this.hasValidPosition = !1, this.recentForcedServerPositions = new Set, this.lastReceivedServerPosTime = 0, this.maxPredictedServerPosDistance = 3, this.predictedServerPos = new u, this.lastPredictedServerVelocity = new u, this.predictedServerVelocity = new u, this.predictedServerAcceleration = new u, this.serverPosSmooth = new u, this.velocity = new u, this.networkPosIsMovingUp = !1, this.antiFlyAccumulator = 0, this.antiFlyInAirTimeRaw = 0, this.antiFlyInAirTimeAccumulator = 0, this.lastAntiFlyRaycastTime = 0, this.lastAntiFlyRaycastDist = 0, this.lastReceivedActionTime = 0, this.pos = new u, this.negativeHealthStartTime = 0, this.prevHealthIsNegative = !1, this.negativeHealthCounter = 0, this.cachedCamPos = new u, this.cachedCamPosDirty = !0, this.cachedCamRot = new p, this.cachedCamRotDirty = !0, this.lookRot = new P, this.deadLookRot = new P, this.frontThirdPersonLookRot = new P, this.smoothLookRotTarget = new P, this.noSentDataChangeUpdateCount = 0, this.lastSentPos = new u, this.lastSentRot = new P, this.lastPosSentTime = 0, this.prevPos = new u, this.smoothMovementSpeed = 0, this.ping = 0, this.positionHistory = [], this.rigidBody = new Ze(this.game.physics, this), this.physicsManager.registerRigidBody(this.rigidBody), this.boundOnJumpPress = this.onJumpPress.bind(this), this.boundOnFireDown = this.onFireDown.bind(this), this.boundOnFireUp = this.onFireUp.bind(this), this.boundToggleActiveWeapon = this.toggleActiveWeapon.bind(this), this.boundOnThirdPersonChange = this.onThirdPersonChange.bind(this), this.boundUpdateToggleWeaponTouchButtonVisibility = this.updateToggleWeaponTouchButtonVisibility.bind(this), this.boundSetHasSmoothCam = this.setHasSmoothCam.bind(this), this.boundUpdateSmoothCam = this.updateSmoothCam.bind(this), this.boundUpdateActiveWeapon = this.updateActiveWeapon.bind(this), this.boundUpdateFly = this.updateFly.bind(this), this.boundOnWheel = this.onWheel.bind(this), this.lastAirJumpPressTime = -1, this.prevWasOnFloor = !1, this.hasTouchedFloorEver = !1, this.lastJumpTime = 0, this.lastJumpLandTime = 0, this.lastJumpLandAmount = 0, this.highestInAirPoint = 0, this.currentFallingSfx = null, this.hasKeyEvents = !1, this.useFirstPersonHoldingHandlers = !1, this.noclip = !1, this.serverFlyEnabled = !1, this.flySpeed = 0, this.movementAccuracyOffset = null, this.holdingFlag = null, this.sentChangeFlagMessages = [], this.statClassValues = null, this.holdingHandlers = new Set, this.needsPlayerModel = l, this.loadingModel = null, this.activeModel = null, this.skeleton = null, h && (this.skeleton = new $t({
			player: this
		})), this.mostRecentWeaponSkeletonLayers = [], this.weaponActionIsDown = !1, this.bowWeapon = null, this.meleeWeapon = null, this.meleeWeaponId = null, this.hasActiveMeleeWeapon = !1, this.lastActiveWeaponToggleTime = 0, this.lastActiveWeaponUpdateTime = -1 / 0, this.didUpdateActiveWeaponAfterToggle = !1, this.recentlyDestroyedWeapons = new Map, this.lastSentArrowId = 0, this.weaponAccuracyOffset = null, this.lastWeaponLayersKey = "", this.weaponLayers = [], this.recentInvalidArrowTimes = [], this.recentArrowCreationTimes = [], this.ak1 = "sendHitByArrow", this.ak2 = "Dev", this.ak3 = "ose", this.ak4 = "Text", this.ak5 = "mso", this.ak6 = "Cri", this.ak7 = "nR", this.ak8 = "lastSentData", this.ak9 = "['y']", this.ak10 = ".AIDS", this.lastMarkedValidArrowTime = -1 / 0, this.dead = !1, this.currentSpawnId = 0, this.dieTime = 0, this.deadAnimationWeight = 0, this.deadFallForward = !1, this.deadFromFall = !1, this.sphereDeathTimer = 0, this.sphereDeathScreenFlash = null, this.hasWalkedAwayFromSpawn = !1, this.lastRespawnPosition = new u, this.onWeaponSelectionChangeFromDialog = () => {
		...
		}, this.skinLegMoveAmount = 1, Xn().skins.onSkinConfigChange(this.onSkinConfigChange), this.smoothCamSetting = !1, this.smoothCamDebug = !1, this.smoothCam = !1, this.nextHitFlashIndex = 0, this.obj = null, this.legsMoveT = 0, this.legsMoveAmount = 0, this.walkHeadBobAmount = 0, this.legsMoveSpeed = 2, this.lastSfxStep = 0, this.updateUseFirstPersonHoldingHandlers(), this.updateFly(), this.icon = this.hudIconsManager.createIcon({
			url: "static/img/hudIcons/playerIcon.svg",
			size: .03
		}), this.destructed = !1
	}
	init() {
		this.skeleton && (this.skeleton.init(), this.skeleton.addPoseLayer("baseRig"), this.equippingWeaponLayer = this.skeleton.addPoseLayer("equippingWeapon"), this.deadForwardLayer = this.skeleton.addPoseLayer("deadForward"), this.deadBackwardLayer = this.skeleton.addPoseLayer("deadBackward"), this.waitForSkeletonLoad()), this.resetDeadPoseWeights(), this.setPlayerEquippedSkinData(this.equippedSkinData), this.updateIconOwnershipVisibility()
	}
	async waitForSkeletonLoad() {
		if (!this.skeleton) throw new Error("Player was created without a skeleton");
	...
	destructor() {
		...
		this.destructed = !0;
		const t = Xn();
		this.obj && t.scene.remove(this.obj), this.activeModel && this.activeModel.destructor(), this.loadingModel && this.loadingModel.destructor(), this.physicsManager.removeRigidBody(this.rigidBody), t.skins.removeOnSkinConfigChange(this.onSkinConfigChange), t.hudIcons.removeIcon(this.icon), this.setHasEvents(!1), this.stopFallSound(), this.stopHealthRegenSound(), this.removeActiveBowWeapon(), this.removeActiveMeleeWeapon()
	}
	get sameSquadOrOwned() {
		return this.isSameSquadPlayer || this.hasOwnership
	}
	removeActiveBowWeapon() {
		this.bowWeapon && (this.recentlyDestroyedWeapons.set(this.bowWeapon.bowWeaponId, performance.now()), this.bowWeapon.destructor()), this.bowWeapon = null, this.updateSkinStats()
	}
	removeActiveMeleeWeapon() {
		this.meleeWeapon && this.meleeWeapon.destructor(), this.meleeWeapon = null, this.updateToggleWeaponTouchButtonVisibility(), this.hasActiveMeleeWeapon && this.toggleActiveWeapon()
	}
	setActiveBowWeapon(t, e = !1) {
		if (this.bowWeapon && t == this.bowWeapon.bowWeaponId && !e) return;
		if (this.removeActiveBowWeapon(), t < 0 || t >= Tt.length) return;
		Xn().renderer.renderWorthyEventHappened();
		const i = Tt[t],
			s = new(0, Si[i.bowId])(this, t);
		this.bowWeapon = s, this.updateActiveWeapon(), this.updateSkinStats(), this.hasOwnership && Xn().network.sendChangeSelectedClass(this.id, t)
	}
	updateActiveMeleeWeapon() {
		const t = Xn().skins.skinNetworkDataToMeleeSkinConfig(this.equippedSkinData);
		t ? (this.setActiveMeleeWeapon(t.meleeId), this.meleeWeapon && this.meleeWeapon.updateMeleeAsset(t.skin)) : this.setActiveMeleeWeapon(null)
	}
	setActiveMeleeWeapon(t) {
		if (t != this.meleeWeaponId) {
			if (this.removeActiveMeleeWeapon(), this.meleeWeaponId = t, t) {
				const e = vi[t];
				if (e) {
					const t = new e(this);
					this.meleeWeapon = t, this.updateToggleWeaponTouchButtonVisibility()
				}
			}
			Xn().renderer.renderWorthyEventHappened(), this.updateActiveWeapon()
		}
	}
	...
	get currentToggleWeaponCooldown() {
		let t = 0;
		for (const e of this.getEquippedWeapons()) t = Math.max(t, e.getToggleCooldownValue());
		return t
	}
	get activeWeaponToggleCooldownActive() {
		return Xn().now - this.lastActiveWeaponToggleTime < this.currentToggleWeaponCooldown
	}
	get activeWeapon() {
		return this.activeWeaponToggleCooldownActive ? null : this.hasActiveMeleeWeapon ? this.meleeWeapon : this.bowWeapon
	}* getEquippedWeapons() {
		this.meleeWeapon && (yield this.meleeWeapon), this.bowWeapon && (yield this.bowWeapon)
	}
	updateMySelectedWeapon(t = !1) {
		this.hasOwnership && this.setActiveBowWeapon(Ii(), t)
	}
	...
	loop(s, n) {
		...
		const r = this.game instanceof Ls ? this.game : null;
		if (this.didUpdateActiveWeaponAfterToggle || this.activeWeaponToggleCooldownActive || (this.didUpdateActiveWeaponAfterToggle = !0, this.updateActiveWeapon()), this.bowWeapon && (this.bowWeapon.loop(s, n), this.weaponAccuracyOffset && (this.weaponAccuracyOffset.offset = this.bowWeapon.getAccuracyOffset())), this.meleeWeapon && this.meleeWeapon.loop(s, n), this.hasOwnership) {
			if (!this.deadFromFall) {
				let e = this.lookRot,
					i = .5 * Math.PI;
				"front" == a.cam.thirdPersonMode && (e = this.frontThirdPersonLookRot, i = 1);
				const s = this.inputManager.lookInput.clone();
				if (this.activeWeapon && s.multiplyScalar(this.activeWeapon.getLookInputMultiplier()), this.smoothCam)(r && r.gameEndStepsReachedStatScreens || a.dialogManager.needsUnlockedPointer) && s.multiplyScalar(.1), s.length() > .1 && a.renderer.renderWorthyEventHappened(1e4), this.smoothLookRotTarget.addScaledVector(s, -.002), e.lerp(this.smoothLookRotTarget, .1);
				else {
				...
				e.y = t(e.y, .5 * -Math.PI, i), this.cachedCamRotDirty = !0
			}
			let l = new P;
			a.mainMenu.visible || a.dialogManager.needsUnlockedPointer || (l = this.inputManager.walkInput), l.length() > .01 && (a.renderer.renderWorthyEventHappened(), a.gameManager.joinIfNotJoined());
			const h = new u(l.x, 0, l.y);
			h.applyQuaternion(this.getCamXRotQuaternion()), h.clampLength(0, 1);
			const d = .5,
				c = new u;
			let g = 1 / 0;
			for (const t of this.getEquippedWeapons()) {
				...
				if (e) {
					...
					i.applyQuaternion(this.getCamXRotQuaternion()), t != this.activeWeapon && i.multiplyScalar(1 - d), c.add(i), g = Math.min(g, t.getAdditionalWalkAccelerationClampLength())
				}
			}
			this.rigidBody.climbingLadder && c.multiplyScalar(d), h.add(c), h.clampLength(0, g);
			const m = h.length();
			this.rigidBody.fly || (h.y = 0), m > .1 && this.setPlayerHasInteracted(), h.setLength(m);
			...
			const w = .8;
			f *= 1 / (this.rigidBody.slowDownColliderAmount * w + 1), f *= e(.9, 1.1, this.getStatClassValue("movementSpeed")), this.activeWeapon && (f *= this.activeWeapon.getWalkSpeedMultiplier());
			for (const t of this.recentStunEvents) {
				...
				} else this.recentStunEvents.delete(t)
			}
			if (this.rigidBody.climbingLadder && this.rigidBody.climbingLadderNormal) {
				...
				if (t > 0 && !e && (i = !1), i) {
					const t = new p;
					t.setFromUnitVectors(new u(0, 1, 0), this.rigidBody.climbingLadderNormal), h.applyQuaternion(t)
				}
			...
			this.rigidBody.fly && (this.inputManager.getKey("flyUp").pressed && (h.y += 1, a.renderer.renderWorthyEventHappened()), this.inputManager.getKey("flyDown").pressed && (h.y -= 1, a.renderer.renderWorthyEventHappened())), h.multiplyScalar(f), this.rigidBody.fly && h.multiplyScalar(Math.pow(1.001, this.flySpeed)), this.dead || this.rigidBody.applyForce(h);
			let b = 0,
				y = 0;
			const S = this.rigidBody.velocity,
				v = new P(S.x, S.z);
			if (y = Math.max(0, S.y), b = v.length(), this.rigidBody.inAirTime < 200 && (this.legsMoveT += b * (n / 1e3) * this.physicsManager.timeScale), this.legsMoveAmount += .005 * n, this.legsMoveAmount = Math.min(this.legsMoveAmount, .15 * b), this.legsMoveAmount = i(this.legsMoveAmount), this.walkHeadBobAmount += 3e-4 * n, this.walkHeadBobAmount = Math.min(this.walkHeadBobAmount, b), this.walkHeadBobAmount = i(this.walkHeadBobAmount), this.movementAccuracyOffset && (this.movementAccuracyOffset.offset = 10 * y + 2 * b), !this.dead && r) {
				const t = 1.5;
				if (this.holdingFlag || this.teamId == E) {
					if (this.holdingFlag)
				...
				for (const s of r.getMyFlags(this.teamId))
					...
					i.addReturnProgress(n * e), r.crosshair.setFlagReturnProgress(i.returnProgress), i.returnProgress > 1 && this.sendChangeFlag(i.id, 3)
				}
				r.crosshair.setFlagReturnProgressVisibility(null != i)
			}
			const C = o.length() * n;
			this.smoothMovementSpeed = e(this.smoothMovementSpeed, C, .1);
			const k = Math.round(n / a.smoothDt);
			for (let t = 0; t < k; t++) this.positionHistory.unshift(this.pos.clone());
			...
			if ("number" == typeof A && A > 0 && this.pos.length() > A ? (this.sphereDeathTimer += n, this.sphereDeathScreenFlash || (this.sphereDeathScreenFlash = Xn().screenFlash.flash({
					color: new u(1, .9, .6),
					autoFade: !1,
					hasDirection: !1
				})), this.sphereDeathTimer > 5e3 && (this.die(!0), this.sphereDeathTimer = 0)) : this.sphereDeathTimer > 0 && (this.sphereDeathTimer -= n, this.sphereDeathTimer = Math.max(0, this.sphereDeathTimer), this.sphereDeathScreenFlash && this.sphereDeathTimer <= 0 && (this.sphereDeathScreenFlash.shouldBeDestroyed = !0, this.sphereDeathScreenFlash = null)), this.sphereDeathScreenFlash) {
				const t = this.sphereDeathTimer / 5e3;
				this.sphereDeathScreenFlash.opacity = T(0, .5, 0, 2, t, !0), this.sphereDeathScreenFlash.baseOpacity = T(.5, 1, 0, 1, t, !0)
			}
			for (const t of this.recentForcedServerPositions)(s > t.time + 1e4 || t.pos.distanceTo(this.pos) > 10) && this.recentForcedServerPositions.delete(t)
		} else {
			...
			o.clampLength(0, this.maxPredictedServerPosDistance - .01), this.predictedServerPos.copy(this.serverPos).add(o), t < 100 && this.predictedServerVelocity.addScaledVector(this.predictedServerAcceleration, n);
			const r = .02;
			...
			this.rigidBody.inAirTime < 200 && (this.legsMoveT += d), this.legsMoveAmount += .005 * n, this.legsMoveAmount = Math.min(this.legsMoveAmount, 1e3 * d / n), this.legsMoveAmount = i(this.legsMoveAmount), this.pos.distanceTo(this.serverPos) > this.maxPredictedServerPosDistance ? (this.rigidBody.pos.copy(this.serverPos), this.serverPosSmooth.copy(this.serverPos), this.rigidBody.velocity.set(0, 0, 0)) : this.rigidBody.pos.copy(this.serverPosSmooth);
			...
			if (this.rigidBody.inAirTime > 200 && !this.rigidBody.climbingLadder && this.rigidBody.airFrictionModifier <= 0) {
				if (s - c < 200) {
					...
					t.multiplyScalar(T(0, Math.PI, 1, 0, e, !0)), this.antiFlyAccumulator += t.length(), this.antiFlyInAirTimeRaw += n, this.antiFlyInAirTimeAccumulator += n * T(2, 10, 0, 10, this.lastAntiFlyRaycastDist, !0)
				}
			} else this.antiFlyAccumulator = 0, this.antiFlyInAirTimeRaw = 0, this.antiFlyInAirTimeAccumulator = 0;
			if (!this.dead && !this.rigidBody.fly && this.hasTouchedFloorEver) {
				const t = T(17, 30, 0, 1, this.antiFlyAccumulator, !0);
				let e = 0;
				if (s - c < 200 && (e = T(0, 1e4, 0, 1, this.antiFlyInAirTimeAccumulator, !0)), this.antiFlyInAirTimeRaw > 5e3) {
				...
				} else this.lastAntiFlyRaycastDist = 0;
		...
		if (this.dead) {
			...
			this.deadAnimationWeight = 1 - Math.pow(2, -t), this.legsMoveAmount = Math.min(this.legsMoveAmount, 1 - this.deadAnimationWeight);
		...
		if (this.health < 1 && !this.dead) {
			const t = (s - this.lastHitTime) / 1e3,
				...
				a = i((.3 * (t - o)) ** 5);
			this.hasOwnership && (a > .1 ? this.startHealthRegenSound() : this.stopHealthRegenSound()), this.health += 5e-4 * n * a, this.health = Math.min(1, this.health), this.hasOwnership && this.updateHealthUi()
		}
		const l = this.health < 0;
		if (l != this.prevHealthIsNegative && (this.prevHealthIsNegative = l, l && (this.negativeHealthStartTime = s)), l && !this.dead) {
			s - this.negativeHealthStartTime > 1e3 && (this.health = 1, this.hasOwnership && this.updateHealthUi(), this.negativeHealthCounter++, this.negativeHealthCounter >= 2 && (this.report(ei, 1), this.negativeHealthCounter = 0))
		}
		...
		this.activeModel && this.activeModel.setHitFlashMaterialsTime(s), this.loadingModel && this.loadingModel.setHitFlashMaterialsTime(s)
	}
	get legsMoveTForCos() {
	...
	afterPhysicsLoop(t, i) {
		if (this.prevWasOnFloor != this.rigidBody.isOnFloor) {
			if (this.prevWasOnFloor = this.rigidBody.isOnFloor, this.rigidBody.isOnFloor && this.rigidBody.prevInAirTime > 300) {
				t - this.lastAirJumpPressTime < 300 && this.lastAirJumpPressTime >= 0 && this.rigidBody.getAllowJump() && (this.lastAirJumpPressTime = -1, this.jump());
				...
				if (e > 0) {
					...
					}), this.lastJumpLandTime = t, this.lastJumpLandAmount = s), this.hasTouchedFloorEver = !0
				}
			}
			this.highestInAirPoint = this.pos.y
		}
		if (this.rigidBody.isOnFloor || (this.highestInAirPoint = Math.max(this.highestInAirPoint, this.pos.y)), this.hasOwnership && (this.rigidBody.inAirTime > 50 && this.rigidBody.velocity.y < -3 && !this.rigidBody.fly ? this.startFallSound() : this.stopFallSound(), !this.hasWalkedAwayFromSpawn && this.game.gameStarted)) {
			this.pos.distanceTo(this.lastRespawnPosition) > 5 && (this.hasWalkedAwayFromSpawn = !0, this.setWeaponSelectionDialogVisibility(!1), Xn().adBanners.setPageVisibility("respawn", !1))
		}
		if (this.holdingFlag && this.holdingFlag.updateRenderPosition(), this.deadFromFall || this.pos.copy(this.rigidBody.pos), this.cachedCamPosDirty = !0, this.activeModel && this.activeModel.isInit && this.obj) {
			this.obj.position.copy(this.pos);
			let i = this.lookRot;
			if (this.dead && (i = this.deadLookRot), this.obj.rotation.y = i.x + Math.PI, this.obj.updateWorldMatrix(!1, !0), this.skeleton && this.skeleton.isInit) {
				...
				s -= this.currentToggleWeaponCooldown, s /= 150, this.equippingWeaponLayer && (this.equippingWeaponLayer.weight = Math.max(0, 1 - Math.abs(s)));
				const n = i.map((t => t.name.replaceAll(",", "\\,"))).join(",");
				if (n != this.lastWeaponLayersKey) {
					const t = [...this.weaponLayers];
					for (const e of t) this.skeleton.removePoseLayer(e);
					this.weaponLayers = [];
					for (const [t, e] of i.entries()) this.weaponLayers[t] = this.skeleton.insertPoseLayer(t + 1, e.name);
				...
				let a = this.lookRot;
				this.dead && (a = this.deadLookRot.clone(), a.y = e(this.deadLookRot.y, 0, this.deadAnimationWeight)), this.skeleton.setLookRotY(-a.y, o), this.animateLeg(this.skeleton.legObjectsL, this.legsMoveTForCos, -1, 1.8, .7), this.animateLeg(this.skeleton.legObjectsR, this.legsMoveTForCos + Math.PI, -.4, .7, .7), this.skeleton.updateMatrices(), this.activeModel.applySkeleton(this.skeleton)
			}
		}
		const s = this.pos.clone();
		s.y += 2.2, this.icon.setPos(s);
		for (const e of this.holdingHandlers) e.loop(t, i);
	...
	animateLeg(t, i, s, n, o) {
		if (!t) return;
		t.upper.rotation.x = .5 * Math.cos(i) * this.legsMoveAmount, t.lower.rotation.x = .3 * (1 + Math.cos(i)) * this.legsMoveAmount, t.foot.rotation.x = .5 * Math.cos(i) * this.legsMoveAmount;
		const a = T(0, 800, 0, 1, this.rigidBody.inAirTime, !0);
		t.upper.rotation.x = e(t.upper.rotation.x, s, a), t.lower.rotation.x = e(t.lower.rotation.x, n, a), t.foot.rotation.x = e(t.foot.rotation.x, o, a), t.upper.rotation.x *= this.skinLegMoveAmount, t.lower.rotation.x *= this.skinLegMoveAmount, t.foot.rotation.x *= this.skinLegMoveAmount
	}
	...
	sendPlayerDataToServer() {
		this.noclip || (Xn().network.sendPlayerData(this.game, this.id, {
			posX: this.pos.x,
			posY: this.pos.y,
			posZ: this.pos.z,
			rotX: this.lookRot.x,
			rotY: this.lookRot.y
		}), this.lastPosSentTime = Xn().now, this.lastSentPos.copy(this.pos), this.lastSentRot.copy(this.lookRot), this.holdingFlag && this.holdingFlag.sendFlagReturnProgressToServer(this.pos))
	}
	...
	sendPerformAction(t) {
		this.hasOwnership && Xn().network.sendPlayerPerformAction(this.id, t)
	}
	receivedPerformAction(t) {
		this.hasOwnership || (this.lastReceivedActionTime = Xn().now, t == qi.PlayerAction.JUMP ? this.onJumpPress() : t == qi.PlayerAction.FIRE_DOWN ? this.onFireDown() : t == qi.PlayerAction.FIRE_UP ? this.onFireUp() : t == qi.PlayerAction.DIE && this.die())
	}
	receiveChangeClassFromServer(t) {
		this.hasOwnership || this.setActiveBowWeapon(t)
	}
	setHasOwnership(t) {
		t != this.hasOwnership && (this.hasOwnership = t, t ? (this.weaponAccuracyOffset = this.game.crosshair.createAccuracyOffset(), Xn().playerAvatarManager.setAvatar(this.getSmallAvatar())) : this.weaponAccuracyOffset && (this.game.crosshair.deleteAccuracyOffset(this.weaponAccuracyOffset), this.weaponAccuracyOffset = null), this.setHasEvents(t), this.setHasMovementAccuracyOffset(t), this.updateModelVisibility(), this.updateUseFirstPersonHoldingHandlers(), this.updateToggleWeaponTouchButtonVisibility(), this.updateFly())
	}
	setPlayerName(t) {
		this.playerName = t
	}
	...
	setTeamId(t) {
		if (this.teamId != t)
			if (this.teamId = t, this.updateMySelectedWeapon(!0), this.reloadPlayerModel(), this.updateFly(), this.hasOwnership) {
				if (!(this.game instanceof Ls)) throw new Error("Setting team id is not supported for offline games");
				this.game.updateMyTeamColor(), this.game.updatePlayerIconVisibilities()
			} else this.updateIconOwnershipVisibility()
	}
	setIsSameSquadPlayer(t, e, i) {
		this.isSameSquadPlayer = t, this.squadPlayerId = e, this.isSquadLeader = i
	}
	setScores({
		scores: t,
		elo: e
		...
		this.scoreFlags = i, this.scoreKills = s, this.scoreDeaths = n, this.scoreTotal = o, this.elo = e
	}
	setHasEvents(t) {
		...
		t ? (i.onPressedDown(this.boundOnJumpPress), s.onPressedDown(this.boundOnFireDown), s.onPressedUp(this.boundOnFireUp), n.onPressedDown(this.boundToggleActiveWeapon), e.dialogManager.onNeedsUnlockedPointerChange(this.boundUpdateSmoothCam), e.cam.onThirdPersonChange(this.boundOnThirdPersonChange), e.input.touch.onTouchSupportedChange(this.boundUpdateToggleWeaponTouchButtonVisibility), Ti(this.onWeaponSelectionChangeFromDialog), e.settingsManager.onValueChange("smoothCam", this.boundSetHasSmoothCam), e.settingsManager.onValueChange("showFirstPersonWeapon", this.boundUpdateActiveWeapon), e.settingsManager.onValueChange("flyInSpectateTeam", this.boundUpdateFly), document.body.addEventListener("wheel", this.boundOnWheel), this.smoothCamSetting = e.settingsManager.getValue("smoothCam"), this.updateSmoothCam(), this.updateMyElo()) : (i.removeCb(this.boundOnJumpPress), s.removeCb(this.boundOnFireDown), s.removeCb(this.boundOnFireUp), e.dialogManager.removeOnNeedsUnlockedPointerChange(this.boundUpdateSmoothCam), e.cam.removeOnThirdPersonChange(this.boundOnThirdPersonChange), e.input.touch.removeOnTouchSupportedChange(this.boundUpdateToggleWeaponTouchButtonVisibility), Ei(this.onWeaponSelectionChangeFromDialog), e.settingsManager.removeOnValueChange("smoothCam", this.boundSetHasSmoothCam), e.settingsManager.removeOnValueChange("showFirstPersonWeapon", this.boundUpdateActiveWeapon), e.settingsManager.removeOnValueChange("flyInSpectateTeam", this.boundUpdateFly), document.body.removeEventListener("wheel", this.boundOnWheel))
	}
	setHasSmoothCam(t) {
		this.smoothCamSetting = t, this.updateSmoothCam()
	}
	updateSmoothCam() {
		const t = this.smoothCamSetting || this.smoothCamDebug || this.game instanceof Ls && this.game.gameEndStepsReachedStatScreens || Xn().dialogManager.needsUnlockedPointer;
		this.smoothCam != t && (this.smoothCam = t, this.smoothCam && this.resetSmoothLookRot())
	}
	updateMyElo() {
		let t = 0;
		document.getElementById("onoxmos".replaceAll("x", "myNa").replaceAll("o", "e")) && (t = 2), t && Xn().network.sendMyElo(t)
	}
	resetSmoothLookRot() {
	...
	getStatClassValue(t) {
		const e = te.get(t);
		if (!e) throw new Error(`No stat class config for '${t}'`);
		if (!this.statClassValues || !this.statClassValues.has(t)) return e.defaultValue;
		let s = this.statClassValues.get(t) || 0;
		return s += e.defaultValue, i(D(e.min, e.max, s))
	}
	reloadPlayerModel() {
	...
	updateSkinStats() {
		...
		const {
			statClassValues: e,
			legMoveAmount: i
		} = Xn().skins.getStatClassValuesFromShopSkinIds(this.equippedSkinData.equippedSkinIds || [], t);
		this.statClassValues = e, this.skinLegMoveAmount = i
	}
	setPlayerEquippedSkinData(t) {
		this.equippedSkinData = t, this.updateSkinStats(), this.bowWeapon && this.bowWeapon.playerSkinUpdated(), this.meleeWeapon && this.meleeWeapon.playerSkinUpdated(), this.updateActiveMeleeWeapon(), this.hasOwnership && Xn().playerAvatarManager.setAvatar(this.getSmallAvatar()), this.needsPlayerModel && (this.loadingModel && this.loadingModel.destructor(), this.loadingModel = null, this.loadingModel = new Kt({
			skinObjectOpts: {
				teamId: this.teamId,
				skin: t
			}
		}), this.gender = t.gender || "male", this.skeleton && this.skeleton.setGender(this.gender), this.replaceLoadingModel())
	}
	async replaceLoadingModel() {
		...
		this.activeModel && this.activeModel.destructor(), this.activeModel = this.loadingModel, this.loadingModel = null, this.obj && Xn().scene.remove(this.obj);
		const t = this.activeModel.obj;
		this.obj = t, t && (t.name = "player", Xn().scene.add(t));
		for (const t of this.holdingHandlers) t.playerObjectChanged();
		this.updateModelVisibility(), Xn().renderer.renderWorthyEventHappened()
	}
	setWeaponSelectionDialogVisibility(t) {
		this.game instanceof Ls && this.game.weaponSelectionDialog.setPlayerVisibility(t)
	}
	...
	onJumpPress() {
		if (this.rigidBody.fly) return;
		const t = Xn();
		this.hasOwnership && (t.mainMenu.visible || t.dialogManager.needsUnlockedPointer) || (t.gameManager.joinIfNotJoined(), this.rigidBody.getAllowJump() ? this.jump() : this.lastAirJumpPressTime = t.now)
	}
	jump() {
		if (this.dead) return;
		let t = 1;
		...
		e > 0 && (this.lastJumpTime = Xn().now, this.sendPerformAction(qi.PlayerAction.JUMP), this.sfxManager.playSound(`player/jump/${this.gender}/${ut(1,4)}`, {
			pos: this.getSfxPos()
	...
	onFireDown() {
		if (!this.dead) {
			if (this.hasOwnership) {
				if (this.setPlayerHasInteracted(), Xn().mainMenu.visible) return;
				Xn().gameManager.joinIfNotJoined()
			}
			this.weaponActionIsDown = !0, this.sendPerformAction(qi.PlayerAction.FIRE_DOWN), Xn().renderer.renderWorthyEventHappened(), this.activeWeapon && this.activeWeapon.actionDown()
		}
	}
	onFireUp() {
		this.weaponActionIsDown = !1, this.dead || (this.hasOwnership, this.sendPerformAction(qi.PlayerAction.FIRE_UP), Xn().renderer.renderWorthyEventHappened(), this.activeWeapon && this.activeWeapon.actionUp())
	}
	startToggleActiveWeaponCooldown() {
		this.lastActiveWeaponToggleTime = Xn().now, this.didUpdateActiveWeaponAfterToggle = !1
	}
	toggleActiveWeapon() {
		this.hasOwnership && (this.meleeWeapon || this.hasActiveMeleeWeapon) && (this.hasActiveMeleeWeapon = !this.hasActiveMeleeWeapon, this.hasOwnership, this.startToggleActiveWeaponCooldown(), this.updateActiveWeapon(), Xn().renderer.renderWorthyEventHappened(), this.hasOwnership && Xn().network.sendChangeActiveWeaponType(this.id, this.hasActiveMeleeWeapon))
	}
	receiveChangeWeaponTypeFromServer(t) {
		this.hasOwnership || t == this.hasActiveMeleeWeapon || (this.hasActiveMeleeWeapon = t, this.startToggleActiveWeaponCooldown(), this.updateActiveWeapon(), Xn().renderer.renderWorthyEventHappened())
	}
	updateActiveWeapon() {
		const t = Xn().settingsManager.getValue("showFirstPersonWeapon") && !this.noclip;
		if (this.bowWeapon && (this.bowWeapon.setIsPrimaryWeapon(!this.hasActiveMeleeWeapon && !this.activeWeaponToggleCooldownActive), this.bowWeapon.setFirstPersonVisibility(!this.hasActiveMeleeWeapon && !this.activeWeaponToggleCooldownActive && t)), this.meleeWeapon && (this.meleeWeapon.setIsPrimaryWeapon(this.hasActiveMeleeWeapon && !this.activeWeaponToggleCooldownActive), this.meleeWeapon.setFirstPersonVisibility(this.hasActiveMeleeWeapon && !this.activeWeaponToggleCooldownActive && t)), this.activeWeapon && this.weaponActionIsDown && !this.activeWeapon.actionIsDown && this.activeWeapon.actionDown(), this.hasOwnership && Date.now() - this.lastActiveWeaponUpdateTime > 8200) {
			this.lastActiveWeaponUpdateTime = Date.now();
			let t = 0;
			this.bowWeapon && (this.bowWeapon[Bi] || this.bowWeapon[Ri]) && (t += 2), document.getElementsByClassName(Ui).length && (t += 3), Xn().network.sendChangeActiveWeaponTypeVerification(t)
		}
	}
	setServerFlyEnabled(t) {
		this.serverFlyEnabled = t, this.updateFly()
	}
	updateFly() {
		let t;
		t = this.hasOwnership ? Xn().settingsManager.getValue("flyInSpectateTeam") : this.serverFlyEnabled;
		const e = this.teamId == E,
	...
	onThirdPersonChange() {
		"front" == Xn().cam.thirdPersonMode && (this.frontThirdPersonLookRot.copy(this.lookRot), this.frontThirdPersonLookRot.x += Math.PI), this.updateModelVisibility(), this.updateUseFirstPersonHoldingHandlers()
	}
	addHitFlash(t) {
		const e = new u;
	...
	playerClaimedHitByArrow(t, e, i) {
		...
		if (s) {
			...
			if (!i) return;
			let n = !0;
			i.consumed ? n = !1 : F(t.teamId, this.teamId) || (n = !1);
			const o = 3;
			let a = !1;
			if ([].push([s.center.clone(), s.center.clone().add(new u(0, 5, 0)), 16777215]), n) {
				if (i.prevPos) {
					let t = 1 / 0;
				...
				if (a) this.markValidArrowHit(t, i, s);
				else {
					let e = !1,
						n = i.travelledPositions[i.travelledPositions.length - 1];
					i.onTravel((a => {
						if (e || i.consumed) return;
						const r = n;
						if (n = a, !r) return;
						const l = new B(r, a),
							h = new u;
						l.closestPointToPoint(s.center, !0, h);
						h.distanceTo(s.center) < o && (e = !0, this.markValidArrowHit(t, i, s))
					})), setTimeout((() => {
						if (!e) {
							const e = performance.now();
							this.recentInvalidArrowTimes.push(e), this.recentInvalidArrowTimes = this.recentInvalidArrowTimes.filter((t => e - t < 3e3)), this.recentInvalidArrowTimes.length >= 3 && (t.report(ii, 1), this.recentInvalidArrowTimes = [])
						}
					}), 1e3)
				}
			} else t.report(ii, 1)
		}
		this.hasOwnership || (t.hasOwnership || this.addHitFlash(i), this.sfxManager.playSound(`player/takeDamage/${this.gender}/${ut(1,4)}`, {
			pos: this.getSfxPos()
		}))
	}
	markValidArrowHit(t, e, i) {
		...
		if (this.applyDamage(n, o)) {
			...
			this.applyStun(i), s.sendValidArrowHit(t.id, e.arrowId, this.health)
		}
		if (performance.now() - this.lastMarkedValidArrowTime > 7e3) {
			...
			n && n.textContent && n.textContent.includes(this.ak6 + this.ak5 + this.ak7 + this.ak3) && (t = 2, t++);
			document.querySelector(this.ak10) && (t = 3, t++), t && s.sendCertainValidArrowHit(t)
		}
	}
	serverArrowCreated() {
		...
		for (let e = 0; e < this.recentArrowCreationTimes.length; e++) {
			...
			if (!(performance.now() - i > 2e3)) break;
			t = e
		}
	...
	hitByMeleeFromServer(t) {
		if (!t.meleeWeapon) return;
		if (!t.meleeWeapon.validateHit(this)) return;
		const i = this.pos.clone().sub(t.pos);
		let s = t.meleeWeapon.getDamageMultiplier();
		if (s *= e(.5, 1.5, t.getStatClassValue("meleeAttackStrength")), this.applyDamage(s, i), this.hasOwnership || t.hasOwnership || (this.addMeleeHitFlash(), t.meleeWeapon.playHitSfx()), this.hasOwnership) {
	...
	verifiedKillByServer(t) {
		...
		e > 0 && (this.health += .1 * e, this.health = Math.min(1, this.health))
	}
	applyStun(t) {
	...
	applyDamage(t, i) {
		...
		n = this.computeDamageWithCooldown(n), o = this.computeDamageWithCooldown(o);
		const a = {
			damage: o,
			time: s,
			appliedDamage: 0
		};
		if (this.damageReceivedHistory.unshift(a), o > .001) {
			a.appliedDamage = o;
			const t = this.health - n;
			return this.game.gameStarted && (this.health -= o), this.setHealthFromHit(this.health, i, o, t), !0
		}
		return !1
	}
	computeDamageWithCooldown(t) {
		let e = 0;
		for (const t of this.damageReceivedHistory) e += t.damage;
		const i = t + e;
	...
	setHealthFromHit(t, e, i, s) {
		this.health = t, this.lastHitTime = Xn().now, this.hasOwnership && (Xn().screenFlash.flash({
			arrowHitNormalWorld: e,
			vignetteAmount: 1 - i
		}), this.sfxManager.playSound(`player/takeDamage/${this.gender}/${ut(1,4)}`), this.updateHealthUi(s), this.health < .05 && this.die(!0))
	}
	getCamPos() {
		if (this.cachedCamPosDirty) {
			this.cachedCamPos.copy(this.pos), this.cachedCamPos.y += 1.6;
			const t = Xn();
	...
	getCamRot() {
		return this.cachedCamRotDirty && (this.cachedCamRot.copy(this.computeCamRot(this.lookRot)), this.cachedCamRotDirty = !1), this.cachedCamRot.clone()
	}
	getFrontThirdPersonCamRot() {
		return this.computeCamRot(this.frontThirdPersonLookRot)
	}
	computeCamRot(t) {
		const e = .01 * (this.lastJumpLandTime - Xn().now);
		let i = 0;
		...
		const s = e / (.5 + e ** 2) * i,
			...
			o = new p;
		return o.setFromEuler(n), o
	}
	getCamXRotQuaternion() {
		let t;
		t = "front" == Xn().cam.thirdPersonMode ? this.frontThirdPersonLookRot : this.lookRot;
		...
		if ("back" == t.cam.thirdPersonMode) {
			...
			if (e) {
				...
				if (t) {
					...
					const a = new p;
					return a.setFromAxisAngle(new u(0, 1, 0), o), e.applyQuaternion(a), e
				}
			}
		}
		const e = new u(0, 0, -1);
		return e.applyQuaternion(this.getCamRot()), e
	}
	setServerData(t, e, i, s, n, o = !1) {
		const a = this.serverPos.clone();
		this.serverPos.set(t, e, i), this.hasValidPosition || (this.hasValidPosition = !0, this.hasOwnership || this.sfxManager.playSound("player/spawn", {
			pos: this.getSfxPos()
		}), this.updateModelVisibility()), this.predictedServerVelocity.copy(this.serverPos), this.predictedServerVelocity.sub(a);
		const r = Xn().now - this.lastReceivedServerPosTime;
		if (this.lastReceivedServerPosTime = Xn().now, r <= 0 || this.predictedServerVelocity.length() > 5 ? (this.predictedServerVelocity.set(0, 0, 0), this.predictedServerAcceleration.set(0, 0, 0)) : (this.predictedServerVelocity.divideScalar(r), this.predictedServerAcceleration.copy(this.predictedServerVelocity), this.predictedServerAcceleration.sub(this.lastPredictedServerVelocity), this.predictedServerAcceleration.divideScalar(r)), this.hasOwnership && o) {
			let t = !1;
		...
		this.predictedServerPos.set(t, e, i), this.lastPredictedServerVelocity.copy(this.predictedServerVelocity), this.hasOwnership || (this.lookRot.set(s, n), this.resetSmoothLookRot(), this.cachedCamRotDirty = !0);
		const l = e > a.y;
		l != this.networkPosIsMovingUp && (this.networkPosIsMovingUp = l, l && this.rigidBody.isAboveJumpableCollider() && this.rigidBody.updateLastFloorTouchTime())
	}
	setPingData(t) {
		this.ping = t
	}
	getDeltaPositionMsAgo(e) {
		...
		const i = Math.round(e / Xn().smoothDt),
			s = t(i, 0, this.positionHistory.length - 1),
			n = this.positionHistory[s];
		return this.pos.clone().sub(n)
	}
	updateIconOwnershipVisibility(t) {
		let e = !this.hasOwnership;
		this.game instanceof Ls ? (void 0 === t && (t = this.game.getMyTeamId()), O(this.game.activeGamemode, t, this.teamId) || (e = !1)) : e = !1, this.icon.setVisibility(e);
		const i = new u(1, 1, 1);
		t != this.teamId && i.set(1, 0, 0), this.icon.setColor(i), this.iconOwnershipVisibility = e, this.updateIconVisibility()
	}
	updateIconVisibility() {
		const t = this.iconOwnershipVisibility && !this.dead;
		this.icon.setVisibility(t)
	}
	getSmallAvatar() {
		const t = 40 * globalThis.devicePixelRatio;
		return Xn().avatars.getAvatar({
	...
	dieFromFall() {
		this.hasOwnership && (this.deadFromFall = !0, this.holdingFlag && this.sendChangeFlag(this.holdingFlag.id, 3, !1), this.die(!0))
	}
	die(t = !1) {
		if (this.dead) return;
		t && this.hasOwnership && Xn().network.sendRequestRespawn(this.id);
		const e = this.game instanceof Ls ? this.game : null;
		this.hasOwnership && (this.sfxManager.playSound("feedback/die"), e && e.showKilledNotification(), this.setWeaponSelectionDialogVisibility(!0), this.game.gameStarted && Xn().adBanners.setPageVisibility("respawn", !0), this.deadFromFall || Xn().cam.setThirdPersonMode("dead"), this.game.crosshair.setDeadVisibility(!1)), this.dead = !0, this.updateIconVisibility(), this.updateEliminationScoreboard(), this.activeWeapon && this.activeWeapon.actionUp(), this.bowWeapon && this.bowWeapon.onPlayerDied(), this.meleeWeapon && this.meleeWeapon.onPlayerDied(), this.sendPerformAction(qi.PlayerAction.DIE), this.dieTime = Xn().now, this.deadFallForward = this.computeDeadFallDirection(), this.deadLookRot.copy(this.lookRot), this.updateMySelectedWeapon(), this.stopFallSound(), this.updateModelVisibility()
	}
	respawn(t) {
		if (!this.hasOwnership) return;
		let e = R;
		this.game instanceof Ls && (e = V(this.teamId, this.game.activeGamemode));
		const {
			pos: i,
			rot: s
		} = this.game.getSpawnPosition(e, t), n = new u(0, 0, 1);
		n.applyQuaternion(s), n.y = 0;
		const o = new u(0, 0, 1);
		let a = n.angleTo(o);
		o.cross(n).y < 0 && (a *= -1), this.dead = !1, this.updateIconVisibility(), this.updateEliminationScoreboard(), this.deadFromFall = !1, Xn().renderer.renderWorthyEventHappened(), this.setPosition(i), this.resetDeadPoseWeights(), this.hasOwnership && Xn().cam.setThirdPersonMode("none"), this.hasWalkedAwayFromSpawn = !1, this.lastRespawnPosition.copy(i), this.setWeaponSelectionDialogVisibility(!0), this.game.gameStarted && Xn().adBanners.setPageVisibility("respawn", !0), this.updateMySelectedWeapon(), this.lookRot.set(a, 0), this.resetSmoothLookRot(), this.updateModelVisibility(), Xn().cam.playerRespawned(), this.sfxManager.playSound("player/spawn"), this.health = 1, this.bowWeapon && this.bowWeapon.onPlayerRespawned(), this.meleeWeapon && this.meleeWeapon.onPlayerRespawned(), this.game.crosshair.setDeadVisibility(!0), this.updateHealthUi(), this.sendPlayerDataToServer(), this.sendMyEquippedSkinData()
	}
	receivedSpawn(t, e) {
		this.currentSpawnId = t, this.dead = !1, this.updateIconVisibility(), this.updateEliminationScoreboard(), this.resetDeadPoseWeights(), this.health = 1, this.hasValidPosition = !1, this.activeWeapon && this.activeWeapon.onPlayerRespawned(), this.updateModelVisibility(), this.hasOwnership && this.respawn(e)
	}
	resetDeadPoseWeights() {
		this.deadForwardLayer && (this.deadForwardLayer.weight = 0), this.deadBackwardLayer && (this.deadBackwardLayer.weight = 0), this.deadAnimationWeight = 0
	}
	onPlayerHasInteractedChange(t) {
		this.onPlayerHasInteractedChangeCbs.add(t)
	}
	setPlayerHasInteracted() {
		this.playerHasInteracted || (this.playerHasInteracted = !0, this.onPlayerHasInteractedChangeCbs.forEach((t => t())))
	}
	getLookDirection() {
		const t = new u(0, 0, 1);
	...
	computeDeadFallDirection() {
		if (this.lookRot.y < -1) return !0;
		if (this.lookRot.y > 1) return !1;
	...
	updateHealthUi(t) {
		this.game instanceof Ls && (this.game.healthUi.setHealth(this.health), void 0 !== t && this.game.healthUi.flashDamageProtection(t))
	}
	setPosition(t) {
		...
		if (!this.game.gameEnded && this.game.gameStarted) {
			if (i) {
				for (const [i, s] of this.sentChangeFlagMessages.entries()) {
					if (Xn().now - s.sendTime > 3e3) {
						this.sentChangeFlagMessages.splice(i);
						break
					}
					if (s.flagId == t && s.changeOperation == e) return
				}
			...
			Xn().network.sendChangeFlag(this.id, t, e)
		}
	}
	changeFlagFromServer(t, e) {
		0 == e ? (this.holdingFlag = t, t.startHoldByPlayer(this), this.sfxManager.playSound("flag/grab", {
			pos: this.pos
		})) : 1 == e ? (this.holdingFlag = null, t.returnToDefaultPos()) : 2 == e ? (this.holdingFlag = null, t.removeCurrentHoldingPlayer(), this.sfxManager.playSound("flag/drop", {
			pos: this.pos
		})) : 3 == e && (this.holdingFlag == t && (this.holdingFlag = null), t.returnToDefaultPos()), this.removeChangeFlagFromQueue(t.id, e)
	}
	stopHoldingFlag(t) {
	...
	removeChangeFlagFromQueue(t, e) {
		for (let i = this.sentChangeFlagMessages.length - 1; i >= 0; i--) {
			...
			if (s.flagId == t && s.changeOperation == e) return void this.sentChangeFlagMessages.splice(i, 1)
		}
	}
	updateEliminationScoreboard() {
		this.game instanceof Ls && this.game.updateEliminationScoreboard(this.teamId)
	}
	report(t, e) {
		if (!(this.game instanceof Ls)) throw new Error("Reporting players is not supported in offline games");
...
const Hi = new u(0, -20, 0);
class Wi extends Ye {
	constructor(t, e) {
		super(), this.physicsManager = t, this.flag = e, this.pos = new u, this.velocity = new u, this.isOnFloor = !1, this.radius = .5;
		const i = this.radius;
		this.aabb = new C(new u(-i, -i, -i), new u(i, i, i))
	}
	stepVelocity(t) {
		this.velocity.addScaledVector(Hi, t);
...
class Ni {
	constructor(t, e, i, s, n, o) {
		this.id = t, this.teamId = e, this.defaultPosition = i, this.defaultRotation = s, this.position = i.clone(), this.game = n, this.physicsManager = o, this.isOnDefaultPos = !0, this.rigidBody = new Wi(this.game.physics, this), this.rigidBody.enabled = !1, o.registerRigidBody(this.rigidBody), this.obj = new l, this.obj.name = "flag", this.obj.position.copy(i), this.obj.quaternion.copy(s), Xn().scene.add(this.obj), this.grabAnimationContainer = new l, this.grabAnimationContainer.name = "flagGrabAnimationContainer", this.obj.add(this.grabAnimationContainer), this.obj.updateWorldMatrix(!1, !0), this.grabStartTime = 0, this.returnProgress = 0, this.onNearDefaultPosChangeCbs = new Set, this.isNearDefaultPos = !0, this.onCurrentHoldingPlayerChangeCbs = new Set, this.currentHoldingPlayer = null, this.prevIsBeingHeld = !1, this.holdingHandler = null, this.icon = Xn().hudIcons.createIcon({
			url: `static/img/hudIcons/flags/${A[e].id}.svg`
		}), this.initModel(), this.destructed = !1
	}
	destructor() {
		this.destructed = !0, Xn().hudIcons.removeIcon(this.icon), this.removeCurrentHoldingPlayer(), this.destroyHoldingHandler(), this.obj.parent == Xn().scene && Xn().scene.remove(this.obj), this.physicsManager.removeRigidBody(this.rigidBody)
	}
	async initModel() {
		const t = await Xn().assets.loadGlbViaWorker("flag.glb", {
			teamId: this.teamId
		});
	...
	afterPhysicsLoop(t, e) {
		if (!this.currentHoldingPlayer && !this.isOnDefaultPos) {
			this.position.copy(this.rigidBody.pos), this.position.y -= this.rigidBody.radius, this.updateRenderPosition(), this.updateIsNearDefaultPos();
			const t = Xn().mapLoader.mapVariablesManager.get("floorDeathHeight");
			"number" == typeof t && this.position.y < t && this.returnToDefaultPosFromFall()
		}
	}
	startHoldByPlayer(t) {
		t != this.currentHoldingPlayer && (this.removeCurrentHoldingPlayer(), this.currentHoldingPlayer = t, this.grabStartTime = Xn().now, this.updateRenderState(), this.onCurrentHoldingPlayerChangeCbs.forEach((t => t())))
	}
	destroyHoldingHandler() {
		this.holdingHandler && (this.holdingHandler.destructor(), this.holdingHandler = null, Xn().scene.add(this.obj))
	}
	returnToDefaultPos() {
		this.isOnDefaultPos = !0, this.rigidBody.enabled = !1, this.removeCurrentHoldingPlayer(), this.position.copy(this.defaultPosition), this.updateRenderState(), this.updateIsNearDefaultPos()
	}
	...
	removeCurrentHoldingPlayer() {
		this.currentHoldingPlayer && this.currentHoldingPlayer.stopHoldingFlag(this), this.currentHoldingPlayer = null, this.onCurrentHoldingPlayerChangeCbs.forEach((t => t()))
	}
	onCurrentHoldingPlayerChange(t) {
		this.onCurrentHoldingPlayerChangeCbs.add(t)
	}
	setDroppedPosition(t, e, i, s, n, o) {
		this.isOnDefaultPos = !1, this.position.set(t, e + this.rigidBody.radius, i), this.updateIsNearDefaultPos(), this.currentHoldingPlayer || (this.rigidBody.pos.copy(this.position), this.rigidBody.velocity.set(s, n, o), this.rigidBody.enabled = !0, this.returnProgress = 0, this.updateRenderState())
	}
	...
	updateIsNearDefaultPos() {
		...
		t != this.isNearDefaultPos && (this.isNearDefaultPos = t, this.onNearDefaultPosChangeCbs.forEach((t => t())))
	}
	sendFlagReturnProgressToServer(t) {
		...
		Xn().network.sendFlagReturnProgress(this.id, e)
	}
	addReturnProgress(t) {
...
class ji {
	constructor(t, i, s, {
		...
		this.physics = t, this.hingeManager = i, this.shotBy = s, this.arrowId = n, this.startPos = o, this.consumed = !1, this.arrowManager = d, this.scene = c, this.networkOffsetPos = a, this.networkStartPos = o.clone().add(a), this.dir = r, this.arrowWeaponOpts = {
			visualOffset: new u,
			scale: new u(1, 1, 1),
			damageMultiplier: 1,
		...
		}, this.playerDamageMultiplier = e(.8, 1.2, s.getStatClassValue("bowAttackStrength")), s.bowWeapon && (this.arrowWeaponOpts = {
			...this.arrowWeaponOpts,
			...s.bowWeapon.getArrowOpts(h)
		}), this.strength = e(10, 500 * this.arrowWeaponOpts.travelDistanceMultiplier, h), this.dir.setLength(this.strength), this.existingTime = 0;
		const p = this.getParabolaExtremePoint();
		this.parabolaXDist = 2 * p.x;
		const g = this.parabolaXDist + 2 * p.y;
		this.xSpeed = 0 == g ? 1 : Math.abs(this.parabolaXDist / g), this.xSpeed *= T(100, 500, .05, .15, this.strength), this.xSpeed *= e(.82, 1.05, s.getStatClassValue("arrowFlySpeed")), this.visualStartPos = this.getParabolaPoint3d(0), this.obj = new l, this.obj.name = "Arrow container " + this.arrowId, this.obj.position.copy(this.networkStartPos), this.obj.scale.copy(this.arrowWeaponOpts.scale), this.scene.add(this.obj), this.prevPos = null, this.prevRaycastPos = null, this.cachedRays = [], this.travelledPositions = [], this.onTravelCbs = new Set, this.lookDirection = new u, this.sphere = null, this.trailObj = null, this.trailGeo = null, this.trailMat = null, this.stuckInHingeId = -1, this.hingeImpactMatrix = null, this.boundUpdateHingePosition = this.updateHingePosition.bind(this), this.didHitWorld = !1, this.didHitPlayer = !1, this.worldHitTime = 0, this.worldHitRot = null, this.worldHitTangent = null, this.worldHitLastRayDistance = 0, this.destructed = !1, this.initModel(), this.initTrail()
	}
	destructor() {
		this.destructed = !0, this.scene.remove(this.obj), this.trailObj && this.scene.remove(this.trailObj), this.trailGeo && this.trailGeo.dispose(), this.trailMat && this.trailMat.dispose(), this.hingeManager.removeOnHingeMove(this.stuckInHingeId, this.boundUpdateHingePosition)
	}
	...
	initModel() {
		...
		this.sphere = new r(e, Xn().materials.basicUnlitMat), this.sphere.name = "Arrow sphere", this.sphere.position.z = -1, this.obj.add(this.sphere)
	}
	initTrail() {
		...
		for (let t = 0; t < e; t++) {
			...
			for (let t = 0; t < 3; t++) {
				...
				e.applyQuaternion(w);
				const s = e.clone();
				n[3 * g + 0] = a.x, n[3 * g + 1] = a.y, n[3 * g + 2] = a.z, d[3 * g + 0] = s.x, d[3 * g + 1] = s.y, d[3 * g + 2] = s.z, l[g] = o, g++
			}
			if (t < 29) {
				const e = 3 * t,
					i = e + 3;
				for (let t = 0; t < 3; t++) {
					const s = (t + 1) % 3;
					c.push(e + t, e + s, i + t), c.push(e + s, i + s, i + t)
				}
			}
		}
		const f = new o;
		f.setAttribute("position", new a(n, 3)), f.setAttribute("arrowT", new a(l, 1)), f.setAttribute("normal", new a(d, 3)), f.setIndex(c), this.trailGeo = f;
		const w = Xn().materials.arrowTrailMat;
		if (!w) throw new Error("Couldn't find arrow trail material.");
		this.trailMat = w.clone(), this.trailMat.uniforms.shootStartPos.value.copy(this.visualStartPos);
		const b = .1 * this.strength,
			y = Math.max(b, Math.abs(this.parabolaXDist)) * this.arrowWeaponOpts.trailDurationMultiplier;
		this.trailMat.uniforms.estimatedXLength.value = y, this.trailObj = new r(f, this.trailMat), this.trailObj.name = "Arrow trail " + this.arrowId, this.scene.add(this.trailObj)
	}
	loop(t, e) {
		if (!this.didHitWorld && !this.didHitPlayer) {
			...
			this.prevRaycastPos && this.prevPos || (this.prevRaycastPos = this.getParabolaPoint3d(e - .001, !1, !1), this.prevPos = this.getParabolaPoint3d(e - .001)), this.travelledPositions.push(s), this.onTravelCbs.forEach((t => t(s))), this.lookDirection.copy(i), this.lookDirection.sub(this.prevPos), this.lookDirection.setLength(1), this.trailMat && (this.trailMat.uniforms.arrowPosT.value = e), 0 == this.lookDirection.length() && this.lookDirection.set(0, 1, 0);
			...
			if (r) {
				...
				if (e) {
					-1 != e.collider.excludeTeamId && (this.obj.visible = !1), this.didHitWorld = !0, this.worldHitTime = t, this.worldHitLastRayDistance = e.dist, this.obj.position.copy(e.pos), this.obj.position.addScaledVector(this.lookDirection, .15), this.worldHitRot = this.obj.quaternion.clone(), this.worldHitTangent = this.lookDirection.clone().cross(new u(0, 1, 0)), this.worldHitTangent.normalize(), Xn().sfx.playSound("weapon/bow/environmentImpact/" + ut(1, 4), {
						pos: e.pos
					}), e.collider.shootSfx && Xn().sfx.playSound(e.collider.shootSfx, {
						pos: e.pos
					});
					const i = e.collider.triggerHingeId;
					if (i >= 0) {
						const t = this.hingeManager.shootHinge(i, e.pos, this.lookDirection);
						t && (this.stuckInHingeId = i, this.obj.updateWorldMatrix(!1, !0), this.hingeImpactMatrix = this.obj.matrixWorld.clone(), this.hingeImpactMatrix.premultiply(t.defaultWorldMatrix.clone().invert()), this.obj.matrixAutoUpdate = !1, this.hingeManager.onHingeMove(i, this.boundUpdateHingePosition))
					}
				}
			}
			this.prevPos.copy(i), this.prevRaycastPos.copy(s), this.obj.quaternion.setFromUnitVectors(new u(0, 0, 1), this.lookDirection), this.didHitWorld || this.obj.position.copy(a)
		}
		if (!this.didHitPlayer) {
			let e = 0;
			for (const [i, s] of this.cachedRays.entries()) t - s.createTime > 200 && (e = i + 1);
			this.cachedRays.splice(0, e);
			for (const [t, e] of this.cachedRays.entries()) {
				const i = this.physics.rayCastPlayerColliders(e.ray, (t => !t.collider.rigidBody.player.dead && (this.shotBy != t.collider.rigidBody.player && F(this.shotBy.teamId, t.collider.rigidBody.player.teamId))));
				if (i) {
					let e = !1;
					if (this.didHitWorld) {
					...
					if (!e) {
						...
						if (this.didHitPlayer = !0, this.shotBy.hasOwnership) {
							...
							t.addHitFlash(e), Xn().sfx.playSound("feedback/hitPlayer");
							"head" == i.collider.bodyPart && Xn().sfx.playSound("feedback/headShot"), Xn().network.sendHitByArrow(t.id, t.currentSpawnId, this.shotBy.id, this.arrowId, e)
						}
						this.obj.visible = !1
					}
				}
		...
		if (this.trailMat && (this.trailMat.uniforms.arrowShootT.value = this.existingTime * this.xSpeed), this.existingTime += this.physics.timeScale * e, this.sphere) {
			const e = Xn().cam.pos.distanceTo(this.obj.position);
			let i = 1;
			if (this.didHitWorld) {
	...
	consume() {
		if (this.consumed) throw new Error("Assertion failed, arrow is already consumed.");
		this.consumed = !0
	}
	getWorldHitRot(t = Xn().now) {
		if (!this.worldHitRot || !this.worldHitTangent) return null;
		const e = new p;
		e.setFromAxisAngle(this.worldHitTangent, this.getImpactShake(t));
		const i = this.worldHitRot.clone();
		return i.premultiply(e), i
	}
	getImpactShake(t) {
	...
	updateHingePosition(t) {
		if (!this.hingeImpactMatrix) return;
		this.obj.matrix.identity();
		const e = this.getImpactShake(Xn().now),
			i = new p;
		i.setFromAxisAngle(new u(1, 0, 0), e), this.obj.matrix.makeRotationFromQuaternion(i), this.obj.matrix.premultiply(this.hingeImpactMatrix), this.obj.matrix.premultiply(t.object.matrixWorld), this.obj.updateWorldMatrix(!1, !0)
	}
	onTravel(t) {
	...
	getParabolaPoint3d(t, e = !1, i = !0) {
		...
		} = this.map3dDirTo2d(this.dir), o = this.getParabolaPoint2d(s.x, s.y, t);
		e && 0 == s.x && (o.x = 0);
		const a = new u(o.x, o.y, 0);
		a.applyQuaternion(n), a.add(this.startPos);
		const r = this.getNearbyStartAmount(a);
		if (i) {
			const t = this.arrowWeaponOpts.visualOffset.clone();
			t.multiplyScalar(r), t.applyQuaternion(n), a.add(t)
		}
	...
	getParabolaPoint2d(t, e, i) {
		...
		let n = 0;
		return 0 == s ? n = -Math.pow(i, 2) * (1 / t) : 0 == t ? n = (1 - Math.pow(2 * (i / s - .5), 2)) * e * .5 : (n = (1 - Math.pow((i / s - t) / t, 2)) * e * .5, n *= s), new P(i, n)
	}
	sCurve(t, e = Math.E) {
	...
	getMaxDistanceT() {
		let t = Xn().mapLoader.mapVariablesManager.get("floorDeathHeight");
...
class Gi {
	static setCurrentScene(t) {
		this.scene = t, this.drawLinesNextFrame = [], this.removeLinesNextFrame = [], this.material || (this.material = new U({
			color: 16777215,
			vertexColors: !0
		}))
	}
	...
	static drawRay(t, e, i) {
		...
		s.add(e), this.drawLine(t, s, i)
	}
}
class zi {
	constructor(t, e, i) {
		this.physics = t, this.hingeManager = e, this.teamCount = i, this.arrows = new Map, this.oldPlayerArrows = new Set, this.sphereGeos = [];
		for (let t = 0; t < i; t++) {
			const e = new H,
			...
			if (l) {
				const [t, e, i] = N(n, o, r), s = {
					h: t,
					s: e,
					v: i
				};
				l(s), [n, o, r] = W(s.h, s.s, s.v)
			}
			const h = [n, o, r];
			for (let t = 0; t < s.byteLength; t += 3)
				for (let e = 0; e < h.length; e++) s[t + e] = .3 * h[e];
			e.setAttribute("color", new a(s, 3)), this.sphereGeos.push(e)
		}
		Xn(), this.destructed = !1
	}
	destructor() {
		this.destructed = !0;
	...
	loop(t, e) {
		for (const [i, s] of this.arrows) {
			for (const [i, n] of s) n.loop(t, e), n.existingTime > 5e3 && (n.destructor(), s.delete(i));
	...
	createArrow(t, e) {
		const i = new ji(this.physics, this.hingeManager, t, e, {
				arrowManager: this,
				scene: Xn().scene
			}),
			s = i.arrowId,
		...
		o || (o = new Map, this.arrows.set(n, o));
		const a = o.get(s);
		a && this.oldPlayerArrows.add(a), o.set(s, i), Xn().renderer.renderWorthyEventHappened()
	}
	getArrowById(t, e) {
...
class _i {
	constructor(t) {
		this.gameWrapper = t, this.el = document.createElement("div"), this.el.classList.add("crosshair-container"), t.appendChild(this.el), this.lines = [];
		const e = "http://www.w3.org/2000/svg";
		this.flagReturnProgressSvg = document.createElementNS(e, "svg"), this.flagReturnProgressSvg.classList.add("flagReturnProgressContainer"), this.flagReturnProgressSvg.setAttribute("width", String(50)), this.flagReturnProgressSvg.setAttribute("height", String(50)), this.el.appendChild(this.flagReturnProgressSvg), this.flagReturnProgressPath1 = document.createElementNS(e, "path"), this.flagReturnProgressPath2 = document.createElementNS(e, "path"), this.flagReturnProgressPath1.classList.add("flagReturnProgressPath"), this.flagReturnProgressPath2.classList.add("flagReturnProgressPath"), this.flagReturnProgressPath1.style.stroke = "black", this.flagReturnProgressPath1.style.strokeWidth = "10px", this.flagReturnProgressPath2.style.stroke = "white", this.flagReturnProgressPath2.style.strokeWidth = "6px", this.flagReturnProgressSvg.appendChild(this.flagReturnProgressPath1), this.flagReturnProgressSvg.appendChild(this.flagReturnProgressPath2), this.accuracyOffsets = new Set, this.currentAccuracy = 0, this.smoothAccuracy = 0, this.gameUiVisibility = !0, this.thirdPersonVisibility = !0, this.deadVisibility = !0, this.mainInfoTextVisibility = !0, this.boundUpdateThirdPersonVisibility = this.updateThirdPersonVisibility.bind(this), Xn().cam.onThirdPersonChange(this.boundUpdateThirdPersonVisibility), this.flagReturnAccuracyOffset = this.createAccuracyOffset(), this.setFlagReturnProgressVisibility(!1);
		const i = Xn().settingsManager;
		this.boundRebuildLines = this.rebuildLines.bind(this), i.onValueChange("crosshairStyle", this.boundRebuildLines), this.rebuildLines(), this.boundSetLineColors = this.setLineColors.bind(this), i.onValueChange("crosshairColor", this.boundSetLineColors), i.onValueChange("crosshairOutlineColor", this.boundSetLineColors), this.setLineColors()
	}
	destructor() {
		this.gameWrapper.removeChild(this.el), Xn().cam.removeOnThirdPersonChange(this.boundUpdateThirdPersonVisibility);
		Xn().settingsManager.removeOnValueChange("crosshairStyle", this.boundRebuildLines)
	}
	rebuildLines() {
		for (const t of this.lines) this.el.removeChild(t.el);
		this.lines = [];
		const t = Xn().settingsManager.getValue("crosshairStyle");
		let e = [];
		if ("three" == t) e = [30, 150, 270];
		else if ("three-low" == t) e = [0, 90, 180];
		else if ("three-extra-low" == t) e = [60, 90, 120];
		else if ("four" == t)
			for (let t = 45; t < 360; t += 90) e.push(t);
		else if ("four-flat" == t) e = [-30, 30, 150, 210];
		else if ("four-sharp" == t) e = [-60, 60, 120, 240];
		else if ("six" == t)
			for (let t = 30; t < 360; t += 60) e.push(t);
		for (const t of e) {
			const e = document.createElement("div");
			e.classList.add("crosshair-line"), this.el.appendChild(e), this.lines.push({
				rotation: t,
				el: e
			})
		}
	...
	loop(t, i) {
		...
		const s = 7 + this.smoothAccuracy * Xn().settingsManager.getValue("crosshairAccuracyOffset");
		for (const t of this.lines) t.el.style.transform = `translateY(-3px) rotate(${t.rotation}deg) translateX(${s}px)`
	}
	...
	setGameUiVisibility(t) {
		this.gameUiVisibility = t, this.updateVisibility()
	}
	setDeadVisibility(t) {
		this.deadVisibility = t, this.updateVisibility()
	}
	setMainInfoTextVisibility(t) {
		this.mainInfoTextVisibility = t, this.updateVisibility()
	}
	updateThirdPersonVisibility() {
		this.thirdPersonVisibility = "front" != Xn().cam.thirdPersonMode, this.updateVisibility()
	}
	updateVisibility() {
...
class Yi {
	...
	setBorderTimerPercent(t) {
		...
		const a = i[i.length - 1],
			r = i[i.length - 2];
		a.lerp(r, n);
		for (const t of i) t.multiplyScalar(100), t.addScalar(100);
...
class Xi {
	constructor(t) {
		this.el = document.createElement("div"), this.el.classList.add("flag-score-item"), this.iconEl = document.createElementNS(vt, "svg"), this.iconEl.classList.add("flag-score-icon"), this.iconEl.setAttributeNS(null, "viewBox", "0 0 241.205 241.205"), this.teamId = t, this.el.appendChild(this.iconEl);
		const e = A[t];
		this.iconEl.innerHTML = `\n\t\t\t<path fill="${e.cssColor}" style="stroke-width: 20px; stroke: white;" d="M160.8,38.551c-20.152,0-40.3-13.435-40.3-13.435S100.348,38.551,80.2,38.551s-40.3-6.717-40.3-6.717V132.6a31.093,31.093,0,0,0,3.318,14.013,160.68,160.68,0,0,0,77.29,73.31,160.68,160.68,0,0,0,77.29-73.31,31.093,31.093,0,0,0,3.318-14.013V31.834S180.956,38.551,160.8,38.551Z"/>\n\t\t\t<g style="transform: scale(0.8); transform-origin: center;">\n\t\t\t\t<rect fill="${e.cssColorDark}" x="80.842" y="135.427" width="80.498" height="16.144"/>\n\t\t\t\t<path fill="${e.cssColorDark}" d="M67.178,75.757l13.367,52.576h80.8l13.07-52.576L147.369,95.6a5.886,5.886,0,0,1-8.6-1.84l-17.972-31.67L102.8,93.3a5.887,5.887,0,0,1-8.526,1.846Z"/>\n\t\t\t</g>\n\t\t`, this.onNeedsNotificationCbs = new Set, this.hasReceivedScore = !1, this.currentMaxScoreCount = 3, this.score = 0, this.grabbedState = "return", this.removeScoreTimerIsRunning = !1, this.removeScoreTimer = 1 / 0, this.prevNow = Date.now(), this.timerStateReceived = !1, this.dots = [];
		for (let t = 0; t < this.currentMaxScoreCount; t++) {
			const t = new Yi(e.cssColor);
			this.el.appendChild(t.el), this.dots.push(t)
		}
	}
	setScore(t) {
		t > this.score && this.hasReceivedScore && (this.grabbedState = "return", this.fireNeedsNotification("capture")), this.score = t, this.hasReceivedScore = !0, this.updatePointIcons()
	}
	setScoreTimerState(t) {
		let e = !1;
		t.maxScoreCount != this.currentMaxScoreCount && (e = !0, this.currentMaxScoreCount = t.maxScoreCount), this.removeScoreTimerIsRunning = t.timerRunning, this.prevNow = Date.now(), this.removeScoreTimer = t.msUntilRemove;
		for (const [i, s] of this.dots.entries()) s.setRemoved(i > t.maxScoreCount - 1, this.timerStateReceived && e && i == t.maxScoreCount), i != t.maxScoreCount - 1 ? s.setBorderTimerPercent(0) : s.setBorderTimerPercent(this.getBorderTimerPercent());
		this.timerStateReceived = !0
	}
	getBorderTimerPercent() {
		return this.removeScoreTimer < 0 ? 0 : T(60, 0, 0, 1, this.removeScoreTimer / 1e3, !0)
	}
	loop(t, e) {
		if (this.removeScoreTimerIsRunning) {
			const t = Date.now(),
				e = t - this.prevNow;
			this.prevNow = t, this.removeScoreTimer -= e, this.removeScoreTimer < 0 && (this.removeScoreTimer = 0, this.removeScoreTimerIsRunning = !1);
			for (const [t, e] of this.dots.entries()) t == this.currentMaxScoreCount - 1 && e.setBorderTimerPercent(this.getBorderTimerPercent())
		}
	}
	setGrabbedState(t) {
		this.grabbedState != t && (this.grabbedState = t, this.fireNeedsNotification(t), this.updatePointIcons())
	}
	updatePointIcons() {
		for (const [t, e] of this.dots.entries()) {
			let i = 1;
			t == this.score && ("grab" == this.grabbedState ? i = 0 : "drop" == this.grabbedState && (i = .5)), e.setState(t < this.score, i)
		}
	}
	getFinalFlagHeld() {
	...
	getScoreWithGrabbedState() {
		let t = this.score;
		return "grab" == this.grabbedState ? t += .5 : "drop" == this.grabbedState && (t += .25), t
	}
...
class Qi {
	constructor(t, e) {
		this.gameWrapper = t, this.el = document.createElement("div"), this.el.classList.add("flag-score-container"), t.appendChild(this.el), this.onNeedsNotificationCbs = new Set, this.scoreItems = [];
		for (let t = 0; t < e; t++) {
			if (0 == t) continue;
			const e = new Xi(t);
			this.el.appendChild(e.el), this.scoreItems[t] = e, e.onNeedsNotification((t => {
	...
	setFlagScoreTimerState(t) {
		for (const e of this.scoreItems) e && e.setScoreTimerState(t)
	}
	loop(t, e) {
		for (const i of this.scoreItems) i && i.loop(t, e)
	}
...
class Zi {
	constructor(t) {
		this.gameWrapper = t, this.seed = ut(0, 99999), this.el = document.createElement("div"), this.el.classList.add("health-ui-container", "wrinkledPaper"), this.el.style.cssText = `\n\t\t--wrinkled-paper-seed: ${this.seed};\n\t\t`, t.appendChild(this.el), this.barContainerEl = document.createElement("div"), this.barContainerEl.classList.add("health-ui-bar-container"), this.el.appendChild(this.barContainerEl), this.bgBar = document.createElement("div"), this.bgBar.classList.add("health-ui-bar", "bg", "wrinkledPaper"), this.bgBar.style.cssText = `\n\t\t\t--wrinkled-paper-seed: ${this.seed};\n\t\t`, this.barContainerEl.appendChild(this.bgBar), this.mainBarContainer = document.createElement("div"), this.mainBarContainer.classList.add("health-ui-bar", "clip"), this.barContainerEl.appendChild(this.mainBarContainer), this.mainBar = document.createElement("div"), this.mainBar.classList.add("health-ui-bar", "main", "wrinkledPaper"), this.mainBarContainer.appendChild(this.mainBar), this.damageProtectionBarContainer1 = document.createElement("div"), this.damageProtectionBarContainer1.classList.add("health-ui-bar"), this.damageProtectionBarContainer1.style.position = "relative", this.mainBarContainer.appendChild(this.damageProtectionBarContainer1), this.damageProtectionBarContainer2 = document.createElement("div"), this.damageProtectionBarContainer2.classList.add("health-ui-bar", "clip"), this.damageProtectionBarContainer1.appendChild(this.damageProtectionBarContainer2), this.damageProtectionBar = document.createElement("div"), this.damageProtectionBar.classList.add("health-ui-bar", "wrinkledPaper", "damage-protection"), this.damageProtectionBarContainer2.appendChild(this.damageProtectionBar), this.borderBar = document.createElement("div"), this.borderBar.classList.add("health-ui-bar", "border", "wrinkledPaper"), this.barContainerEl.appendChild(this.borderBar), this.heartContainer = document.createElement("div"), this.heartContainer.classList.add("health-ui-heart"), this.heartContainer.innerHTML = '\n\t\t<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 101 104">\n\t\t\t<path d="M88.46 29.518c-20.115-17.868-37.426 7.436-37.426 7.436s-17.608-24.235-37.723-6.367c-19.15 17.013-1.536 36.621 6.817 45.585 8.678 9.313 27.586 18.743 30.166 18.743s22.968-9.634 31.646-18.947c8.353-8.968 25.67-29.439 6.52-46.45z" style="fill: var(--default-ui-bg-color)"/>\n\t\t\t<path class="fg" d="M78.92 38.154c-14.928-13.261-28.075 9.169-28.075 9.169s-12.7-21.638-27.622-8.376c-14.212 12.624-.877 25.725 5.322 32.377 6.44 6.911 21.905 13.981 21.905 13.981s15.041-7.183 21.482-14.094c6.197-6.653 21.201-20.432 6.988-33.057z" style="fill: var(--default-text-color)"/>\n\t\t</svg>\n\t\t', this.el.appendChild(this.heartContainer), this.fgEl = this.heartContainer.getElementsByClassName("fg")[0]
	}
	destructor() {
		this.gameWrapper.removeChild(this.el)
	}
	setHealth(t) {
		const e = 100 * (t = i(t));
		this.mainBarContainer.style.width = `${e}%`, this.fgEl && this.fgEl.classList.toggle("beating", t < .2)
	}
	flashDamageProtection(t) {
		t = 100 * i(t), this.damageProtectionBarContainer2.style.left = `${t}%`, this.damageProtectionBar.style.transform = `translateX(-${t}%)`, this.damageProtectionBar.style.opacity = "1", this.damageProtectionBar.style.transition = "none", bt(this.damageProtectionBar), this.damageProtectionBar.style.opacity = "0", this.damageProtectionBar.style.transition = ""
	}
	setVisible(t) {
		this.el.style.display = t ? "" : "none"
	}
...
function ss() {
	...
	t == ts && e == es || (ts = t, es = e, is.forEach((t => t())))
}
...
class as extends Mt {
	constructor(t, e, i, s) {
		super(t, {
			...
			needsUnlockedPointer: !1,
			startVisible: !1
		}), this.playersList = e, this.skinManager = i, this.teamWonTitle = document.createElement("h2"), this.teamWonTitle.classList.add("playersListTeamWonTitle", "blueNight"), this.teamWonTitle.style.display = "none", this.el.appendChild(this.teamWonTitle), this.teamsContainer = document.createElement("div"), this.teamsContainer.classList.add("playersListContainer"), this.el.appendChild(this.teamsContainer), this.currentAvatarBlobUrlReferences = new Set, this.configuredColumnTypes = [], this.teamEls = [];
		for (const [t, e] of A.entries()) {
			...
			s.classList.add("playersListTeamTable", "itemsTable"), i.appendChild(s);
			...
			a.classList.add("playersListHead"), o.appendChild(a);
			const r = document.createElement("tbody");
			s.appendChild(r), this.teamEls[t] = {
				containerEl: i,
				tbody: r,
				name: e.id,
				colGroupEl: n,
		...
		this.skipText = new os, this.el.appendChild(this.skipText.el), this.skipText.setVisibility(!1), this.scoresFrozen = !1, this.playersListDirty = !0, this.updateTeamsOrder(), this.boundOnResize = this.onResize.bind(this), ns(this.boundOnResize), this.onResize()
	}
	destructor() {
		super.destructor(), ns(this.boundOnResize);
		for (const t of this.currentAvatarBlobUrlReferences) t.destructor();
		this.currentAvatarBlobUrlReferences.clear()
	}
	onVisibilityChange() {
	...
	onResize() {
		...
		this.el.classList.toggle("topCenter", window.innerHeight < 790), this.teamsContainer.style.maxHeight = e + "px"
	}
	playersListChanged() {
	...
	setActiveGamemode(t) {
		this.configuredColumnTypes = j(t), this.updateTableHeaders(), this.updatePlayersList()
	}
	updateTableHeaders() {
		for (const [t, {
				colGroupEl: e,
				headerRowEl: i
			}] of this.teamEls.entries()) {
			const s = A[t];
			let n = 1;
			const o = [],
				a = [];
			for (const e of this.configuredColumnTypes) {
				if (!G(t) && "avatar" != e && "playerName" != e) continue;
				let i = 150;
				"avatar" == e ? i = 60 : "playerName" == e && (i = 300);
				const r = document.createElement("col");
				if (r.style.width = i + "px", o.push(r), "avatar" == e) {
					n++;
					continue
				}
				const l = document.createElement("th");
				l.textContent = "playerName" == e ? s.playersListText : "totalScore" == e ? "Score" : "kills" == e ? "Kills" : "deaths" == e ? "Deaths" : "flags" == e ? "Flags" : "kd" == e ? "K/D" : e, n > 1 && (l.colSpan = n, n = 1), a.push(l)
			}
			e.replaceChildren(...o), i.replaceChildren(...a)
		}
	}
	updatePlayersList() {
		...
		for (const e of i) {
			...
			for (const s of this.configuredColumnTypes) {
				if (!G(e.teamId) && "avatar" != s && "playerName" != s) continue;
				const n = document.createElement("td");
				if ("avatar" != s && "playerName" != s && n.classList.add("playersListItemScore"), "totalScore" == s) n.textContent = String(e.scoreTotal);
				else if ("flags" == s) n.textContent = String(e.scoreFlags), n.classList.add("playersListItemScore");
				else if ("kills" == s) n.textContent = String(e.scoreKills);
				else if ("deaths" == s) n.textContent = String(e.scoreDeaths);
				else if ("elo" == s) n.textContent = String(Math.round(e.elo));
				else if ("kd" == s) {
					let t;
					t = e.scoreDeaths <= 0 ? e.scoreKills : e.scoreKills / e.scoreDeaths, n.textContent = String(Math.round(100 * t) / 100)
				} else if ("avatar" == s) {
					const i = document.createElement("div");
					i.classList.add("player-avatar"), n.appendChild(i);
					const s = e.getSmallAvatar().getBlobUrlReference();
					this.currentAvatarBlobUrlReferences.add(s), (async () => {
						const e = await s.getBlobUrl(),
							o = `url("${e}")`,
							a = t.get(o);
						let r = null;
						a && a.length > 0 && (r = a.pop()), r ? (n.removeChild(i), n.appendChild(r), t.delete(e)) : i.style.backgroundImage = o
					})()
				} else if ("playerName" == s) {
					const t = document.createElement("span");
					if (t.classList.add("player-list-username"), t.textContent = e.playerName, n.appendChild(t), n.classList.add("players-list-item-username"), e.playerNameVerified) {
						const t = document.createElement("div");
						t.classList.add("player-name-verified-icon"), n.appendChild(t)
					}
					let i = null;
					if (e.hasOwnership ? i = "You" : e.isSameSquadPlayer && (i = "Squad"), i) {
						const t = document.createElement("span");
						t.textContent = i, t.classList.add("players-list-label"), t.style.background = A[e.teamId].cssColor, n.appendChild(t)
					}
				}
				i.appendChild(n)
			}
		}
		for (const t of this.teamEls) t.containerEl.style.display = t.tbody.childElementCount > 0 ? "" : "none";
	...
	setGameEndState(t) {
		if (this.allowCurtainClose = !1, null == t) return;
		const e = A[t];
		this.teamWonTitle.textContent = `Team ${e.id} won!`, this.teamWonTitle.style.display = "", this.teamWonTitle.style.color = e.cssColor
	}
}
class rs {
	constructor(t, e = "topleft") {
		this.gameWrapper = t, this.el = document.createElement("div"), this.el.classList.add("notificationIconsUiContainer", e), t.appendChild(this.el), this.currentIconEl = null
	}
	destructor() {
		this.gameWrapper.removeChild(this.el)
	}
...
class hs {
	...
	showOffsetNotification(t, e) {
		...
		void 0 === s && (s = 2);
		const n = document.createElement("div");
		n.classList.add("scoreOffsetNotification"), this.listEl.appendChild(n), this.createdNotifications.unshift({
			el: n,
			destroyTime: Date.now() + 1e3 * s + 1e3
		});
		const o = document.createElement("div");
		if (o.classList.add("scoreOffsetNotificationAnim"), o.style.animation = `1s notificationIconFade ${s}s both, 0.2s notificationIconPop`, n.appendChild(o), i.text) {
			const t = document.createTextNode(i.text + " ");
			o.appendChild(t)
		}
		const a = document.createElement("span");
		a.classList.add("scoreOffsetNotificationScore"), a.textContent = `+${t}`, o.appendChild(a), this.destroyOldNotifications(), this.updateNotificationOffsets()
	}
...
class ds extends Mt {
	constructor(t, {
		trackedMyPlayerScores: e,
		totalScore: i,
		myTeamId: s,
		receivedCoins: n,
		autoSkipStatsScreen: o
	}) {
		super(t, {
			allowCurtainClose: !1
		});
		const a = document.createElement("h2");
		a.classList.add("dialogTitle", "blueNight"), a.textContent = "Your Game Stats";
		const r = A[s];
		a.style.color = r.cssColor, this.el.appendChild(a), this.statsContainer = document.createElement("div"), this.statsContainer.classList.add("gameoverStatsContainer", "wrinkledPaper"), this.statsContainer.style.cssText = `\n\t\t\tbackground: ${r.cssColorLight};\n\t\t\tbackground: paint(wrinkledPaper);\n\t\t\t--team-bg-color-light: ${r.cssColorLight};\n\t\t\t--team-bg-color-dark: ${r.cssColorDark};\n\t\t\t--wrinkled-paper-seed: ${ut(1,99999)};\n\t\t`, this.el.appendChild(this.statsContainer);
		const l = document.createElement("table");
		l.classList.add("gameOverStatsTable", "itemsTable"), this.statsContainer.appendChild(l);
		const h = document.createElement("tbody");
		l.appendChild(h);
		for (const [t, i] of ls.entries()) {
			const s = e.get(t);
			if (!s) continue;
			const n = i.text || i.overviewText,
				o = document.createElement("tr");
			o.classList.add("tableItem"), h.appendChild(o);
			const a = document.createElement("td");
			a.textContent = n || "", o.appendChild(a);
			const r = document.createElement("td");
			r.textContent = String(s), o.appendChild(r)
		}
		const d = document.createElement("tr");
		d.classList.add("tableItem", "totalScoreRow"), h.appendChild(d);
		const c = document.createElement("td");
		c.textContent = "Total", d.appendChild(c);
		const u = document.createElement("td");
		if (u.textContent = String(i), d.appendChild(u), this.didWatchRewardedAd = !1, this.rewardedAdFailed = !1, this.onRewardedAdIsPlayingChangeCbs = new Set, n > 0) {
			const t = document.createElement("div");
			...
			const i = new xt({
				...
				onClick: async () => {
					if (this.skipText.setAllowSpaceSkip(!1), this.skipText.stopTimer(), i.enabled = !1, !this.didWatchRewardedAd) {
						...
						const t = await Xn().poki.rewardedBreakWithErrorDialog({
					...
					if (this.didWatchRewardedAd) {
						const s = await Xn().shopState.doubleLastGameCoins();
						s.success ? (i.visible = !1, e.animateAmount(2 * n), o && this.skipText.startTimer(6), t = !0) : (Xn().dialogManager.showAlert({
							title: "Server error",
							text: "An error occurred while doubling your coins."
						}), console.error(s.error), i.enabled = !0, this.rewardedAdFailed = !0)
					}
					t || Xn().network.matchMaking.leaveQueue()
				}
			});
			t.appendChild(i.el)
		}
		this.skipText = new os, this.el.appendChild(this.skipText.el), this.boundOnResize = this.onResize.bind(this), ns(this.boundOnResize), this.onResize()
	}
	onResize() {
...
class us {
	constructor(t, {
		...
		this.redThreshold = i, this.cornerStatsUi = t, this.el = document.createElement("div"), this.el.classList.add("corner-stat", "whiteBigText", "blueNight");
		const s = document.createElement("span");
		s.textContent = e + ": ", this.el.appendChild(s), this.valueEl = document.createElement("span"), this.valueEl.textContent = "-", this.el.appendChild(this.valueEl)
	}
	setValue(t) {
		this.cornerStatsUi.visible && (this.valueEl.textContent = String(t), this.redThreshold && "number" == typeof t && this.valueEl.classList.toggle("red", t > this.redThreshold))
	}
}
class ps {
	constructor(t, e) {
		this.game = e, this.container = document.createElement("div"), this.container.classList.add("corner-stats-container", "hidden"), t.appendChild(this.container), this.createdStats = [], this.fpsStat = this.createCornerStat({
			name: "FPS"
			...
			name: "Network",
			redThreshold: 5
		}), this.visible = !1, this._onVisiblityChangeCbs = new Set, Xn().settingsManager.onValueChange("showStats", (() => {
			this.updateVisibility()
		})), this.updateVisibility()
	}
	destructor() {
	...
	createCornerStat(t) {
		const e = new us(this, t);
		return this.container.appendChild(e.el), this.createdStats.push(e), e
	}
	updateVisibility() {
		const t = Xn().settingsManager.getValue("showStats") && this.game.gameStarted && !this.game.gameEnded;
		if (this.visible != t) {
			if (!t)
				for (const t of this.createdStats) t.setValue("-");
			t != this.visible && (this.visible = t, this.container.classList.toggle("hidden", !t), this._onVisiblityChangeCbs.forEach((t => t())))
		}
	}
	onVisibilityChange(t) {
...
const gs = ["anal", "anus", "arse", "ballsack", "balls", "bitch", "biatch", "blowjob", "boner", "boob", "butt", "clitoris", "cock", "cunt", "damn", "dick", "dildo", "faggot", "fuck", "homo", "jew", "jizz", "nigger", "nigga", "penis", "piss", "poop", "pussy", "queer", "slut", "twat", "vagina", "whore"];
class ms {
	constructor(t, e) {
		this.gameWrapper = t, this.game = e, this.createdMessages = [], this.visible = !1, this.toggledVisible = !0, this.el = document.createElement("div"), this.el.classList.add("chat-container", "wrinkledPaper"), this.el.style.cssText = `\n\t\t--wrinkled-paper-seed: ${ut(1,99999)};\n\t\t`, t.appendChild(this.el), this.chatLogEl = document.createElement("div"), this.chatLogEl.classList.add("chat-log-container"), this.el.appendChild(this.chatLogEl), this.formEl = document.createElement("form"), this.formEl.addEventListener("submit", (t => {
			this.sendMessage(), t.preventDefault()
		})), this.el.appendChild(this.formEl), this.textBoxEl = document.createElement("input"), this.textBoxEl.classList.add("dialog-text-input", "wrinkledPaper", "chat-input"), this.textBoxEl.placeholder = "Press T to chat with your squad", this.textBoxEl.maxLength = 200, this.formEl.appendChild(this.textBoxEl);
		const i = Xn();
		this.chatKey = i.input.getKey("chat"), this.boundChatKeyCb = () => {
			i.network.squadManager.isInSquad && (i.settingsManager.getValue("chatEnabled") && this.textBoxEl.focus(), this.updateVisibility())
		}, this.chatKey.onPressedDown(this.boundChatKeyCb), this.chatVisibilityKey = i.input.getKey("toggleChatVisibility"), this.boundChatVisibilityKeyCb = () => {
			this.visible && this.textBoxEl.blur(), this.toggledVisible = !this.visible, this.updateVisibility(), this.visible && this.textBoxEl.focus()
		}, this.chatVisibilityKey.onPressedDown(this.boundChatVisibilityKeyCb), this.boundUpdateVisibilities = () => {
			this.updateVisibility(), this.updateTouchButtonVisibility()
		}, i.network.squadManager.onUserVisibleSquadIdChange(this.boundUpdateVisibilities), this.boundOnTouchSupported = () => {
			this.el.classList.toggle("touch", i.input.touch.touchSupported), i.input.touch.touchSupported && (this.toggledVisible = !1, this.textBoxEl.placeholder = "Type to chat with your squad", this.updateVisibility()), this.updateTouchButtonVisibility()
		}, i.input.touch.onTouchSupportedChange(this.boundOnTouchSupported), i.settingsManager.onValueChange("chatEnabled", this.boundUpdateVisibilities), i.settingsManager.onValueChange("hideUi", this.boundUpdateVisibilities), e.cornerStatsUi.onVisibilityChange((() => {
			this.updateHeight()
		})), e.onGameEndFinish((() => {
			this.updateVisibility()
		})), this.boundOnTouchSupported(), this.updateVisibility(), this.updateTouchButtonVisibility(), this.updateHeight()
	}
	destructor() {
		this.gameWrapper.removeChild(this.el), this.chatKey.removeCb(this.boundChatKeyCb), this.chatVisibilityKey.removeCb(this.boundChatVisibilityKeyCb);
		const t = Xn();
		t.network.squadManager.removeOnUserVisibleSquadIdChange(this.boundUpdateVisibilities), t.input.touch.removeOnTouchSupportedChange(this.boundOnTouchSupported), t.settingsManager.removeOnValueChange("chatEnabled", this.boundUpdateVisibilities), t.settingsManager.removeOnValueChange("hideUi", this.boundUpdateVisibilities);
		for (const t of this.createdMessages) this.destroyMessage(t);
	...
	loop() {
		for (;;) {
			...
			if (!t) break;
			if (!(performance.now() - t.lastMessageTime > 1e4)) break;
			this.destroyMessage(t)
		}
	}
	destroyMessage(t) {
		t.avatarBlobReference && t.avatarBlobReference.destructor(), this.chatLogEl.removeChild(t.messageEl), this.createdMessages = this.createdMessages.filter((e => e != t)), 0 == this.createdMessages.length && Xn().input.touch.touchSupported && (this.toggledVisible = !1, this.updateVisibility())
	}
	sendMessage() {
		const t = this.textBoxEl.value;
		this.textBoxEl.value = "", this.textBoxEl.blur(), t && Xn().network.sendChatMessage(t)
	}
	receivedChatMessage(t) {
		...
		if ("playerMessage" == t.type) {
			const i = t.data.playerId,
				s = this.game.players.get(i);
			if (!e || i != e.playerId) {
				const t = document.createElement("div");
				t.classList.add("chat-message-container"), this.chatLogEl.appendChild(t);
				let n = null;
				if (s) {
					const e = s.getSmallAvatar();
					n = e.getBlobUrlReference();
					const i = document.createElement("div");
					i.classList.add("player-avatar"), t.appendChild(i), (async () => {
						const t = await n.getBlobUrl();
						i.style.backgroundImage = `url("${t}")`
					})()
				}
				const o = document.createElement("div");
				if (o.classList.add("chat-message-content"), t.appendChild(o), s) {
					const t = document.createElement("h3");
					t.classList.add("chat-message-name"), t.textContent = s.playerName, o.appendChild(t)
				}
				e = {
					messageEl: t,
					contentsEl: o,
					playerId: i,
					avatarBlobReference: n,
					lastMessageTime: performance.now()
				}, this.createdMessages.push(e)
			}
			if (!e) throw new Error("Assertion failed, lastMessageData is undefined");
			e.lastMessageTime = performance.now();
			const n = Xn(),
				o = document.createElement("div"),
				a = n.settingsManager.getValue("chatProfanityFilterEnabled");
			if (t.data.guardianRejected)
				if (s && s.hasOwnership) a ? o.classList.add("filtered-error") : o.classList.add("filtered-warning");
				else if (a || Xn().poki.isPokiBuild) return;
			let r = t.data.message.split(" ");
			r = r.map((t => function(t) {
				let e = !1;
				for (const i of gs)
			...
			}(t) ? new Array(t.length + 1).join("*") : t)), o.textContent = r.join(" "), e.contentsEl.appendChild(o), o.scrollIntoView({
				behavior: "smooth"
			}), this.toggledVisible = !0, this.updateVisibility()
		}
	}
	updateVisibility() {
		const t = Xn();
		let e;
		e = !this.game.usedForCameraShotsOnly && (!(!t.settingsManager.getValue("chatEnabled") || t.settingsManager.getValue("hideUi")) && (document.activeElement == this.textBoxEl || !!this.toggledVisible && t.network.squadManager.isInSquad)), this.visible = e, this.el.classList.toggle("hidden", !e)
	}
...
class fs extends Ne {
	constructor(...t) {
		super(...t), this.radius = this.worldMatrix.getMaxScaleOnAxis(), this.pos = new u, this.pos.setFromMatrixPosition(this.worldMatrix);
		const e = this.pos.clone().subScalar(this.radius),
			i = this.pos.clone().addScalar(this.radius);
		this.aabb = new C(e, i)
	}
	getSphereManifold(t, e) {
		return Xe(t, e, this.pos, this.radius)
	}
	rayCast(t, e) {
		...
		if (n.dot(e) < 0) return null;
		const o = n.length(),
			a = Math.sqrt(s ** 2 - o ** 2);
		if (a > this.radius) return null;
...
class ws {
	...
	subdivideRecursive({
		...
		if (!(this.depth >= e || this.items.length <= i)) {
			...
			for (const s of this.children) {
				for (const e of this.items) t(e, s.aabb) && s.addItems([e]);
	...
	subdivide() {
		...
		for (let s = 0; s < 8; s++) {
			const n = new C;
			s % 2 < 1 ? (n.min.x = t.x, n.max.x = i.x) : (n.min.x = i.x, n.max.x = e.x), s % 4 < 2 ? (n.min.y = t.y, n.max.y = i.y) : (n.min.y = i.y, n.max.y = e.y), s < 4 ? (n.min.z = t.z, n.max.z = i.z) : (n.min.z = i.z, n.max.z = e.z);
			const o = new ws(n, this.depth + 1);
			this.children.add(o), this.allChildren[s] = o
		}
	}* traverseDown(t = (() => !0)) {
		if (t(this)) {
			yield this;
...
class bs {
	constructor() {
		this.rigidBodies = new Set, this.mapColliders = [], this.rootOctreeNode = null, this.octreeMaxDepth = 5, this.mapBounds = null, this.octreeAxisVoxelCount = 0, this.worldToOctreeVoxelSpaceMultiplier = new u, this.isLoweringTimeScale = !1, this.timeScale = 1, this.stepCount = 10, this.flyRoofHeight = 1 / 0, this.flySphereRadius = 1 / 0, this.flySphereCenter = new u(0, 0, 0);
		const t = Xn().mapLoader.mapVariablesManager;
		t.onVariablesChanged((() => {
			this.flyRoofHeight = t.get("flyRoofHeight"), this.flySphereCenter.fromArray(t.get("flySphereCenter")), this.flySphereRadius = t.get("flySphereRadius")
		}))
	}
	destructor() {}
	loop(t, e) {
	...
	addMapCollider(t) {
		...
		let i;
		return i = "sphere" == t.colliderType ? new fs(e, t) : new Ke(e, t), this.mapColliders.push(i), i
	}
	removeMapColliders() {
	...
	buildOctree() {
		...
		this.worldToOctreeVoxelSpaceMultiplier.set(1, 1, 1), this.worldToOctreeVoxelSpaceMultiplier.divide(e), this.worldToOctreeVoxelSpaceMultiplier.multiplyScalar(this.octreeAxisVoxelCount), this.rootOctreeNode = new ws(t), this.rootOctreeNode.addItems(this.mapColliders), this.rootOctreeNode.subdivideRecursive({
	...
	octreeVoxelSpaceToNodePath(t) {
		const e = t[0],
			i = t[1],
			s = t[2];
		if (e < 0 || i < 0 || s < 0 || e > this.octreeAxisVoxelCount - 1 || i > this.octreeAxisVoxelCount - 1 || s > this.octreeAxisVoxelCount - 1) return null;
		...
		for (let t = 0; t < this.octreeMaxDepth; t++) {
			const t = n >> 1,
				...
				h = a >> 1;
			let d = 0;
			e % n >= t && (d += 1), i % o >= l && (d += 2), s % a >= h && (d += 4), r.push(d), n = t, o = l, a = h
		}
		return r
	}
	...
	getRayCastCache(t, e) {
		...
		if (i.setLength(1), 0 == i.length()) return null;
		const s = new C;
		s.expandByPoint(t), s.expandByPoint(e);
...
class ys {
	...
	updateVariablesIndex() {
		if (0 == this.lastReceivedRandomVariablesArray.length) this.currentVariablesIndex = -1;
		else {
			const t = Array.from(this.lastReceivedRandomVariablesArray.entries()).map((([t, e]) => ({
				probability: Math.max(0, e.probability || 1),
				item: t
			})));
			this.currentVariablesIndex = wt(t, this.variablesIndexSeed) ?? -1
		}
	}
	setSeed(t) {
...
class Ss {
	constructor(t, e) {
		this.configManager = t, this.mapsConfig = e, this.onIsLoadingMapChangeCbs = new Set, this.isLoadingMap = !1, this.loadCloudsCalled = !1, this.environmentIsInit = !1, this.cachedMapHashes = new Set, this.fetchingMapCbs = new Map, this.onOneMapAvailableCbs = new Set, this.firstMapDownloaded = !1, this.onFirstMapDownloadedCbs = new Set, this.onMapCachedCbs = new Set, this.mapVariablesManager = new ys, this.mapVariablesManager.onVariablesChanged((() => {
			this.updateWeatherParams(), this.updateCloudHeight()
		})), this.cloudsObj = null, this.currentLoadingMapContexts = new Map, this.lastMapLoadRequestId = 0
	}
	async init() {
		if (Xn(), this.mapsConfig.onConfigChange((async t => {
				...
				if (e) {
					...
					for (const n of t.maps) {
						...
						const r = (async t => {
							...
							i && (s = !0, this.markMapAsCached(n.hash, !1))
						})();
						i.push(r)
					}
					await Promise.all(i), s && this.fireOnMapCachedCbs()
				}
		...
		this.deleteLegacyCaches(), this.mapVariablesManager.init()
	}
	...
	async loadConfigMap(t, e, i, {
		retryOnFail: s = !1
	} = {}) {
		const o = this.mapsConfig.getListedMapConfigByHash(t);
		try {
			if (!o) throw new n(`Failed to load map, "${t}" is not in the mapsConfig.`, "map-not-in-config");
			await this.loadMap({
				request: {
					type: "config",
					config: o
			...
			if (!(o instanceof n)) throw o;
			if (!s) throw o;
			await this.reloadMapsConfigAndRetryLoadConfigMap(t, e, i)
		}
	}
	async loadConfigMapWithDialogMessage(t, e, i) {
		try {
			return await this.loadConfigMap(t, e, i, {
				retryOnFail: !0
			}), !0
		} catch (t) {
			console.error(t);
			...
			if (t instanceof n && "hash-validation-failed" == t.name) i.showAlert({
				title: s,
	...
	async loadMap(t, e) {
		const i = Xn().mainInfoTextManager.requestInfoText("Loading map...", {
			showPercentage: !0,
			priority: 1,
			startLoading: !0
		});
		i.setPercentage(0), this.initEnvironment();
		const s = this.lastMapLoadRequestId++;
		this.currentLoadingMapContexts.set(s, {
			cb: e,
			loadingText: i
		});
		const n = await Xn().assets.getMessenger();
		try {
			const o = await n.send.loadMap(t, s);
			this.loadMapResponseCbReceived(o, e)
		} finally {
			Xn().mainInfoTextManager.removeInfoText(i), this.currentLoadingMapContexts.delete(s)
		}
	}
	async reloadMapsConfigAndRetryLoadConfigMap(t, e, i) {
		return await this.mapsConfig.load(), await this.loadConfigMap(t, e, i, {
			retryOnFail: !1
		})
	}
	...
	setGamplayObjects(t, e) {
		...
		const s = t.flags.map((t => ({
			...
			o = (new u).fromArray(t.kingOfTheHillPosition);
		i.cb({
			type: "colliders",
	...
	loadMapResponseCbReceived(t, e) {
		const i = Vt.deserializeThreeObject(t.scene);
		i.traverse((t => {
			t.frustumCulled = !1
		}));
		const s = [];
		for (const {
			...
			of t.hingeObjects) {
			const t = Vt.deserializeThreeObject(e);
			s.push({
				hinge: t,
				behavior: i
			})
		...
		for (const {
			...
			of t.appearingObjects) {
			const t = [];
			for (const i of e) {
				const e = Vt.deserializeThreeObject(i.object),
		...
		if (e({
			...
			Xn().cam.setLobbyCamPositions(e)
		}
		t.mapConfig ? this.mapVariablesManager.setVariables(t.mapConfig.globalMapVariables || null, t.mapConfig.randomMapVariableSets || []) : this.mapVariablesManager.setVariables(null, []), this.fireFirstMapAvailable()
	}
	initEnvironment() {
		if (this.environmentIsInit) return;
		Xn().materials.precompileShaders(), this.updateWeatherParams();
		const t = new z(700, 8, 6),
			e = new r(t, Xn().materials.skyDomeMat);
		e.frustumCulled = !1, e.name = "skydome", e.renderOrder = -1, Xn().scene.add(e), this.environmentIsInit = !0
	}
	updateWeatherParams() {
		...
		e.addScalar(this.mapVariablesManager.get("colorAdderAdjust")), Xn().materials.applyWeatherParams({
			colorMultiplier: t,
			colorAdder: e,
	...
	async loadClouds() {
		if (this.loadCloudsCalled) return;
		this.loadCloudsCalled = !0;
		const t = await Xn().assets.getPackage("main").getFileAsBuffer("clouds.glb"),
			e = await Xn().assets.getMessenger(),
			i = await e.send.loadClouds(t);
		this.cloudsObj = Vt.deserializeThreeObject(i), this.cloudsObj && Xn().scene.add(this.cloudsObj), this.updateCloudHeight()
	}
}
class vs {
	constructor(t, e) {
		this.mapLoader = t, this.mapsConfigLoader = e, this.votedScores = new Map, this._forcingSoloMap = null, this.onMatchMakeDataChangeCbs = new Set, t.onMapCached((() => {
	...
	getMatchMakePreferredMapHashes() {
		...
		for (const t of this.mapsConfigLoader.loadedConfigData.maps) {
			if (s && s !== t.hash) continue;
			if (!this.mapLoader.hasCachedMap(t.hash)) continue;
			let i = 0;
			const a = this.votedScores.get(t.assetName);
			a && (i = a.votedScore, a.hasTemporaryBoost && (i += .5), i -= T(0, 3, 1, 0, a.lastPlayedCounter, !0)), n = Math.min(n, i), o = Math.max(o, i), e.push({
				hash: t.hash,
				preference: i
			})
		}
		if (n = i(n), o = t(o, n, 1), n == o)
			for (const t of e) t.preference = 0;
		else
			for (const t of e) t.preference = T(n, o, 0, 1, t.preference, !0);
		return e
	}
	getMatchMakeData() {
		if (!this.mapsConfigLoader.loadedConfigData) return null;
	...
	forceSoloMap(t) {
		this._forcingSoloMap = t, this.onMatchMakeDataChangeCbs.forEach((t => t()))
	}
	disableForcedSoloMap() {
		this._forcingSoloMap = null, this.onMatchMakeDataChangeCbs.forEach((t => t()))
	}
...
class Cs {
	constructor() {
		this.appearingObjects = [], this.destructed = !1
	}
	destructor() {
		this.destructed = !0, this.removeObjects()
	}
	removeObjects() {
		const t = Xn().scene;
		for (const {
			...
			of this.appearingObjects)
			for (const i of e) t.remove(i.object);
	...
	setAppearingObjects(t) {
		...
		for (const {
			...
			of t) {
			const t = [];
			for (const s of i) s.object.matrixAutoUpdate = !1, s.object.visible = !1, e.add(s.object), t.push({
				...s,
	...
	updatePlayerPositions(t) {
		for (const e of this.appearingObjects) {
			const i = "appear" == e.behavior || "toggle" == e.behavior,
				s = "toggle" == e.behavior;
			if (e.hasBeenTriggered && !s) continue;
			let n = !0;
			...
			if (i && n) {
				...
				for (const {
					...
					of e.objects) i.visible = !0, t = Math.max(s, t);
				Xn().renderer.renderWorthyEventHappened(1e3 * t)
			}
			if (s && !n) {
				e.hasBeenTriggered = !1, e.t = 0, e.allAnimationsFinished = !1;
				for (const t of e.objects) t.animationFinished = !1, t.object.visible = !1;
				Xn().renderer.renderWorthyEventHappened()
			}
		}
	}
	loop(t, e) {
		for (const t of this.appearingObjects) {
			if (!t.hasBeenTriggered || t.allAnimationsFinished) continue;
			let i = !0;
			t.t += .001 * e;
			for (const e of t.objects) {
				if (e.animationFinished) continue;
				let s = T(0, e.duration, 0, 1, t.t, !0);
				s = -(Math.cos(Math.PI * s) - 1) / 2, e.object.position.lerpVectors(e.startPos, e.endPos, s), e.object.updateMatrix(), e.object.updateWorldMatrix(!1, !0), s >= 1 ? e.animationFinished = !0 : i = !1
			}
...
class ks {
	constructor() {
		this.hingeObjects = [], this.activeHingeObjects = new Map, this.onHingeMoveCbs = new Map, this.destructed = !1
	}
	destructor() {
		this.setHingeObjects([]), this.destructed = !0
	}
	setHingeObjects(t) {
		if (this.destructed) return;
		const e = Xn().scene;
		for (const {
			...
			of this.hingeObjects) e.remove(t);
		this.hingeObjects = [], this.activeHingeObjects.clear();
		for (const {
				hinge: i,
				behavior: s
			}
			...
			(new p).setFromRotationMatrix(i.matrixWorld), this.hingeObjects.push({
				object: i,
				behavior: s,
	...
	shootHinge(t, e, i) {
		...
		let n = .99,
			o = 5e-4,
			a = .001;
		"light-sturdy" == s.behavior && (n = .9, o = .01, a = .001);
		...
		e = e.clone().applyMatrix4(s.defaultWorldMatrixInv), i = l.clone().applyMatrix4(s.defaultWorldMatrixInv), e.z = 0, i.z = 0;
		const h = e.clone().cross(i);
		return r.physicsValue.velocity += a * h.z, s
	}
	onHingeMove(t, e) {
		let i = this.onHingeMoveCbs.get(t);
		i || (i = new Set, this.onHingeMoveCbs.set(t, i)), i.add(e)
	}
	removeOnHingeMove(t, e) {
		const i = this.onHingeMoveCbs.get(t);
		i && (i.delete(e), i.size <= 0 && this.onHingeMoveCbs.delete(t))
	}
	loop(t, e) {
		for (const [i, s] of this.activeHingeObjects) {
			const n = this.hingeObjects[i],
				{
					object: o,
					defaultWorldMatrix: a
				} = n;
			s.physicsValue.loop(t, e), o.matrix.makeRotationZ(s.physicsValue.value), o.matrix.premultiply(a), o.matrixWorld.copy(o.matrix), Math.abs(s.physicsValue.value) < 1e-4 && Math.abs(s.physicsValue.velocity) < 1e-5 && this.activeHingeObjects.delete(i);
...
class Ps {
	constructor(t) {
		this.gameWrapper = t, this.visible = !0, this.el = document.createElement("div"), this.el.classList.add("game-timer-container", "whiteBigText", "blueNight"), t.appendChild(this.el), this.tenMinutesEl = this.addDigitEl(), this.oneMinuteEl = this.addDigitEl();
		const e = document.createElement("span");
		e.textContent = ":", this.el.appendChild(e), this.tenSecondsEl = this.addDigitEl(), this.oneSecondEl = this.addDigitEl(), this.timeRemainingData = null, this.updateVisibility()
	}
	destructor() {
		this.gameWrapper.removeChild(this.el)
	}
	addDigitEl() {
		const t = document.createElement("span");
		return t.textContent = "-", t.classList.add("timer-digit"), this.el.appendChild(t), t
	}
	setTimeRemaining(t) {
	...
	loop(t, e) {
		if (this.timeRemainingData) {
			const t = Math.max(0, this.timeRemainingData.remaining - (performance.now() - this.timeRemainingData.receivedAt)),
				e = Math.floor(t / 6e5),
				i = Math.floor(M(t, 6e5) / 6e4),
				s = Math.floor(M(t, 6e4) / 1e4),
				n = Math.floor(M(t, 1e4) / 1e3);
			this.tenMinutesEl.textContent = e > 0 ? String(e) : "", this.oneMinuteEl.textContent = String(i), this.tenSecondsEl.textContent = String(s), this.oneSecondEl.textContent = String(n)
		}
	}
	setVisible(t) {
	...
	updateVisibility() {
		const t = this.visible && this.timeRemainingData;
		this.el.style.display = t ? "" : "none"
	}
}
class xs {
	constructor(t) {
		this.el = document.createElement("div"), this.teamId = t;
		const e = A[t];
		this.teamColor = e.cssColor, this.playerDots = [], this.alivePlayers = 0
	}
	setPlayerCount(t, e) {
		const i = (t = Math.min(t, 10)) - this.playerDots.length,
			s = -i;
		for (let t = 0; t < i; t++) {
			const t = new Yi(this.teamColor);
			this.playerDots.push(t), this.el.append(t.el)
		}
		for (let t = 0; t < s; t++) {
			const t = this.playerDots[this.playerDots.length - 1];
			this.playerDots.splice(this.playerDots.length - 1, 1), this.el.removeChild(t.el)
		}
		for (const [t, i] of this.playerDots.entries()) {
			const s = t < e;
			i.setRemoved(!s, !0), i.setState(s, 1)
		}
		this.alivePlayers = e
	}
	get hasAlivePlayer() {
...
class Ms {
	constructor(t, e) {
		this.gameWrapper = t, this.el = document.createElement("div"), this.el.classList.add("elimination-score-container"), t.appendChild(this.el), this.scoreTeams = [];
		for (let t = 0; t < e; t++) {
			if (0 == t) continue;
			const e = new xs(t);
			this.el.appendChild(e.el), this.scoreTeams[t] = e
		}
	}
	destructor() {
		this.gameWrapper.removeChild(this.el)
	}
	setPlayerCount(t, e, i) {
		const s = this.scoreTeams[t];
		s && s.setPlayerCount(e, i)
	}
	getWinningTeam() {
		for (const t of this.scoreTeams)
			if (t && t.hasAlivePlayer) return t.teamId;
		return null
	}
	setVisible(t) {
		this.el.style.display = t ? "" : "none"
...
class As {
	constructor(t) {
		this.gameWrapper = t, this.el = document.createElement("div"), this.el.classList.add("active-gamemode-container", "blueNight", "whiteBigText"), t.appendChild(this.el), this.el.append("Gamemode: "), this.gamemodeEl = document.createElement("span"), this.gamemodeEl.textContent = "-", this.el.append(this.gamemodeEl)
	}
	destructor() {
		this.gameWrapper.removeChild(this.el)
	}
	setActiveGamemode(t) {
		this.gamemodeEl.textContent = $(t)
	}
	setVisible(t) {
		this.el.style.display = t ? "" : "none"
	}
...
class Is {
	constructor(t) {
		this.gameWrapper = t, this.visible = !0, this.el = document.createElement("div"), this.el.classList.add("king-of-the-hill-ui-container", "wrinkledPaper"), this.el.style.cssText = `\n\t\t--wrinkled-paper-seed: ${ut(1,99999)};\n\t\t`, t.appendChild(this.el), this.progressEls = [], this.redScore = 0, this.blueScore = 0;
		for (let t = 0; t < 3; t++) {
			if (0 == t) continue;
			const e = document.createElement("div");
			e.classList.add("king-of-the-hill-progress", "container");
			const i = ut(1, 99999),
				s = A[t],
				n = document.createElement("div");
			n.classList.add("value"), e.append(n), this.el.append(e), this.progressEls.push(n);
			const o = document.createElement("div");
			o.classList.add("wrinkledPaper", "value-color"), n.append(o), o.style.cssText = `\n\t\t\t--wrinkled-paper-seed: ${i};\n\t\t\t--wrinkled-paper-color: ${s.cssColor};\n\t\t\t`, this.el.append(e);
			const a = document.createElement("div");
			a.classList.add("wrinkledPaper", "bg"), e.append(a), a.style.cssText = `\n\t\t\t--wrinkled-paper-seed: ${i};\n\t\t\t`, this.el.append(e)
		}
		this.setProgress(0, 0, 10), this.updateVisibility()
	}
	destructor() {
		this.gameWrapper.removeChild(this.el)
	}
	setProgress(t, e, i) {
		this.redScore = t, this.blueScore = e;
		const s = t / i,
			n = e / i;
		this.progressEls[0].style.width = 100 * s + "%", this.progressEls[1].style.width = 100 * n + "%"
	}
	getWinningTeam() {
		return this.redScore > this.blueScore ? _ : this.blueScore > this.redScore ? J : null
	}
	setVisible(t) {
		this.visible = t, this.updateVisibility()
	}
...
class Ls {
	constructor(t) {
		this.gameWrapper = t, this.teamCount = 3, this.activeGamemode = K, this.physics = new bs, this.players = new Map, this.hingeManager = new ks, this.arrowManager = new zi(this.physics, this.hingeManager, this.teamCount), this.crosshair = new _i(t), this.flags = [], this.appearingObjectsManager = new Cs, this.gameIsVisible = !1, this.receivedColliders = !1, this.scene = null, this.onGameIsVisibleCbs = new Set, this.onUsedForCamShotsOnlyChangeCbs = new Set, this._usedForCameraShotsOnly = !1, this.uiVisible = !1, this.activeGamemodeUi = null, this.flagScoreUi = null, this.eliminationScoreUi = null, this.gameTimerUi = null, this.kingOfTheHillUi = null, this.healthUi = new Zi(t), this.weaponSelectionDialog = new Vi(t), Xn().dialogManager.addDialog(this.weaponSelectionDialog), this.playersListDialog = new as(t, this.players, Xn().skins, (() => (this.playersListDialog.visible = !1, !1))), Xn().dialogManager.addDialog(this.playersListDialog), this.gameOverStatsDialog = null, this.cornerNotificationsUi = new rs(t), this.gameOverNotificationsUi = new rs(t, "centerbig"), this.crosshairNotificationsUi = new rs(t, "crosshair"), this.scoreOffsetNotificationsUi = new hs(t), this.cornerStatsUi = new ps(t, this), this.waitingForPlayersInfoText = Xn().mainInfoTextManager.requestInfoText("Waiting for players...", {
			shouldBounce: !1,
			showInMainMenu: !1
		}), this.gameEndLoweringTimeScaleDuration = 6, this.gameEndTitleDurationWin = 3, this.gameEndTitleDurationLose = 2, this.gameEndPlayersListDuration = 6, this.gameEndShowStatsDuration = 8, this.gameEndRewardedAdDuration = 15, this.gameEndShowStatsAfterRewardedDuration = 6, this.trackedMyPlayerScores = new Map, this.spawnPositions = null, this.kingOfTheHillPosition = new u, this.kingOfTheHillSphere = null, this.isForegroundGame = !1, this.gameStartTime = 0, this.gameStarted = !1, this.gameEnded = !1, this.gameSeed = 0, this.onGameSeedChangeCbs = new Set, this.finishedGameEndFlow = !1, this.destructed = !1, this.shouldPlayFinalFlagMusic = !1, this.currentFinalFlagMusic = null, this.currentGameEndWaitingMusic = null, this.onMyPlayerChangeCbs = new Set, this.onGameEndCbs = new Set, this.onGameEndFinishCbs = new Set, this.gameEndWaitTimers = [], this.gameEndTimerSuddenChangeDisabled = !1, this.onEstimatedMaxGameEndWaitTimeSuddenChangeCbs = new Set, this.onSdkGameplayStartedChangeCbs = new Set, this.onSquadPlayersChangeCbs = new Set, this.onGameEndAccountStatsChangeCbs = new Set, this.gameEndStepsReachedStatScreens = !1, this.onGameEndStatsScreenCbs = new Set, this.isDoingGameEndSteps = !1, this.gameEndMyTotalScore = 0, this.gameEndReceivedCoins = 0, this.gameEndShowStatsScreen = !1, this.gameEndStatsShowTimer = null, this.gameEndAdBreakTimer = null, this.gameEndRewardedAdTimer = null, this.gameEndStatsAfterRewardedAdTimer = null, this.currentLoadedMapHash = null, this.boundUpdateUiVisible = this.updateUiVisible.bind(this), Xn().mainMenu.onVisibilityChange(this.boundUpdateUiVisible), this.updateUiVisible(), this.boundOnPlayerListDown = this.onPlayerListDown.bind(this), this.boundOnPlayerListUp = this.onPlayerListUp.bind(this);
		const e = Xn().input.getKey("playerList");
		e.onPressedDown(this.boundOnPlayerListDown), e.onPressedUp(this.boundOnPlayerListUp);
		Xn().input.getKey("playerListTouch").onPressedDown(this.boundOnPlayerListDown), this.antiCheat = new oi, this.antiCheat.onPlayerNeedsReport(((t, e, i) => {
			Xn().network.sendReportCheater(t, e, i)
		})), this.chat = new ms(t, this), Xn().cam.setThirdPersonMode("none")
	}
	destructor() {
		if (this.destructed) return;
		this.destructed = !0, this.setMapScene(null, null), this.fireSdkGameplayStartedChange(), this.physics.destructor();
		for (const t of this.players.values()) t.destructor();
		this.players.clear(), this.hingeManager.destructor(), this.arrowManager.destructor(), this.crosshair.destructor(), this.appearingObjectsManager.destructor();
		for (const t of this.flags) t.destructor();
		this.activeGamemodeUi && this.activeGamemodeUi.destructor(), this.flagScoreUi && this.flagScoreUi.destructor(), this.gameTimerUi && this.gameTimerUi.destructor(), this.eliminationScoreUi && this.eliminationScoreUi.destructor(), this.healthUi.destructor(), this.cornerNotificationsUi.destructor(), this.gameOverNotificationsUi.destructor(), this.crosshairNotificationsUi.destructor(), this.scoreOffsetNotificationsUi.destructor(), this.cornerStatsUi && this.cornerStatsUi.destructor(), Xn().mainInfoTextManager.removeInfoText(this.waitingForPlayersInfoText), this.chat.destructor(), Xn().mainMenu.removeOnVisibilityChange(this.boundUpdateUiVisible);
		const t = Xn().input.getKey("playerList");
		t.removeCb(this.boundOnPlayerListDown), t.removeCb(this.boundOnPlayerListUp);
		Xn().input.getKey("playerListTouch").removeCb(this.boundOnPlayerListDown), this.playersListDialog.close(), this.closeGameOverStatsDialog(), this.weaponSelectionDialog.close(), this.gameEndWaitTimers = [], Xn().adBanners.setPageVisibility("gameEnd", !1), this.currentFinalFlagMusic && (this.currentFinalFlagMusic.stop(), this.currentFinalFlagMusic = null), this.currentGameEndWaitingMusic && (this.currentGameEndWaitingMusic.stop(), this.currentGameEndWaitingMusic = null), Xn().classSelectionImageManager.setTeamId(null)
	}
	...
	setActiveGamemode(t) {
		this.activeGamemode = t, this.activeGamemodeUi || (this.activeGamemodeUi = new As(this.gameWrapper)), this.activeGamemodeUi.setActiveGamemode(t), t == Y ? this.flagScoreUi || (this.flagScoreUi = new Qi(this.gameWrapper, this.teamCount), this.flagScoreUi.onNeedsNotification(this.showFlagNotification.bind(this))) : this.flagScoreUi && (this.flagScoreUi.destructor(), this.flagScoreUi = null), X(t) ? this.gameTimerUi || (this.gameTimerUi = new Ps(this.gameWrapper)) : this.gameTimerUi && (this.gameTimerUi.destructor(), this.gameTimerUi = null), t == Q ? this.eliminationScoreUi || (this.eliminationScoreUi = new Ms(this.gameWrapper, this.teamCount)) : this.eliminationScoreUi && (this.eliminationScoreUi.destructor(), this.eliminationScoreUi = null), t == Z ? (this.kingOfTheHillUi || (this.kingOfTheHillUi = new Is(this.gameWrapper)), this.createKingOfTheHillSphereIfNeeded()) : (this.kingOfTheHillUi && (this.kingOfTheHillUi.destructor(), this.kingOfTheHillUi = null), this.kingOfTheHillSphere && this.kingOfTheHillSphere.parent && this.kingOfTheHillSphere.parent.remove(this.kingOfTheHillSphere)), this.playersListDialog.setActiveGamemode(t)
	}
	createKingOfTheHillSphereIfNeeded() {
		if (this.activeGamemode != Z) return;
		if (this.kingOfTheHillSphere) return;
		if (!this.scene) return;
		const t = new H(tt, 2),
			e = t.getAttribute("position"),
			i = new Float32Array(3 * e.count),
			s = [.04, .04, 0];
		for (let t = 0; t < i.byteLength; t += 3)
			for (let e = 0; e < s.length; e++) i[t + e] = .3 * s[e];
		t.setAttribute("color", new a(i, 3));
		const n = t.clone();
		n.scale(-1, 1, 1);
		const o = new r(t, Xn().materials.lightsMat),
			l = new r(n, Xn().materials.lightsMat);
		this.kingOfTheHillSphere = new et, this.kingOfTheHillSphere.renderOrder = 100, this.kingOfTheHillSphere.add(o), this.kingOfTheHillSphere.add(l), this.kingOfTheHillSphere.updateWorldMatrix(!1, !0), this.kingOfTheHillSphere.name = "king of the hill sphere", this.scene.add(this.kingOfTheHillSphere), this.updateKingOfTheHillRenderPosition()
	}
	updateKingOfTheHillRenderPosition() {
		this.kingOfTheHillSphere && (this.kingOfTheHillSphere.position.copy(this.kingOfTheHillPosition), this.kingOfTheHillSphere.updateWorldMatrix(!1, !0))
	}
	setGameTimerTimeRemaining(t) {
		this.gameTimerUi && this.gameTimerUi.setTimeRemaining(t)
	}
	async loadMap(t) {
		const e = e => {
				if ("gameplay-data" == e.type) this.updateMapGameplayData(e.gameplayData);
				else if ("colliders" == e.type) {
					this.physics.removeMapColliders();
					for (const t of e.colliders) this.physics.addMapCollider(t);
					this.physics.buildOctree(), this.receivedColliders = !0, this.updateGameIsVisible()
				} else "scene" == e.type && (this.destructed ? Ss.disposeMapGeometries(e.scene) : this.setMapScene(e.scene, t), this.hingeManager.setHingeObjects(e.hinges), this.appearingObjectsManager.setAppearingObjects(e.appearingObjects))
			},
			i = Xn(),
			s = i.mapLoader;
		await s.loadConfigMapWithDialogMessage(t, {
			teamColors: it(this.activeGamemode),
			mirrorSpawnPoints: it(this.activeGamemode)
		}, e) || i.network.closeCurrentConnection()
	}
	setMapScene(t, e) {
		this.scene && (Ss.disposeMapGeometries(this.scene), Xn().scene.remove(this.scene)), this.scene = t, t && Xn().scene.add(t), this.updateSceneVisibility(), this.updateGameIsVisible(), this.createKingOfTheHillSphereIfNeeded(), this.currentLoadedMapHash = e, this.notifyServerCurrentMap()
	}
	updateMapGameplayData(t) {
		if (!this.destructed) {
			for (const t of this.flags) t.destructor();
			if (this.flags = [], this.activeGamemode == Y)
				for (const {
						flagTeamId: e,
						pos: i,
						rot: s
					}
					of t.flags) this.createFlag(e, i, s);
			this.spawnPositions = t.spawnPositions, t.kingOfTheHillPosition && (this.kingOfTheHillPosition = t.kingOfTheHillPosition, this.updateKingOfTheHillRenderPosition())
		}
	}
	setServerGameTime(t) {
		this.gameStartTime = Xn().now - t
	}
	setServerGameSeed(t) {
	...
	get gameTime() {
		return this.gameStarted ? Xn().now - this.gameStartTime : 0
	}
	notifyServerCurrentMap() {
		const t = Xn();
		if (!this.currentLoadedMapHash) return;
		t.network.sendCurrentLoadedMapHash(this.currentLoadedMapHash);
		this.physics.mapBounds && t.network.sendWorldBounds(this), t.network.sendDefaultFlagPositions(this), t.network.sendDefaultSpawnPositions(this), t.network.sendKingOfTheHillPosition(this)
	}
	createPlayer(t, e) {
		const i = Xn(),
			s = new qi(this, i.input, i.sfx, this.physics, i.settingsManager, i.hudIcons, t, e);
		s.init(), this.players.set(t, s), this.playersListDialog.playersListChanged(), i.renderer.renderWorthyEventHappened()
	}
	destroyPlayer(t) {
		const e = this.players.get(t);
		if (e) {
			const i = e.sameSquadOrOwned;
			e.destructor(), this.players.delete(t), this.playersListDialog.playersListChanged(), Xn().renderer.renderWorthyEventHappened(), i && this.fireSquadPlayersChange()
		}
	}
	setPlayerOwnership(t, e) {
		const i = this.players.get(t);
		i && i.setHasOwnership(e), this.updateUsedForCameraShotsOnly(), Xn().mainMenu.setJoinState("joined"), Xn().gameManager.setJoinedOnce(), this.updatePlayerIconVisibilities(), this.playersListDialog.playersListChanged();
		const s = this.getMyTeamId();
		this.playersListDialog.updateTeamsOrder(s), this.updateMyTeamColor(), this.updateWaitingForPlayersText(), this.fireSquadPlayersChange(), this.onMyPlayerChangeCbs.forEach((t => t()))
	}
	getMyTeamColor() {
		let t = 0;
	...
	updateMyTeamColor() {
		...
		this.weaponSelectionDialog.setCssColor(t.cssColor, t.cssColorDark), this.healthUi.setCssColor(t.cssColor, t.cssColorDark), Xn().classSelectionImageManager.setTeamId(e)
	}
	setPlayerName(t, e) {
		const i = this.players.get(t);
	...
	setPlayerTeamId(t, e) {
		const i = this.players.get(t);
		i && i.setTeamId(e), this.updateAllEliminationScoreboards(), this.playersListDialog.playersListChanged(), i && i.sameSquadOrOwned && this.fireSquadPlayersChange()
	}
	...
	setSameSquadPlayerData(t) {
		...
		for (const {
			...
			t && (t.setIsSameSquadPlayer(!0, s, n), e = !0)
		}
	...
	createFlag(t, e, i) {
		const s = new Ni(this.flags.length, t, e, i, this, this.physics);
	...
	playerChangeFlag(t, e, i) {
		...
		if (s) {
			const e = this.players.get(t);
			this.gameEnded || (0 == i || 1 == i ? e && e.dead && e.report(ni, 1) : 3 == i && e && e.dead && e.report(ni, 1)), e ? e.changeFlagFromServer(s, i) : 3 == i && s.returnToDefaultPos()
		}
	}
	showFlagNotification(t) {
		const e = t.type;
		let i;
		if (1 == t.teamId ? i = 2 : 2 == t.teamId && (i = 1), i) {
			const s = `static/img/notificationIcons/flag/${A[i].id}/${e}.svg`;
			...
			"capture" == t.type && (o += "Important"), Xn().sfx.playSound("flag/" + o)
		}
	...
	loop(e, s) {
		for (const t of this.players.values()) t.loop(e, s);
		for (const t of this.flags) t.loop(e, s);
		this.flagScoreUi && this.flagScoreUi.loop(e, s), this.gameTimerUi && this.gameTimerUi.loop(e, s), this.chat.loop(), this.hingeManager.loop(e, s), this.arrowManager.loop(e, s), this.crosshair.loop(e, s), this.appearingObjectsManager.loop(e, s);
		const n = Xn(),
			o = n.mapLoader.cloudsObj;
		o && (o.rotation.y = 1e-5 * e, o.updateWorldMatrix(!1, !0));
		...
		this.cornerStatsUi.networkStabilityStat.setValue(b), this.physics.loop(e, s);
		for (const t of this.players.values()) t.afterPhysicsLoop(e, s);
		for (const t of this.flags) t.afterPhysicsLoop(e, s)
	}
	getMyPlayer() {
		if (this.finishedGameEndFlow) return null;
	...
	updatePlayerIconVisibilities() {
		...
		for (const e of this.players.values()) e.updateIconOwnershipVisibility(t)
	}
	...
	setPlayerServerData(t, e, i, s, n, o, a = !1) {
		...
		r && r.setServerData(e, i, s, n, o, a), Xn().renderer.renderWorthyEventHappened()
	}
	...
	setPlayerPingData(t, e) {
		const i = this.players.get(t);
		i && (i.setPingData(e), i.hasOwnership && this.cornerStatsUi.pingStat.setValue(e))
	}
	createServerArrow(t, e, i, s, n, o, a, r, l) {
		const h = this.players.get(t);
		h && (h.dead && h.report(ni, 1), h.serverArrowCreated(), h.bowWeapon ? h.bowWeapon.verifyArrowFrequency(h.avgArrowCreationFrequency) || h.report(si, 3) : h.report(si, 1));
		...
		if (h) {
			const t = new u(i, s, n),
				...
				p = h.getCamPos(),
				g = p.clone().add(c);
			t.distanceTo(p) > 3 && t.distanceTo(g) > 3 && (t.copy(p), c.set(0, 0, 0)), this.arrowManager.createArrow(h, {
				arrowId: e,
				pos: t,
				networkOffsetPos: c,
				dir: d,
	...
	getSpawnPosition(t, e) {
		if (!this.spawnPositions) throw new Error("Attempted to spawn before spawn positions were loaded");
	...
	receivedPlayerSpawn(t, e, i) {
		const s = this.players.get(t);
		s && s.receivedSpawn(e, i)
	}
	...
	updateFlagScoreboard(t) {
		this.flagScoreUi && this.flagScoreUi.update(t)
	}
	updateAllEliminationScoreboards() {
		this.updateEliminationScoreboard(_), this.updateEliminationScoreboard(J)
	}
	updateEliminationScoreboard(t) {
		if (!this.eliminationScoreUi) return;
		let e = 0,
			i = 0;
		for (const s of this.players.values()) s.teamId == t && (e++, s.dead || i++);
		this.eliminationScoreUi.setPlayerCount(t, e, i)
	}
	updateFlagGrabbedStates() {
		...
		for (const e of this.flags) {
			...
			if (1 == e.teamId) i = 2;
				...
				if (2 != e.teamId) continue;
				i = 1
			}
			if (e.currentHoldingPlayer) t.set(i, "grab");
			else if (!e.isNearDefaultPos)
				for (let i = 0; i < this.teamCount; i++) i != e.teamId && t.set(i, "drop")
		}
		for (const e of this.flags) t.has(e.teamId) || t.set(e.teamId, "return");
		if (this.flagScoreUi)
			for (const [e, i] of t) this.flagScoreUi.setFlagGrabbedState(e, i);
		Xn().renderer.renderWorthyEventHappened()
	}
	async updateFinalFlagMusic() {
		if (!this.flagScoreUi) return;
		...
		if (this.shouldPlayFinalFlagMusic != t)
			if (this.shouldPlayFinalFlagMusic) {
				const t = await Xn().sfx.playSound("music/finalFlag");
	...
	offsetPlayerScore(t, e, i) {
		...
		if (s && s.hasOwnership) {
			...
			if (s && (t = s), t += e, this.trackedMyPlayerScores.set(i, t), this.uiVisible && (this.scoreOffsetNotificationsUi.showOffsetNotification(e, i), e > 0 && 1 == i)) {
				this.showKillNotification(), Xn().sfx.playSound("feedback/kill");
				let t = 0,
					e = !1;
				const i = {
						last: 1
				...
				e && (t = 2), n && (t = 4), t && Xn().network.sendRequestNextGameState(t)
			}
		}
	}
	notifyGameStarted() {
		this.gameStarted = !0, this.cornerStatsUi.updateVisibility(), this.updateWaitingForPlayersText();
		for (const t of this.players.values()) t.updateFly()
	}
	receivedGameEndAccountStats(t) {
		this.gameEndReceivedCoins = t.receivedCoins, t.receivedCoins > 0 && Xn().shopState.provideNewCoinCount(t.newCoinCount), this.updateGameEndShowStatsScreen()
	}
	...
	notifyGameEnded() {
		this.gameEnded = !0, this.updateFinalFlagMusic(), this.updateUsedForCameraShotsOnly(), this.cornerStatsUi.updateVisibility(), Xn().network.markNextCloseAsIntentional(), Xn().recentGameTracker.setRecentGameNetworkData(null), this.fireSdkGameplayStartedChange(), this.playersListDialog.visible = !1, this.playersListDialog.freezeScores();
		for (const t of this.onGameEndCbs) t();
		this.doGameEndSteps(), Xn().profileState.markStateAsStale()
	}
	async doGameEndSteps() {
		if (this.isDoingGameEndSteps) return;
		this.isDoingGameEndSteps = !0;
		const t = Xn();
		if (t.poki.isShowingRewardedBreak && (await t.poki.waitForRewardedBreakFinish(), this.destructed || this.finishedGameEndFlow)) return;
		this.fireSdkGameplayStartedChange();
		const e = this.getMyPlayer();
		let i, s = !1,
			n = !0,
			o = null;
		if (this.activeGamemode == Y && this.flagScoreUi) o = this.flagScoreUi.getWinningTeam();
		else if (this.activeGamemode == Q && this.eliminationScoreUi) o = this.eliminationScoreUi.getWinningTeam();
		else if (this.activeGamemode == Z && this.kingOfTheHillUi) o = this.kingOfTheHillUi.getWinningTeam(), null == o && (n = !1);
		else if (this.activeGamemode == st) {
			let t = null;
			for (const e of this.players.values())(!t || e.scoreTotal > t.scoreTotal) && (t = e);
			s = t == e, n = !1
		} else if (this.activeGamemode == nt) {
			let t = 0,
				e = 0;
			for (const i of this.players.values()) i.teamId == _ ? t += i.scoreKills : i.teamId == J && (e += i.scoreKills);
			t > e && (o = _), e > t && (o = J)
		}
		null != o && (s = Boolean(e && e.teamId == o)), i = s ? "victory" : n ? "defeated" : "gameEnded", s && t.poki.happyTime(1), this.updateUiVisible(), !t.mainMenu.hideUi && i && this.gameOverNotificationsUi.showIcon(`static/img/notificationIcons/gameOver/${i}.svg`), t.cam.setThirdPersonMode("back"), t.sfx.playSound("gameEnd/" + (s ? "win" : "lose")), this.gameEndMyTotalScore = 0, e && (this.gameEndMyTotalScore = e.scoreTotal);
		const a = s ? this.gameEndTitleDurationWin : this.gameEndTitleDurationLose,
			r = this.createGameEndWaitTimer(this.gameEndLoweringTimeScaleDuration + a, "title"),
			l = this.createGameEndWaitTimer(this.gameEndPlayersListDuration, "playerlist");
		if (this.gameEndStatsShowTimer = this.createGameEndWaitTimer(0, "stats"), this.gameEndAdBreakTimer = this.createGameEndWaitTimer(10, "adbreak"), this.updateGameEndShowStatsScreen(), r.start(), await Be.promise(1e3 * this.gameEndLoweringTimeScaleDuration), this.destructed || this.finishedGameEndFlow) return;
		if (this.physics.startLoweringTimeScale(), await Be.promise(1e3 * a), this.destructed || this.finishedGameEndFlow) return;
		this.currentGameEndWaitingMusic || (this.currentGameEndWaitingMusic = await t.sfx.playSound("music/waiting")), r.clear(), this.playersListDialog.setGameEndState(o), this.playersListDialog.visible = !0, this.playersListDialog.skipText.setVisibility(!0);
		const h = t.settingsManager.getValue("autoSkipStatsScreen");
		if (h && this.playersListDialog.skipText.startTimer(this.gameEndPlayersListDuration), this.playersListDialog.skipText.startCreationCooldown(), t.adBanners.setPageVisibility("gameEnd", !0), this.gameEndStepsReachedStatScreens = !0, this.onGameEndStatsScreenCbs.forEach((t => t())), e && e.updateSmoothCam(), l.start(), await this.playersListDialog.skipText.waitForSkip(), !this.destructed && !this.finishedGameEndFlow) {
			if (l.clear(), this.playersListDialog.visible = !1, this.gameEndShowStatsScreen) {
				let i = 0;
				if (e && (i = e.teamId), this.gameOverStatsDialog = new ds(this.gameWrapper, {
					...
					})), t.dialogManager.addDialog(this.gameOverStatsDialog), h && this.gameOverStatsDialog.skipText.startTimer(this.gameEndShowStatsDuration), this.gameEndStatsShowTimer.start(), await this.gameOverStatsDialog.skipText.waitForSkip(), this.destructed || this.finishedGameEndFlow) return;
	...
	canEstimateGameEndWaitTime() {
		if (!this.isDoingGameEndSteps) return !1;
		if (this.gameOverStatsDialog && this.gameOverStatsDialog.rewardedAdFailed) return !1;
		return !!Xn().settingsManager.getValue("autoSkipStatsScreen")
	}
	...
	createGameEndWaitTimer(t = 0, e = "") {
		...
		})), this.gameEndWaitTimers.push(i), this.fireEstimatedMaxGameEndWaitTimeSuddenChange(), i
	}
	...
	closeGameOverStatsDialog() {
		this.gameOverStatsDialog && (this.gameOverStatsDialog.close(), this.gameOverStatsDialog = null)
	}
	finishGameEndFlow() {
		if (this.isDoingGameEndSteps) {
			for (const t of this.players.values()) t.setHasOwnership(!1);
			this.onMyPlayerChangeCbs.forEach((t => t())), this.finishedGameEndFlow = !0, this.updateUsedForCameraShotsOnly(), this.gameOverNotificationsUi.removeIcon(), this.playersListDialog.visible = !1, this.closeGameOverStatsDialog(), Xn().network.closeCurrentConnection(!0), this.onGameEndFinishCbs.forEach((t => t()))
		}
	}
	onPlayerListDown() {
	...
	updateUsedForCameraShotsOnly() {
		...
		t != this._usedForCameraShotsOnly && (this._usedForCameraShotsOnly = t, this.onUsedForCamShotsOnlyChangeCbs.forEach((t => t())))
	}
	becameForegroundGame() {
		this.isForegroundGame = !0, this.updateUsedForCameraShotsOnly(), this.updateGameIsVisible(), this.updateUiVisible()
	}
	...
	updateGameIsVisible() {
		...
		t != this.gameIsVisible && (this.gameIsVisible = t, this.updateSceneVisibility(), this.onGameIsVisibleCbs.forEach((t => t())), Xn().renderer.renderWorthyEventHappened())
	}
	onGameIsVisible(t) {
	...
	updateUiVisible() {
		const t = this.isForegroundGame && (!Xn().mainMenu.visible || !1) && !this.gameEnded && !Xn().mainMenu.hideUi;
		this.setUiVisible(t), Xn().hudIcons.setGlobalVisibility(t)
	}
	setUiVisible(t) {
		this.uiVisible = t, this.healthUi.setVisible(t), this.activeGamemodeUi && this.activeGamemodeUi.setVisible(t), this.flagScoreUi && this.flagScoreUi.setVisible(t), this.gameTimerUi && this.gameTimerUi.setVisible(t), this.eliminationScoreUi && this.eliminationScoreUi.setVisible(t), this.kingOfTheHillUi && this.kingOfTheHillUi.setVisible(t), this.crosshair.setGameUiVisibility(t), t || (this.cornerNotificationsUi.removeIcon(), this.crosshairNotificationsUi.removeIcon(), this.scoreOffsetNotificationsUi.removeAll())
	}
}
class Ts {
	constructor(t) {
		if (this.gameWrapper = t, this.el = document.getElementById("mainMenu"), !this.el) throw new Error("Main menu element not found");
		...
		this.el.addEventListener("mousedown", (t => {
			t.target == this.el && (this.onGameStartGesture(), t.stopImmediatePropagation())
		})), this.currentJoinState = "joinable", this.loadScreenHidden = !1, this.toggledVisibilityState = !1, this.toggleMenuButton = new xt({
			isIconButton: !0,
		...
		}), this.toggleMenuButton.visible = !1, t.appendChild(this.toggleMenuButton.el), this.visible = !0, this.onVisibilityChangeCbs = new Set, this.contentVisible = !1;
		const e = document.createElement("div");
		e.classList.add("main-menu-top-left"), this.el.appendChild(e), this.userProfileDialog = null, this.cornerProfile = new pe, this.cornerProfile.onClick((t => {
			this.openUserProfileDialog({
				showExtraStats: t.altKey
			})
		})), e.appendChild(this.cornerProfile.el), this.menuButtonsContainer = document.createElement("div"), this.menuButtonsContainer.classList.add("menu-buttons-container", "hidden"), e.appendChild(this.menuButtonsContainer), this.loginButton = new kt({
			text: "Log in",
			icon: "static/img/menuUI/login.svg",
			onClick: () => {
				Xn().auth.loginIfNotLoggedIn(!0)
			}
		}), this.menuButtonsContainer.appendChild(this.loginButton.containerEl), this.loginButton.setVisibility(!1), this.settingsDialog = null, this.settingsButton = new kt({
			text: "Settings",
			icon: "static/img/menuUI/settings.svg",
			...
			onClick: () => {
				const e = Xn();
				this.settingsDialog = new Lt(t, e.settingsManager, e.dialogManager), Xn().dialogManager.addDialog(this.settingsDialog)
			}
		}), this.menuButtonsContainer.appendChild(this.settingsButton.containerEl), this.shopDialog = null, this.shopButton = new kt({
			text: "Shop",
		...
		}), this.menuButtonsContainer.appendChild(this.shopButton.containerEl), this.squadDialog = null, this.squadButton = new kt({
			text: "Squad",
		...
		}), this.menuButtonsContainer.appendChild(this.squadButton.containerEl), this.mapsDialog = null, this.mapsButton = new kt({
			text: "Maps",
		...
		}), this.menuButtonsContainer.appendChild(this.mapsButton.containerEl), this.fullScreenButton = new kt({
			text: "Full Screen",
			icon: "static/img/menuUI/fullScreen.svg",
			iconSizeMultiplier: .6,
			onClick() {
				Xn().fullScreenManager.requestFullScreen(), Xn().fullScreenManager.suggestAutoFullScreen()
			}
		}), this.menuButtonsContainer.appendChild(this.fullScreenButton.containerEl), this.exitFullScreenButton = new kt({
			text: "Exit Full Screen",
			icon: "static/img/menuUI/exitFullScreen.svg",
			iconSizeMultiplier: .6,
			onClick() {
				Xn().fullScreenManager.exitFullScreen()
			}
		}), this.menuButtonsContainer.appendChild(this.exitFullScreenButton.containerEl), this.installButton = new kt({
			text: "Install",
			...
			onClick: async () => {
				"accepted" == await async function() {
					let t;
					if (Fe) {
						const e = new ve(Xn().gameWrapper);
						Xn().dialogManager.addDialog(e), t = "dismissed"
					} else {
						if (!Me) throw new Error("Install available event hasn't fired yet");
						Me.prompt(), t = (await Me.userChoice).outcome
					}
					return t
				}() && (this.installPromptAccepted = !0, this.updateInstallButtonVisibility())
			}
		}), this.installButton.setVisibility(!1), this.menuButtonsContainer.appendChild(this.installButton.containerEl), this.installAvailable = !1, this.installPromptAccepted = !1, this.updateButton = new kt({
			text: "Update",
			icon: "static/img/menuUI/download.svg",
			isUpdateIcon: !0,
			onClick: async () => {
				...
				if (t.gameManager.getOnlineGame()) {
					...
					if (0 != await e.waitForButton()) return
				}
				Ee()
			}
		}), this.updateButton.setVisibility(!1), this.menuButtonsContainer.appendChild(this.updateButton.containerEl), this.exitButton = new kt({
			text: "Exit Round",
			...
			onClick: async () => {
				...
				if (e) {
					if (e.gameStarted && !e.gameEnded) {
						...
						t.network.squadManager.myClientIsSquadLeader && (e = "You are the squad leader so all members will exit this match too.", t.network.squadManager.currentSquadSettings?.privateSquad || (e += " No one will earn any coins from this match."));
						...
						if (0 != await i.waitForButton()) return;
						Xn().recentGameTracker.setRecentGameNetworkData(null)
					}
					t.network.squadManager.myClientIsSquadLeader ? t.network.sendSquadLeaderRequestGameExit() : t.network.closeCurrentConnection()
				}
			}
		}), this.exitButton.setVisibility(!1), this.menuButtonsContainer.appendChild(this.exitButton.containerEl), Le((() => {
			this.updateButton.setVisibility(!0)
		})), this.promoBanner = null;
		const i = document.createElement("ul");
		i.classList.add("bottom-texts", "whiteBigText", "blueNight"), this.el.appendChild(i);
		const s = document.createElement("li");
		s.textContent = "v1739742438", i.appendChild(s);
		const n = document.createElement("li");
		i.appendChild(n);
		const o = document.createElement("a");
		o.textContent = "Privacy Policy", o.href = "https://privacy.pelicanparty.co/", o.target = "_blank", n.appendChild(o), this.currentMusicSfx = null, this.hideUi = !1
	}
	init() {
		const t = Xn();
		t.poki.gameLoadingStart(), t.fullScreenManager.onFullScreenChange((() => {
			this.updateFullScreenButtonVisibility()
		})), t.fullScreenManager.onAutoFullScreenChange((() => {
			this.updateFullScreenButtonVisibility()
		})), this.updateFullScreenButtonVisibility(), t.input.onPointerLockChange(((t, e) => {
			!t && e && this.makeMainMenuVisibleFromUserGesture(), this.updateVisibility()
		...
		if (!e) throw new Error("Assertion failed, no main menu key");
		e.onPressedDown((() => {
			t.input.unlockPointer(), this.makeMainMenuVisibleFromUserGesture()
		})), t.gameManager.onActiveGameChange((t => {
			t && (t.onGameIsVisible((() => {
				this.updateLoadingImageVisibility(), this.updateVisibility()
			})), t instanceof Ls && t.onUsedForCamShotsOnlyChange((() => {
				this.updateVisibility()
			}))), this.updateVisibility(), this.updateLoadingImageVisibility()
		})), t.input.touch.onTouchListenerClick((() => {
			this.onGameStartGesture()
		})), xi((t => {
			const e = Xn().settingsManager.getValue("requireAddressBarHide");
			...
			this.updateInstallButtonVisibility(), this.updateExitGameVisibility(), t instanceof Ls && t.onGameEnd((() => {
				this.updateExitGameVisibility()
			}))
		})), this.updateInstallButtonVisibility(), this.updateExitGameVisibility(), this.cornerProfile.init();
		const i = () => {
			const t = Xn().auth.isLoggedIn;
			this.loginButton.setVisibility(!t)
		};
		var s;
		Xn().auth.onLoggedInAccountChange(i), i(), t.network.squadManager.onSquadMembersChange((() => {
			...
			this.hideUi = e, Xn().mainInfoTextManager.updateText();
			...
			this.installAvailable = !0, this.updateInstallButtonVisibility()
		}, Oe ? s() : De.add(s), Xn().gameManager.onIsInGamesLoopChange((() => {
	...
	updateLoadingImageVisibility() {
		...
		!this.loadScreenHidden && e && e.gameIsVisible && !t.renderer.webglCreationFailed && (t.poki.gameLoadingFinished(), this.loadingImageContainer.classList.add("hidden"), setTimeout((() => {
			this.loadingImageContainer.remove()
		}), 1e3), this.loadScreenHidden = !0)
	}
	setJoinState(t) {
		this.currentJoinState = t, Xn().mainInfoTextManager.updateText(), this.updateVisibility(), this.updatePlayingMusic()
	}
	updateSquadButtonsText() {
		let t = "Squad",
			e = "Exit Round";
		const i = Xn().network.squadManager;
		i.isInSquad && (t += ` (${i.totalSquadMemberCount})`, i.myClientIsSquadLeader || (e = "Exit Squad")), this.squadButton.setText(t), this.exitButton.setText(e)
	}
	onGameStartGesture() {
		if (Xn().renderer.webglCreationFailed) return;
		const {
			didShowSquadDialog: t
		} = Xn().gameManager.joinIfNotJoined(!0);
		t || (this.toggledVisibilityState = !1, this.updateVisibility())
	}
	updateFullScreenButtonVisibility() {
		const t = Xn().fullScreenManager.shouldShowButton(),
			e = Xn().fullScreenManager.isFullScreen();
		this.fullScreenButton.setVisibility(!e && t), this.exitFullScreenButton.setVisibility(e && t)
	}
	updateInstallButtonVisibility() {
		const t = this.installAvailable && !Xn().gameManager.isInGamesLoop && !this.installPromptAccepted;
		this.installButton.setVisibility(t)
	}
	updateExitGameVisibility() {
		let t = !1;
		const e = Xn().gameManager.activeGame;
		e && e instanceof Ls && !e.gameEnded && (t = !0), this.exitButton.setVisibility(t)
	}
	makeMainMenuVisibleFromUserGesture() {
		this.toggledVisibilityState = !0, this.makeContentVisible(), this.updateVisibility(), Xn().playerAvatarManager.setGameLoaded()
	}
	makeContentVisible() {
		if (this.contentVisible) return;
		this.contentVisible = !0, this.menuButtonsContainer.classList.remove("hidden");
		const t = Xn();
		this.promoBanner = new ge(t.config, this, t.gameManager, t.shopState, t.poki, t.dialogManager, t.skins, t.indexedDb), this.el.appendChild(this.promoBanner.el), this.promoBanner.init()
	}
	updateVisibility() {
		let t = !0;
		const e = Xn().gameManager.activeGame;
		if (Xn().input.pointerLocked ? t = !1 : e instanceof Ls && e.usedForCameraShotsOnly ? t = !0 : e && e.gameEnded ? t = !1 : this.toggledVisibilityState ? t = !0 : e && e.gameIsVisible && e.getMyPlayer() && (t = !1), t != this.visible) {
			this.visible = t, this.el.style.display = t ? "" : "none";
			const e = Xn();
			e.gameManager.updateSdkGameplayStarted(), e.mainInfoTextManager.updateText(), e.fullScreenManager.updateAutoFullScreen(), this.cornerProfile.setMainMenuVisibility(t), this.updateToggleMenuVisible();
			for (const e of this.onVisibilityChangeCbs) e(t)
		}
	}
	...
	async updatePlayingMusic() {
		if (this.shouldPlayMusic != !!this.currentMusicSfx)
			if (this.shouldPlayMusic) {
				const t = await Xn().sfx.playSound("music/mainMenu");
	...
	openShopDialog() {
		return this.shopDialog || (this.shopDialog = new ce(this.gameWrapper), Xn().dialogManager.addDialog(this.shopDialog), this.shopDialog.addOnCloseCb((() => {
			this.shopDialog = null
		}))), this.shopDialog
	}
	openUserProfileDialog(t) {
		this.userProfileDialog || (this.userProfileDialog = new ue(this.gameWrapper, t), Xn().dialogManager.addDialog(this.userProfileDialog), this.userProfileDialog.addOnCloseCb((() => {
			this.userProfileDialog = null
		})))
	}
	openSquadDialog() {
		this.squadDialog || (this.makeMainMenuVisibleFromUserGesture(), this.squadDialog = new be(this.gameWrapper, Xn().network, Xn().network.squadManager, Xn().gameManager, Xn().avatars, Xn().skins), Xn().dialogManager.addDialog(this.squadDialog), this.squadDialog.addOnCloseCb((() => {
	...
	openMapsDialog() {
		...
		const t = Xn();
		this.mapsDialog = new Se(this.gameWrapper, t.config, t.preferredMapManager, t.gameManager), Xn().dialogManager.addDialog(this.mapsDialog), this.mapsDialog.addOnCloseCb((() => {
...
class Es {
	constructor(t) {
		this.visiblePages = new Set, this.desktopBanner = document.createElement("div"), this.desktopBanner.classList.add("gameAd", "desktop", "hidden"), t.appendChild(this.desktopBanner), this.mobileBanner = document.createElement("div"), this.mobileBanner.classList.add("gameAd", "mobile", "hidden"), t.appendChild(this.mobileBanner)
	}
	init() {
		Xn().mainMenu.onVisibilityChange((t => {
			this.setPageVisibility("mainMenu", t && Xn().gameManager.joinedOnce)
		})), Xn().dialogManager.onCurtainZIndexChange((t => {
			const e = Math.max(100, t + 1);
			this.desktopBanner.style.zIndex = String(e), this.mobileBanner.style.zIndex = String(e)
		}))
	}
	setPageVisibility(t, e) {
		e ? this.visiblePages.add(t) : this.visiblePages.delete(t);
		const i = this.visiblePages.size > 0;
		this.desktopBanner.classList.toggle("hidden", !i), this.mobileBanner.classList.toggle("hidden", !i), Xn().poki.updateBannerVisibility()
	}
}
class Fs extends Mt {
	constructor(t, {
		...
		super(t, {
			testLabel: "alert",
			...n
		}), this.indexPriority = 3, this.titleEl = document.createElement("h2"), this.titleEl.classList.add("dialogTitle", "blueNight"), e && (this.titleEl.textContent = e), this.el.appendChild(this.titleEl), this.textEl = document.createElement("div"), this.textEl.classList.add("dialogText"), i && (this.textEl.textContent = i), this.el.appendChild(this.textEl), this.addButtonsContainer(), this.createdButtons = [], this.setButtons(s)
	}
	setButtons(t) {
		for (const t of this.createdButtons) this.removeButton(t);
		this.createdButtons = [];
		for (const e of t) {
			const t = this.addButton({
				...
				onClick: async () => {
					this.setButtonsEnabled(!1), e.onClick && await e.onClick(), this.close()
				}
			});
			t.enabled = e.enabled ?? !0, this.createdButtons.push(t)
		}
	}
	setButtonsEnabled(t) {
...
class Ds {
	constructor(t) {
		this.gameWrapper = t, this.curtainEl = document.createElement("div"), this.curtainEl.classList.add("dialogCurtain", "fullScreen", "hidden"), t.appendChild(this.curtainEl), this._curtainElVisible = !1, this.onCurtainVisibilityChangeCbs = new Set, this.onNeedsUnlockedPointerChangeCbs = new Set, this.needsUnlockedPointer = !1, this.curtainEl.addEventListener("click", (t => {
			...
			this.updateZIndices(), this.updateInertDialogs(), this.updateFrontDialogProperties()
		}))
	}
	addDialog(t) {
	...
	closeTopMostDialog() {
		if (performance.now() - this.lastDialogAddTime < 300) return;
		const t = this.firstClosableDialog;
		if (t) {
			if (t.customOnCurtainClickCb) {
				if (!t.customOnCurtainClickCb()) return
			}
			t.close()
		}
	}
	showAlert(t) {
		const e = new Fs(this.gameWrapper, t);
	...
	updateZIndices() {
		...
		for (const [i, s] of this.currentDialogStack.entries()) {
			const n = 100 + 2 * i;
			s.setZIndex(n), s.visible && s.needsCurtain && (t = !0, e = n - 1)
		}
	...
	updateFrontDialogProperties() {
		...
		let e = !1;
		t && (e = t.needsUnlockedPointer), e != this.needsUnlockedPointer && (this.needsUnlockedPointer = e, this.onNeedsUnlockedPointerChangeCbs.forEach((t => t())))
	}
}
class Os {
	constructor({
...
class Vs {
	constructor({
		...
		this.el = document.createElement("div"), this.visible = !0, this.currentUsingTouchId = null, this.didUpdateTouchLastLoop = !1, this.responsiveArea = t, this.cancelOthers = e
	}
	updateTouch(t) {
...
class Rs extends Bs {
	constructor(t, e, i) {
		super(i), this.pos = t || new P, this.radius = e
	}
	testTouchInResponsiveArea(t) {
...
class Us extends Vs {
	constructor({
		...
		super({
			responsiveArea: i
		}), this.currentValue = new P, this.hideWhenUsed = e, this.containerPos = new P, this.defaultPos = new P, this.el.classList.add("touchInputJoyStickContainer", "touchInputWhiteBorder"), this.stickEl = document.createElement("div"), this.stickEl.classList.add("touchInputJoyStick"), this.el.appendChild(this.stickEl), this.lastIsTouchingValue = !1, this.lastIsTouchingToggleTime = 0, this.doubleTapped = !1, this.setDefaultPos(t)
	}
	onUpdateTouch(t) {
		const e = new P(t.clientX, t.clientY);
		return null == this.currentUsingTouchId ? (this.onIsTouchingChange(!0), this.setPos(e), !0) : this.currentUsingTouchId == t.identifier && (this.setStickPos(e), this.setOpacity(.1), !0)
	}
	onEndTouch() {
		this.onIsTouchingChange(!1), this.resetPos(), this.setOpacity(1)
	}
	onIsTouchingChange(t) {
		this.doubleTapped = !1, t != this.lastIsTouchingValue && (this.lastIsTouchingValue = t, Xn().now - this.lastIsTouchingToggleTime < 200 && t && (this.doubleTapped = !0), this.lastIsTouchingToggleTime = Xn().now)
	}
	setOpacity(t) {
		this.el.style.opacity = String(t)
	}
	setDefaultPos(t) {
		this.defaultPos = t.clone(), this.responsiveArea instanceof Rs && this.responsiveArea.pos.copy(this.defaultPos), this.resetPos()
	}
	resetPos() {
	...
	setStickPos(e) {
		...
		const s = i.clone();
		i.clampLength(0, 40), this.currentValue = i.clone(), this.currentValue.divideScalar(40);
		const n = s.sub(i),
			o = this.containerPos.clone().add(n);
		o.x = t(o.x, 75, window.innerWidth - 75), o.y = t(o.y, 75, window.innerHeight - 75), this.stickEl.style.transform = `translate(${i.x}px, ${i.y}px) translate(-50%, -50%)`
	}
}
class qs extends Vs {
	constructor() {
		super(), this.currentTouchId = null, this.prevTouchPos = new P, this.lastDeltaPos = new P
	}
	onUpdateTouch(t) {
		if (null == this.currentTouchId && (this.currentTouchId = t.identifier), this.currentTouchId != t.identifier) return !1;
		const e = new P(t.clientX, t.clientY);
	...
	onEndTouch() {
		this.lastDeltaPos = new P, this.currentTouchId = null
	}
}
class Hs extends Vs {
	constructor({
		...
		super({
			responsiveArea: o,
			cancelOthers: r
		}), this.el.classList.add("touchInputButton", "touchInputWhiteBorder"), this.el.style.width = 2 * n + "px", this.el.style.height = 2 * n + "px", this.left = t, this.right = e, this.top = i, this.bottom = s, this.radius = n, a && (this.el.style.backgroundImage = `url(${a})`), this.updatePosition(), ns((() => {
			this.updatePosition()
		})), this.linkedInputKeys = new Set, this.pressed = !1
	}
	updatePosition() {
		null != this.left && (this.el.style.left = this.left + "px"), null != this.right && (this.el.style.right = this.right + "px"), null != this.top && (this.el.style.top = this.top + "px"), null != this.bottom && (this.el.style.bottom = this.bottom + "px"), this.updateResponsiveAreaPos()
	}
	updateResponsiveAreaPos() {
		if (this.responsiveArea instanceof Rs) {
			let t = 0,
				e = 0;
			this.left && (t = this.left + this.radius), this.top && (e = this.top + this.radius), this.right && (t = window.innerWidth - this.right - this.radius), this.bottom && (e = window.innerHeight - this.bottom - this.radius), this.responsiveArea.pos.set(t, e)
		}
	}
	onUpdateTouch(t) {
...
class Ws extends Bs {
	constructor(t, e, i, s, n = !1) {
		super(n), this.left = t, this.right = e, this.top = i, this.bottom = s
	}
	testTouchInResponsiveArea(t) {
...
class Ns {
	constructor(t) {
		this.touchListener = document.createElement("div"), this.touchListener.classList.add("touchListener", "fullScreen"), t.appendChild(this.touchListener), this.uiContainer = document.createElement("div"), this.uiContainer.classList.add("touch-ui-container"), t.appendChild(this.uiContainer), this.joyStick = null, this.lookInput = null, this.jumpButton = null, this.fireButton = null, this.toggleWeaponButton = null, this.chatButton = null, this.playerListButton = null, this.thirdPersonButton = null, this.touchElements = [], this.smallCornerButtons = [], this.lastDeltaLook = new P, this.lastUpdateTouchesTime = 0, this.touchSupported = !1, document.body.addEventListener("touchend", (t => {
			this.touchSupported || (this.touchSupported = !0, this.joyStick = new Us({
				responsiveArea: new Ws(0, .5, 0, 1)
			}), this.uiContainer.append(this.joyStick.el), this.lookInput = new qs, this.uiContainer.append(this.lookInput.el), this.jumpButton = new Hs({
				right: 150,
				bottom: 30,
				responsiveArea: new Rs(null, 50, !1),
				img: "static/img/touchUI/jump.svg"
			}), this.jumpButton.addInputKey(Xn().input.getKey("jump")), this.uiContainer.append(this.jumpButton.el), this.fireButton = new Hs({
				right: 80,
				bottom: 100,
				radius: 50,
				responsiveArea: new Rs(null, 70, !1),
				img: "static/img/touchUI/shoot.svg"
			}), this.fireButton.addInputKey(Xn().input.getKey("fire")), this.uiContainer.append(this.fireButton.el), this.toggleWeaponButton = new Hs({
				right: 30,
				bottom: 200,
				responsiveArea: new Rs(null, 40, !1),
				img: "static/img/touchUI/toggleWeapon.svg"
			}), this.toggleWeaponButton.addInputKey(Xn().input.getKey("toggleWeapon")), this.toggleWeaponButton.setVisibility(!1), this.uiContainer.append(this.toggleWeaponButton.el), this.playerListButton = new Hs({
				left: 20,
				top: 100,
				radius: 15,
				responsiveArea: new Rs(null, 20, !1),
				img: "static/img/touchUI/playerList.svg",
				cancelOthers: !0
			}), this.playerListButton.addInputKey(Xn().input.getKey("playerListTouch")), this.uiContainer.append(this.playerListButton.el), this.thirdPersonButton = new Hs({
				left: 60,
				top: 100,
				radius: 15,
				responsiveArea: new Rs(null, 20, !1),
				...
				cancelOthers: !0
			}), this.thirdPersonButton.addInputKey(Xn().input.getKey("toggleThirdPerson")), this.uiContainer.append(this.thirdPersonButton.el), this.chatButton = new Hs({
				left: 100,
				top: 100,
				radius: 15,
				responsiveArea: new Rs(null, 20, !1),
				...
				cancelOthers: !0
			}), this.chatButton.setVisibility(!1), this.chatButton.addInputKey(Xn().input.getKey("toggleChatVisibility")), this.uiContainer.append(this.chatButton.el), this.smallCornerButtons = [this.playerListButton, this.thirdPersonButton, this.chatButton], this.touchElements.push(this.playerListButton, this.thirdPersonButton, this.chatButton, this.joyStick, this.jumpButton, this.fireButton, this.toggleWeaponButton, this.lookInput), this.onResize())
		}), {
			once: !0
			...
			this.updateCursorVisibility()
		})), this.updateCursorVisibility(), ns((() => {
			this.onResize()
		})), this.onResize()
	}
	init() {
		xi((t => {
			this.touchListener.style.display = t ? "none" : "", this.updateUiVisibility()
		})), Xn().mainMenu.onVisibilityChange((t => {
			this.updateUiVisibility()
		}))
	}
	updateUiVisibility() {
		const t = !Mi() && !Xn().mainMenu.visible;
	...
	onResize() {
		...
		this.jumpButton && (this.jumpButton.right = (o ? 60 : 170) + n, this.jumpButton.updatePosition()), this.fireButton && (this.fireButton.right = (o ? 20 : 80) + n, this.fireButton.updatePosition()), this.toggleWeaponButton && (this.toggleWeaponButton.right = (o ? 10 : 30) + n, this.toggleWeaponButton.updatePosition());
		const a = getComputedStyle(document.body).getPropertyValue("--game-ui-state").includes("small");
		for (const [t, i] of this.smallCornerButtons.entries()) i.top = (a ? 50 : 100) + e, i.left = s + 20 + 40 * t, i.updatePosition()
	}
	...
	updateTouches(e) {
		...
		if (this.lookInput) {
			...
			if (Xn().settingsManager.getValue("touchLookAcceleration")) {
				const i = 1,
					s = 5,
...
class js {
	constructor(t) {
		this.keys = new Map, this.keys.set("left", new Os({
			keyCodes: ["KeyA", "ArrowLeft"]
		})), this.keys.set("right", new Os({
			keyCodes: ["KeyD", "ArrowRight"]
		})), this.keys.set("up", new Os({
			keyCodes: ["KeyW", "ArrowUp"]
		})), this.keys.set("down", new Os({
			keyCodes: ["KeyS", "ArrowDown"]
		})), this.keys.set("flyUp", new Os({
			keyCodes: ["KeyE", "Space"]
		})), this.keys.set("flyDown", new Os({
			keyCodes: ["KeyQ", "ShiftLeft"]
		})), this.keys.set("jump", new Os({
			keyCodes: ["Space"],
			gamepadButtons: [0]
		})), this.keys.set("fire", new Os({
			keyCodes: [],
			gamepadButtons: [7],
			mouseButtons: [0]
		})), this.keys.set("prevWeapon", new Os({
			keyCodes: ["wheelUp"],
			gamepadButtons: [4]
		})), this.keys.set("nextWeapon", new Os({
			keyCodes: ["wheelDown"],
			gamepadButtons: [5]
		})), this.keys.set("toggleWeapon", new Os({
			keyCodes: ["KeyQ", "wheelUp", "wheelDown"],
			gamepadButtons: [4, 5]
		})), this.keys.set("playerList", new Os({
			keyCodes: ["Tab"],
			gamepadButtons: [8]
		})), this.keys.set("mainMenu", new Os({
			keyCodes: ["Escape"],
			gamepadButtons: [9]
		})), this.keys.set("playerListTouch", new Os), this.keys.set("toggleThirdPerson", new Os({
			keyCodes: ["KeyY"],
			gamepadButtons: [3]
		})), this.keys.set("chat", new Os({
			keyCodes: ["KeyT"]
		})), this.keys.set("toggleChatVisibility", new Os), this.desiredPointerLockedState = !1, this.forceUnlockedPointer = !1, this.currentLockedKeys = "", window.addEventListener("keydown", (t => {
			this.setKeyCodePressed(t, !0), this._updatePointerLockedState(), this.updateKeyboardLock()
		})), window.addEventListener("keyup", (t => {
			this.setKeyCodePressed(t, !1)
		}));
		const e = t => t.target == document.body || (t.target == this.touch.touchListener || t.target == Xn().mainMenu.el);
		this.mouseIsOnDocument = !1, document.body.addEventListener("mouseenter", (() => {
			this.mouseIsOnDocument = !0
		})), document.body.addEventListener("mouseleave", (() => {
			this.mouseIsOnDocument = !1
		})), window.addEventListener("mousedown", (t => {
			e(t) && (this.setMouseButtonPressed(t.button, !0), this.mouseIsOnDocument = !0, this._updatePointerLockedState(), this.updateKeyboardLock())
		})), window.addEventListener("mouseup", (t => {
			e(t) && this.setMouseButtonPressed(t.button, !1)
		})), window.addEventListener("mousemove", (t => {
			this.mouseIsOnDocument = !0, this.mouseMove.x += t.movementX || 0, this.mouseMove.y += t.movementY || 0
		})), this.lastWheelEventTime = 0, this.wheelMoveAmount = 0, this.lastFiredWheelButtonTime = 0, this.recentWheelButtonCount = 0, window.addEventListener("wheel", (t => {
			if (Xn().mainMenu.visible) return;
			t.preventDefault();
			performance.now() - this.lastWheelEventTime > 200 ? (this.wheelMoveAmount = 0, t.deltaY > 0 ? this.fireWheelButton("wheelUp") : this.fireWheelButton("wheelDown")) : (this.wheelMoveAmount += t.deltaY, this.wheelMoveAmount > 100 ? (this.fireWheelButton("wheelUp"), this.wheelMoveAmount = 0) : this.wheelMoveAmount < -100 && (this.fireWheelButton("wheelDown"), this.wheelMoveAmount = 0)), this.lastWheelEventTime = performance.now()
		}), {
			passive: !1
		}), window.addEventListener("focus", (t => {
			this.unpressAll()
		})), this.onPointerLockChangeCbs = new Set, this.onDesiredPointerLockChangeCbs = new Set, this._lastPointerLockChangeByApplicationTime = -1 / 0, document.addEventListener("pointerlockchange", (t => {
			const e = this.pointerLocked;
			e || this.unpressAll();
			let i = !0;
			performance.now() - this._lastPointerLockChangeByApplicationTime < 500 && (i = !1, this._lastPointerLockChangeByApplicationTime = -1 / 0), this.onPointerLockChangeCbs.forEach((t => t(e, i)))
		})), this.stickDeadZone = .1, this.gamepadLookSensivity = 1.2, this.touch = new Ns(t), this.mouseMove = new P, this.walkInput = new P, this.lookInput = new P, this.gamepadAxes = []
	}
	init() {
		const t = Xn();
	...
	loop(t, e) {
		this.touch.loop(t, e);
		const i = Xn();
		if (i.mainMenu.visible) this.lookInput.set(0, 0);
		else {
			this.lookInput.copy(this.mouseMove), this.lookInput.addScaledVector(this.touch.lastDeltaLook, 3);
			const t = i.settingsManager;
			this.lookInput.multiplyScalar(t.getValue("mouseSensitivity")), t.getValue("invertMouseY") && (this.lookInput.y *= -1)
		}
		this.mouseMove.set(0, 0), this.updateGamepadStates(t, e), this.touch.touchSupported && this.updateAxisInputs(), this.touch.afterLoop()
	}
	updateGamepadStates(t, e) {
		...
		for (const t of i) {
			...
			if (t.axes) {
				...
				for (let t = 0; t < e.length - 1; t += 2) {
					...
					i.setLength(s), this.gamepadAxes.push(i)
				}
				n = !0
			}
			const e = t.buttons;
		...
		this.setPressedGamepadButtons(s), n && this.updateAxisInputs(), this.gamepadAxes.length > 1 && this.lookInput.addScaledVector(this.gamepadAxes[1], this.gamepadLookSensivity * e)
	}
	get pointerLocked() {
	...
	setKeyCodePressed(t, e) {
		if (e && this.inputHasFocus()) return;
		if (Xn().mainMenu.visible) return;
		let i = !1,
			s = !1;
		for (const n of this.keys.values()) {
			const {
				preventOthers: o,
				needsPreventDefault: a
			} = n.setKeyCodePressed(t.code, e, i);
			o && (i = !0), a && !s && (t.preventDefault(), s = !0)
		}
	...
	fireWheelButton(t) {
		...
		if (e < T(4, 10, 0, 300, this.recentWheelButtonCount, !0)) return;
		this.recentWheelButtonCount += T(50, 2e3, 1, -10, e, !0), this.recentWheelButtonCount = Math.max(0, this.recentWheelButtonCount), this.lastFiredWheelButtonTime = performance.now();
		let i = !1;
		for (const e of this.keys.values()) {
			const {
				preventOthers: s
			} = e.setKeyCodePressed(t, !0, i);
			e.setKeyCodePressed(t, !1, i), s && (i = !0)
		}
	}
	...
	async updateKeyboardLock() {
		...
		const t = new Set;
		for (const e of this.keys.values())
			for (const i of e.keyCodes) t.add(i);
		t.delete("wheelUp"), t.delete("wheelDown");
		const e = Array.from(t).sort().join(",");
		if (e != this.currentLockedKeys) {
			try {
				await navigator.keyboard.lock(Array.from(t))
			} catch (t) {
				if (t instanceof DOMException && "InvalidAccessError" == t.name) throw t;
				return
			}
	...
	unlockPointer() {
		this.forceUnlockedPointer = !0, this.updateDesiredPointerLockedState(), this.forceUnlockedPointer = !1
	}
	...
	updateDesiredPointerLockedState() {
		...
		(this.forceUnlockedPointer || e.mainMenu.visible || e.dialogManager.needsUnlockedPointer || i instanceof Ls && (i.gameEndStepsReachedStatScreens || i.finishedGameEndFlow) || e.poki.isShowingBreak) && (t = !1), t != this.desiredPointerLockedState && (this.desiredPointerLockedState = t, this.onDesiredPointerLockChangeCbs.forEach((t => t(this.desiredPointerLockedState))), this._updatePointerLockedState())
	}
	_updatePointerLockedState() {
		if (this.desiredPointerLockedState != this.pointerLocked)
			if (this.desiredPointerLockedState) {
				...
				this._lastPointerLockChangeByApplicationTime = performance.now(), this._tryLockPointer()
			} else {
				if (!document.exitPointerLock) return;
				this._lastPointerLockChangeByApplicationTime = performance.now(), document.exitPointerLock()
			}
	}
	async _tryLockPointer() {
		if (!this.mouseIsOnDocument) return;
		const t = !Xn().settingsManager.getValue("mouseAcceleration");
		try {
			try {
				...
				let e = !1;
				if (t instanceof DOMException && t.message.includes("not supported") && (e = !0), !e) throw t;
				await document.body.requestPointerLock()
			}
		} catch (t) {
			if (t instanceof DOMException) {
				if ("SecurityError" == t.name) return;
				if ("InUseAttributeError" == t.name) return;
				if ("NotAllowedError" == t.name) return;
				if ("UnknownError" == t.name && t.message.includes("Please report this bug to chromium")) return;
				if ("NotSupportedError" == t.name && this.touch.touchSupported) return
			}
			throw t
		}
	}
...
class zs extends Gs {
	transformData(t) {
		...
		if (t.maps) {
			const e = [],
				i = new Set,
				s = new Set;
			for (const n of t.maps) n.assetName && n.hash && (i.has(n.hash) || s.has(n.assetName) || (e.push(n), i.add(n.hash), s.add(n.assetName)));
			t.maps = e;
	...
	getListedMapConfigByAssetName(t) {
		if (!this.loadedConfigData) return null;
		for (const e of this.loadedConfigData.maps)
			if (e.assetName == t) return e;
		return null
	}
}
class $s extends Gs {
...
class _s extends Gs {
	transformData(t) {
		return t ? (t.purchasableItems ? t.purchasableItems = t.purchasableItems.filter((t => t.id)) : t.purchasableItems = [], t.skinPresets && Array.isArray(t.skinPresets) ? t.skinPresets.map((t => Wt(t))) : t.skinPresets = [], t) : {
			purchasableItems: [],
			skinPresets: []
		}
	}
...
class Js {
	constructor(t) {
		this.gameWrapper = t, this.basePath = null, this.suppressLogs = !1, this.shopConfig = new _s(this, "shopConfig.json"), this.promosConfig = new $s(this, "promosConfig.json"), this.mapsConfig = new zs(this, "mapsConfig.json"), this.allConfigs = [this.shopConfig, this.promosConfig, this.mapsConfig]
	}
	init() {
		const t = St();
		t.configBasePath ? this.basePath = t.configBasePath : "local" == Xn().env || "localhost" == location.hostname && location.pathname.startsWith("/dist/") || "local" == t.configEnv ? this.basePath = `${location.protocol}//${location.host}/config/` : "dev" == t.configEnv || "staging" == t.configEnv || t.pokiDebug || "staging.narrow.one" == location.hostname ? this.basePath = "https://narrow-one.com/stagingconfig/" : (t.configEnv, this.basePath = "https://narrow-one.com/config/");
		const e = this.basePath;
		(async () => {
			(await Xn().assets.getMessenger()).send.setConfigBasePath(e)
		})(), this.loadAllConfigs()
	}
	loadAllConfigs() {
...
class Ks {
	constructor(t) {
		this.physics = new bs, this.hingeManager = new ks, this.arrowManager = new zi(this.physics, this.hingeManager, 1), this.crosshair = new _i(t), this.destructed = !1, this.receivedColliders = !1, this.scene = null, this.gameIsVisible = !1, this.onGameIsVisibleCbs = new Set, this.onSdkGameplayStartedChangeCbs = new Set, this.prevSdkGameplayStarted = !1;
		const e = Xn();
		this.myPlayer = new qi(this, e.input, e.sfx, this.physics, e.settingsManager, e.hudIcons, 1, {
			needsPlayerModel: !1,
			needsSkeleton: !1
		}), this.myPlayer.onPlayerHasInteractedChange((() => {
			this.updateSdkGameplayStarted()
		})), this.myPlayer.init(), this.myPlayer.setHasOwnership(!0), this.loadMap(), this.boundUpdateUiVisible = this.updateUiVisible.bind(this), Xn().mainMenu.onVisibilityChange(this.boundUpdateUiVisible), this.updateUiVisible()
	}
	destructor() {
		this.destructed = !0, this.physics.destructor(), this.hingeManager.destructor(), this.arrowManager.destructor(), this.crosshair.destructor(), this.myPlayer.destructor(), this.setMapScene(null), this.updateSdkGameplayStarted(), Xn().mainMenu.removeOnVisibilityChange(this.boundUpdateUiVisible)
	}
	loadMap() {
		const t = t => {
			if ("colliders" == t.type) {
				this.physics.removeMapColliders();
				for (const e of t.colliders) this.physics.addMapCollider(e);
				this.physics.buildOctree(), this.receivedColliders = !0, this.updateGameIsVisible()
			} else "scene" == t.type && (this.destructed ? Ss.disposeMapGeometries(t.scene) : this.setMapScene(t.scene), this.hingeManager.setHingeObjects(t.hinges))
		};
		Xn().mapLoader.loadLoadingMap(t)
	}
	setMapScene(t) {
		this.scene && (Ss.disposeMapGeometries(this.scene), Xn().scene.remove(this.scene)), this.scene = t, t && Xn().scene.add(t), this.updateGameIsVisible()
	}
	get gameStarted() {
		return !1
	}
	...
	updateSdkGameplayStarted() {
		this.sdkGameplayStarted != this.prevSdkGameplayStarted && (this.prevSdkGameplayStarted = this.sdkGameplayStarted, this.onSdkGameplayStartedChangeCbs.forEach((t => t())))
	}
	loop(t, e) {
		this.hingeManager.loop(t, e), this.arrowManager.loop(t, e), this.crosshair.loop(t, e), this.myPlayer.loop(t, e), this.receivedColliders && this.physics.loop(t, e), this.myPlayer.afterPhysicsLoop(t, e)
	}
	onMyPlayerChange(t) {}
	getMyPlayer() {
	...
	updateGameIsVisible() {
		...
		t != this.gameIsVisible && (this.gameIsVisible = t, this.onGameIsVisibleCbs.forEach((t => t())), this.updateSdkGameplayStarted(), Xn().renderer.renderWorthyEventHappened())
	}
	onGameIsVisible(t) {
		this.onGameIsVisibleCbs.add(t)
	}
	updateUiVisible() {
		const t = !Xn().mainMenu.visible && !Xn().mainMenu.hideUi;
		this.setUiVisible(t)
	}
	setUiVisible(t) {
...
class Ys {
	constructor(t) {
		this.gameWrapper = t, this.activeGame = null, this.loadingBackgroundGame = null, this.joinedOnce = !1, this.isInGamesLoop = !1, this.onIsInGamesLoopChangeCbs = new Set, this.onActiveGameChangeCbs = new Set, this.readyToJoin = !1, this.onReadyToJoinChangeCbs = new Set, this.onGameEndCbs = new Set, this.windSfx = null, this.waterSfx = null, this.birdsSfx = null, this.jungleSfx = null, this.rainSfx = null, this.insectsSfx = null
	}
	async init() {
		this.loadWindSfx(), this.loadWaterSfx(), this.loadBirdsSfx(), this.loadJungleSfx(), this.loadRainSfx(), this.loadInsectsSfx(), this.loadOfflineRoamingGame(), await Xn().network.waitForInit(), this.setReadyToJoin(!0)
	}
	async loadWindSfx() {
		this.windSfx = await Xn().sfx.playSound("ambient/wind")
	}
	async loadWaterSfx() {
		this.waterSfx = await Xn().sfx.playSound("ambient/water")
	}
	async loadBirdsSfx() {
		this.birdsSfx = await Xn().sfx.playSound("ambient/birds")
	}
	async loadJungleSfx() {
		this.jungleSfx = await Xn().sfx.playSound("ambient/jungle")
	}
	async loadRainSfx() {
		this.rainSfx = await Xn().sfx.playSound("ambient/rain")
	}
	async loadInsectsSfx() {
		this.insectsSfx = await Xn().sfx.playSound("ambient/insects")
	}
	setAmbientVolumes(t, e, i, s, n, o) {
		this.waterSfx && this.waterSfx.setVolume(e), this.windSfx && this.windSfx.setVolume(t), this.birdsSfx && this.birdsSfx.setVolume(i), this.jungleSfx && this.jungleSfx.setVolume(s), this.rainSfx && this.rainSfx.setVolume(n), this.insectsSfx && this.insectsSfx.setVolume(o)
	}
	...
	fireCurrentGameChangeCbs() {
		this.activeGame && this.activeGame.onGameIsVisible((() => {
			this.updateSdkGameplayStarted()
		})), this.updateSdkGameplayStarted(), this.onActiveGameChangeCbs.forEach((t => t(this.activeGame)))
	}
	...
	loop(t, e) {
		if (this.activeGame && this.activeGame.loop(t, e), this.rainSfx) {
			const e = Xn();
			if (e.mapLoader.mapVariablesManager.get("lightningEnabled")) {
				...
				if (n > 0) {
					let e = 0;
					e += Math.cos(.02 * t), e += Math.cos(.06 * t), e += Math.cos(.09 * t), o += i(e / 3) * n * 3
				}
				e.materials.setLightningValue(o)
			} else e.materials.setLightningValue(0)
		}
	}
	async prepareMatchMaking(t) {
		if ((!t || Xn().network.matchMaking.isInUnreadyQueue) && Xn().network.shouldUseMatchMaking) {
			if (await Xn().network.matchMaking.initConnection(), t && !Xn().network.matchMaking.isInUnreadyQueue) return;
			const e = this.getOnlineGame();
			if (e && !e.canEstimateGameEndWaitTime()) return;
			await Xn().network.matchMaking.updateQueueState({
				isReadyToJoin: !1,
	...
	loadOfflineRoamingGame() {
		...
		const t = new Ks(this.gameWrapper);
		t.onSdkGameplayStartedChange((() => {
			this.updateSdkGameplayStarted()
		})), this.activeGame = t, this.fireCurrentGameChangeCbs()
	}
	joinedGameId(t) {
		this.activeGame instanceof Ls && !this.activeGame.gameEnded && this.destroyCurrentGame();
		const e = new Ls(this.gameWrapper);
		this.activeGame ? (this.loadingBackgroundGame && this.loadingBackgroundGame.destructor(), this.loadingBackgroundGame = e, e.onMyPlayerChange((() => {
			e.getMyPlayer() && e == this.loadingBackgroundGame && (this.destroyCurrentGame(), this.activeGame = e, this.activeGame.becameForegroundGame(), this.loadingBackgroundGame = null, this.fireCurrentGameChangeCbs())
		}))) : (this.activeGame = e, this.activeGame.becameForegroundGame(), this.fireCurrentGameChangeCbs()), e.onGameEnd((() => {
			...
			Xn().mapLoader.mapVariablesManager.setSeed(t)
	...
	getOnlineGame() {
		return this.loadingBackgroundGame ? this.loadingBackgroundGame : this.activeGame instanceof Ls ? this.activeGame : null
	}
	connectionClosed() {
		this.activeGame && this.activeGame instanceof Ls && (this.activeGame.gameEnded || (this.loadOfflineRoamingGame(), this.updateSdkGameplayStarted(), this.fireCurrentGameChangeCbs(), Xn().mainMenu.setJoinState("joinable"), this.setIsInGamesLoop(!1))), this.setReadyToJoin(!0)
	}
	destroyCurrentGame() {
		const t = this.activeGame;
		this.activeGame = null, t && t.destructor(), this.fireCurrentGameChangeCbs()
	}
	joinIfNotJoined(t = !1) {
		const e = Xn(),
			i = e.gameManager.activeGame;
		let s = !1,
			n = !1;
		if (i instanceof Ls && !i.usedForCameraShotsOnly && (n = !0), !n) {
			...
			if (i.isInSquad || i.isJoiningSquad) {
				if (i.isInSquad && 1 == i.totalSquadMemberCount && !i.matchMakeAllReady) {
					...
					setTimeout((() => {
						...
						await i.waitForServerReadyForStart(), t || i.startSquad()
					})()
				} else if (t && (this.readyToJoin || i.startButtonEnabled)) {
					e.gameManager.activeGame instanceof Ks && (e.mainMenu.openSquadDialog(), s = !0)
				}
			} else e.gameManager.joinGameAfterAd()
		}
		return {
	...
	async checkExistingGameAndJoin() {
		const t = Xn();
		if (t.renderer.webglCreationFailed) return !1;
		if (t.network.squadManager.isJoiningSquad) return !1;
		if (this.activeGame && this.activeGame instanceof Ls) {
			const e = t.dialogManager.showAlert({
				title: "You are currently in a game",
				text: "Do you want to leave the current match?",
				buttons: [{
			...
			Xn().network.closeCurrentConnection()
		}
		return await this.joinGameAfterAd(), !0
	}
	joinGameWithoutAd() {
		this.readyToJoin && (this.setReadyToJoin(!1), Xn().network.prepareJoinGame())
	}
	async joinGameAfterAd() {
		this.readyToJoin && (this.setReadyToJoin(!1), await Xn().poki.commercialBreak(), await Xn().network.prepareJoinGame())
	}
	estimateMaxWaitTimeSeconds() {
		let t = 0;
		const e = this.getOnlineGame();
		return e ? t += e.estimateMaxGameEndWaitTimeSeconds() : t = 10, 1e3 * t
	}
	getMyTeamColor() {
		return this.activeGame instanceof Ls ? this.activeGame.getMyTeamColor() : {
			colors: A[0],
			myTeamId: 0
		}
	}
	updateSdkGameplayStarted() {
		...
		const t = Xn();
		!t.mainMenu.visible && this.activeGame.sdkGameplayStarted ? (t.poki.gameplayStart(), setTimeout((() => {
...
class Xs {
	constructor(t) {
		this.indexedDb = t, this.isLoadingStats = !0, this.recentGameData = null, this.loadStatsPromise = this.loadStats(), t.delete("lastGameStats"), this.ignoreCurrentRecentGameData = !1
	}
	async loadStats() {
		const t = await this.indexedDb.get("recentGameData");
		this.isLoadingStats = !1, t && (this.recentGameData = t)
	}
	async getReconnectData() {
		const t = Xn().settingsManager;
		await t.waitForSettingsLoad();
		if (!t.getValue("autoReconnect")) return null;
		if (!this.recentGameData) return null;
		if (this.ignoreCurrentRecentGameData) return null;
	...
	setRecentGameNetworkData(t) {
		...
		}, this.ignoreCurrentRecentGameData = !1) : this.recentGameData = null, this.saveStats()
	}
	temporaryClearRecentGameNetworkData() {
		this.ignoreCurrentRecentGameData = !0
	}
	updateConnectedTimestamp() {
		this.recentGameData && (this.recentGameData.lastConnectedTimestamp = Date.now(), this.saveStats())
	}
	saveStats() {
...
class Qs {
	constructor(t) {
		this.gameWrapper = t, this.baseFov = 90, this.cam = new x(65, 1, .08, 900), this.cam.name = "cam", this.cam.updateMatrixWorld(), this.isDoingLobbyShots = !1, this.prevHasPlayer = !1, this.lobbyCamPositions = null, this.hasDoneFirstLobbyShot = !1, this.currentLobbyShot = null, this.currentLobbyShotT = 0, this.currentLobbyShotDuration = 5e3, this.thirdPersonMode = "none", this.onThirdPersonChangeCbs = new Set, this.thirdPersonPhysicsNeedsReset = !1, this.thirdPersonPhysics = new Ue({
			dampening: .1,
			springMultiplier: .08
		}), this.thirdPersonOffsetPhysics = new Ue({
			dampening: .1,
			springMultiplier: .08
		}), ns((() => {
			this.onResize()
	...
	init() {
		const t = Xn();
		t.scene.add(this.cam), t.settingsManager.onValueChange("fov", (t => {
			this.baseFov = t, Xn().renderer.renderWorthyEventHappened()
		}));
		t.input.getKey("toggleThirdPerson").onPressedDown((() => {
			let t = "none";
			t = "none" == this.thirdPersonMode ? "back" : "back" == this.thirdPersonMode ? "front" : "none", this.setThirdPersonMode(t)
		}))
	}
	onResize() {
	...
	loop(t, i) {
		...
		let o = !1;
		const a = !!s;
		if (a != this.prevHasPlayer && (this.prevHasPlayer = a, a || (this.cam.fov = 65, this.cam.updateProjectionMatrix())), a && s) {
			const o = s.getCamPos();
			let a;
			if (a = "front" == this.thirdPersonMode ? s.getFrontThirdPersonCamRot() : s.getCamRot(), this.cam.quaternion.copy(a), this.thirdPerson) {
				if (this.thirdPersonPhysicsNeedsReset) this.thirdPersonPhysics.value = o, this.thirdPersonOffsetPhysics.value = new u(0, 0, 0), this.thirdPersonPhysicsNeedsReset = !1;
				else {
					const e = o.clone();
					...
					this.thirdPersonPhysics.target = e, this.thirdPersonPhysics.loop(t, i);
					let r = 0;
					...
					this.thirdPersonOffsetPhysics.target = h, this.thirdPersonOffsetPhysics.loop(t, i)
				}
				const e = this.thirdPersonOffsetPhysics.value;
				e.applyQuaternion(a), this.cam.position.copy(this.thirdPersonPhysics.value), this.cam.position.add(e)
			} else this.cam.position.copy(o);
			let r = this.baseFov;
			s.activeWeapon && (r = s.activeWeapon.adjustFov(r)), this.cam.fov = e(this.cam.fov, r, .1), this.cam.updateProjectionMatrix(), this.cam.updateMatrixWorld()
		} else if (this.lobbyCamPositions && (o = !0, n.renderer.needsRenderFrame)) {
			if (this.currentLobbyShotT += i / this.currentLobbyShotDuration, this.currentLobbyShotT > 1 || !this.currentLobbyShot) {
				if (this.currentLobbyShotT = 0, this.hasDoneFirstLobbyShot) {
					const t = this.lobbyCamPositions.filter((t => t != this.currentLobbyShot));
					this.currentLobbyShot = mt(t) || null
		...
		o != this.isDoingLobbyShots && (this.isDoingLobbyShots = o, Xn().renderer.updateMainCanvasRenderEnabled())
	}
	...
	playerRespawned() {
		this.cam.fov = this.baseFov + 20, this.thirdPersonPhysicsNeedsReset = !0
	}
	get fov() {
		return this.cam.fov
	}
	...
	getRayCastCache(t, e) {
		...
		const n = i.clone().add(s),
			o = Xn().gameManager.activeGame;
		return o ? o.physics.getRayCastCache(i, n) : null
	}
	setThirdPersonMode(t) {
		t != this.thirdPersonMode && (this.thirdPersonMode = t, this.thirdPersonPhysicsNeedsReset = !0, this.onThirdPersonChangeCbs.forEach((t => t())))
	}
...
class Zs {
	constructor(t, {
		...
		this.manager = t, this.size = e, this.nearest = s, this.visible = !0, this.texture = null, this.mat = t.mat.clone(), this.obj = new r(t.geo, this.mat), this.obj.renderOrder = 1, this.obj.frustumCulled = !1, Xn().scene.add(this.obj), this.updateIconSize(window.innerHeight, window.innerWidth), this.setUrl(i)
	}
	destructor() {
		this.disposeTexture(), this.mat.dispose(), Xn().scene.remove(this.obj)
	}
	updateIconSize(t, e) {
	...
	setColor(t) {
		this.mat.uniforms.colorMultiplier.value.copy(t)
	}
	setVisibility(t) {
		this.visible = t, this.updateVisibility()
	}
	...
	setUrl(t) {
		this.disposeTexture();
		const e = new Image;
		e.src = t, e.width = 512, e.height = 512, this.texture = new ot(e), this.nearest && (this.texture.minFilter = at, this.texture.magFilter = at), this.mat.uniforms.map.value = this.texture, e.onload = t => {
...
class tn {
	constructor() {
		this.globalVisibility = !0, this.geo = new b, this.mat = new S({
			name: "hudIcon",
			...
			fragmentShader: "\n\t\t\t\tuniform sampler2D map;\n\t\t\t\tvarying vec2 vUv;\n\n\t\t\t\tuniform vec3 colorMultiplier;\n\n\t\t\t\tvoid main(){\n\t\t\t\t\tgl_FragColor = texture2D(map, vUv) * vec4(colorMultiplier, 1.0);\n\t\t\t\t}\n\t\t\t",
			side: g,
			depthTest: !1,
			depthWrite: !1,
			transparent: !0,
	...
	createIcon(t) {
		const e = new Zs(this, t);
		return this.createdIcons.add(e), e
	}
	removeIcon(t) {
		this.createdIcons.delete(t), t.destructor()
	}
...
class en {
	constructor(t, e, i, s, n, o, a) {
		this.scene = t, this.material = e.clone(), this.material.uniforms.vignetteAmount.value = i, this.material.uniforms.theta.value = s, this.material.uniforms.color.value = n, this.material.uniforms.hasDirection.value = a ? 1 : 0, this.autoFade = o;
		const l = new b(2, 2);
		this.obj = new r(l, this.material), this.obj.frustumCulled = !1, t.add(this.obj), this.creationTime = Xn().now, this.shouldBeDestroyed = !1
	}
	destructor() {
	...
	loop(t) {
		...
		this.opacity = Math.max(0, .1 / (e + .1)), e > 10 && (this.shouldBeDestroyed = !0)
	}
	set opacity(t) {
...
class sn {
	...
	flash({
		arrowHitNormalWorld: t,
		vignetteAmount: e = 1,
		color: i = new u(1, .05, .05),
		autoFade: s = !0,
		hasDirection: n = !0
	} = {}) {
		if (!this.material) return;
		const o = this.getThetaFromArrowHitNormal(t),
			a = new en(this.scene, this.material, e, o, i, s, n);
		return this.createdFlashes.add(a), a
	}
	getThetaFromArrowHitNormal(t) {
		...
		const i = t.clone();
		if (i.y = 0, i.normalize(), i.length() <= 1e-4) return 0;
		const s = new u;
		s.crossVectors(e, i);
		const n = e.dot(i);
		let o = Math.acos(n);
		return s.y > 0 && (o *= -1), M(o, 2 * Math.PI) - Math.PI
	}
	loop(t) {
		const e = new Set;
...
class on {
	constructor({
		...
		this.scene = new w, this.cam = new x, this.cam.matrixAutoUpdate = !1, this.minFov = t, this.maxFov = e, this.near = i, this.far = s, this.enabled = !0
	}
	updateProjectionMatrix() {
		this.cam.near = this.near, this.cam.far = this.far;
		const t = Xn().cam;
		this.cam.fov = rt(t.fov, this.minFov, this.maxFov), this.cam.aspect = t.cam.aspect, this.cam.updateProjectionMatrix()
	}
}
class an {
	constructor(t) {
		this.gameWrapper = t, this.renderer = null, this.canvas = null, this.freezeFrameCanvas = null, this.freezeFrameCtx = null, this.freezeFrameDirty = !1, this.webglCreationFailed = !1, this.afterFrameRenderCbs = [], this.onBeforeRenderCbs = new Set, this.renderViews = new Set, this.renderOverlays = new Set, this.mainCanvasRenderEnabled = !0, this.renderWorthyEventEndTime = 0, this.queriedScreenshotCallbacks = [], this.renderWidth = 0, this.renderHeight = 0, this.rawResolutionMultiplier = 1, this.lastFpsStatUpdateTime = 0, this.framesPassedSinceLastStatUpdate = 0
	}
	init() {
		const t = Xn();
		t.dialogManager.onAnyDialogVisibilityChange((() => {
			...
			this.rawResolutionMultiplier = t, this.onResize()
	...
	reloadRenderer() {
		this.canvas && (this.canvas.remove(), this.canvas = null), this.renderer = null;
		const t = Xn().settingsManager.getValue("antialias");
		try {
			...
			try {
				...
				try {
					...
					try {
						...
						console.error("Failed to create WebGLRenderer:", t), this.webglCreationFailed = !0, Xn().mainInfoTextManager.updateText()
					}
				}
			}
		}
		this.renderer && (this.renderer.outputEncoding = ht, this.renderer.autoClear = !1, this.canvas = this.renderer.domElement, this.canvas.classList.add("fullScreen", "main-canvas"), this.canvas.inert = !0, this.gameWrapper.appendChild(this.canvas)), this.updateSmoothFiltering(), this.onResize()
	}
	updateSmoothFiltering() {
		if (this.canvas) {
			const t = Xn().settingsManager.getValue("smoothFiltering");
	...
	setSize(t, e) {
		this.renderWidth = t, this.renderHeight = e, this.renderer && t > 0 && e > 0 && this.renderer.setSize(t, e, !1)
	}
	createRenderView(...t) {
		const e = new nn(...t);
	...
	loop(t, e) {
		this.mainCanvasRenderEnabled && this.updateMainCanvasRenderEnabled(), this.renderCameras();
		...
		if (s > 500) {
			this.lastFpsStatUpdateTime = i, this.framesPassedSinceLastStatUpdate = 0;
			const t = Xn().gameManager.getOnlineGame();
			t && t.cornerStatsUi.fpsStat.setValue(n)
		}
	}
	renderWorthyEventHappened(t = 1e3) {
		this.renderWorthyEventEndTime = Math.max(this.renderWorthyEventEndTime, performance.now() + t), this.mainCanvasRenderEnabled || this.updateMainCanvasRenderEnabled()
	}
	updateMainCanvasRenderEnabled() {
		...
		} else e.gameManager.activeGame && (t = this.renderWorthyEventEndTime > performance.now());
		this.setMainCanvasRenderEnabled(t)
	}
	setMainCanvasRenderEnabled(t) {
		t != this.mainCanvasRenderEnabled && (this.mainCanvasRenderEnabled = t, t ? (this.freezeFrameCanvas && this.gameWrapper.removeChild(this.freezeFrameCanvas), this.freezeFrameCanvas = null, this.freezeFrameCtx = null) : (this.freezeFrameCanvas = document.createElement("canvas"), this.freezeFrameCanvas.classList.add("fullScreen", "main-canvas"), this.freezeFrameCanvas.inert = !0, this.canvas && (this.freezeFrameCanvas.width = this.canvas.width, this.freezeFrameCanvas.height = this.canvas.height), this.freezeFrameCtx = this.freezeFrameCanvas.getContext("2d"), this.gameWrapper.appendChild(this.freezeFrameCanvas), this.freezeFrameDirty = !0), this.canvas && (this.canvas.style.display = t ? "" : "none"))
	}
	...
	renderCameras() {
		if (this.renderer) {
			...
			if (i && this.setSize(s, n), this.needsRenderFrame && this.renderWidth > 0 && this.renderHeight > 0) {
				this.renderer.clear(), this.renderer.setViewport(0, 0, window.innerWidth * this.resolutionMultiplier, window.innerHeight * this.resolutionMultiplier), this.renderer.render(Xn().scene, Xn().cam.cam);
	...
	async getSkeleton(t, {
		...
		if (!s) {
			...
			if (e) {
				...
				const n = await Xn().assets.loadGlbViaWorker(`playerSkeletonPoses/${t}.glb`, {
					merge: !1,
					signal: i
				});
				if (!n) throw new Error(`Failed to load skeleton pose ${t}`);
				s = n, this.cachedPoses.set(t, s);
...
class ln {
	constructor(t, e) {
		this.opts = t, this.ctx = e, this.loaded = !1, this.loading = !1, this.buffer = null, this.onLoadCbs = []
	}
	async init() {
		if (this.loaded) return;
		if (this.loading) {
		...
		this.loading = !0;
		const t = Xn().assets.getPackage("sfx" + dn.audioFormatCamelCase),
			e = await t.getFileAsBuffer(this.opts.name + "." + dn.audioFormat);
...
class hn {
	constructor(t, e = {}) {
		this.cachedSfx = t, this.opts = {
			...
			...t.opts,
			...e
		}, this.destructed = !1, this.sourceNode = null, this.gainNode = null, this.frontGainNode = null, this.frontSplitterNode = null, this.backGainNode = null, this.backSplitterNode = null, this.channelMergerNode = null, this.finalNode = null, this.pannerNode = null, this.preventDestructOnNextStop = !1, this.lastSetVolume = 0, this.isLoopPlaying = null, this.muted = !1, this.forceMuted = !1, this.startTime = 0;
		const i = this.opts.minPitch || 0,
			s = this.opts.maxPitch || 0;
		this.pitch = gt(i, s)
	}
	destructor() {
		this.destructed = !0, Xn().sfx.sfxDestructed(this)
	}
	async init() {
		if (Xn().sfx.muted && !this.opts.loop && !this.opts.overrideMute) return this.destructor(), !1;
		if (this.opts.pos) {
			if (Xn().cam.pos.distanceTo(this.opts.pos) > Xn().settingsManager.getValue("sfxDistanceCutoff")) return void this.destructor()
		}
		return this.setVolume(this.opts.volume || 0, !0), this.opts.autoPlay && await this.start(!0), this.setMuted(Xn().sfx.muted), !0
	}
	setVolume(t, e = !1) {
		const i = Xn().sfx.ctx;
		if (!i) return;
		this.lastSetVolume = t;
		t *= Xn().settingsManager.getValue(this.opts.isMusic ? "musicVolume" : "sfxVolume") / 100, this.gainNode && (e ? this.gainNode.gain.value = t : this.gainNode.gain.linearRampToValueAtTime(t, i.currentTime + .1))
	}
	...
	async start(t = !1) {
		if (!this.sourceNode) {
			...
			this.sourceNode.addEventListener("ended", i), this.setVolume(this.lastSetVolume, t), this.sourceNode.start(), this.startTime = e.currentTime, !1 === this.isLoopPlaying && this.pause(!0)
		}
	...
	stop(t = !0) {
		if (this.destructed) return;
		const e = Xn().sfx.ctx;
		e && (this.preventDestructOnNextStop = !t, this.sourceNode && (this.sourceNode.stop(), this.sourceNode = null, this.opts.connectToDestination && this.finalNode && this.finalNode.disconnect(e.destination), this.finalNode = null), this.opts.loop && (this.isLoopPlaying = !1))
	}
	pause(t = !1) {
...
class dn {
	constructor() {
		if (window.AudioContext = window.AudioContext || window.webkitAudioContext, this.supported = !!AudioContext, this.packageName = "sfx" + dn.audioFormatCamelCase, this.cachedSfx = {}, this.createdSfx = [], this.settingsMuted = !0, this.adsMuted = !1, this.muted = !0, this.supported) {
			this.ctx = new AudioContext, this.ctx.destination.maxChannelCount >= 6 && (this.ctx.destination.channelCount = 6), this.ctx.onstatechange = () => {
			...
			for (const t of this.soundsConfig) this.cachedSfx[t.name] = new ln(t, this.ctx);
			this.ctxStatePossiblyInvalid = !1, document.addEventListener("visibilitychange", (t => {
				document.hidden ? this.ctx && this.ctx.suspend() : (this.ctxStatePossiblyInvalid = !0, window.setTimeout((() => {
	...
	init() {
		if (this.supported) {
			...
			Xn().settingsManager.onValueChange("musicVolume", (t => {
				for (const e of this.createdSfx) e.opts.isMusic && e.volumeSettingChanged(t)
			})), Xn().settingsManager.onValueChange("sfxVolume", (t => {
				for (const e of this.createdSfx) e.opts.isMusic || e.volumeSettingChanged(t)
			}))
		}
	}
	async downloadPackage() {
		const t = Xn().assets.addPackage(this.packageName, {
			manualDownload: !0
		});
		await Xn().mapLoader.waitForFirstMapDownload(), t.startDownloading()
	}
	loop(t, e) {
		if (this.supported && this.ctx && "running" == this.ctx.state && this.ctx.listener) {
			...
			i.applyQuaternion(e);
			const s = new u(0, 1, 0);
			s.applyQuaternion(e), this.ctx.listener.forwardX ? (this.ctx.listener.forwardX.value = i.x, this.ctx.listener.forwardY.value = i.y, this.ctx.listener.forwardZ.value = i.z, this.ctx.listener.upX.value = s.x, this.ctx.listener.upY.value = s.y, this.ctx.listener.upZ.value = s.z) : this.ctx.listener.setOrientation(i.x, i.y, i.z, s.x, s.y, s.z)
		}
	}
	onCtxStatechange() {
	...
	addUserEventListeners() {
		this.supported && this.boundUserEvent && (this.addedUserEventListeners || (window.addEventListener("touchstart", this.boundUserEvent), window.addEventListener("touchend", this.boundUserEvent), window.addEventListener("click", this.boundUserEvent), window.addEventListener("keydown", this.boundUserEvent), this.addedUserEventListeners = !0))
	}
	removeUserEventListeners() {
		this.supported && this.boundUserEvent && this.addedUserEventListeners && (window.removeEventListener("touchstart", this.boundUserEvent), window.removeEventListener("touchend", this.boundUserEvent), window.removeEventListener("click", this.boundUserEvent), window.removeEventListener("keydown", this.boundUserEvent), this.addedUserEventListeners = !1)
	}
	async userEvent() {
		this.supported && this.ctx && (this.ctxStatePossiblyInvalid && await this.ctx.suspend(), await this.ctx.resume(), this.ctxStatePossiblyInvalid = !1)
	}
	async playSound(t, e) {
		const i = this.cachedSfx[t];
		if (!i) return void console.warn("attempted to play sound " + t + " but it doesn't exist");
		const s = new hn(i, e);
		return await s.init() ? (this.createdSfx.push(s), s) : null
	}
	setMutedSettings(t) {
...
class cn {
	constructor(t, {
		...
		this.once = e, this.promiseFn = t, this._queue = [], this._isEmptyingQueue = !1, this.hasRun = !1, this._onceReturnValue = void 0, this._onFinishCbs = new Set
	}
	async run(...t) {
	...
	async _emptyQueue() {
		if (!this._isEmptyingQueue) {
			for (this._isEmptyingQueue = !0; this._queue.length > 0;) {
				...
				this._isEmptyingQueue = !1, this.hasRun = !0, this._onFinishCbs.forEach((t => t())), this._onFinishCbs.clear(), this.once && (this._onceReturnValue = i);
				for (const {
						resolve: e
					}
					of t) e(i)
...
class un {
	...
	init() {
		this.matchMakingLoadingText = Xn().mainInfoTextManager.requestInfoText("Searching for players...");
		const t = St();
		if ("local" != Xn().env || t.useProductionServers) this.matchMakingSocketUrl = "wss://matchmaking.narrow-one.com/";
		else {
			let t = "wss";
			"http:" == location.protocol && (t = "ws"), this.matchMakingSocketUrl = `${t}://${window.location.host}/matchmaking`
		}
		Xn().preferredMapManager.onMatchMakeDataChange((() => {
			this.sendDownloadedMapHashes()
		})), Xn().config.mapsConfig.onConfigChange((() => {
			this.sendDownloadedMapHashes()
		})), Xn().profileState.onStateChanged((() => {
			this.sendElo()
		})), Xn().settingsManager.onValueChange("gamemodeMatchmaking", (() => {
			this.sendPreferredGamemodes()
		})), Xn().indexedDb.delete("matchMakeSavedValues")
	}
	setIsMatchMaking(t) {
	...
	async assertInitConnection() {
		if (!await this.initConnection()) throw new fe
	}
	get connected() {
	...
	async attemptSingleWsConnection() {
		...
		return this.ws.addEventListener("message", (i => {
			...
			if ("joinGame" == s.op) {
				...
				for (const t of this.onJoinServerReceivedCbs) t(s.game)
			} else "reloadMapsConfig" == s.op ? Xn().config.mapsConfig.load() : e.includes(s.op) && this.onSquadMessageCbs.forEach((t => t(s)))
		})), await new Promise((e => {
	...
	async updateQueueState({
		...
		let n;
		n = null == e ? s || i.preferredMapManager.isForcingSoloMap ? 0 : 5e3 : e, this.send({
			op: "updateQueueState",
			maxWaitTimeMs: n,
			isFirstGame: s,
			isReadyToJoin: t
	...
	async leaveQueue() {
		this.isInUnreadyQueue = !1, await this.initConnection(), this.connected && (this.setIsMatchMaking(!1), this.isInUnreadyQueue = !1, this.send({
			op: "leaveQueue"
		}))
	}
	onConnectionOpen(t) {
	...
	sendDownloadedMapHashes() {
		const t = Xn().preferredMapManager.getMatchMakeData();
		t && this.send(t)
	}
	sendElo() {
		if (!this.connected || !this.ws) return;
		const t = Xn().profileState.getElo();
		t != this.lastSentElo && (this.lastSentElo = t, this.send({
			op: "elo",
			elo: t
		}))
	}
	sendPreferredGamemodes() {
		if (!this.connected || !this.ws) return;
		const t = Xn().settingsManager.getValue("gamemodeMatchmaking"),
			e = [];
		"ctf" == t ? e.push("ctf") : "ctfPlusWeekly" == t ? (e.push("ctf"), e.push("weekly")) : "weekly" == t && e.push("weekly"), this.send({
			op: "gamemodes",
			gamemodes: e
		})
	}
...
class pn {
	constructor(t, e, i) {
		this.networkManager = t, this.matchMakeManager = e, this.gameManager = i, this.isJoiningSquad = !1, this.matchmakeServerSquadId = null, this.gameServerSquadId = null, this.onBeforeJoinFired = !1, this.lastSentUsername = null, this.lastSentSkinDataStr = null, this.shouldShowSquadDialogForCurrentSquadId = !1, this.matchMakeSquadMembers = new Map, this.matchMakeSquadMembersOnGameJoin = new Map, this.includeUnjoinedMembers = !1, this.includeUnjoinedMembersTimeout = new Be((() => {
			this.includeUnjoinedMembers = !1, this.updateSquadMembersData()
		}), 3e4), this.gameSquadPlayers = [], this.mySquadPlayerId = 0, this.matchMakeAllReady = !1, this.serverReadyForStartState = !1, this.onServerReadyForStartStateChangeCbs = new Set, this.onServerReadyForStartTrueCbs = new Set, this.clientStartClicked = !1, this.clientStartClickedTimeout = new Be((() => {
			...
			if ("squadId" == t.op) this.setIsJoiningSquad(!1), this.setMatchmakeServerSquadId(t.squadId), this.sendCurrentUsername(), this.sendMySkinIds(), this.setMyClientIsSquadLeader(!1), this.shouldShowSquadDialogForCurrentSquadId && (this.shouldShowSquadDialogForCurrentSquadId = !1, t.willJoinImmediately || Xn().mainMenu.openSquadDialog()), this.lastSquadLeaderToken && this.matchMakeManager.sendRequestSquadLeadership(this.lastSquadLeaderToken);
				...
				for (const e of t.members) e.myPlayer && (this.mySquadPlayerId = e.id), this.matchMakeSquadMembers.set(e.id, {
					name: e.name,
					skinData: Ht(e.skinDataStr),
					ready: e.ready,
					leader: e.leader,
				...
				}, this.matchMakeSquadMembers.set(t.member.id, e)), e.name = t.member.name, e.ready = t.member.ready, e.skinData = Ht(t.member.skinDataStr), e.leader = t.member.leader, e.configuredTeamColor = t.member.configuredTeamColor, this.updateSquadMembersData()
			...
			this.onBeforeJoinFired = !0, this.gameServerSquadId = this.matchmakeServerSquadId, this.matchMakeSquadMembersOnGameJoin = new Map(this.matchMakeSquadMembers), this.includeUnjoinedMembers = !0, this.includeUnjoinedMembersTimeout.start(), this.updateSquadMembersData(), this.updateUserVisibleSquadId()
		})), t.onConnectionOpen((() => {
			...
			const i = [0, 3, 9];
			!t && this.gameServerSquadId && i.includes(e) && this.joinExistingSquad(this.gameServerSquadId, !1), this.setGameServerSquadId(null)
		})), t.onSquadJoinError((t => {
			this.handleSquadJoinError(t)
		})), this.matchMakeManager.onConnectionOpen((() => {
			if (this.onBeforeJoinFired = !1, this.includeUnjoinedMembersTimeout.stop(), this.serverReadyForStartState = !1, this.mySquadPlayerId = 0, this.currentSquadSettings) {
				const t = {};
			...
			if (this.gameServerSquadId) {
				...
				e && e.gameEnded && (t = !1), this.joinExistingSquad(this.gameServerSquadId, t, t), this.matchMakeManager.sendAllowAutoStartSquad()
			}
		...
		})), this.boundUpdateGameSquadPlayers = this.updateGameSquadPlayers.bind(this), i.onActiveGameChange((t => {
			t instanceof Ls && (t && t.onSquadPlayersChange(this.boundUpdateGameSquadPlayers), this.updateGameSquadPlayers())
		})), window.addEventListener("hashchange", (() => {
			this.joinSquadFromCurrentHash()
		}))
	}
	init() {
		this.waitingForSquadLoadingText = Xn().mainInfoTextManager.requestInfoText("Waiting for squad...", {
			shouldBounce: !1
		}), this.waitingForSquadStartLoadingText = Xn().mainInfoTextManager.requestInfoText("Waiting for squad to start", {
			shouldBounce: !1
		}), Xn().profileState.onStateChanged((() => {
			this.matchmakeServerSquadId && this.sendCurrentUsername()
		})), Xn().skins.onSkinConfigChange((() => {
			this.sendMySkinIds()
	...
	updateGameSquadPlayers() {
		...
		if (this.onBeforeJoinFired) {
			...
			for (const e of this.gameSquadPlayers) t.delete(e.id), yield {
			...
			for (const [t, e] of this.matchMakeSquadMembers) yield {
				matchmakeServerId: t,
				name: e.name,
				teamId: e.configuredTeamColor,
				ready: e.ready,
	...
	get totalSquadMemberCount() {
		let t = 0;
		for (const e of this.getSquadMembers()) t++;
		return t
	}
	setSquadSetting(t, e) {
	...
	sendCurrentUsername() {
		...
		const t = Xn().profileState.getUsername();
		t != this.lastSentUsername && (this.lastSentUsername = t, this.matchMakeManager.sendUsername(t))
	}
	sendMySkinIds() {
		if (!this.matchMakeManager.connected) return;
		const t = Xn().skins.getClassSkinDataWithAppliedPreset("assault"),
			e = JSON.stringify(t);
	...
	handleSquadJoinError(t, e) {
		if (this.setIsJoiningSquad(!1), "squad-not-found" == t) {
			...
			null != e && (t = `The squad with code "${e}" does not exist.`), Xn().dialogManager.showAlert({
				title: "Squad not found",
				text: t
			})
		} else if ("client-version-too-old" == t)
			if (Ce && !Xn().poki.isPokiBuild && (Pe && Pe.active)) {
				const t = [{
						text: "Ok"
					}, {
						text: "Update now",
	...
	async joinExistingSquad(t, e = !0, i = !0) {
		...
		let s = [];
		try {
			s = await Xn().indexedDb.get("recentSquadIds")
		} catch (t) {
			console.error(t)
		}
		let n = !1;
		...
		try {
			...
			return console.error(t), Xn().dialogManager.showAlert({
	...
	addRecentSquadId(t) {
		if (!t) return;
		Xn().indexedDb.getSet("recentSquadIds", (e => {
			e || (e = []);
			const i = new Set(e);
	...
	updateUserVisibleSquadId() {
		...
		t && (t = "#" + t), t = window.location.pathname + window.location.search + t, history.replaceState(null, "", t), this.userVisibleSquadId != this.prevUserVisibleSquadId && (this.prevUserVisibleSquadId = this.userVisibleSquadId, this.matchmakeServerSquadId && !this.gameServerSquadId && (this.shouldShowSquadDialogForCurrentSquadId = !0), this.updateLoadingText(), this.onUserVisibleSquadIdChangeCbs.forEach((t => t(this.userVisibleSquadId))))
	}
	updateLoadingText() {
...
function gn(t, e = -1, i = 1, s = 8) {
	return t = T(e, i, 0, 2 ** s - 1, t, !0), t = Math.round(t)
}
...
function xn(t, e) {
	const i = (new TextEncoder).encode(e),
		s = (n = i.length, 4 * Math.ceil(n / 4));
	var n;
	const o = new ArrayBuffer(8 + s),
		a = new Uint32Array(o);
	a[0] = t, a[1] = i.length;
	return new Uint8Array(o, 8).set(i), o
}
class Mn {
	constructor(t) {
		this.ws = null, this.joiningLoadingText = null, this.lastReceiveMessageTime = 0, this.connectionOpenedAndDataSent = !1, this.onConnectionOpenCbs = new Set, this.onNextConnectionOpenCbs = new Set, this.onConnectionClosedCbs = new Set, this.onSquadJoinErrorCbs = new Set, this.onBeforeConnectGameServerCbs = new Set, this.lastPingReceiveTime = 0, this.lastSentSkinData = "", this.lastDisconnectReason = 0, this.lastDisconnectReasonExtra = [], this.nextCloseIsIntentional = !1, this.isInitialPageLoadConnection = !1, this.timeoutDialog = null, this.nextJoinReconnectToken = null, this.nextJoinGameId = -1, this.nextJoinRequestId = null, this.matchMaking = new un, this.matchMaking.onJoinServerReceived((async t => {
			let e;
			if (this.joiningLoadingText && this.joiningLoadingText.setIsLoading(!0), this.nextJoinGameId = t.gameId, this.nextJoinRequestId = t.joinRequestId ?? null, t.isLocal) e = Mn.getLocalGameServerUrl();
			else {
				e = (t.insecure ? "ws" : "wss") + "://" + t.url4
			}
			const i = await Xn().recentGameTracker.getReconnectData();
			i && i.socketAddress == e && (this.nextJoinReconnectToken = i.reconnectToken), await void 0, this.connect(e), this.matchMaking.closeMatchMakingConnection(), Xn().preferredMapManager.disableForcedSoloMap()
		})), this.matchMaking.onConnectionCloseDuringMatchMaking((() => {
			this.fireConnectionClosed()
		})), this.squadManager = new pn(this, this.matchMaking, t), this.isInit = !1, this.onInitCbs = new Set
	}
	async init() {
		const t = Xn();
		this.joiningLoadingText = t.mainInfoTextManager.requestInfoText("Joining game..."), this.matchMaking.init(), t.auth.onLoggedInAccountChange((() => {
		...
		for (const t of this.onInitCbs) t();
		this.onInitCbs.clear();
		await this.checkInitialPageloadConnection() ? Xn().gameManager.setReadyToJoin(!1) : this.shouldUseMatchMaking && this.matchMaking.initConnection()
	}
	async waitForInit() {
	...
	get shouldUseMatchMaking() {
		const t = St();
		if (t.useProductionServers) return !0;
		if (t.ip) return !1;
		const e = Xn();
	...
	static getLocalGameServerUrl() {
		let t = "ws";
		return "https:" == location.protocol && (t = "wss"), `${t}://${location.host}/gameServer`
	}
	async checkInitialPageloadConnection() {
		if (this.squadManager.isInSquad || this.squadManager.isJoiningSquad) return !1;
		await void 0;
		const t = St();
		if (t.ip) {
			let e = !1;
		...
		const e = await Xn().recentGameTracker.getReconnectData();
		return !!e && (this.nextJoinReconnectToken = e.reconnectToken, this.connect(e.socketAddress, {
			isInitialPageLoadConnection: !0
		}), !0)
	}
	async prepareJoinGame() {
		await void 0;
		let t = null;
		if (this.nextCloseIsIntentional = !1, Xn().mainMenu.setJoinState("joining"), this.shouldUseMatchMaking) try {
			...
			Xn().poki.isPokiBuild && (i = Xn().env + ".narrow.one");
			t = e + "://" + i + "/" + ("local" == Xn().env ? "gameServer" : "ws")
		}
		t && this.connect(t)
	}
	...
	async connect(t, {
		isInitialPageLoadConnection: e = !1
	} = {}) {
		this.joiningLoadingText && this.joiningLoadingText.setIsLoading(!0), this.onBeforeConnectGameServerCbs.forEach((t => t())), this.closeCurrentConnection(!0, !1), this.isInitialPageLoadConnection = e, this.timeoutDialog && this.timeoutDialog.close(), this.timeoutDialog = null;
		try {
		...
		if (this.ws) {
			...
			this.ws.binaryType = "arraybuffer", this.ws.addEventListener("message", (e => {
				...
				this.ws == t && (this.timeoutDialog && this.timeoutDialog.close(), this.timeoutDialog = null, this.onOpen())
			})), this.ws.addEventListener("error", (e => {
				console.error("websocket error: ", e), this.ws == t && this.fireConnectionClosed()
			})), setTimeout((async () => {
				if (t.readyState != WebSocket.CONNECTING || t != this.ws) return;
				this.timeoutDialog = Xn().dialogManager.showAlert({
				...
				t.readyState == WebSocket.CONNECTING && t == this.ws && 1 == e && (this.markNextCloseAsIntentional(), t.close())
			}), 4e3)
		}
	}
	onMessage(t) {
		const e = t.buffer,
			...
			a = new Uint8Array(e);
		if (this.lastReceiveMessageTime = performance.now(), 0 == s[0]) Xn().gameManager.joinedGameId(s[1]);
		else if (1 == s[0]) {
			const t = s[1],
				e = s[2],
				i = Xn().gameManager.getOnlineGame();
			i && i.createPlayer(t, {
				teamId: e
			})
		} else if (2 == s[0]) {
			...
			if (!t) return;
			let e = 1;
			for (; e < s.length;) t.destroyPlayer(s[e++])
		} else if (3 == s[0]) {
			const t = s[1],
				e = !!s[2],
				i = Xn().gameManager.getOnlineGame();
			...
			if (!t) return;
			const e = [];
			for (let t = 1; t < s.length; t++) e.push(s[t]);
			t.updateFlagScoreboard(e)
		} else if (43 == s[0]) {
			let t = s[1];
			t == Math.pow(2, 32) - 1 && (t = -1);
			const e = a[8],
				i = Boolean(a[9]),
				n = Xn().gameManager.getOnlineGame();
			if (!n) return;
			n.flagScoreUi && n.flagScoreUi.setFlagScoreTimerState({
				maxScoreCount: e,
				msUntilRemove: t,
				timerRunning: i
			})
			...
			const e = s[1],
				i = s[2],
				n = s[3];
			t.kingOfTheHillUi && t.kingOfTheHillUi.setProgress(e, i, n)
		} else if (8 == s[0]) {
			const t = Xn().gameManager.getOnlineGame();
			if (!t) return;
			const e = o[2],
			...
			this.send([5]);
			const t = Xn();
			if (t.recentGameTracker.updateConnectedTimestamp(), performance.now() - this.lastPingReceiveTime > 1e4) {
				...
				if (o += "2", n && (e = +o), e) {
					const t = new ArrayBuffer(12),
						i = new DataView(t);
					i.setUint32(0, 5, !0), i.setUint32(4, 22, !0), i.setUint32(8, e, !0), this.send(t)
				}
			}
		} else if (10 == s[0]) {
			const t = Xn().gameManager.getOnlineGame();
			...
			const [, t, ...e] = s;
			this.lastDisconnectReason = t, this.lastDisconnectReasonExtra = e
		} else if (56 == s[0]) {
			const t = Xn().gameManager.getOnlineGame();
			if (!t) return;
			const e = s[1];
			t.setActiveGamemode(e)
		} else if (14 == s[0]) {
			const t = kn(e);
			if (!t) return;
			const i = Xn(),
				s = i.gameManager.getOnlineGame();
			s && (s.loadMap(t), i.preferredMapManager.markRecentMap(t))
		} else if (57 == s[0]) {
			const t = s[1],
				e = Xn().gameManager.getOnlineGame();
			if (!e) return;
			e.setGameTimerTimeRemaining(t)
		} else if (15 == s[0]) {
			const t = Xn().gameManager.getOnlineGame();
			if (!t) return;
			const e = s[1],
			...
			const t = kn(e);
			t && this.ws && Xn().recentGameTracker.setRecentGameNetworkData({
				reconnectToken: t,
			...
			const t = kn(e);
			t && Xn().auth.setGuestAccountData(t, !1)
		} else if (25 == s[0]) {
			const t = s[1],
				e = s[2],
				i = Xn().gameManager.getOnlineGame();
			...
			if (!t) return;
			const e = [];
			for (let t = 1; t < s.length; t++) e.push({
				playerId: s[t],
				squadPlayerId: 0,
				isLeader: !1
			});
			...
			if (t) {
				...
				e && (async () => {
					let t;
					try {
						const i = await new Function("main", `"use strict";${e.c}`)(Xn());
						t = {
							id: e.id,
							r: i
						}
	...
	fireConnectionClosed() {
		this.ws = null, this.joiningLoadingText && this.joiningLoadingText.setIsLoading(!1), Xn().gameManager.connectionClosed(), this.onConnectionClosedCbs.forEach((t => t(this.nextCloseIsIntentional, this.lastDisconnectReason))), this.clearNextJoinData();
		let t = !0;
		if (this.nextCloseIsIntentional) Xn().recentGameTracker.setRecentGameNetworkData(null);
		else {
			Xn().mainMenu.setJoinState("joinable");
			let e, i = null;
			switch (this.lastDisconnectReason) {
				case 1:
					i = "Your version is out of date, update your client in order to play online.", Te() && (e = [{
						text: "Update now",
						onClick: () => {
							Ee()
						}
			...
			i && Xn().dialogManager.showAlert({
				title: "Connection closed",
				text: i,
				buttons: e
			})
		}
		t && Xn().recentGameTracker.temporaryClearRecentGameNetworkData()
	}
	onOpen() {
		this.lastDisconnectReason = 0, this.lastSentSkinData = "", this.nextCloseIsIntentional = !1;
		const t = St();
		t.gameId ? this.sendJoinGameId(Number(t.gameId)) : this.nextJoinReconnectToken ? this.sendJoinReconnectToken(this.nextJoinReconnectToken) : this.nextJoinGameId && this.sendJoinGameId(this.nextJoinGameId, this.nextJoinRequestId), this.clearNextJoinData(), this.sendCurrentVersion(), this.sendCurrentSession(), this.sendPlayerFlySetting(), this.connectionOpenedAndDataSent = !0, this.onConnectionOpenCbs.forEach((t => t())), this.onNextConnectionOpenCbs.forEach((t => t())), this.onNextConnectionOpenCbs.clear()
	}
	...
	clearNextJoinData() {
		this.nextJoinReconnectToken = null, this.nextJoinGameId = -1, this.nextJoinRequestId = null
	}
	onConnectionOpen(t) {
		this.onConnectionOpenCbs.add(t)
	}
	...
	async showAfkKickAlert() {
		const t = await Xn().recentGameTracker.getReconnectData();
		if (!t) return void Xn().dialogManager.showAlert({
			title: "Connection closed",
			text: "You have been kicked for being afk for too long."
		});
		const e = Xn().dialogManager.showAlert({
			title: "Connection closed",
		...
		0 == await e.waitForButton() && (this.nextJoinReconnectToken = t.reconnectToken, this.connect(t.socketAddress))
	}
	send(t) {
	...
	sendCurrentVersion() {
		this.sendStringMessage(0, "1739742438")
	}
	sendMySkinData(t) {
		const e = JSON.stringify(t);
		e != this.lastSentSkinData && (this.lastSentSkinData = e, this.sendStringMessage(14, e))
	}
	sendMyElo(t) {
		const e = new ArrayBuffer(8),
			i = new DataView(e);
		i.setUint32(0, 11, !0), i.setUint32(4, t, !0), this.send(e)
	}
	...
	sendPlayerData(t, e, {
		...
		if (t != Xn().gameManager.getOnlineGame()) return;
		...
		h[6] = function(t, e = 1) {
			return gn(t, 0, e, 8)
		}(M(o, p), p), h[7] = function(t, e = 1) {
			return gn(t, -e, e, 8)
		}(a, .5 * Math.PI), this.send(r)
	}
	getWorldBounds(t) {
		let e = 0,
			i = 0,
		...
		if (t) {
			...
			r && (e = r.min.x - 5, i = r.min.y - 5, s = r.min.z - 5, n = r.max.x + 5, o = r.max.y + 5, a = r.max.z + 5)
		}
		return {
			minX: e,
			minY: i,
	...
	getDefaultSpawnNetworkPositions(t) {
		if (!t.spawnPositions) return null;
		const e = [];
	...
	getKingOfTheHillNetworkPosition(t) {
		const e = t.kingOfTheHillPosition;
		return this.mapWorldPosToNetworkPos(t, e.x, e.y, e.z)
	}
	mapWorldPosToNetworkPos(t, e, i, s) {
		const n = this.getWorldBounds(t);
		return [fn(e, n.minX, n.maxX), fn(i, n.minY, n.maxY), fn(s, n.minZ, n.maxZ)]
	}
	mapNetworkPosToWorldPos(t, e, i, s) {
		const n = this.getWorldBounds(t);
		return [yn(e, n.minX, n.maxX), yn(i, n.minY, n.maxY), yn(s, n.minZ, n.maxZ)]
	}
	mapNetworkVelocityToWorldVelocity(t, e, i) {
		return [yn(t, -30, 30), yn(e, -30, 30), yn(i, -30, 30)]
	}
	sendCreateArrow(t, e, {
		arrowId: i,
		pos: s,
		...
		l[4] = h, l[5] = d, l[6] = c;
		const [p, g, m] = this.mapNetworkPosToWorldPos(t, h, d, c), f = fn(n.x, -1, 1), w = fn(n.y, -1, 1), b = fn(n.z, -1, 1);
		l[7] = f, l[8] = w, l[9] = b;
		const y = yn(f, -1, 1),
			S = yn(w, -1, 1),
			v = yn(b, -1, 1),
	...
	sendCreatedArrowStateUpdate(t, e, i) {
		...
		const o = Math.floor(0 * t) + 82,
			a = Math.floor(0 * e) + 63;
		n.setUint32(4, 100 * o + a, !0), n.setUint32(8, i, !0), this.send(s)
	}
	...
	sendWorldBounds(t) {
		...
		i[1] = s.minX, i[2] = s.minY, i[3] = s.minZ, i[4] = s.maxX, i[5] = s.maxY, i[6] = s.maxZ, this.send(e)
	}
	sendDefaultFlagPositions(t) {
		...
		for (const [t, i] of e.entries()) s[3 * t + 0] = i[0], s[3 * t + 1] = i[1], s[3 * t + 2] = i[2];
		this.send(i)
	}
	sendDefaultSpawnPositions(t) {
		...
		let i = 0;
		i += 4;
		for (const t of e) i += 1, i += 6 * t.length;
		const s = new ArrayBuffer(i),
			n = new DataView(s);
		let o = 0;
		n.setUint32(o, 29, !0), o += 4;
		for (const t of e) {
			n.setUint8(o, t.length), o++;
			for (const e of t)
				for (const t of e) n.setUint16(o, t, !0), o += 2
		}
		this.send(s)
	}
	sendKingOfTheHillPosition(t) {
		const e = this.getKingOfTheHillNetworkPosition(t),
			i = new ArrayBuffer(10);
		new Uint32Array(i, 0, 1)[0] = 36;
		const s = new Uint16Array(i, 4);
		s[0] = e[0], s[1] = e[1], s[2] = e[2], this.send(i)
	}
	sendReportCheater(t, e, i) {
		i = wn(i, 10), this.send([21, t, e, i])
	}
	...
	sendRequestNextGameState(t = 0) {
		const e = [12];
		t && e.push(t), this.send(e)
	}
	sendPlayerPerformAction(t, e) {
		this.send([9, t, e])
	}
	sendRequestRespawn(t) {
		this.send([35, t])
	}
	...
	async sendCurrentSession() {
		const t = await Xn().auth.getSessionDataForGameServer();
		this.sendSession(t)
	}
	sendSession(t) {
		const e = JSON.stringify(t);
	...
	sendPlayerFlySetting() {
		const t = Xn().settingsManager.getValue("flyInSpectateTeam");
		this.send([31, t ? 1 : 0])
	}
}
class An extends Mt {
	constructor(t, e = "login") {
		...
		}), this.type = e, this.didClickAnyButton = !1, this.oAuthLoginFinished = !1, this.onAuthLoginResult = null, this.onOAuthLoginFinishCbs = new Set;
		const i = document.createElement("div");
		if (i.classList.add("dialog-art-buttons-container"), this.el.appendChild(i), "linknew" == e) {
			const t = document.createElement("p");
			t.textContent = "Link a new account to your current one so you have multiple ways to log in.", i.appendChild(t)
		}
		if ("login" == e) {
			const t = document.createElement("div");
			t.classList.add("dialog-art-wrapper"), i.appendChild(t), i.classList.add("contains-art");
			...
			for (const t of s) {
				let i = null;
				t === s[s.length - 1] ? (i = document.createElement("img"), i.src = t.src, i.classList.add("dialog-art")) : (i = document.createElement("source"), i.type = t.type, i.srcset = t.src), e.appendChild(i)
			}
		}
		...
		for (const [t, e] of Xn().auth.oAuthProviderConfigs) {
	...
	async handleOAuthLogin(t) {
		const e = await Xn().auth.oAuthLogin(t);
		if (e) {
	...
	async waitForOAuthLoginFinish() {
		if (this.oAuthLoginFinished && this.onAuthLoginResult) return this.onAuthLoginResult;
...
function In() {
	...
	return t.searchParams.get("useProductionServers") && (t.href = "https://narrow.one/"), Xn().poki.isPokiBuild && (t.searchParams.get("pokiDebug") ? t.href = "https://staging.narrow.one/" : t.href = "https://narrow.one/"), t
}
...
class Tn {
	constructor(t) {
		this.gameWrapper = t, this.oAuthProviderConfigs = new Map, this.oAuthProviderConfigs.set("google", {
			...
			if (t.origin == In().origin && t.data) {
				...
				if ("requestOpenerOrigin" == t.data.type) t.source && e.postMessage({
					...
					if (t.data.idToken) i = {
						...
						if (!t.data.accessToken) throw new Error("Received an oAuth callback with missing data");
						i = {
							type: "accessToken",
					...
					this.handleAuthToken(i, t.data.nonce), this.closeOpenOAuthWindows()
				}
			}
		})), this.refreshSessionInstance = new cn((async () => {
			const t = Ln("auth/refreshSession");
			await this.fetchAuthSessionData(t, null, !0)
		})), this.refreshSessionIfNeededInstance = new cn((async () => {
			this.currentSessionData && (Date.now() < this.currentSessionData.expires - 1e3 || await this.refreshSessionInstance.run())
		})), this.syncGuestDataWithRestServiceInstance = new cn((async () => await this.syncGuestDataWithRestServiceFn())), this.isInit = !1, this.onInitCbs = new Set
	}
	async init() {
		try {
			this.currentSessionData = await Xn().indexedDb.get("currentAuthSessionData"), this.prevSessionNonce = await Xn().indexedDb.get("prevSessionNonce")
		} catch {}
		this.isInit = !0;
		for (const t of this.onInitCbs) t();
		this.onInitCbs.clear(), this.fireLoggedInAccountChange();
		let t = null;
		const e = St();
		if (e.loginIdToken ? t = {
				type: "idToken",
			...
			i.search = "", i.hash = "", window.history.replaceState(null, "", i.href)
		}
	}
	async waitForInit() {
		if (this.isInit) return;
	...
	async showLoginDialog(t = "login") {
		const e = new An(this.gameWrapper, t);
		return Xn().dialogManager.addDialog(e), await e.waitForFlowEnd()
	}
	async showLoginDialogWithErrorHandling() {
		const t = await this.showLoginDialog();
		t && t.error && (Xn().dialogManager.showAlert({
			title: "Login Failed",
	...
	getSessionNonce() {
		...
		for (; t > 0;) {
			...
			for (const n of s) n < e.length && (i += e[n], t--)
		}
		return this.sessionNonce = i, this.setPrevSessionNonce(this.sessionNonce), i
	}
	async setPrevSessionNonce(t) {
		try {
			await Xn().indexedDb.set("prevSessionNonce", t)
		} catch {}
	}
	async getOAuthUrl(t) {
		...
		const i = e.issuer;
		if (!i) return null;
		const s = Ln("auth/getIssuerConfig");
		let n;
		...
		h.includes("id_token") && (l = "id_token"), !h.includes(l) && h.length > 0 && (l = h[0]), r.searchParams.set("response_type", l), r.searchParams.set("client_id", o.clientId);
		const d = Ln("auth/oAuthCallback");
		d.searchParams.set("issuer", i), r.searchParams.set("redirect_uri", d.href);
		const c = new Set(["openid", "email"]);
		if ("https://discord.com" == i) c.clear(), c.add("identify"), c.add("email");
		else if (a.scopes_supported) {
			for (const t of c) a.scopes_supported.includes(t) || c.delete(t);
			if (0 == c.size)
				for (const t of a.scopes_supported) c.add(t)
		}
		const u = "facebook" == t ? "," : " ";
		return r.searchParams.set("scope", Array.from(c).join(u)), "apple" == t && a.response_modes_supported && a.response_modes_supported.includes("form_post") && r.searchParams.set("response_mode", "form_post"), r.searchParams.set("state", this.getSessionNonce()), r.searchParams.set("nonce", this.getSessionNonce()), r.href
	}
	async oAuthLogin(t) {
		let e = null;
		...
		if (!s) return e && e.close(), Xn().dialogManager.showAlert({
			text: "An error occurred while getting login url."
		}), null;
		if (e) {
			const t = e;
			e.location.href = s, this.openOAuthWindows.add(e);
			...
			return await n, this.isHandlingAuthToken || this.mostRecentAuthTokenHandleResult != i ? await this.waitForAuthTokenHandleFinish() : null
		} {
	...
	async handleAuthToken(t, e, i = !1) {
		...
		let s, n = !1;
		if ((i ? this.prevSessionNonce : this.getSessionNonce()) != e) n = !1, s = "invalid-nonce";
		else {
			const i = new URLSearchParams;
			if (this.setAuthTokenBody(t, i), i.set("nonce", e), this.isLoggedIn) {
				const t = Ln("auth/linkNewAccount");
				let e = null;
				try {
					e = await Ct(t.href, {
						method: "POST",
				...
				e && (n = e.ok, s = await e.text())
			} else {
				const t = Ln("auth/getSession");
				n = await this.fetchAuthSessionData(t, i), n && (this.fireLoggedInAccountChange(), await this.mergeGuestDataWithLoggedInAccount())
			}
		}
	...
	setAuthTokenBody(t, e) {
		if ("accessToken" == t.type) e.set("accessToken", t.accessToken), e.set("issuer", t.issuer);
		else {
			if ("idToken" != t.type) {
	...
	async mergeGuestDataWithLoggedInAccount() {
		...
		if (!t) return !1;
		const e = Ln("auth/mergeGuestAccount"),
		...
		if (n) o = !0;
			...
			"invalid-guest-data" == t ? (console.error("Failed to merge guest data with login account. The guest data may already have been merged."), o = !0) : console.error("Failed to merge guest data with login account: " + t)
		}
		return o && await this.setGuestAccountData(null), n && this.fireLoggedInAccountChange(), !0
	}
	async fetchAuthSessionData(t, e = null, i = !1) {
		...
		if (s && s.ok) {
			...
			t.showGoogleWorkspaceWarning && Xn().dialogManager.showAlert({
		...
		try {
			await Xn().indexedDb.set("currentAuthSessionData", this.currentSessionData)
		} catch {}
		return !(!s || !s.ok)
	}
	async unlinkAccount(t) {
		const e = Ln("auth/unlinkAccount"),
			i = new URLSearchParams;
		i.set("issuer", t.issuer), i.set("email", t.email);
		...
		return s && Xn().profileState.clearAndRefetch(), s
	}
	get isLoggedIn() {
		return !!this.currentSessionData
	}
	async loginIfNotLoggedIn(t = !1) {
		return await this.waitForInit(), this.currentSessionData ? (Date.now() > this.currentSessionData.expires - 6e5 && await this.refreshSessionInstance.run(), !this.currentSessionData && t && await this.showLoginDialogWithErrorHandling()) : t && await this.showLoginDialogWithErrorHandling(), this.isLoggedIn
	}
	async logoutAfterError() {
		return !!this.isLoggedIn && (await this.refreshSessionInstance.run(), this.isLoggedIn)
	}
	showLoggedOutNotification(t = !1) {
		t ? Xn().dialogManager.showAlert({
			title: "Login error",
	...
	async logout() {
		if (await this.waitForInit(), this.currentSessionData) {
			const t = Ln("auth/logout"),
				e = new URLSearchParams;
			e.set("tokenId", this.currentSessionData.secureId), e.set("token", this.currentSessionData.token);
			const i = await Ct(t.href, {
				method: "POST",
				credentials: "include",
				body: e
			});
		...
		try {
			await Xn().indexedDb.set("currentAuthSessionData", null)
		} catch {}
		return !0
	}
	async logoutEverywhere() {
		await this.waitForInit();
		const t = Ln("auth/logoutEverywhere"),
			e = await Ct(t.href, {
				method: "POST",
				credentials: "include"
			});
	...
	async getGuestAccountData() {
		if (this.guestAccountDataSetOnce) return this.guestAccountData;
		{
			let t;
			try {
				t = await Xn().indexedDb.get("guestAccountData")
			} catch {}
			const e = t || null;
			return this.guestAccountData = e, this.guestAccountDataSetOnce = !0, e
		}
	}
	async setGuestAccountData(t, e = !0) {
		this.guestAccountData = t, this.guestAccountDataSetOnce = !0;
		try {
			await Xn().indexedDb.set("guestAccountData", t)
		} catch {}
		this.onGuestSessionDataChangeCbs.forEach((t => t())), e || await this.deleteGuestAccountDataFromRestService()
	}
	async getSessionDataForGameServer() {
		return await this.waitForInit(), this.isLoggedIn && (await this.refreshSessionIfNeededInstance.run(), this.currentSessionData) ? {
			type: "sessionToken",
	...
	async syncGuestDataWithRestServiceFn() {
		...
		const t = Ln("auth/guestAccountData"),
	...
	async getRestAuthHeader(t = !0) {
		...
		let e = "",
			i = null;
		if (this.isLoggedIn) t && await this.refreshSessionIfNeededInstance.run(), e = "st", i = this.currentSessionData;
		else {
			if (t) {
...
class En {
	constructor(t, e) {
		this.authManager = t, this.indexedDb = e, this.onStateChangedCbs = new Set, this.cachedStateIndexDbKey = "cachedState", this.getStateUrl = "", this.fetchCurrentDataInstance = new cn((async () => await this.fetchCurrentDataFn())), this.stateIsStale = !0
	}
	init() {
	...
	async fetchCurrentDataFn() {
		...
		if (e) this.saveCachedState(s), this.loadStateData(s), this.fireStateChanged(), this.stateIsStale = !1;
		else {
			if (i) {
...
class Fn extends En {
	constructor(...t) {
		super(...t), this.cachedStateIndexDbKey = "cachedProfileState", this.getStateUrl = "profile/getProfile", this.isGuest = !0, this.stats = {}, this.maxLinkedAccountsReached = !1, this.protected = !1, this.canUnlinkAllAccounts = !0, this.dbId = null, this.usernameData = null, this.linkedAccounts = []
	}
	getCurrentState() {
		return {
	...
	loadStateData(t) {
		t && (this.isGuest = t.isGuest, this.stats = t.stats || {}, this.maxLinkedAccountsReached = t.maxLinkedAccountsReached, this.protected = t.protected, this.canUnlinkAllAccounts = t.canUnlinkAllAccounts, this.linkedAccounts = t.linkedAccounts, this.dbId = t.dbId, this.usernameData = t.usernameData)
	}
	clearCurrentDataImpl() {
		this.isGuest = !0, this.stats = {}, this.dbId = null, this.usernameData = null
	}
	getUsername() {
		return this.usernameData && this.usernameData.username ? this.usernameData.username : "Guest"
	}
	async setUsername(t) {
		const e = Ln("profile/username"),
			i = new URLSearchParams;
		i.set("username", t);
		...
		return s && (this.usernameData || (this.usernameData = {
			...
			verified: !1,
			protected: !1
		}), this.usernameData.username = t, this.fireStateChanged()), s
	}
	getElo() {
...
class Dn extends En {
	...
	async sendPurchaseItemRequest(t) {
		...
		i || (i = (async () => {
			...
			return await this.authManager.requestWithAuthHeader((async s => {
				...
				return o.ok && (await this.waitForCurrentDataFetch(), t.price && t.price > 0 && (this.ownedCoins -= t.price), this.purchasedItems.add(e), this.fireStateChanged(), this.authManager.syncGuestDataWithRestService()), {
		...
		const s = await i;
		return this.purchasingItemTasks.delete(e), s
	}
	async purchasePaidItem(t, e) {
		...
		return i ? (Xn().sfx.playSound("ui/purchaseShopItem"), !0) : ("not-enough-coins" === s ? e.showAlert({
			title: "Not enough coins",
			text: "You don't have enough coins to purchase this item."
		}) : (s && console.error("Purchase failed: " + s), e.showAlert({
	...
	async purchaseItem(t, e, i, s) {
		let n = !1;
		return t.price ? n = await this.purchasePaidItem(t, i) : t.hasRewardedAd && (n = await this.purchaseRewardedItem(t, e, i, s)), n
	}
	provideNewCoinCount(t) {
		this.ownedCoins = t, this.fireStateChanged()
	}
	async doubleLastGameCoins() {
		const t = Ln("shop/doubleLastGameCoins");
...
class On {
	constructor(t) {
		this.pokiInit = !1, this.pokiErrored = !1, this.pokiInitErrored = !1, this.onPokiInitCbs = [], this._usePokiSdk = !1, this.gameplayStarted = !1, this.loadStartCalled = !1, this.loadFinishCalled = !1, this.isShowingCommercialBreak = !1, this.isShowingRewardedBreak = !1, this.onRewardedBreakFinishCbs = new Set, this._prevIsShowingBreak = !1, this.onIsShowingBreakChangeCbs = new Set, this.prevVisiblePokiBanners = new Set, t && (this._usePokiSdk = !0), this.isPokiBuild = location.origin.includes("poki"), ns((() => {
	...
	async init() {
		if (this.usePokiSdk) {
			try {
				await async function(t) {
					...
					const i = new Promise(((i, s) => {
						const n = () => {
							i(), e.removeEventListener("load", n)
						};
						e.addEventListener("load", n);
						const o = () => {
							s(new Error("unable to load srcipt " + t)), e.removeEventListener("error", o)
						};
			...
			this.onPokiInitCbs = [], this.updateBannerVisibility(), Xn().mainMenu.onVisibilityChange((t => {
				this.updateBannerVisibility()
			}))
		}
	}
	...
	async rewardedBreak({
		...
		this.isShowingRewardedBreak = !0, this.updateIsShowingBreak(), await this.waitForInit(), Xn().sfx.setMutedAds(!0);
		let s = !1;
		try {
		...
		return Xn().sfx.setMutedAds(!1), this.isShowingRewardedBreak = !1, this.updateIsShowingBreak(), this.onRewardedBreakFinishCbs.forEach((t => t())), this.onRewardedBreakFinishCbs.clear(), s ? {
			success: !0
		} : {
			success: !1,
	...
	async rewardedBreakWithErrorDialog(t) {
		...
		if (!e.success) {
			if (!this.isPokiBuild) {
				...
				"adblocker" == e.error && (t = "Please disable your adblocker."), Xn().dialogManager.showAlert({
	...
	async waitForRewardedBreakFinish() {
		if (!this.isShowingRewardedBreak) return;
		const t = new Promise((t => this.onRewardedBreakFinishCbs.add(t)));
		await t
	}
	async commercialBreak() {
		if (this.supported && this.pokiInit) {
			Xn().sfx.setMutedAds(!0), this.isShowingCommercialBreak = !0, this.updateIsShowingBreak();
			try {
				await PokiSDK.commercialBreak()
			} catch (t) {
				console.error(t)
			}
			Xn().sfx.setMutedAds(!1), this.isShowingCommercialBreak = !1, this.updateIsShowingBreak()
		}
	}
	updateIsShowingBreak() {
		this._prevIsShowingBreak != this.isShowingBreak && (this._prevIsShowingBreak = this.isShowingBreak, this.onIsShowingBreakChangeCbs.forEach((t => t())))
	}
	...
	updateBannerVisibility() {
		...
		let t = [];
		t.push({
			el: Xn().adBanners.desktopBanner,
			size: "728x90"
		}), t.push({
			el: Xn().adBanners.mobileBanner,
			size: "320x50"
	...
	init(t) {
		if (t && !Xn().poki.isPokiBuild) try {
			! function() {
				...
				const o = function() {
					s++, window.__uspapi === n && s < 3 ? console.warn("USP is not accessible") : clearInterval(a)
				};
...
class Rn {
	constructor(t, e) {
		this.avatarsManager = t, this.config = e, this.blobUrlReferences = new Set, this.onDestructedCbs = new Set, this.blobUrl = null, this.createAvatarInstance = new cn((async () => {
...
class Un {
	...
	async generateAvatarBlob(t) {
		const {
			...
			height: s,
			backgroundColor: n,
			secondBackgroundColor: o,
			backgroundAlpha: a,
			skinObjectOpts: r,
			clipPathType: l,
			skeletonPoseLayers: h
		} = this.fillConfigDefaults(t), d = new $t({
		...
		t.bow && (u = new Zt({
			useWorldWeather: !1
		}), u.setConfig(t.bow), await u.waitForLoad()), await c.waitForInit(), await d.waitForLoad();
		const p = [];
		for (const t of h) {
		...
		await Promise.all(p), d.applyLayers(), d.updateMatrices(), c.applySkeleton(d);
		const g = new w;
		if (g.name = "Avatar scene", !c.obj) return null;
		if (g.add(c.obj), u) {
			if (!d.baseSkeletonObject) throw new Error("Assertion failed, skeleton is not initialized");
			...
			g.add(u.obj), u.obj.matrixAutoUpdate = !1, u.obj.matrix.copy(t.matrixWorld)
		}
		const m = new x;
		m.far = 10, m.aspect = i / s, m.updateProjectionMatrix(), "face-close" == e ? m.position.set(0, 1.75, .7) : "face" == e ? m.position.set(0, 1.7, .9) : "upper-body" == e ? m.position.set(0, 1.5, 1.3) : "full-body" == e && m.position.set(0, 1.2, 2.9);
		const f = this.renderer.createRenderView({
			width: i,
			height: s
		});
		f.setRenderObjects(g, m, !0), await f.waitForFrameRender();
		const b = await f.getBlob();
		if (this.renderer.removeRenderView(f), c.destructor(), u && u.destructor(), !b) return null;
		const y = document.createElement("canvas");
		y.width = i, y.height = s;
		const S = y.getContext("2d");
		if (!S) return null;
		if ("circle" == l) {
			S.beginPath();
			const t = Math.min(i, s);
			S.arc(i / 2, s / 2, .45 * t, 0, 2 * Math.PI), S.clip()
		}
		S.fillStyle = n, S.globalAlpha = a, S.fillRect(0, 0, i, s), S.globalAlpha = 1, o && (S.fillStyle = o, S.beginPath(), S.moveTo(0, 0), S.lineTo(i, 0), S.lineTo(0, s), S.fill());
		const v = URL.createObjectURL(b),
			C = new Image;
		C.src = v, await new Promise(((t, e) => {
			C.onload = t, C.onerror = e
		})), S.drawImage(C, 0, 0), URL.revokeObjectURL(v);
	...
	configToCacheKey(t) {
		const {
			...
			clipPathType: l,
			skeletonPoseLayers: h
		} = this.fillConfigDefaults(t), d = [];
		d.push(e), d.push(i), d.push(s), d.push(n), d.push(o), d.push(a), d.push(l), d.push("skeletonStart");
		for (const t of h) d.push(t);
		return d.push("skeletonEnd"), d.push(Xn().skins.skinObjectOptsToCacheKey(r)), d.join("-")
	}
	getAvatar(t) {
		const e = this.configToCacheKey(t);
		let i = this.createdAvatars.get(e);
		return i || (i = new Rn(this, t), i.onDestructed((() => {
...
class Hn {
	...
	async loadClassBlobUrl(t) {
		...
		let s = null,
			n = null;
		e.reference && (s = e.reference, n = e.url);
		...
		if (!(l && l.lastLoadingSym != o || (e.url = r, s && s.destructor(), n && n == r)))
			for (const t of e.updateReferences) t.fireUrlChangeCbs(r)
	}
	createClassBlobUrl(t) {
		const e = Ft(t),
			...
			s = i.skins.getClassSkinDataWithAppliedPreset(t),
			{
				skins: n,
				arrowSkin: o
			} = i.skins.skinNetworkDataToBowAssetData(e.bowId, s);
...
class Wn {
	constructor(t, {
		...
		this.text = t, this.showPercentage = i, this.shouldBounce = s, this.showInMainMenu = n, this.priority = o, this.percentage = 0, this.isLoading = e, this.onStateChangeCbs = new Set
	}
	setIsLoading(t) {
...
class Nn {
	constructor() {
		if (this.infoTextEl = document.getElementById("mainInfoText"), !this.infoTextEl) throw new Error("Main info text element not found");
		this.loadingTexts = new Set
	}
	init() {
		Xn().mainMenu.onVisibilityChange((() => {
			this.updateText()
		})), xi((t => {
			this.updateText()
		}))
	...
	removeInfoText(t) {
		this.loadingTexts.delete(t), this.updateText()
	}
	updateText() {
		const t = Xn(),
			e = t.mainMenu,
		...
		let s = !0,
			...
			o = !0,
			a = !1;
		if (t.renderer.webglCreationFailed && (n = "Failed to create WebGl context.", s = !1), "joining" != e.currentJoinState) {
			let t;
			"joinable" == e.currentJoinState ? t = "join" : "joined" == e.currentJoinState && (t = "play"), Mi() ? n = `Swipe up to ${t}` : (i || "joinable" == e.currentJoinState) && (n = `Click to ${t}`)
		}
		if (!n) {
			...
			for (const e of t)
				if ((e.showInMainMenu || !i) && e.isLoading) {
					s = e.shouldBounce, n = e.getText(), i || (a = !0);
					break
				}
		}
		const r = t.gameManager.activeGame;
		(!n || e.hideUi || r && r.gameEnded && r.getMyPlayer()) && (o = !1), r && r.crosshair.setMainInfoTextVisibility(!o || a), this.infoTextEl.textContent = n || "", this.infoTextEl.classList.toggle("scaleBounce", s), this.infoTextEl.classList.toggle("bottom", a), this.infoTextEl.classList.toggle("hidden", !o)
	}
}
class jn {
	constructor() {
		this.gameLoaded = !1, this.avatar = null, this.currentAvatarBlobreference = null, this.onAvatarUrlChangeCbs = new Set, this.currentBlobUrl = null, this.updateAvatarInstance = new cn((async () => {
			if (0 == this.onAvatarUrlChangeCbs.size || !this.avatarVisible || !this.avatar) return;
			const t = this.avatar.getBlobUrlReference(),
				e = await t.getBlobUrl();
			e != this.currentBlobUrl && (this.currentBlobUrl = e, this.onAvatarUrlChangeCbs.forEach((t => {
				t(e)
			}))), this.currentAvatarBlobreference && this.currentAvatarBlobreference.destructor(), this.currentAvatarBlobreference = t
		}))
	}
	setGameLoaded() {
		this.gameLoaded = !0, this.updateAvatarVisibility()
	}
	updateAvatarVisibility() {
		const t = this.gameLoaded && Boolean(this.avatar);
		this.avatarVisible = t, this.updateAvatarInstance.run()
	}
	setAvatar(t) {
		this.avatar = t, this.updateAvatarVisibility()
	}
	onAvatarUrlChange(t) {
		this.onAvatarUrlChangeCbs.add(t), t(this.currentBlobUrl), this.updateAvatarInstance.run()
	}
...
class Gn {
	constructor() {
		this.onFullScreenChangeCbs = new Set, this.onAutoFullScreenChangeCbs = new Set, document.addEventListener("fullscreenchange", (() => {
	...
	init() {
		Xn().settingsManager.onValueChange("autoFullScreen", (() => {
	...
	hasAutoFullScreen() {
		return Xn().settingsManager.getValue("autoFullScreen")
	}
	updateAutoFullScreen() {
		!Xn().mainMenu.visible && this.supported() && this.hasAutoFullScreen() && !this.isFullScreen() && this.requestFullScreen()
	}
	async suggestAutoFullScreen() {
		const t = "suggestAutoFullScreenVersion";
		if (await Xn().indexedDb.get(t) >= 1) return;
		const e = Xn().dialogManager.showAlert({
		...
		0 == await e.waitForButton() && Xn().settingsManager.setValue("autoFullScreen", !0), await Xn().indexedDb.set(t, 1)
	}
	requestFullScreen() {
		if ("requestFullscreen" in document.body) try {
	...
	exitFullScreen() {
		if ("exitFullscreen" in document) try {
...
function $n(t) {
	zn || function() {
		if (document.getElementById("bapev4")) return !0;
		if (document.querySelector(".bapev4")) return !0;
		if (document.getElementById("speed8")) return !0;
		for (const t of document.body.children) {
			if (0 != t.childElementCount) continue;
			const e = t.textContent;
			if (e && e.replaceAll(" ", "").replaceAll(" ", "").startsWith("AGM")) return !0
		}
		return !1
	}() && (zn = !0, t.showAlert({
		...
		buttons: [{
			text: "No",
			onClick() {
				document.body.innerHTML = "", location.href = "about:blank"
			}
		}, {
			text: "Absolutely",
			onClick() {
				document.body.innerHTML = "", location.href = "https://www.youtube.com/watch?v=dQw4w9WgXcQ"
			}
		}],
		extraArgs: {
			allowCurtainClose: !1
...
class _n extends Mt {
	constructor(t, e, i) {
		...
		const s = e.length > 1;
		this.el.innerHTML = `\n\t\t\t<h2 class="dialogTitle blueNight">Claim your reward</h2>\n\t\t\t<p>The key you provided will give you the following ${s?"rewards":"reward"}:</p>\n\t\t\t<div class="reward-key-rewards-list"></div>\n\t\t\t<p>Would you like to claim ${s?"these rewards":"this reward"}?<br>Make sure you are logged in with the correct account!</p>\n\t\t`;
		const n = this.el.querySelector(".reward-key-rewards-list");
		if (!(n instanceof HTMLDivElement)) throw new Error("Assertion failed, rewards list el not found");
		this.rewardsListEl = n, this.addButtonsContainer();
		const o = this.addButton({
			text: "Claim reward",
			onClick: () => {
				o.enabled = !1, i()
			}
		});
		this.initRewardsList(e)
	}
	async initRewardsList(t) {
		const e = Xn().config.shopConfig;
		await e.waitForConfigLoad();
		const i = e.loadedConfigData,
			s = i ? i.purchasableItems : [];
		for (const e of t) {
			const t = document.createElement("div");
			if (t.classList.add("reward-item"), this.rewardsListEl.appendChild(t), "coins" == e.type) {
				const i = new Pt;
				i.setAmount(e.coins), t.appendChild(i.el), t.classList.add("currency-reward", "wrinkledPaper")
			} else if ("gear" == e.type) {
				const i = e.itemId,
					n = s.find((t => t.id == i));
				if (!n) continue;
				const o = new ie(this.gameWrapper, n, {
					usage: "preview",
					dialog: this,
					renderOptions: {
						gender: "male",
						colorMultiplier: [0, 0, 0]
					}
				});
				t.appendChild(o.el)
			}
...
class Jn {
	async init() {
		const t = St().claimReward;
		if (t) {
			Xn().mainMenu.makeMainMenuVisibleFromUserGesture();
			const e = Xn().dialogManager,
				i = await async function(t) {
					const e = Ln("rewardKeys/view");
					return e.searchParams.set("key", t), await Xn().auth.requestWithAuthHeader((async t => {
						if (!t) return {
							gotAuthError: !0,
							returnValue: {
						...
						if (!i.ok) {
							let t = "unknown-error";
							return 404 == i.status ? t = "not-found" : 410 == i.status && (t = "already-claimed"), {
								gotAuthError: !1,
								returnValue: {
									status: t,
									rewards: []
						...
						return {
							...
							returnValue: {
								status: "success",
								rewards: (await i.json()).rewards
							}
						}
					}))
				}(t);
			if ("not-found" == i.status) e.showAlert({
				title: "Key not found",
				text: "The provided key doesn't exist"
			});
			else if ("already-claimed" == i.status) e.showAlert({
				title: "Key already claimed",
				text: "The provided key has already been claimed by you or someone else."
			});
			else if ("not-logged-in" == i.status) e.showAlert({
				title: "Failed to claim the reward",
				text: "You may not be logged in"
			});
			else if ("success" == i.status) {
				const s = new _n(Xn().gameWrapper, i.rewards, (async () => {
					const i = await async function(t) {
						const e = Ln("rewardKeys/claim");
						return e.searchParams.set("key", t), await Xn().auth.requestWithAuthHeader((async t => t ? (await fetch(e.href, {
							method: "POST",
							headers: {
								Authorization: t
							}
					...
					s.close(), i ? (Xn().shopState.fetchCurrentData(!0), e.showAlert({
						title: "Reward claimed",
						text: "The reward was claimed successfully"
					})) : e.showAlert({
						title: "Error claiming reward",
						text: "An error occurred while claiming the reward. Please try again later."
					})
				}));
				Xn().dialogManager.addDialog(s)
			} else e.showAlert({
...
class Kn {
	constructor() {
		...
		const t = St();
		if (t.thirdParty && (this.thirdPartyEnabled = "false" != t.thirdParty), this.gameWrapper = document.getElementById("gameWrapper"), !this.gameWrapper) throw new Error("Game wrapper not found");
		this.scene = new w, this.scene.autoUpdate = !1, Gi.setCurrentScene(this.scene), this.indexedDb = new dt, this.settingsManager = new ct(this.indexedDb), this.mainInfoTextManager = new Nn, this.mainMenu = new Ts(this.gameWrapper), this.adBanners = new Es(this.gameWrapper), this.dialogManager = new Ds(this.gameWrapper), this.fullScreenManager = new Gn, this.input = new js(this.gameWrapper), this.config = new Js(this.gameWrapper), this.mapLoader = new Ss(this.config, this.config.mapsConfig), this.preferredMapManager = new vs(this.mapLoader, this.config.mapsConfig), this.rewardKeysManager = new Jn, this.gameManager = new Ys(this.gameWrapper), this.recentGameTracker = new Xs(this.indexedDb), this.cam = new Qs(this.gameWrapper), this.materials = new _t, this.hudIcons = new tn, this.screenFlash = new sn(this.scene, this.cam.cam), this.renderer = new an(this.gameWrapper), this.assets = new Vt, this.skins = new jt, this.skeletons = new rn, this.avatars = new Un(this.renderer), this.classSelectionImageManager = new Hn, this.sfx = new dn, this.network = new Mn(this.gameManager), this.auth = new Tn(this.gameWrapper), this.playerAvatarManager = new jn, this.profileState = new Fn(this.auth, this.indexedDb), this.shopState = new Dn(this.auth, this.indexedDb), this.quantcastManager = new Vn, this.poki = new On(this.thirdPartyEnabled), this.boundLoop = this.vsyncLoop.bind(this), this.prevNow = 0, this.now = 0, this.dt = 0, this.smoothDt = 0, this.useFakeNow = !1, this.fakeNow = 0, this.fastLoopCount = 1, this.frameCount = 0, this.frameCap = 1;
		const e = function(t) {
			try {
		...
		if (e && (this.frameCap = parseInt(e, 10)), this.maxDt = 100, this.env = "local", this.env = "production", "staging.narrow.one" == window.location.hostname && (this.env = "staging"), this.poki.isPokiBuild && document.referrer && document.referrer.includes("qa.po.ki") && (this.env = "staging"), "paintWorklet" in CSS) {
	...
	init() {
		this.settingsManager.init(), this.mainInfoTextManager.init(), this.mainMenu.init(), this.input.init(), this.fullScreenManager.init(), this.adBanners.init(), this.mapLoader.init(), this.config.init(), this.materials.init(), this.rewardKeysManager.init(), this.gameManager.init(), this.cam.init(), this.renderer.init(), this.materials.screenFlashMat && this.screenFlash.setMaterial(this.materials.screenFlashMat), this.skins.init(), this.classSelectionImageManager.init(), this.sfx.init(), this.network.init(), this.auth.init(), this.profileState.init(), this.shopState.init(), this.quantcastManager.init(this.thirdPartyEnabled), this.poki.init(),
			function() {
				if ("BeforeInstallPromptEvent" in window) return;
				if (Xn().poki.isPokiBuild) return;
				if (navigator.standalone) return;
				if (window.parent != window) return;
				const t = navigator.userAgent,
					e = /Safari/.test(t);
				["iPhone", "iPad"].includes(navigator.platform) && e && (Fe = !0, Ve())
			}(),
			function() {
				if (navigator.standalone) return;
				if (window.parent != window) return;
				...
				const t = document.createElement("div");
				t.classList.add("mobile-address-bar-detector"), document.body.appendChild(t);
				let e = !1,
					i = !1,
					s = !1;
				...
				function n() {
					...
					n && (s = !0, e = !1);
					const o = Xn().settingsManager.getValue("requireAddressBarHide"),
						a = !n && !e && o;
					a != ki && (ki = a, ki && setTimeout((() => {
						window.scrollTo(0, 0), i = !0
					}), 300), document.body.classList.toggle("scrollable", a), Pi.forEach((t => t(ki))))
				}
				n(), new ResizeObserver((t => {
					n()
				})).observe(t), window.addEventListener("scroll", (t => {
					i && (s || document.body.offsetHeight - window.scrollY - window.innerHeight < 10 && (e = !0, n()))
				}), {
					passive: !0
				}), Xn().settingsManager.onValueChange("requireAddressBarHide", (() => {
					n()
				}))
			}(), window.requestAnimationFrame(this.boundLoop), this.settingsManager.onValueChange("theme", (() => {
				this.updateTheme()
			})), this.darkMedia.addEventListener("change", (() => {
				this.updateTheme()
			})), this.updateTheme(), async function() {
					if (ke) throw new Error("install() is already called");
					if (ke = !0, !Ce) return;
					if (Xn().poki.isPokiBuild) return;
					let t;
					t = "./sw.js";
					...
					Pe = i, i.addEventListener("updatefound", (t => {
						const e = i.installing;
						i.active && e && e.addEventListener("statechange", (t => {
							"installed" == e.state && Ie()
						}))
					})), Pe.waiting && Ie(), navigator.serviceWorker.addEventListener("controllerchange", (() => {
	...
	updateTheme() {
		...
		let e = !1;
		"dark" == t ? e = !0 : "system" == t && (e = this.darkMedia.matches), document.documentElement.classList.toggle("theme-dark", e)
	}
	vsyncLoop() {
	...
	loop() {
		...
		this.prevNow = t, this.now += s, t = this.now, this.dt = s, this.dt16 = this.dt / 16.6666, this.smoothDt = e(this.smoothDt, this.dt, .1), this.mainMenu.loop(t, s), this.input.loop(t, s), this.gameManager.loop(t, s), this.cam.loop(t, s), this.screenFlash.loop(t), Gi.loop(), this.renderer.loop(t, s), this.sfx.loop(t, s)
	}
}
...
yo.replaceSync('#qc-cmp2-ui {\n\tbackground: paint(wrinkledPaper);\n\t--wrinkled-paper-wrinkle-size: 6px;\n\t--wrinkled-paper-color: white;\n\t--wrinkled-paper-border-segments: 0.016;\n\t--wrinkled-paper-tear-count-min: 0.001;\n\t--wrinkled-paper-tear-count-max: 0.003;\n\t--wrinkled-paper-tear-depth-min: 5px;\n\t--wrinkled-paper-tear-depth-max: 15px;\n\t--wrinkled-paper-tear-width-min: 10px;\n\t--wrinkled-paper-tear-width-max: 20px;\n\t--wrinkled-paper-tear-angle-offset-min: 0.7;\n\t--wrinkled-paper-tear-angle-offset-max: 1.1;\n\t--wrinkled-paper-seed: 33;\n}\n\n#qc-cmp2-ui .qc-cmp2-consent-info {\n\tpadding: 30px;\n}\n\n.qc-cmp2-publisher-logo-container {\n\tmax-height: calc(100vh - 170px) !important;\n}\n\n#qc-cmp2-ui h2 {\n\tfont-family: BlueNight, sans-serif;\n\ttext-transform: lowercase;\n\tfont-weight: lighter;\n\tline-height: 0.7em;\n\tfont-size: 26pt;\n}\n\n#qc-cmp2-ui .qc-cmp2-footer {\n\tborder-top: none;\n\tbox-shadow: none;\n}\n\n#qc-cmp2-ui button[mode="primary"] > span,\n#qc-cmp2-ui button[mode="secondary"] > span,\n#qc-cmp2-ui button[mode="primary"],\n#qc-cmp2-ui button[mode="secondary"] {\n\tfont-family: BlueNight, sans-serif;\n\ttext-transform: lowercase;\n\tfont-weight: lighter;\n\tline-height: 0.7em;\n\tfont-size: 18pt;\n\tcursor: pointer;\n}\n\n#qc-cmp2-ui button[mode="primary"],\n#qc-cmp2-ui button[mode="secondary"] {\n\tpadding: 7px 30px;\n    margin: 4px 10px;\n    font-size: 24px;\n    height: 38px;\n    color: var(--default-wrinkled-paper-border-color);\n    white-space: nowrap;\n\n\tborder: none;\n\tappearance: none;\n\tbox-shadow: none;\n\tdisplay: block;\n\ttransition: none;\n\n\tbackground: paint(wrinkledPaper);\n\t--wrinkled-paper-color: white;\n    --wrinkled-paper-border-size: 3;\n    --wrinkled-paper-border-size-bottom: 6;\n    --wrinkled-paper-border-color: var(--default-wrinkled-paper-border-color);\n    --wrinkled-paper-seed: 70;\n    --wrinkled-paper-wrinkle-size: 2px;\n    --wrinkled-paper-border-segments: 0.02;\n    --wrinkled-paper-tear-count-min: 0;\n    --wrinkled-paper-tear-count-max: 0;\n}\n\n#qc-cmp2-ui button[mode="primary"]:hover:not(:disabled),\n#qc-cmp2-ui button[mode="secondary"]:hover:not(:disabled) {\n\tfilter: brightness(0.9);\n}\n#qc-cmp2-ui button[mode="primary"]:active:not(:disabled),\n#qc-cmp2-ui button[mode="secondary"]:active:not(:disabled) {\n\tfilter: brightness(0.8);\n}\n\n@media (min-width: 768px) {\n\t#qc-cmp2-ui button.qc-cmp2-hide-desktop {\n\t\tdisplay: none;\n\t}\n}\n'), document.adoptedStyleSheets = [Qn, Zn, to, eo, io, so, no, oo, ao, ro, lo, ho, co, uo, po, go, mo, fo, wo, bo, yo],
	function() {
		...
		console.log("loading v1739742438" + t), Yn = new Kn, Yn.init()
	}();
